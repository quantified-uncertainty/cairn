...
---
import { ArgumentMap, DisagreementMap, InfoBox, KeyQuestions, Mermaid } from '../../../../components/wiki';
...
|-------------|---------------------------|---------------|--------------------|-----------------------|
| Anthropic | [Scaling Monosemanticity](https://transformer-circuits.pub/2024/scaling-monosemanticity/) | Claude 3 Sonnet (production model) | 34 million features | 70% human-interpretable |
| OpenAI | [Extracting Concepts from GPT-4](https://openai.com/index/extracting-concepts-from-gpt-4/) | GPT-4 | 16 million features | Many still difficult to interpret |
| DeepMind | [Gemma Scope](https://deepmind.google/discover/blog/gemma-scope-helping-the-safety-community-shed-light-on-the-inner-workings-of-language-models/) | Gemma 2 (2B-9B parameters) | Hundreds of SAEs released | Open for research |
| MIT (MAIA) | [Automated interpretability agent](https://news.mit.edu/2024/mit-researchers-advance-automated-interpretability-ai-models-maia-0723) | Vision-language models | Automated discovery | Reduces labor bottleneck |
...
Research on [AI Alignment through RLHF](https://arxiv.org/abs/2406.18346) identifies fundamental vulnerabilities:
...
|------|-----------|--------------|--------|
| 2020 | [Circuits in CNNs](https://distill.pub/2020/circuits/) | First demonstration of interpretable circuits in vision models | Olah et al. |
| 2021 | [A Mathematical Framework for Transformer Circuits](https://transformer-circuits.pub/2021/framework/index.html) | Formal framework for understanding transformers | Anthropic |
| 2022 | [Induction Heads](https://transformer-circuits.pub/2022/in-context-learning-and-induction-heads/index.html) | Key mechanism for in-context learning identified | Anthropic |
| 2023 | [Towards Monosemanticity](https://transformer-circuits.pub/2023/monosemantic-features/index.html) | Sparse autoencoders extract interpretable features from 1-layer transformers | Anthropic |
| 2024 (Jan) | 8-layer SAE features | SAEs work on deeper transformers | Anthropic |
| 2024 (May) | [Scaling Monosemanticity](https://transformer-circuits.pub/2024/scaling-monosemanticity/) | **34M features from Claude 3 Sonnet; 70% interpretable** | Anthropic |
| 2024 (Jun) | [GPT-4 concepts](https://openai.com/index/extracting-concepts-from-gpt-4/) | 16M features extracted from GPT-4 | OpenAI |
| 2024 (Jul) | [Gemma Scope](https://deepmind.google/discover/blog/gemma-scope-helping-the-safety-community-shed-light-on-the-inner-workings-of-language-models/) | Open SAE suite for Gemma 2 | DeepMind |
| 2024 (Jul) | [MAIA](https://news.mit.edu/2024/mit-researchers-advance-automated-interpretability-ai-models-maia-0723) | Automated interpretability agent | MIT |
| 2025 | [Gemma Scope 2](https://deepmind.google/blog/gemma-scope-2-helping-the-ai-safety-community-deepen-understanding-of-complex-language-model-behavior/) | Largest open-source interpretability release (110 PB, 1T+ parameters trained) | DeepMind |
...
Per [Bereska & Gavves (2024)](https://arxiv.org/abs/2404.14082), a comprehensive review of mechanistic interpretability for AI safety:
