---
title: "Critical Outcomes"
description: "Intermediate scenarios between parameters and ultimate outcomes—the specific ways AI development could lead to catastrophe or beneficial transformation."
sidebar:
  label: Overview
  order: 0
