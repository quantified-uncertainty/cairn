...
Parameters aggregate upward into outcomes we care about. This hierarchy helps us understand which parameter changes matter most for which outcomes.
...
| Outcome | Question | Primary Aggregates |
|---------|----------|-------------------|
| [Acute Risk](/knowledge-base/parameters/outcomes/acute-risk/) | What's the probability of catastrophe? | Technical Safety ↓, Threat Environment ↑ |
| [Steady State](/knowledge-base/parameters/outcomes/steady-state/) | If we survive, what world do we get? | Epistemic Foundation, Governance |
| [Transition](/knowledge-base/parameters/outcomes/transition-smoothness/) | How rough is the path? | Societal Adaptability, Governance |

### Five Aggregate Parameters

| Aggregate | Primary Outcome | Components |
|-----------|-----------------|------------|
| [Technical Safety](/knowledge-base/parameters/aggregates/technical-safety/) | Acute Risk ↓ | Alignment, Interpretability, Oversight, Safety Culture |
| [Threat Environment](/knowledge-base/parameters/aggregates/threat-environment/) | Acute Risk ↑ | Bio/Cyber Exposure, Concentration, Racing |
| [Governance Capacity](/knowledge-base/parameters/aggregates/governance-capacity/) | All three | Regulation, Coordination, Institutions |
| [Epistemic Foundation](/knowledge-base/parameters/aggregates/epistemic-foundation/) | Steady State | Trust, Information Authenticity, Epistemic Health |
| [Societal Adaptability](/knowledge-base/parameters/aggregates/societal-adaptability/) | Transition | Resilience, Economic Stability, Human Expertise |
