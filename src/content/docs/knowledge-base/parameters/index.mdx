...
Parameters flow upward through four levels, from concrete measurable variables to ultimate outcomes we care about:

```
Leaf Parameters (24) → Aggregate Parameters (5) → Critical Outcomes (8) → Ultimate Outcomes (2)
```
...
flowchart TD
    ...
    subgraph LeafParams["Leaf Parameters"]
        MORE[24 total...]
    end
...
<CauseEffectGraph
  ...
  initialNodes={[
    ...
    // === AGGREGATE PARAMETERS (second row) ===
    {
      id: 'tech-safety',
      type: 'causeEffect',
      position: { x: 0, y: 0 },
      data: {
        ...
        description: 'How well we can build AI systems that behave as intended.',
        type: 'cause',
        confidence: 0.55,
        confidenceLabel: 'current level',
        details: 'Technical Safety aggregates alignment robustness, interpretability coverage, human oversight quality, and safety culture. Low technical safety enables both rapid and gradual AI takeover scenarios.',
        relatedConcepts: ['Alignment', 'Interpretability', 'Scalable Oversight', 'RLHF'],
    ...
    },
    {
      ...
      data: {
        ...
        description: 'External pressures that make catastrophe more likely.',
        type: 'cause',
        confidence: 0.65,
        confidenceLabel: 'severity',
        details: 'Includes biological and cyber threat exposure, racing dynamics between labs/nations, and power concentration risks. High threat environment enables state and rogue actor catastrophes.',
    ...
    },
    {
      ...
      data: {
        ...
        description: 'Ability of institutions to effectively manage AI development.',
        type: 'cause',
        confidence: 0.40,
        confidenceLabel: 'current level',
        details: 'Includes regulatory capacity, international coordination, and institutional quality. Low governance enables gradual takeover, state catastrophes, and shapes what values get locked in.',
        relatedConcepts: ['AI Regulation', 'International Coordination', 'Compute Governance'],
        sources: ['GovAI Research', 'CAIS Policy Work']
      }
    },
    {
      id: 'epistemic',
      ...
      position: { x: 0, y: 0 },
      data: {
        label: 'Epistemic Foundation',
        description: 'Society\'s capacity for truth-finding and shared reality.',
        type: 'cause',
        confidence: 0.50,
        confidenceLabel: 'current level',
        details: 'Includes societal trust, information authenticity, and epistemic health. Shapes whether we get epistemic renaissance or collapse, and affects gradual takeover risk.',
        relatedConcepts: ['Misinformation', 'Deepfakes', 'Trust Decline', 'Content Authentication'],
        sources: ['Partnership on AI', 'Chesney & Citron on Deepfakes']
      }
    },
    {
      id: 'adaptability',
      ...
      data: {
        ...
        description: 'Society\'s capacity to adapt to rapid AI-driven change.',
        type: 'cause',
        confidence: 0.45,
        confidenceLabel: 'current level',
        details: 'Includes societal resilience, economic stability, and human expertise preservation. Shapes power transition dynamics, lock-in risk, and transition turbulence.',
        relatedConcepts: ['Economic Disruption', 'Job Displacement', 'Human Agency', 'Skill Atrophy'],
        sources: ['IMF AI Reports', 'Korinek Scenario Planning']
      }
    },
    {
      id: 'turb',
    ...
    },
    {
      ...
      data: {
        ...
        description: 'What\'s the expected value of the post-transition world?',
        type: 'effect',
        confidence: 0.50,
        confidenceLabel: 'high uncertainty',
        details: 'Conditional on avoiding acute catastrophe, what quality of future do we get? Depends on what values get locked in, epistemic trajectory, and how power transition unfolds.',
        relatedConcepts: ['Flourishing', 'Dystopia', 'Human Agency', 'Existential Hope'],
        sources: ['MacAskill What We Owe The Future', 'Foresight Existential Hope']
      }
    }
  ]}
  initialEdges={[
    // === LEAF → AGGREGATE edges ===
    { id: 'e-capspeed-tech', source: 'capabilities-speed', target: 'tech-safety', data: { strength: 'medium', effect: 'decreases' } },
    { id: 'e-capspeed-threat', source: 'capabilities-speed', target: 'threat-env', data: { strength: 'medium', effect: 'increases' } },
    { id: 'e-rsi-tech', source: 'rsi-potential', target: 'tech-safety', data: { strength: 'strong', effect: 'decreases' } },
    { id: 'e-align-tech', source: 'alignment-robustness', target: 'tech-safety', data: { strength: 'strong', effect: 'increases' } },
    { id: 'e-interp-tech', source: 'interpretability-coverage', target: 'tech-safety', data: { strength: 'strong', effect: 'increases' } },
    { id: 'e-gap-tech', source: 'safety-gap', target: 'tech-safety', data: { strength: 'strong', effect: 'decreases' } },
    { id: 'e-oversight-tech', source: 'human-oversight', target: 'tech-safety', data: { strength: 'strong', effect: 'increases' } },
    { id: 'e-culture-tech', source: 'safety-culture', target: 'tech-safety', data: { strength: 'medium', effect: 'increases' } },
    { id: 'e-racing-threat', source: 'racing-intensity', target: 'threat-env', data: { strength: 'strong', effect: 'increases' } },
    { id: 'e-racing-tech', source: 'racing-intensity', target: 'tech-safety', data: { strength: 'medium', effect: 'decreases' } },
    ...
    { id: 'e-intl-gov', source: 'intl-coordination', target: 'governance', data: { strength: 'strong', effect: 'increases' } },
    { id: 'e-trust-epist', source: 'societal-trust', target: 'epistemic', data: { strength: 'strong', effect: 'increases' } },
    { id: 'e-auth-epist', source: 'info-authenticity', target: 'epistemic', data: { strength: 'strong', effect: 'increases' } },
    { id: 'e-agency-adapt', source: 'human-agency', target: 'adaptability', data: { strength: 'strong', effect: 'increases' } },
    { id: 'e-expertise-adapt', source: 'human-expertise', target: 'adaptability', data: { strength: 'medium', effect: 'increases' } },
    ...
    // === AGGREGATE → CRITICAL OUTCOME edges ===
    { id: 'e-tech-fast', source: 'tech-safety', target: 'fast-takeover', data: { strength: 'strong', confidence: 'high', effect: 'decreases' } },
    { id: 'e-tech-slow', source: 'tech-safety', target: 'slow-takeover', data: { strength: 'strong', confidence: 'high', effect: 'decreases' } },
    ...
    { id: 'e-gov-slow', source: 'governance', target: 'slow-takeover', data: { strength: 'medium', confidence: 'medium', effect: 'decreases' } },
    { id: 'e-gov-state', source: 'governance', target: 'state-catastrophe', data: { strength: 'medium', confidence: 'medium', effect: 'decreases' } },
    { id: 'e-gov-lock', source: 'governance', target: 'lock-in', data: { strength: 'medium', confidence: 'medium', effect: 'decreases' } },
    { id: 'e-epist-traj', source: 'epistemic', target: 'epistemic-traj', data: { strength: 'strong', confidence: 'high', effect: 'increases' } },
    { id: 'e-epist-slow', source: 'epistemic', target: 'slow-takeover', data: { strength: 'weak', confidence: 'low', effect: 'decreases' } },
    { id: 'e-adapt-power', source: 'adaptability', target: 'power-trans', data: { strength: 'strong', confidence: 'medium', effect: 'increases' } },
    { id: 'e-adapt-lock', source: 'adaptability', target: 'lock-in', data: { strength: 'medium', confidence: 'medium', effect: 'decreases' } },
    { id: 'e-adapt-turb', source: 'adaptability', target: 'turb', data: { strength: 'strong', confidence: 'high', effect: 'decreases' } },
    { id: 'e-turb-acute', source: 'turb', target: 'acute-risk', data: { strength: 'medium', confidence: 'medium', effect: 'increases' } },
    { id: 'e-turb-value', source: 'turb', target: 'longrun-value', data: { strength: 'medium', confidence: 'medium', effect: 'decreases' } },
    ...
    { id: 'e-slow-value', source: 'slow-takeover', target: 'longrun-value', data: { strength: 'strong', confidence: 'medium', effect: 'decreases' } },
    ...
    { id: 'e-lock-value', source: 'lock-in', target: 'longrun-value', data: { strength: 'strong', confidence: 'high', effect: 'increases' } },
    { id: 'e-epist-value', source: 'epistemic-traj', target: 'longrun-value', data: { strength: 'medium', confidence: 'medium', effect: 'increases' } },
    { id: 'e-power-value', source: 'power-trans', target: 'longrun-value', data: { strength: 'medium', confidence: 'medium', effect: 'increases' } }
  ]}
/>
...
| Outcome | Question | Primary Critical Outcomes |
|---------|----------|--------------------------|
| [Acute Risk](/knowledge-base/parameters/outcomes/acute-risk/) | Does catastrophe occur? | AI Takeover, State/Rogue Catastrophe, Transition Turbulence |
| [Long-run Value](/knowledge-base/parameters/outcomes/long-run-value/) | What's the future worth? | Value Lock-in, Epistemic Trajectory, Power Transition |

### Eight Critical Outcomes

[Critical Outcomes](/knowledge-base/parameters/critical-outcomes/) are the intermediate scenarios connecting parameters to ultimate outcomes—they describe *how* parameter changes lead to catastrophe or success. Note that these interact with each other (e.g., State-Caused Catastrophe can lead to Value Lock-in).

| Critical Outcome | Polarity | Key Aggregates | Ultimate Outcomes |
|-----------------|----------|----------------|-------------------|
| [Transition Turbulence](/knowledge-base/parameters/critical-outcomes/transition-turbulence/) | Negative | Societal Adaptability | Acute Risk, Long-run Value |
| [Rapid AI Takeover](/knowledge-base/parameters/critical-outcomes/ai-takeover-fast/) | Negative | Technical Safety, Threat Environment | Acute Risk |
| [Gradual AI Takeover](/knowledge-base/parameters/critical-outcomes/ai-takeover-gradual/) | Negative | Technical Safety, Governance, Epistemic | Acute Risk, Long-run Value |
| [State-Caused Catastrophe](/knowledge-base/parameters/critical-outcomes/state-actor-catastrophe/) | Negative | Threat Environment, Governance | Acute Risk → Lock-in |
| [Rogue Actor Catastrophe](/knowledge-base/parameters/critical-outcomes/rogue-actor-catastrophe/) | Negative | Threat Environment | Acute Risk |
| [Value Lock-in](/knowledge-base/parameters/critical-outcomes/value-lock-in/) | Symmetric (±) | Governance, Adaptability | Acute Risk, Long-run Value |
| [Epistemic Quality](/knowledge-base/parameters/critical-outcomes/epistemic-quality/) | Symmetric (±) | Epistemic Foundation | Long-run Value |
| [Power Transition](/knowledge-base/parameters/critical-outcomes/power-transition/) | Neutral | Societal Adaptability | Long-run Value |

### Five Aggregate Parameters

Each aggregate influences multiple critical outcomes (not just one):

| Aggregate | Critical Outcomes Influenced | Components |
|-----------|------------------------------|------------|
| [Technical Safety](/knowledge-base/parameters/aggregates/technical-safety/) | Rapid + Gradual AI Takeover | Alignment, Interpretability, Oversight, Safety Culture |
| [Threat Environment](/knowledge-base/parameters/aggregates/threat-environment/) | Rapid AI Takeover, State + Rogue Catastrophes | Bio/Cyber Exposure, Concentration, Racing |
| [Governance Capacity](/knowledge-base/parameters/aggregates/governance-capacity/) | Gradual AI Takeover, State Catastrophe, Lock-in | Regulation, Coordination, Institutions |
| [Epistemic Foundation](/knowledge-base/parameters/aggregates/epistemic-foundation/) | Gradual AI Takeover, Epistemic Trajectory | Trust, Information Authenticity, Epistemic Health |
| [Societal Adaptability](/knowledge-base/parameters/aggregates/societal-adaptability/) | Power Transition, Value Lock-in, Transition Turbulence | Resilience, Economic Stability, Human Expertise |
