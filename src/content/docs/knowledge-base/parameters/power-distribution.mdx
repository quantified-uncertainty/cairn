...
Power Distribution measures how concentrated or distributed power over AI development and deployment is across actors—including corporations, governments, and individuals. Unlike most parameters where "higher is better," power distribution has an **optimal range**: extreme concentration enables authoritarianism and regulatory capture, while extreme diffusion prevents coordination and creates race-to-the-bottom dynamics on safety standards.
...
This debate intersects directly with [coordination-level](/knowledge-base/parameters/coordination-level/) and [international-coordination](/knowledge-base/parameters/international-coordination/) parameters.
...
### Related Parameters
- [Coordination Level](/knowledge-base/parameters/coordination-level/) — How effectively actors coordinate on AI governance; directly shaped by power distribution
