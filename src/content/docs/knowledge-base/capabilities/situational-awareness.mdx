...
sidebar:
  order: 2
quality: 3
llmSummary: This page analyzes AI situational awareness - models' understanding
  of their own nature and circumstances. It identifies five levels from basic
  self-recognition to meta-strategic concealment, emphasizing how this
  capability enables deceptive alignment and undermines current safety
  assumptions.
