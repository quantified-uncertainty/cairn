...
sidebar:
  order: 10
quality: 3
llmSummary: Comprehensive analysis of AI's growing scientific research
  capabilities across domains like biology (AlphaFold), drug discovery, and
  materials science, demonstrating both transformative potential and dual-use
  risks including bioweapons development and accelerated AI progress that could
  compress safety timelines.
