...
sidebar:
  order: 10
quality: 3
llmSummary: Comprehensive analysis of AI systems' growing capabilities in
  conducting scientific research, from literature analysis to autonomous
  discovery. Highlights major successes like AlphaFold and explores dual-use
  safety implications including bioweapons risks and accelerated AI development.
