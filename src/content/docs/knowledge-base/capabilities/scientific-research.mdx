...
sidebar:
  order: 10
quality: 68
llmSummary: "Comprehensive overview of AI's scientific research capabilities, documenting breakthroughs like AlphaFold (solving 50-year protein folding problem, 200M+ structures predicted) and GNoME (2.2M new materials discovered at 71% validation rate). Assesses dual-use risks where systems accelerating beneficial research could equally enable bioweapons development, with autonomous AI scientists projected within 10-15 years creating urgent governance challenges."
