...
sidebar:
  order: 10
quality: 80
llmSummary: "Comprehensive overview of AI's scientific research capabilities, documenting breakthroughs like AlphaFold (solving 50-year protein folding problem, 214M structures predicted, 43,000 citations, 3M+ researchers in 190 countries) and GNoME (2.2M new materials discovered at 71% validation rate). AI drug candidates achieve 80-90% Phase I success rates versus 40-65% traditional, with Insilico Medicine reaching Phase II in 18 months versus 5+ years traditionally. Sakana's AI Scientist-v2 produced first fully AI-generated peer-reviewed paper. Assesses dual-use risks where systems accelerating beneficial research could equally enable bioweapons development."
...
The growth trajectory is striking: AI-discovered drug candidates entering clinical trials grew from just 3 in 2016 to 17 in 2020 and **67 in 2023**, representing a compound annual growth rate exceeding 60%. A [BiopharmaTrend report from April 2024](https://www.researchgate.net/publication/380223979_How_successful_are_AI-discovered_drugs_in_clinical_trials_A_first_analysis_and_emerging_lessons) found eight leading AI drug discovery companies had 31 drugs in human clinical trials: 17 in Phase I, five in Phase I/II, and nine in Phase II/III.

A prominent example is [Insilico Medicine's AI-designed drug candidate INS018_055](https://pmc.ncbi.nlm.nih.gov/articles/PMC12298131/) for idiopathic pulmonary fibrosis (IPF). This compound progressed from target identification to a preclinical candidate in under 18 months—a process that traditionally takes 5+ years—and has entered Phase II clinical trials. A systematic review found that 100% of 173 studies demonstrated some form of timeline impact from AI integration, signifying that AI consistently contributes to accelerating various stages of the drug development pipeline.

**Current limitations:** As of 2024, no AI-first-pipeline medications have reached market approval. From 2012 to 2024, partnerships between AI drug discovery companies and Big Pharma have not yet resulted in AI-discovered targets or AI-designed molecules reaching Phase II studies. The [global market for AI in drug discovery](https://www.coherentsolutions.com/insights/artificial-intelligence-in-pharmaceuticals-and-biotechnology-current-trends-and-innovations) is projected to grow from \$1.5 billion to approximately \$13 billion by 2032.
...
The updated [AI Scientist-v2](https://pub.sakana.ai/ai-scientist-v2/paper/paper.pdf) marked a historic first: a fully AI-generated manuscript successfully passed peer review at a recognized machine learning workshop (ICLR), exceeding the average human acceptance threshold. Researcher Cong Lu described the system as "equivalent to an early Ph.D. student" with "some surprisingly creative ideas"—though good ideas were vastly outnumbered by bad ones.

**Critical limitations:** An [independent evaluation](https://arxiv.org/abs/2502.14297) revealed significant shortcomings. The system's literature reviews produced poor novelty assessments, often misclassifying established concepts as novel. 42% of experiments failed due to coding errors, and the system lacks computer vision capabilities to fix visual issues in papers. It sometimes makes "critical errors when writing and evaluating results," especially when comparing magnitudes.
...
- **AlphaFold:** [Jumper et al., Nature 2021](https://www.nature.com/articles/s41586-021-03819-2) - Highly accurate protein structure prediction (43,000+ citations)
- **AlphaFold 3:** [Abramson et al., Nature 2024](https://www.nature.com/articles/s41586-024-07487-w) - Extended to protein-DNA-RNA-ligand interactions
- **AlphaFold Database:** [Varadi et al., NAR 2024](https://academic.oup.com/nar/article/52/D1/D368/7337620) - 214 million protein structures
- **GNoME:** [Merchant et al., Nature 2023](https://www.nature.com/articles/s41586-023-06735-9) - 2.2 million new crystal structures discovered

### AI Drug Discovery

- **AI Drug Discovery Survey:** [PMC 2025](https://pmc.ncbi.nlm.nih.gov/articles/PMC12298131/) - Comprehensive review of timeline impacts
- **Clinical Trial Success Rates:** [ResearchGate 2024](https://www.researchgate.net/publication/380223979_How_successful_are_AI-discovered_drugs_in_clinical_trials_A_first_analysis_and_emerging_lessons) - Analysis of AI-discovered drugs in trials
- **AI Pharma Market Trends:** [Coherent Solutions 2025](https://www.coherentsolutions.com/insights/artificial-intelligence-in-pharmaceuticals-and-biotechnology-current-trends-and-innovations)

### Automated Research Systems

- **The AI Scientist:** [Sakana AI 2024](https://sakana.ai/ai-scientist/) - First automated scientific discovery framework
- **AI Scientist-v2:** [Sakana AI 2025](https://pub.sakana.ai/ai-scientist-v2/paper/paper.pdf) - First AI-generated peer-reviewed paper
- **Independent Evaluation:** [arXiv 2025](https://arxiv.org/abs/2502.14297) - Critical assessment of AI Scientist limitations
- **A-Lab Berkeley:** [Berkeley Lab 2025](https://newscenter.lbl.gov/2025/09/04/how-berkeley-lab-is-using-ai-and-automation-to-speed-up-science-and-discovery/) - AI-robot materials synthesis

### Capability Trends

- **Epoch AI Capabilities Index:** [Epoch AI 2024](https://epoch.ai/data-insights/ai-capabilities-progress-has-sped-up) - Rate of improvement nearly doubled in 2024
- **Stanford AI Index:** [Stanford HAI 2024](https://aiindex.stanford.edu/report/) - Comprehensive AI progress tracking
- **Epoch AI Biology Coverage:** [Epoch AI 2024](https://epoch.ai/blog/announcing-expanded-biology-ai-coverage) - 360+ biological AI models tracked