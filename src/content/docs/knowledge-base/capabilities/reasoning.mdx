...
sidebar:
  order: 4
quality: 5
llmSummary: "Documents rapid advancement of AI reasoning from chain-of-thought (2022) to superhuman performance on structured tasks. As of late 2025: o4-mini 99.5% AIME (with tools), Gemini 2.5 Pro 92% AIME 2024, Claude 4 Opus 90% AIME. However, ARC-AGI-2 shows less than 3% model performance vs. 60% human average, and FrontierMath at only 15-19% reveals limits. Epoch AI's ECI shows 90% acceleration 2023-2025 from reasoning models. Critical safety finding: CoT faithfulness only 25-39%, making interpretability benefits fragile."
