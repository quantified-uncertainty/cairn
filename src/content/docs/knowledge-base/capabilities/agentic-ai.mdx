...
sidebar:
  order: 3
quality: 3
llmSummary: Comprehensive overview of agentic AI systems that autonomously take
  actions through tool use, planning, persistence, and reduced human oversight.
  Covers current examples, safety implications including power-seeking
  enablement, and various risk mitigation approaches.
