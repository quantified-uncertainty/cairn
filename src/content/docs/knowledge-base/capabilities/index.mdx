...
import { RiskRelationshipDiagram, EntityLink } from '../../../../components/wiki';
...
AI Capabilities is one of the five Root Factors in the <EntityLink id="ai-transition-model" />:

**<EntityLink id="ai-capabilities" />** — How powerful AI systems become across speed, generality, and autonomy dimensions.

Capability levels affect all three scenario pathways:
- **<EntityLink id="ai-takeover" />** — Higher capabilities enable both rapid and gradual takeover
- **<EntityLink id="human-catastrophe" />** — Capabilities determine what humans can do with AI
- **<EntityLink id="long-term-lockin" />** — Capabilities affect power distribution and value embedding
