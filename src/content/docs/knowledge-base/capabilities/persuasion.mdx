...
sidebar:
  order: 8
quality: 4
llmSummary: This comprehensive analysis examines AI systems' ability to
  influence human beliefs and behaviors through various persuasive techniques
  including personalization, deception, and social engineering. It finds that
  current AI already demonstrates significant persuasive capabilities that
  outperform humans in some contexts, with concerning implications for
  manipulation at scale and weakening of human autonomy.
