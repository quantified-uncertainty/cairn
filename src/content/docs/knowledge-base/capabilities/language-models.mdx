...
sidebar:
  order: 1
quality: 2
llmSummary: This page provides an overview of Large Language Models (LLMs),
  neural networks trained on text that demonstrate emergent capabilities like
  reasoning and coding. It covers capability progression from GPT-2 to o1,
  safety-relevant capabilities including both concerning aspects (persuasion,
  deception) and promising applications (interpretability, constitutional AI),
  along with current limitations and scaling trends.
