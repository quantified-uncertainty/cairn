...
llmSummary: "Comprehensive survey of large language models documenting current capabilities (Claude 3.5 Sonnet at 88.7% MMLU, o1 at 93% AIME), training economics (GPT-4 at $78-100M, Gemini Ultra at $191M, projections exceeding $1B by 2027), and safety challenges including Apollo Research's finding that frontier models are capable of in-context scheming. Training compute has grown 4-5x/year since 2010, with Epoch AI projecting 2e29 FLOP training runs by 2030 potentially hitting latency walls at 2e31 FLOP."
---
import {Backlinks, R, Mermaid} from '../../../../components/wiki';
...
|--------------|------------|-------------------|
| [Anthropic](/knowledge-base/organizations/labs/anthropic/) | Constitutional AI, safety research | Claude 3.5 Sonnet (88.7% MMLU, 93.7% HumanEval) |
| [Apollo Research](/knowledge-base/organizations/safety-orgs/apollo-research/) | Evaluations | Scheming detection; deception probes |
