...
import { Section, EntityCard, EntityCards, KeyQuestions } from '../../../../components/wiki';
...
- **[The Case FOR AI X-Risk](/knowledge-base/arguments/case-for-xrisk/)**: The strongest argument that AI poses existential risk, presented as formal logical structure
- **[The Case AGAINST AI X-Risk](/knowledge-base/arguments/case-against-xrisk/)**: The steelmanned skeptical position—why AI might not pose existential risk

### Arguments About Alignment Difficulty

- **[Why Alignment Might Be Hard](/knowledge-base/arguments/why-alignment-hard/)**: Core arguments for alignment being a fundamentally difficult problem
- **[Why Alignment Might Be Easy](/knowledge-base/arguments/why-alignment-easy/)**: Arguments that alignment is tractable with current or near-term methods
...
See the [Understanding AI Risk](/understanding-ai-risk/) section for conceptual background and the [Key Debates](/knowledge-base/debates/) section for ongoing disagreements.
