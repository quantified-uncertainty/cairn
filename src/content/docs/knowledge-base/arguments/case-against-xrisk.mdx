...
For comparison, prominent skeptics estimate even lower probabilities:
- **Yann LeCun**: Effectively 0% ("complete B.S.")
- **Andrew Ng**: No plausible path to extinction
- **Roman Yampolskiy** (for contrast): 99%
