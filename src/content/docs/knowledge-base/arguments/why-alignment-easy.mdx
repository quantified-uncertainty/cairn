...
importance: 5
quality: 4
llmSummary: This page presents the optimistic case for AI alignment
  tractability, arguing that current techniques (RLHF, Constitutional AI,
  interpretability) are working and will scale to advanced AI. It estimates
  70-85% probability of solving alignment in time, based on empirical progress,
  natural value learning, economic incentives, and sufficient time for research.
---
