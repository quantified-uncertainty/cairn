...
maturity: Neglected
quality: 4
llmSummary: Analyzes the risk of humans losing critical skills through
  over-reliance on AI, using examples from aviation (AF447 crash), medicine, and
  navigation. Documents a systematic progression from AI augmentation to
  complete dependency, with specific timelines and affected domains.
