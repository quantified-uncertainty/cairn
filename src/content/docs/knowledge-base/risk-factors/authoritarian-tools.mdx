...
maturity: Growing
quality: 2
llmSummary: This page examines how AI enables authoritarian control through
  surveillance, censorship, and predictive suppression, with particular focus on
  implementations in China and Russia. It argues that AI-enabled
  authoritarianism could create uniquely stable and durable repressive regimes.
