...
maturity: Growing
quality: 3
llmSummary: This page examines irreversible changes in AI development that could
  create permanent points of no return, including value lock-in, technological
  proliferation, and societal transformation. It distinguishes between decisive
  risks (sudden catastrophic events) and accumulative risks (gradual
  threshold-crossing), with particular focus on how AI systems might permanently
  embed certain values or become impossible to shut down.
