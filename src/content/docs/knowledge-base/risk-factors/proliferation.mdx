...
todo: "Add more analysis of open-source vs. closed debate; expand on compute governance as control point; include more recent proliferation examples from 2025; add comparative analysis to nuclear/bioweapon proliferation"
---
