...
importance: 62.5
llmSummary: "Quantitative model estimating AI disinformation's electoral impact through a causal pathway framework, finding 1.5-4x exposure multiplier and 1-3% expected vote shifts in close elections, with 1-3 elections potentially flipped globally per year. Provides concrete intervention costs ($100-500M ranges) and argues systemic democratic trust erosion may matter more than individual election outcomes."
---
