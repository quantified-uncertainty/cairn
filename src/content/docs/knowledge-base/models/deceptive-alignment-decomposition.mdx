...
llmSummary: This model decomposes deceptive alignment probability into five
  necessary conditions (mesa-optimization, misalignment, situational awareness,
  strategic deception, survival through safety training) using a multiplicative
  framework. It estimates a central case probability of 5% for deceptive
  alignment emerging, with ranges from 0.5% to 24% across scenarios.
---
