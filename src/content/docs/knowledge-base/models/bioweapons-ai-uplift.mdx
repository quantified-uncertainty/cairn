...
ratings:
  ...
  completeness: 5
importance: 82.5
llmSummary: "Uses mathematical modeling to estimate AI's marginal contribution to bioweapons risk across different actor types and attack phases, finding current uplift of 1.3-2.5x (2024) increasing to 3-5x by 2030. Identifies biosecurity evasion capabilities as the greatest concern, with AI able to evade 75%+ of DNA synthesis screening while providing limited knowledge uplift due to existing scientific literature accessibility."
---
