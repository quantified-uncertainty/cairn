...
llmSummary: This model quantifies AI's marginal contribution to bioweapons risk
  through 'uplift' ratios, finding current LLMs provide 1.3-2.5x uplift for
  non-experts but minimal uplift for experts. It projects uplift increasing to
  3-5x by 2030, with evasion capabilities (2-3x) significantly exceeding
  knowledge uplift (1.0-1.2x).
---
