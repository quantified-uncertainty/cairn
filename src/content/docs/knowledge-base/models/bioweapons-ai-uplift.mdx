...
ratings:
  ...
  completeness: 5
importance: 85.5
llmSummary: "Quantitative model estimating AI's marginal contribution to bioweapons risk across actor types and attack phases, finding modest current knowledge uplift (1.0-1.2x per RAND) but concerning evasion capabilities (2-3x, potentially 7-10x by 2028). Analysis reveals critical asymmetry: AI helps attackers circumvent biosecurity defenses more than it aids synthesis, suggesting adaptive screening should be prioritized over information restriction."
---
