...
description: "This model identifies high-leverage uncertainties in AI risk. Key variables include alignment difficulty (estimates range 15-30%), takeoff speed, and governance effectiveness (5-20%)."
