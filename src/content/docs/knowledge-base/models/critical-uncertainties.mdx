...
|-------------|----------|-------------------|------------------|
| **Expert Surveys** | [AI Impacts](https://arxiv.org/pdf/2401.02843), [Pew Research](https://www.pewresearch.org/internet/2025/04/03/how-the-us-public-and-ai-experts-view-artificial-intelligence/), [International AI Safety Report](https://internationalaisafetyreport.org/publication/international-ai-safety-report-2025) | Alignment difficulty, extinction probability, timeline estimates | Annual |
| **Forecasting Platforms** | [Metaculus](https://www.metaculus.com/questions/5121/when-will-the-first-general-ai-system-be-devised-tested-and-publicly-announced/), Manifold, Polymarket | AGI timelines, capability milestones, policy outcomes | Continuous |
| **Industry Reports** | [Stanford AI Index](https://hai.stanford.edu/ai-index/2025-ai-index-report), [McKinsey State of AI](https://www.mckinsey.com/capabilities/quantumblack/our-insights/the-state-of-ai), [Epoch AI](https://epoch.ai/blog/can-ai-scaling-continue-through-2030) | Compute trends, algorithmic progress, economic value | Annual |
| **Governance Tracking** | [IAPP AI Governance](https://iapp.org/resources/article/ai-governance-in-practice-report), regulatory databases | Policy stringency, compliance rates, enforcement actions | Quarterly |
...
The [AI Impacts 2023 survey](https://arxiv.org/pdf/2401.02843) of 2,788 AI researchers provides crucial data on expert disagreement:
...
The [IAPP AI Governance Survey 2024](https://iapp.org/resources/article/ai-governance-in-practice-report) found that only 25% of organizations have fully implemented AI governance programs despite 78% using AI—a 53-percentage-point gap. The [Stanford AI Index 2025](https://hai.stanford.edu/ai-index/2025-ai-index-report) reports U.S. federal agencies introduced 59 AI regulations in 2024, double the 2023 count.
...
**Governance maturity gap:** According to [Infosys research](https://www.allaboutai.com/resources/ai-statistics/ai-governance/), only 2% of companies meet gold-standard benchmarks for responsible AI controls—comprehensive controls, continuous monitoring, and proven effectiveness across the AI lifecycle.
...
The [safety funding gap](https://medium.com/@nomannayeem/the-ai-safety-crisis-hiding-behind-trillion-dollar-valuations-358e7fd0718e) is stark: capability investment to safety research is approximately 10,000:1 by some estimates. AI safety incidents surged 56.4% in 2024, with 233 documented failures. Total AI safety funding reached approximately \$100-650M annually (including internal lab budgets), versus \$10B+ in capability development. Mechanistic interpretability research, while [progressing](https://leonardbereska.github.io/blog/2024/mechinterpreview/), still lacks standardized metrics for "percentage of model explained."
...
**Expert survey limitations.** Much of the underlying data comes from expert surveys, which have known biases: AI researchers may systematically under- or over-estimate risks in their own field; sample selection may exclude important perspectives; and framing effects can significantly shift probability estimates. The [AI Impacts survey](https://arxiv.org/pdf/2401.02843) notes that question phrasing affected timeline estimates by 13-48 years.
...
|---------------|--------------|
| [Racing Dynamics Impact](/knowledge-base/models/racing-dynamics-impact/) | Explores economic/strategic variables in depth |
| [Capability Threshold Model](/knowledge-base/models/capability-threshold-model/) | Details capability threshold variables |
| [Lab Incentives Model](/knowledge-base/models/lab-incentives-model/) | Analyzes safety funding and coordination dynamics |
| [Warning Signs Model](/knowledge-base/models/warning-signs-model/) | Expands on warning shot and response lag variables |
| [International Coordination Game](/knowledge-base/models/international-coordination-game/) | Deep dive on US-China and multilateral dynamics |
...
### Expert Surveys
- [AI Impacts 2023 Survey](https://arxiv.org/pdf/2401.02843) - 2,788 AI researchers on timelines, risks, and alignment difficulty
- [Pew Research AI Survey 2024](https://www.pewresearch.org/internet/2025/04/03/how-the-us-public-and-ai-experts-view-artificial-intelligence/) - Expert vs. public opinion on AI impacts
- [International AI Safety Report 2025](https://internationalaisafetyreport.org/publication/international-ai-safety-report-2025) - 96 experts from 30 countries

### Industry & Research Reports
- [Stanford AI Index 2025](https://hai.stanford.edu/ai-index/2025-ai-index-report) - Comprehensive AI trends and metrics
- [Epoch AI: Can Scaling Continue Through 2030?](https://epoch.ai/blog/can-ai-scaling-continue-through-2030) - Compute and data projections
- [IAPP AI Governance Survey 2024](https://iapp.org/resources/article/ai-governance-in-practice-report) - Organizational governance maturity
- [McKinsey State of AI 2025](https://www.mckinsey.com/capabilities/quantumblack/our-insights/the-state-of-ai) - Enterprise AI adoption and risk management

### Forecasting Platforms
- [Metaculus AGI Forecasts](https://www.metaculus.com/questions/5121/when-will-the-first-general-ai-system-be-devised-tested-and-publicly-announced/) - Community predictions on capability milestones
- [80,000 Hours: Shrinking AGI Timelines](https://80000hours.org/2025/03/when-do-experts-expect-agi-to-arrive/) - Analysis of expert forecast evolution

### Safety Research
- [Mechanistic Interpretability Review](https://leonardbereska.github.io/blog/2024/mechinterpreview/) - State of the field assessment
- [AI Safety Funding Overview](https://www.lesswrong.com/posts/WGpFFJo2uFe5ssgEb/an-overview-of-the-ai-safety-funding-situation) - Funding landscape analysis