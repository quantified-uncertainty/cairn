...
ratings:
  ...
  completeness: 4
importance: 4
llmSummary: This model analyzes how AI surveillance technologies spread from
  developers to authoritarian regimes through commercial sales, development
  programs, joint ventures, and reverse engineering. It identifies semiconductor
  supply chains as the highest-leverage intervention point but estimates this
  advantage will erode within 5-10 years as domestic capabilities develop.
---
