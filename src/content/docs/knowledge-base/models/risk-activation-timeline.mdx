...
description: This model maps when risks become critical based on capability
  levels. Near-term risks activate at current capabilities; transformative risks
  require advanced autonomous systems.
sidebar:
  order: 15
quality: 4
ratings:
...
importance: 85
llmSummary: This model systematically maps when different AI risks become
  critical based on capability thresholds, categorizing current risks
  (disinformation, economic displacement), near-term risks activating by
  2025-2027 (bioweapons, cyberweapons), and long-term existential risks
  requiring superintelligence. It provides specific activation windows, progress
  percentages toward thresholds, and identifies cascade effects between risk
  categories.
---
...
|-----------|------------|----------------------|
| **Potential severity** | Variable - ranges from medium (current) to existential (long-term) | Current risks: $10-50B annual impact; Long-term: civilization-level |
| **Probability-weighted importance** | Very High - multiple risks activating simultaneously | 3-5 risks crossing thresholds in 2025-2027 window |
| **Comparative ranking** | Meta-model for prioritizing across all risk categories | Informs allocation of $10B+ annual safety investment |

### Activation Probability by Year

| Risk Category | 2025 | 2027 | 2030 | 2035 |
|---------------|------|------|------|------|
| Mass disinformation at scale | 95% (active) | 99% | 99% | 99% |
| Cyberweapon autonomous discovery | 40% | 75% | 90% | 99% |
| Bioweapons uplift (meaningful) | 25% | 50% | 70% | 85% |
| Agentic system failures | 35% | 70% | 90% | 99% |
| Meaningful situational awareness | 20% | 50% | 75% | 90% |
| Authentication collapse | 30% | 60% | 80% | 95% |
| Mass unemployment crisis (>10%) | 15% | 40% | 65% | 85% |
| Strategic deception in AI | 5% | 20% | 45% | 70% |
| Misaligned superintelligence | Less than 1% | 3% | 15% | 35% |

### Resource Implications

| Priority | Investment Window | Recommended Investment | Expected Impact |
|----------|-------------------|----------------------|-----------------|
| Bioweapons screening | 2024-2027 | $500M-1B cumulative | Delays threshold 2-3 years |
| AI control research | 2024-2028 | $1-2B annually | Reduces control risk 30-50% |
| International governance | 2024-2027 | $200-500M cumulative | Establishes norms before crisis |
| Authentication systems | 2024-2026 | $300-600M cumulative | Preserves epistemic infrastructure |
| Interpretability research | Ongoing | $500M-1B annually | Enables detection across risks |

### Key Cruxes

| Crux | If True | If False | Current Assessment |
|------|---------|----------|-------------------|
| Scaling laws continue through 2030 | All timelines accelerate 2-3 years | More gradual activation | 60% likely |
| Open-source achieves parity by 2027 | Misuse risks accelerate significantly | Centralized mitigation possible | 55% likely |
| Major safety failure occurs | Accelerates governance, slows deployment | Smooth capability growth | 30% by 2028 |
| Alignment solved before ASI | Long-term risks substantially reduced | Current trajectory continues | 15% by 2035 |
