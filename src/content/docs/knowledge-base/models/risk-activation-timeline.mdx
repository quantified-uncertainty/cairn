...
importance: 5
llmSummary: This model maps when different AI risks become critical based on
  capability thresholds, finding many misuse risks are already active while
  existential risks require ASI-level systems. It identifies 2025-2027 as the
  critical window for bioweapons (25-50% activation), cyberweapons (40-75%), and
  agentic failures (35-70%).
---
