...
description: "This model maps technical pathways to AI risk. It identifies key branching points where technical choices significantly affect downstream risk profiles."
