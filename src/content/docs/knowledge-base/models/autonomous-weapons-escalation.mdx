...
ratings:
  ...
  completeness: 4
importance: 4
llmSummary: This model analyzes how autonomous weapons systems could trigger
  rapid military escalation due to machine-speed decision-making that outpaces
  human control. It estimates 1-5% annual probability of catastrophic escalation
  once systems are widely deployed, rising to 10-40% cumulative risk over a
  decade.
---
