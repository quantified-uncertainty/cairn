...
description: This model analyzes AI-accelerated conflict escalation risks. It
  estimates 1-5% annual probability of catastrophic escalation once autonomous
  systems are deployed, implying 10-40% cumulative risk over a decade.
sidebar:
  order: 23
quality: 4
...
ratings:
  ...
  completeness: 4
importance: 85.2
llmSummary: This model analyzes how autonomous weapons systems create escalation
  risks through speed mismatches between human decision-making (5-30 minutes)
  and machine action cycles (0.2-0.7 seconds), estimating 1-5% annual
  probability of catastrophic escalation and 10-40% cumulative risk over a
  decade once systems are deployed.
---
...
|-----------|------------|----------------------|
| **Potential severity** | Catastrophic - could trigger unintended wars between nuclear powers | Single flash war incident: 100K-10M+ casualties |
| **Probability-weighted importance** | High - annual risk compounds to near-certainty over decades | 10-40% cumulative decade risk at competitive deployment |
| **Comparative ranking** | Among highest-consequence military risks | Comparable to Cold War nuclear close-call frequency |

### Historical Calibration

| Incident | Year | Time to Resolution | Human Judgment Role | Autonomous Equivalent |
|----------|------|-------------------|---------------------|----------------------|
| Cuban Missile Crisis | 1962 | 13 days | Central | Would resolve in less than 1 second |
| Petrov Incident | 1983 | 5 minutes | Decisive | No intervention possible |
| Norwegian Rocket | 1995 | 8 minutes | Decisive | Would trigger retaliation |
| Able Archer | 1983 | Days | Central | Hours or less |

In all four cases, human deliberation time prevented catastrophe. Autonomous systems eliminate this buffer.

### Resource Implications

| Intervention | Annual Cost | Decade Cumulative | Expected Risk Reduction |
|--------------|-------------|-------------------|------------------------|
| Meaningful human control R&D | $200M | $2B | 40-60% |
| Bilateral crisis protocols | $50M | $500M | 15-25% |
| Circuit breaker technology | $300M | $3B | 15-30% |
| International treaty negotiation | $100M | $1B | 70-90% (if successful, 15% probability) |

### Key Cruxes

| Crux | If True | If False | Current Assessment |
|------|---------|----------|-------------------|
| Human-machine speed gap is insurmountable | Flash war risk inevitable without doctrine change | Technical solutions may preserve human control | 90% likely true |
| Major powers will deploy autonomous strike systems | Competitive deployment scenario realized | Defensive-only scenario possible | 60% likely by 2030 |
| Adversarial ML creates unpredictable emergent behaviors | Escalation risks higher than estimated | More predictable interaction dynamics | 75% likely |
| Attribution after incident is feasible | Deterrence partially restored | No accountability for autonomous attacks | 50% uncertain |
