...
description: This model analyzes AI-driven power accumulation dynamics. It finds
  compute concentration at 90-99% among top labs, talent concentration at
  60-85%, with only 5-30% probability of effective antitrust action by 2030.
sidebar:
  order: 23
quality: 4
...
ratings:
  ...
  completeness: 5
importance: 84.2
llmSummary: This systems model analyzes AI-driven power concentration using
  feedback loops and quantitative stocks-flows analysis, finding that
  reinforcing loops (R1-R4) currently dominate weak balancing forces, with
  compute concentration at 90-99% among top labs and only 5-30% probability of
  effective antitrust action by 2030. The model identifies specific mechanisms
  of economic amplification, political capture, and military advantage that
  create cross-domain power accumulation with potential tipping points
  approaching.
...
| Loop ID | Type | Mechanism | Strength | Delay |
|---------|------|-----------|----------|-------|
| **R1** | Reinforcing | AI Capabilities → Economic Returns → Investment → Better AI | Very Strong | Months |
| **R2** | Reinforcing | Users → Data → Model Quality → More Users | Strong | Weeks |
| **R3** | Reinforcing | Economic Power → Political Influence → Favorable Regulation → More Power | Moderate | Years |
| **R4** | Reinforcing | AI Capabilities → Military Advantage → Strategic Dominance → Political Power | Strong | Years |
| **B1** | Balancing | Concentration → Public Concern → Regulatory Response → Constraints | Weak | 5-10 years |
| **B2** | Balancing | High Profits → New Entrants → Competition → Lower Profits | Weak | 2-5 years |

<Mermaid client:load chart={`flowchart TD
    A[AI Capabilities] -->|"R1-R4"| B[Power Accumulation]
    B -->|"Reinforcing"| A
    B --> C[Visible Concentration]
    C -->|"B1-B2"| D[Resistance]
    D -->|"Weak"| B
...
**Cross-Domain Power Flows:** Economic power converts to political influence through lobbying; political power enables military control through funding; AI amplifies all connections simultaneously through content generation and information control.
...
Power concentration represents one of the highest-stakes structural risks from AI. Unlike technical risks that might be contained to specific incidents, concentrated power reshapes the entire decision-making landscape for all future AI governance and deployment choices.

| Dimension | Assessment |
|-----------|------------|
| **Potential severity** | Existential - concentrated power can lock in trajectories permanently |
| **Probability-weighted importance** | High priority - current reinforcing loops are very strong |
| **Comparative ranking** | Top-tier for long-term governance; directly affects all other risk mitigation |

### Resource Implications

Priority investments based on model analysis:
- **Compute governance mechanisms** (highest tractability, addresses key bottleneck)
- **Democratic AI infrastructure** (public alternatives to prevent total private control)
- **International coordination** before power gaps become insurmountable
- **Early antitrust enforcement** (window closing rapidly)

### Key Cruxes

- Does concentrated AI power increase or decrease catastrophic risk?
- Can democratic governance adapt fast enough to prevent corporate or authoritarian lock-in?
- Is the 5-7 year regulatory lag estimate accurate, or could crises accelerate response?
- Can middle powers (EU, UK) serve as effective counterweights to US-China concentration?
