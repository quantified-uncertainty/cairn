...
ratings:
  ...
  completeness: 5
importance: 4
llmSummary: This model analyzes how media coverage, public opinion, and AI
  policy form interconnected feedback loops that shape governance outcomes. It
  finds 6-18 month lags between coverage spikes and regulatory response, with
  media framing significantly determining policy windows and feasible options.
---
