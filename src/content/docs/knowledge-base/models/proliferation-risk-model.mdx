...
description: This model analyzes AI capability diffusion dynamics. It estimates
  key capabilities spread within 2-5 years of frontier development, with
  open-source accelerating timelines.
sidebar:
  order: 25
quality: 4
...
ratings:
  ...
  completeness: 5
importance: 5
llmSummary: This model analyzes how AI capabilities spread from frontier labs to
  millions of users through predictable tier-based diffusion patterns. It finds
  diffusion times have compressed from 24-36 months to 12-18 months, with
  projections of 6-12 month cycles by 2025-2026, fundamentally changing
...
| Tier | Actor Type | Actor Count | Access Mechanism | Diffusion Time |
|------|------------|-------------|------------------|----------------|
| **1** | Frontier Labs | 5-10 | Original development | - |
| **2** | Major Tech | 50-100 | API access / Partnerships | 6-18 months |
| **3** | Well-Resourced Orgs | 1K-10K | Fine-tuning / Replication | 12-24 months |
| **4** | Open Source | Millions | Public model weights | 18-36 months |
| **5** | Individuals | Billions | Consumer applications | 24-48 months |
...
| Threshold | Description | Control Status | Response Time |
|-----------|-------------|----------------|---------------|
| **Contained** | Tier 1-2 access only | Control still possible | Months |
| **Organizational** | Tier 3 access | State/criminal access likely | Weeks |
| **Individual** | Tier 4/5 access | Attribution difficult, monitoring overwhelmed | Days |
| **Irreversible** | Open source + common knowledge | Control not possible, focus shifts to defense | N/A |

<Mermaid client:load chart={`flowchart LR
    A[Contained] --> B[Organizational]
    B --> C[Individual]
    C --> D[Irreversible]
