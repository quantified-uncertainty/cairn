...
llmSummary: This model analyzes how AI surveillance affects authoritarian regime
  durability by examining historical collapse pathways and how AI disrupts them.
  It estimates AI-enabled regimes may be 2-3x more durable than historical
  autocracies, with collapse probability reduced by 60-70%.
---
