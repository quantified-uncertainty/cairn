...
ratings:
  ...
  completeness: 4
importance: 4
llmSummary: This model analyzes how network effects, data advantages, and
  economies of scale create winner-take-all dynamics in AI markets. It finds
  early leaders compound advantages at 15-30% annual rates and projects 45%
  probability of stable oligopoly by 2030, with concerning implications for
  power concentration.
---
