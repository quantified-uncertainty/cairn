...
ratings:
  ...
  completeness: 4
importance: 4
llmSummary: This model analyzes how AI affects the balance between cyber
  attackers and defenders, examining structural asymmetries and AI capability
  multipliers. It projects a 30-70% net improvement in attack success rates,
  with offense maintaining significant advantages due to automation scaling and
