...
ratings:
  ...
  completeness: 5
importance: 75.5
llmSummary: Mathematical model analyzing positive feedback loops (data, compute,
  talent, network effects) driving AI market concentration, estimating loop gain
  of 1.2-2.0 indicates winner-take-all dynamics with top 3-5 actors controlling
  70-90% of frontier capabilities within 5 years. Current markets already highly
  concentrated (HHI >2,500) with intervention windows becoming time-limited as
  concentration crosses critical thresholds.
