...
ratings:
  ...
  completeness: 4
importance: 3
llmSummary: "This model analyzes how AI-generated content triggers psychological
  harm cascades through three pathways: targeted campaigns, mass confusion
  events, and dependency cascades. It estimates 1-3% of population as highly
  vulnerable with 5-10x increased risk, projecting moderate-elevated harm
  (4.73/10) by 2030 across scenarios."
---
