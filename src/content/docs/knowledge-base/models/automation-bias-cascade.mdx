...
- [AI Capability Surprise Model](/knowledge-base/models/ai-capability-surprise) - Addresses how unexpected AI capability gains can accelerate automation bias by exceeding users' mental models of system limitations
- [Coordination Failure Cascade Model](/knowledge-base/models/coordination-failure-cascade) - Examines multi-agent dynamics where individual automation bias decisions create collective action problems
