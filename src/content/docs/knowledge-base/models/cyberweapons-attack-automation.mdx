...
ratings:
  ...
  completeness: 4
importance: 85.2
llmSummary: This model analyzes AI capabilities for autonomous cyberattacks
  across a 5-level spectrum, projecting Level 3 (semi-autonomous) attacks by
  2026-2027 and Level 4 (fully autonomous) campaigns by 2029-2033, with current
  AI assessed at ~50% capability toward full autonomy. The analysis includes
  detailed capability requirements, timeline scenarios, and critical technical
  bottlenecks that could delay autonomous cyber operations.
---
