...
ratings:
  ...
  completeness: 5
importance: 82.5
llmSummary: "Game-theoretic analysis showing AI competition systematically drives unsafe outcomes even when actors prefer safety, with cooperation probability dropping from 81% (2 actors) to 21% (15 actors). Estimates 5-10% catastrophic lock-in risk within 3-7 years, with compute governance offering 20-35% risk reduction as highest-leverage intervention."
---
