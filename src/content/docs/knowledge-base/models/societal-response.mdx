...
ratings:
  ...
  completeness: 4
importance: 65
llmSummary: This model analyzes how societal factors like public concern (~45%
  concerned), institutional capacity (~25% adequate), and safety research
  ecosystem (~35% of needed capacity) determine collective response to AI risks.
  It provides quantified assessments of key variables affecting society's
  ability to respond to AI developments, from expert warnings (0.6 consensus) to
  regulatory capacity (0.2 adequacy).
