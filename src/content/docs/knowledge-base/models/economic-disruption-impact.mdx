...
importance: 75.5
llmSummary: This economic model analyzes AI labor displacement dynamics,
  estimating 2-5% workforce displacement over 5 years versus 1-3% adaptation
  capacity, identifying critical thresholds where displacement outpaces economic
  adjustment. The model finds several destabilizing feedback loops and projects
