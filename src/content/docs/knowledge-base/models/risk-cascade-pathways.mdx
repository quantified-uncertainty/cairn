...
description: This model maps common pathways where one risk triggers others. Key
  cascades include racing→corner-cutting→incident→regulation-capture and
  epistemic→trust→coordination-failure.
sidebar:
  order: 52
quality: 4
ratings:
...
importance: 5
llmSummary: This model maps how individual AI risks trigger sequential cascades
  that amplify into systemic failures, identifying five primary pathways
  including racing→technical failure (2-8% probability) and sycophancy→epistemic
  collapse (3-12% probability). It provides quantitative cascade probabilities,
  intervention windows, and ROI estimates for chokepoint interventions, finding
  upstream prevention offers 2-3x better returns than mid-cascade interventions.
---
...
flowchart TD
    ...
    I[Interventions] -.->|"block at each stage"| B
...
|-----------|------------|----------------------|
| **Potential severity** | Catastrophic - cascades amplify individual risks into systemic failures | Full cascade: 5-15% catastrophic outcome probability |
| **Probability-weighted importance** | High - cascades are primary mechanism for catastrophic outcomes | 45-55% probability of at least partial cascade by 2040 |
| **Comparative ranking** | Critical for understanding how manageable risks become unmanageable | Cascade multiplier: 2-10x individual risk severity |

### Cascade Probability Summary

| Cascade Type | Cumulative Probability | Timeline | Intervention Window |
|--------------|----------------------|----------|---------------------|
| Technical (Racing to Corrigibility Failure) | 2-8% | 5-15 years | 2-4 years at corner-cutting stage |
| Epistemic (Sycophancy to Democratic Failure) | 3-12% | 15-40 years | 2-5 years at sycophancy stage |
| Power (Racing to Permanent Lock-in) | 3-15% | 20-50 years | 3-7 years at concentration stage |
| Technical-Structural Fusion | 10-45% (conditional) | 5-15 years | Months-years at integration stage |
| Multi-Domain Convergence | 1-5% | Variable | Limited once convergence begins |

### Resource Implications

| Chokepoint Intervention | Investment Needed | Cascade Prevention Value | ROI Estimate |
|-------------------------|-------------------|-------------------------|--------------|
| Racing dynamics reduction | $500M-1B annually | Blocks technical cascade initiation | 10-20x |
| Sycophancy design fixes | $100-300M total | Blocks epistemic cascade initiation | 15-30x |
| Antitrust/concentration limits | $200-500M annually | Blocks power cascade at early stage | 8-15x |
| Mesa-optimization detection | $300-600M annually | Stops technical cascade mid-chain | 5-10x |
| Interpretability research | $500M-1B annually | Enables detection at multiple stages | 10-25x |

**Priority**: Upstream interventions (racing, sycophancy, concentration) offer 2-3x better ROI than mid-cascade interventions because they prevent multiple downstream stages.

### Key Cruxes

| Crux | If True | If False | Current Assessment |
|------|---------|----------|-------------------|
| Cascades are more sequential than parallel | Chokepoint interventions highly effective | Must address multiple stages simultaneously | 65% likely sequential |
| Early warning indicators are reliable | Cascades can be detected and stopped | Intervention occurs too late | 40% reliable by 2028 |
| Racing dynamics can be reduced through coordination | Technical cascade probability drops 35%+ | Primary cascade initiator persists | 30% achievable by 2030 |
| Interpretability advances enable deception detection | Technical-structural fusion cascade stoppable | 10-45% conditional probability realized | 35% achievable by 2030 |
