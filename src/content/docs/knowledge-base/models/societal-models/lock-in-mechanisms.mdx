...
maturity: "Growing"
quality: 78
llmSummary: "Quantitative model estimating lock-in probabilities across different scenarios, with a combined 10-30% chance of significant lock-in by 2050. Provides timeline analysis and scenario comparison for policy prioritization."
