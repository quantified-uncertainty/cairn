...
description: This framework compares AI risk categories to guide resource
  allocation. It estimates misalignment accounts for 40-70% of x-risk, misuse
  15-35%, and structural risks 10-25%, though all estimates carry ±50%
  uncertainty.
sidebar:
  order: 50
quality: 4
...
ratings:
  ...
  completeness: 3
importance: 5
llmSummary: This framework compares AI risk categories to guide resource
  allocation across the safety community. It estimates misalignment accounts for
  40-70% of existential risk, misuse 15-35%, and structural risks 10-25%, with
  recommendations varying significantly based on AI timeline beliefs.
---
...
This framework compares AI risk categories to guide resource allocation. It estimates misalignment accounts for 40-70% of x-risk, misuse 15-35%, and structural risks 10-25%, though all estimates carry ±50% uncertainty.
