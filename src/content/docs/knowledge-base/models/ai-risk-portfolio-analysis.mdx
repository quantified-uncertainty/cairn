...
ratings:
  ...
  completeness: 5
importance: 92.5
llmSummary: "Quantitative portfolio framework estimates 40-70% of AI x-risk from misalignment, 15-35% from misuse, 10-25% from structural risks, with timeline-dependent allocation recommendations (e.g., 50-60% to misalignment for medium 5-15yr timelines). Analysis of 2024 funding ($110-130M external) shows interpretability ($52M, 40%) and evaluations/benchmarking (68% of OP grants) dominating, with governance underfunded at $18M (14%) versus optimal 20-25%."
---
