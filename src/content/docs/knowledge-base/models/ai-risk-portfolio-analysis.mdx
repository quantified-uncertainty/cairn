...
ratings:
  ...
  completeness: 4
importance: 92.5
llmSummary: "Quantitative portfolio framework estimates 40-70% of AI x-risk from misalignment, 15-35% from misuse, 10-25% from structural risks, with timeline-dependent allocation recommendations (e.g., 50-60% to misalignment for medium 5-15yr timelines). Analysis of $580M 2023 funding shows $30M gap in technical alignment, $15M in misuse prevention, $18M in governance relative to optimal medium-timeline allocation."
---
...
According to <R id="8f2b23ed48e1262c">AI Philanthropy's 2023 report</R>, total AI safety funding reached approximately \$580M in 2023:
...
<R id="38eba87d0a888e2e">AI Impacts 2022 expert survey</R> of 738 AI researchers:
...
According to <R id="120adc539e2fa558">Epoch AI's tracking</R>, AI safety funding has grown 40% annually since 2020:
...
|----------|------------|--------------|
| Portfolio Theory | <R id="b0303ec1db9a1cd0">Markowitz (1952)</R> | University of Chicago |
| Risk Assessment | <R id="f1043d283b6cf307">Kaplan & Garrick (1981)</R> | UCLA |
| AI Risk Surveys | <R id="38eba87d0a888e2e">Grace et al. (2022)</R> | AI Impacts |

### Policy Organizations

| Organization | Focus Area | Key Resources |
|-------------|------------|---------------|
| <R id="cf5fd74e8db11565">RAND Corporation</R> | Defense applications | National security risk assessments |
| <R id="f0d95954b449240a">CSET</R> | Technology policy | AI governance frameworks |
| <R id="3afc8d3cef185a83">CNAS</R> | Security implications | Military AI analysis |

### Funding Data

| Source | Coverage | Update Frequency |
|--------|----------|------------------|
| <R id="8f2b23ed48e1262c">AI Philanthropy</R> | Major donors | Annual |
| <R id="120adc539e2fa558">Epoch AI</R> | Research funding | Quarterly |
| <R id="f8f6f3ee55c2babe">Open Philanthropy</R> | Effective altruism | Grant-by-grant |
