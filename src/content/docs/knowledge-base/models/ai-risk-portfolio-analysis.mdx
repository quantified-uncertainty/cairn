...
ratings:
  ...
  completeness: 3
importance: 85
llmSummary: This portfolio analysis framework estimates misalignment accounts
  for 40-70% of AI existential risk, misuse 15-35%, and structural risks 10-25%,
  providing quantitative guidance for resource allocation across risk categories
  with timeline-dependent recommendations.
---
