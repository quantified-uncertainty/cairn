...
description: This model analyzes how public AI risk perception evolves. It finds
  major incidents shift opinion by 10-25 percentage points, decaying with 6-12
  month half-life.
sidebar:
  order: 42
quality: 4
...
ratings:
  ...
  completeness: 4
importance: 45
llmSummary: This model analyzes how public opinion on AI risk evolves, finding
  that major incidents shift opinion by 10-25 percentage points with 6-12 month
  half-life, but concludes elite opinion has 3-5x more policy influence than
  public opinion. The analysis suggests public engagement may be over-invested
  relative to direct technical work and elite engagement.
...
- [Media-Policy Feedback Loop](/knowledge-base/models/media-policy-feedback-loop/) - Cycle between coverage, opinion, and policy
- [Epistemic Collapse Threshold](/knowledge-base/models/epistemic-collapse-threshold/) - How trust in information breaks down
- [Sycophancy Feedback Loop](/knowledge-base/models/sycophancy-feedback-loop/) - AI validation and opinion reinforcement
- [Disinformation Electoral Impact](/knowledge-base/models/disinformation-electoral-impact/) - AI influence on elections
