...
ratings:
  ...
  completeness: 4
importance: 5
llmSummary: This game theory model analyzes AI development competition as an
  iterated prisoner's dilemma where rational actors prefer coordination but
  individual incentives prevent it. It finds that first-mover advantages create
  racing pressure even when all players would benefit from slower, safer
  development, with coordination probability estimated at only 10-20%.
---
