...
description: This model analyzes game-theoretic dynamics of international AI
  governance. It identifies key equilibria between US-China competition and
  potential cooperation pathways through safety agreements.
sidebar:
  order: 31
quality: 4
...
ratings:
  ...
  completeness: 4
importance: 85.2
llmSummary: Game-theoretic analysis of US-China AI coordination showing mutual
  defection (racing) as the stable Nash equilibrium despite Pareto-optimal
  cooperation being possible, with formal payoff matrices demonstrating why
  defection dominates when cooperation probability is below 50%. The model
  identifies information asymmetry, multidimensional coordination challenges,
  and time dynamics as key barriers to stable international AI safety
  agreements.
...
International coordination determines whether AI development proceeds as a cooperative project or a catastrophic race. The model identifies pathways from current mutual defection toward stable cooperation.

| Dimension | Assessment |
|-----------|------------|
| **Potential severity** | Critical - determines global AI trajectory |
| **Probability-weighted importance** | Highest priority for governance interventions |
| **Comparative ranking** | Top-tier; enables or blocks most safety measures |

### Quantitative Coordination Estimates

| Coordination Mechanism | Probability by 2030 | Expected Impact if Achieved | Key Enabling Factor |
|----------------------|-------------------|---------------------------|-------------------|
| Bilateral US-China safety dialogue | 40-60% | Medium | Crisis or leadership change |
| Compute monitoring agreement | 20-35% | High | Verification technology |
| Red lines on autonomous weapons | 30-50% | Medium | Near-miss incidents |
| Shared safety evaluation standards | 50-70% | Medium-High | Technical community leadership |
| Binding international AI treaty | 5-15% | Very High | Major crisis event |
| Full technology decoupling | 15-25% | Very Negative | Geopolitical escalation |

### Resource Implications

Investment priorities based on model insights:
- Track II diplomacy and technical exchanges (low cost, high potential) - $5-20M/year
- Verification technology development (medium cost, enables agreements) - $50-200M/year
- Middle power coordination capacity (EU/UK bridging role) - $10-50M/year
- Confidence-building measures and information sharing protocols - $5-15M/year

### Key Cruxes

- Can cooperation emerge before capability gaps become too large?
- Do verification technologies exist that both powers would trust?
- What catalyzing events could shift equilibrium toward cooperation?
- Can lab-level coordination substitute for or enable government coordination?
