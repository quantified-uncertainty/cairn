...
llmSummary: This model systematically analyzes how AI risks interact through
  synergistic, additive, or antagonistic effects using pairwise interaction
  coefficients. It finds that 15-25% of risk pairs strongly interact, with total
  portfolio risk potentially 2x higher than linear estimates due to compounding
  effects.
---
