...
description: This model analyzes cascading skill degradation from AI dependency.
  It estimates dependency approximately doubles every 2-3 years (1.7x per
  cycle), with 40-60% capability loss in Gen 1 users.
sidebar:
  order: 16
quality: 4
ratings:
...
importance: 4
llmSummary: This model analyzes how AI dependency causes cascading expertise
  loss through three levels (individual, institutional, generational) over 15-40
  year timescales. It estimates AI dependency doubles every 2-3 years and
  predicts 40-60% capability loss in first-generation AI users, with potential
  irreversibility by 2030-2045.
---
...
- [Sycophancy Feedback Loop Model](/knowledge-base/models/sycophancy-feedback-loop/) — How AI validation reinforces dependency and accelerates atrophy
- [Trust Cascade Failure Model](/knowledge-base/models/trust-cascade-model/) — Institutional expertise loss and organizational fragility
- [Epistemic Collapse Threshold Model](/knowledge-base/models/epistemic-collapse-threshold/) — Society-wide capability loss and knowledge system failure
- [Automation Paradox Model](/knowledge-base/models/automation-paradox/) — The ironic increase in human expertise requirements as automation increases
