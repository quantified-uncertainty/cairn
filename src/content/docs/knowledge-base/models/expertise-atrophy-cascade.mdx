...
importance: 65
llmSummary: This mathematical model analyzes cascading skill degradation from AI
  dependency, estimating that AI use doubles dependency every 2-3 years with
  40-60% capability loss in first-generation AI users, and identifies critical
  thresholds at 70% (competence), 40% (functionality), and 20% (dependence)
  proficiency levels.
---
