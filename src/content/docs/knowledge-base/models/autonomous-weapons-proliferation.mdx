...
ratings:
  ...
  completeness: 4
importance: 4
llmSummary: This model tracks lethal autonomous weapons proliferation through a
  five-stage diffusion framework, finding LAWS spread 4-6x faster than nuclear
  weapons. It projects 60 nations will have LAWS by 2030 and non-state actors
  will achieve operational capability by 2030-2032, making proliferation control
