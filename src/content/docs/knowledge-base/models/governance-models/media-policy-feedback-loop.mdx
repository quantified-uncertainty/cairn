...
description: >-
  This model analyzes cycles between media coverage, public opinion, and AI
  policy. It finds media framing significantly shapes policy windows, with 6-18
  month lag between coverage spikes and regulatory response.
sidebar:
  order: 43
quality: 72
...
importance: 58.5
llmSummary: >-
  Analyzes the feedback dynamics between media coverage, public concern, and AI
  policy using system dynamics equations and empirical estimates. Finds ~6% of
  coverage translates to durable concern, with 6-18 month lags between media
  spikes and policy response, and identifies five dominant media frames with
  varying effects on public concern.
...
- [Racing Dynamics](/knowledge-base/risks/structural/racing-dynamics/) - Competitive pressures in AI development
