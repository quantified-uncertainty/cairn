...
importance: 4
llmSummary: This model analyzes the adversarial race between AI content
  generation and detection systems, projecting that detection accuracy will fall
  from current 65% to near-random (50%) by 2030 under medium adversarial
  pressure. It assigns 55% probability to detection failure and recommends
  accelerating cryptographic provenance systems like C2PA as the primary
  alternative.
---
