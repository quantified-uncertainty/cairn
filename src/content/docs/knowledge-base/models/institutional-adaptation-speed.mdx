...
ratings:
  novelty: 3       # Applies institutional theory to AI governance gap
  rigor: 4         # Strong historical data (regulatory lag table) with quantitative model
  actionability: 4 # Specific strategies with effectiveness ratings and policy recommendations
  completeness: 5  # Comprehensive coverage of factors, domains, and time horizons
---
