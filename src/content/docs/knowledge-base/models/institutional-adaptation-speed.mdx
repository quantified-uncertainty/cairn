...
ratings:
  ...
  completeness: 5
importance: 5
llmSummary: This model analyzes institutional adaptation rates to AI, finding
  institutions change at 10-30% of needed rate per year while AI creates 50-200%
  annual governance gaps. It documents regulatory lag of 15-70 years
  historically and provides quantitative frameworks for predicting adaptation
  timelines across domains.
---
