...
The model divides interventions into three temporal categories based on <R id="cab86dcab3f6c2e2">RAND Corporation</R> analysis of technology governance windows:
...
|--------------|---------------|---------------|----------|
| Export control frameworks | Partially implemented | **Critical** | <R id="9ae4c87175cc63c0">CHIPS Act</R> establishing precedents |
...
- <R id="f905605a70b2b53d">Center for Strategic and International Studies</R> analysis showing deteriorating US-China tech cooperation
...
|--------------|---------------|-----------------|------------------|
| **European Union** | <R id="df6393d58a8ddffc">AI Act</R> implementation phase | 2024-2025 | Global template influence |
