...
ratings:
  ...
  completeness: 4
importance: 62.5
llmSummary: "Five-stage model tracking LAWS proliferation from great powers (2015-2023) to potential mass availability (2030+), projecting 60 nations with capabilities by 2030 and non-state actor access by 2032. Quantitative comparison shows LAWS proliferating 4-6x faster than nuclear weapons due to dual-use commercial technology, with 40-50 nations currently possessing some capability across three tiers."
---
