...
importance: 4
llmSummary: This model estimates AI disinformation's marginal impact on
  elections through a five-step causal pathway from AI capability to electoral
  outcomes. It finds AI increases disinformation reach by 1.5-4x over
  traditional methods, with potential to flip 1-3 elections annually and shift
  2-5% of votes in close races.
---
