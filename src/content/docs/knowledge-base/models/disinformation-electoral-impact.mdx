...
description: This model estimates AI disinformation's marginal impact on
  elections. It finds AI increases reach by 1.5-3x over traditional methods,
  with potential 2-5% vote margin shifts in close elections.
sidebar:
  order: 26
quality: 4
ratings:
...
importance: 72.5
llmSummary: This model quantifies AI disinformation's electoral impact using a
  multi-step causal pathway, estimating AI increases disinformation reach by
  1.5-4x and can shift 2-5% of votes in close elections, with 1-3 elections
  globally potentially flipped per year. The analysis concludes systemic trust
  erosion may be more significant than individual election manipulation.
