...
description: This model decomposes bioweapons attacks into seven sequential
  steps with independent failure modes. DNA synthesis screening offers 5-15%
  risk reduction for $7-20M, with estimates carrying 2-5x uncertainty at each
  step.
sidebar:
  order: 10
quality: 4
...
ratings:
  ...
  completeness: 4
importance: 85.2
llmSummary: This model decomposes bioweapons attacks into seven sequential steps
  with independent failure modes, finding overall attack probability of
  0.02-3.6% with state actors posing highest risk at 3.0%. DNA synthesis
  screening offers 5-15% risk reduction for $7-20M investment, with
  defense-in-depth strategies effective due to multiplicative probability
  structure.
