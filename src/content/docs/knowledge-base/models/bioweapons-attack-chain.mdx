...
ratings:
  ...
  completeness: 4
importance: 5
llmSummary: This model breaks down bioweapons attacks into seven sequential
  steps with multiplicative failure probabilities, estimating overall attack
  success at 0.02-3.6%. It finds that DNA synthesis screening offers 5-15% risk
  reduction for $7-20M annually, with countermeasures and synthesis barriers
  providing the highest-leverage intervention points.
---
