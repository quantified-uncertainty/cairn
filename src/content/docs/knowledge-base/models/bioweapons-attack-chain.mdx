...
ratings:
  novelty: 3       # Standard decomposition approach
  rigor: 4         # Well-sourced probability estimates
  actionability: 4 # Clear intervention points identified
  completeness: 4  # Thorough step-by-step analysis
---

import { DataInfoBox, Backlinks, EstimateBox, ModelRatings } from '../../../../components/wiki';
