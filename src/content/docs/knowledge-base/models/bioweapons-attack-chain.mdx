...
<Mermaid client:load chart={`flowchart LR
    subgraph Low_Tractability[Low Tractability]
        I1[Reduce motivation] -.-> S1[Step 1]
        I2[Restrict AI access] -.-> S2[Step 2]
    end

    subgraph Medium_Tractability[Medium Tractability]
        I3[AI guardrails] --> S3[Step 3]
        I4[Lab security] --> S4[Step 4]
        I5[Synthesis monitoring] --> S5[Step 5]
    end

    subgraph High_Tractability[High Tractability]
        I6[Deployment detection] --> S6[Step 6]
        I7[Countermeasures] --> S7[Step 7]
    end
