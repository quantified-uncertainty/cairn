...
ratings:
  ...
  completeness: 5
importance: 4
llmSummary: This model quantifies how AI surveillance reduces freedom of
  expression through chilling effects, using multiple measurement approaches
  including self-reported censorship and content analysis. It finds 50-70%
  reduction in dissent within months of surveillance deployment, reaching 80-95%
  suppression within 1-2 years, with effects persisting 10-20 years even after
