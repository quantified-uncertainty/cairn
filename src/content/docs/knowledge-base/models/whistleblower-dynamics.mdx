...
ratings:
  ...
  completeness: 5
importance: 5
llmSummary: This model analyzes the barriers and incentives affecting whether AI
  insiders disclose safety concerns to the public. It finds that current legal
  protections are inadequate, leading to 70-90% of critical safety information
  remaining hidden, and identifies specific interventions that could increase
  protected disclosures by 2-3x.
---
