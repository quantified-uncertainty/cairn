...
relatedRisks:
  ...
  - lock-in
importance: 4
llmSummary: This model analyzes how competitive pressure, investor demands, and
  reputation effects shape AI lab safety investments, identifying misaligned
  incentives that contribute 10-25% of total AI risk. It provides specific
  intervention points including whistleblower protections, third-party auditing,
