...
The strategic landscape shifted dramatically in 2024-2025. According to [Recorded Future analysis](https://www.recordedfuture.com/research/measuring-the-us-china-ai-gap), the gap in overall model performance between the best US and Chinese models narrowed from **9.26% in January 2024 to just 1.70% by February 2025**. This was catalyzed by DeepSeek's R1 release in January 2025, which [matched OpenAI's o1 performance](https://www.bu.edu/articles/2025/does-chinas-deepseek-represent-a-new-frontier-in-ai/) while training for just \$1.6 million—a fraction of US costs. Similarly, [open-source models closed to within 1.70%](https://www.red-line.ai/p/state-of-open-source-ai-2025) of frontier closed models on Chatbot Arena, fundamentally changing proliferation dynamics.

Despite narrowing capability gaps, structural asymmetries persist. US private AI investment topped [\$109 billion in 2024](https://www.cfr.org/article/china-united-states-and-ai-race)—over 12 times China's figure. The US maintains roughly 4,049 data centers versus China's 379, representing the [largest single advantage](https://www.rand.org/pubs/commentary/2025/05/chinas-ai-models-are-closing-the-gap-but-americas-real.html) the US enjoys. Yet China leads in deployment: it installed approximately 295,000 industrial robots in 2024 alone—more than the rest of the world combined—and accounts for 69.7% of all AI patents.
...
| **Chinese Labs (aggregate)** | 98.3% | Rapidly closing | Gap narrowed from 9.26% to 1.70% (Jan 2024 - Feb 2025) | [Recorded Future](https://www.recordedfuture.com/research/measuring-the-us-china-ai-gap) |
| **DeepSeek specifically** | ~100% on benchmarks | Matched frontier | R1 matched o1 at \$1.6M training cost; gold medal at IMO 2025 | [CSIS](https://www.csis.org/analysis/deepseek-huawei-export-controls-and-future-us-china-ai-race) |
| **Open-Source (Llama, Qwen)** | 98.3% | Rapidly closing | Gap narrowed from 8.04% to 1.70% on Chatbot Arena | [State of Open-Source AI](https://www.red-line.ai/p/state-of-open-source-ai-2025) |
...
*Sources: [CFR](https://www.cfr.org/article/china-united-states-and-ai-race), [RAND](https://www.rand.org/pubs/commentary/2025/05/chinas-ai-models-are-closing-the-gap-but-americas-real.html), [Stanford HAI](https://tecspectrum.com/happenings/china-ai-vs-us-2024-stanford-report/)*
...
**Key Finding:** The open-source lag has collapsed. As of late 2025, the center of gravity for open-weight models has [shifted toward China](https://www.red-line.ai/p/state-of-open-source-ai-2025), with DeepSeek and Qwen becoming household names. US firms released fewer open-weight models citing commercial and safety constraints, while Chinese labs treated open-weight leadership as a deliberate catch-up strategy. Meta—long a champion of frontier open models—has [delayed release of Llama Behemoth](https://www.cnbc.com/2025/12/09/meta-avocado-ai-strategy-issues.html) and suggested it may keep future "superintelligence" models behind paywalls.
...
|--------------|---------|---------------------|
| Historical analysis | First movers have 47% failure rate; only 11% become market leaders ([Golder & Tellis](https://firstmovers.ai/first-mover/)) | **Weak FMA** |
...
**Key insight:** Evidence from the [Abundance Institute](https://abundance.institute/articles/vibrant-AI-competitive-landscape) suggests "no signs of winner-take-all dynamics" in the current AI ecosystem. However, TAI (transformative AI) may differ qualitatively if it enables rapid capability improvements or strategic advantages not available to followers. The model's 0.7 first-mover advantage estimate may be too high based on current evidence, but TAI-level dynamics remain highly uncertain.
...
Current research from [AI Impacts](https://aiimpacts.org/multipolar-research-projects/) identifies key research questions: What "considerations might tip us between multipolar and unipolar scenarios"? What "risks [are] distinctive to a multipolar scenario"? The [CO/AI analysis](https://getcoai.com/news/ai-multipolarity-gains-importance-in-global-tech-landscape/) notes that while current AI safety discussions often default to unipolar frameworks, "exploring decentralized governance structures could address key risks like value lock-in and institutional stagnation."
...
- [Recorded Future: US-China AI Gap Analysis (2025)](https://www.recordedfuture.com/research/measuring-the-us-china-ai-gap)
- [RAND: China's AI Models Closing the Gap (2025)](https://www.rand.org/pubs/commentary/2025/05/chinas-ai-models-are-closing-the-gap-but-americas-real.html)
- [Council on Foreign Relations: China, the United States, and the AI Race](https://www.cfr.org/article/china-united-states-and-ai-race)
- [Boston University: DeepSeek and AI Frontier (2025)](https://www.bu.edu/articles/2025/does-chinas-deepseek-represent-a-new-frontier-in-ai/)
- [State of Open-Source AI 2025](https://www.red-line.ai/p/state-of-open-source-ai-2025)
- [CSIS: DeepSeek, Huawei, and US-China AI Race](https://www.csis.org/analysis/deepseek-huawei-export-controls-and-future-us-china-ai-race)
- [Abundance Institute: AI Competitive Landscape](https://abundance.institute/articles/vibrant-AI-competitive-landscape)
- [AI Impacts: Multipolar Research Projects](https://aiimpacts.org/multipolar-research-projects/)
- [Frontier Model Forum: Progress Update 2024](https://www.frontiermodelforum.org/updates/progress-update-advancing-frontier-ai-safety-in-2024-and-beyond/)