...
description: "This model analyzes how risk depends on which actors develop TAI. It maps actor incentive structures and identifies conditions where actor identity dominates technical factors."
