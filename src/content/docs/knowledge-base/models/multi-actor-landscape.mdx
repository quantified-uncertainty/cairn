...
ratings:
  ...
  completeness: 4
importance: 5
llmSummary: This comprehensive model analyzes how AI existential risk depends on
  which actors develop TAI and their strategic incentives. It estimates 25%
  total x-risk from four pathways (8% unaligned singleton, 6% multi-agent
  conflict, 5% authoritarian lock-in, 7% catastrophic misuse), with actor
  landscape contributing 40-60% of total risk variance.
---
