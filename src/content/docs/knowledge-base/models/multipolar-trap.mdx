...
ratings:
  ...
  completeness: 5
importance: 5
llmSummary: This model analyzes coordination failures where rational individual
  actions by AI developers create collectively catastrophic outcomes through
  racing dynamics and safety corner-cutting. It identifies specific
  manifestations in AI development and provides quantitative estimates showing
  racing reduces adequate safety behaviors by 1.6-4x.
---
