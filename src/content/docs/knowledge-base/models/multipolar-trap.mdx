...
description: This model analyzes coordination failures in AI development where rational individual actions produce collective catastrophe. It identifies racing dynamics, safety corner-cutting, and arms race equilibria.
sidebar:
  order: 21
quality: 4
