...
description: This model analyzes the gap between AI capability progress and
  safety/governance readiness. Risk emerges when capabilities outpace alignment
  research and institutional adaptation.
...
ratings:
  ...
  completeness: 4
importance: 85.5
llmSummary: This model quantifies the critical gap between AI capability
  progress and safety/governance readiness, finding capabilities currently ~3
  years ahead of alignment with the gap increasing. It provides concrete metrics
  for key variables like compute scaling (10²⁶ FLOP), interpretability coverage
  (~15%), and governance effectiveness (~0.25) that are essential for
...
This model analyzes the gap between AI capability progress and safety/governance readiness. Risk emerges when capabilities outpace alignment research and institutional adaptation.
...
The capability-alignment gap is the core variable determining whether advanced AI development goes well. The race dynamic fundamentally shapes all other risks.

| Dimension | Assessment | Quantitative Estimate |
|-----------|------------|----------------------|
| **Potential severity** | Existential - the gap determines overall trajectory | Gap size directly correlates with catastrophe probability (r=0.8) |
| **Probability-weighted importance** | Highest priority - currently widening | Gap increasing at ~0.5 years/year (capabilities accelerating) |
| **Comparative ranking** | Foundation for all other risk models | Primary causal driver of 60-80% of identified risks |
| **Malleability** | Medium - both sides of gap are influenceable | $1B/year could narrow gap by 0.5-1 year |

### Current Gap Assessment

| Gap Component | 2020 | 2023 | 2025 | 2027 (Projected) | Trend |
|---------------|------|------|------|------------------|-------|
| Capability level (% human expert) | 30% | 55% | 70% | 85% | +10-15pp/year |
| Alignment coverage | 25% | 30% | 35% | 40% | +3-5pp/year |
| Gap (capability - alignment) | 5pp | 25pp | 35pp | 45pp | Widening 8-10pp/year |
| Years alignment trails | 1 year | 2 years | 3 years | 4-5 years | Widening 0.5 years/year |

### Gap Closure Scenarios

| Scenario | Probability | Mechanism | Gap at 2030 |
|----------|-------------|-----------|-------------|
| Business as usual | 50% | Current trajectories continue | 5-6 years (critical) |
| Alignment breakthrough | 20% | Major interpretability or oversight advance | 1-2 years (manageable) |
| Capability slowdown | 15% | Scaling laws fail, compute limits | 2-3 years (manageable) |
| Coordinated pause | 10% | International agreement on capability limits | 0-1 years (safe) |
| Acceleration | 5% | AI R&D automation faster than expected | 7+ years (catastrophic) |

### Resource Implications

The model suggests priority investments in:
- Alignment research (directly reduces gap): **$500M-1B/year** (vs. ~$200M current) for 0.5-1 year gap reduction
- Interpretability (reduces alignment tax): **$150-300M/year** for ~0.3 year gap reduction
- Governance capacity (provides time through deployment delay): **$200-400M/year** for regulatory capacity
- Warning shot detection (enables protective feedback loop): **$30-50M/year** for monitoring infrastructure

**Total recommended investment to stabilize gap:** $900M-1.8B/year (4-8x current levels).

### Key Cruxes

| Crux | If True | If False | Current Probability |
|------|---------|----------|---------------------|
| Alignment can keep pace | Technical approach sufficient | Governance/pause required | 35% |
| Warning shots occur | Natural coordination window | Must build proactively | 60% |
| Protective feedback loop is strong | Democratic response works | Regulatory capture persists | 40% |
| Interpretability can close gap | Core safety tool works | Need alternative approaches | 45% |