...
ratings:
  ...
  completeness: 4
importance: 4
llmSummary: This model analyzes how AI enables artificial consensus creation
  through synthetic personas, narrative flooding, and coordinated amplification.
  It estimates 15-40% shifts in perceived opinion distribution and 5-15% actual
  opinion changes from sustained campaigns.
---
