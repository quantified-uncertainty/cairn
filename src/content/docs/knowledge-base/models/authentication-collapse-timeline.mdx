...
ratings:
  ...
  completeness: 5
importance: 5
llmSummary: This model projects when generative AI will defeat digital
  verification systems across text, images, audio and video. It estimates text
  detection already at random-chance levels (50-55%), with image/audio detection
  crossing failure thresholds by 2026-2028, leading to institutional crises in
  legal systems, journalism, and finance requiring $425B-1.7T in global
  adaptation costs.
---
