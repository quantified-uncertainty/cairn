...
| P2 (Incentives) | [Misuse Potential](/knowledge-base/ai-transition-model/factors/misuse-potential/) |
| P3 (Alignment) | [Misalignment Potential](/knowledge-base/ai-transition-model/factors/misalignment-potential/) |
| P4 (Power-Seeking) | [Misalignment Potential](/knowledge-base/ai-transition-model/factors/misalignment-potential/) |
...
1. **Doesn't cover all risks**: Focuses on power-seeking; doesn't address [catastrophic misuse](/knowledge-base/research-notes/critical-issues-brainstorm/catastrophic-misuse/) or [gradual disempowerment](/knowledge-base/ai-transition-model/scenarios/ai-takeover/gradual/)
