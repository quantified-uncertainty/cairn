...
ratings:
  ...
  completeness: 4
importance: 65
llmSummary: This model analyzes recovery pathways from AI incidents across 5
  types (technical failures to alignment failures), finding that clear
  attribution enables 3-5x faster recovery and recommending allocation of 5-10%
  of safety resources to recovery capacity, with particular focus on
  trust/epistemic recovery and skill preservation as the most neglected areas.
