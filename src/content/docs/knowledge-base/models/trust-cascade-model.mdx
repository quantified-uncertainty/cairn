...
ratings:
  ...
  completeness: 5
importance: 4
llmSummary: This model analyzes how AI-accelerated attacks could trigger
  catastrophic cascades where institutional trust failures propagate through
  interconnected networks. It finds trust failures propagate at 1.5-2x rates in
  AI-mediated environments, with critical thresholds around 30-40% below which
  institutions lose validation ability and cascades become self-reinforcing.
---
