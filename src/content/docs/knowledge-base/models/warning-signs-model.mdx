...
description: This model catalogs early indicators for detecting emerging AI
  risks. It prioritizes indicators by lead time, reliability, and actionability.
sidebar:
  order: 17
quality: 4
...
ratings:
  ...
  completeness: 4
importance: 85
llmSummary: This model provides a systematic framework for detecting emerging AI
  risks through leading and lagging indicators across five signal categories
  (capability, behavioral, incident, research, social), with quantitative
  assessments showing most critical warning signs are 18-48 months from
  threshold crossing with detection probabilities ranging from 45-90%. The
  analysis reveals a critical governance gap where most warning signs lack
  systematic tracking, agreed thresholds, or pre-committed responses.
---
...
The warning signs model addresses a critical infrastructure gap: the AI safety field has conceptual frameworks for risks but lacks operational capacity to detect when risks are materializing.

| Factor | Estimate | Confidence | Notes |
|--------|----------|------------|-------|
| P(major risk materializes with less than 6mo warning) | 40-70% | Low | Current monitoring inadequate |
| Value of 12-month warning for major risk | $10B-$1T | Very Low | Depends on response effectiveness |
| Current monitoring coverage (% of critical indicators) | 20-40% | Medium | Most indicators untracked |
| P(false positive triggers inappropriate response) | 10-25% | Low | Calibration data lacking |
| Cost of comprehensive monitoring infrastructure | $50-150M annually | Medium | Based on proposed systems |

### Monitoring Gap Analysis

The following table quantifies the current state of warning sign monitoring infrastructure:

| Warning Category | Current Coverage | Adequate Coverage | Gap | Priority |
|-----------------|-----------------|-------------------|-----|----------|
| Capability benchmarks | 60% | 90% | 30% | High |
| Behavioral evaluations | 25% | 80% | 55% | Critical |
| Incident tracking | 15% | 95% | 80% | Critical |
| Social impact metrics | 35% | 70% | 35% | Medium |
| International signals | 10% | 60% | 50% | High |

### Comparative Ranking

Warning signs monitoring ranks as **Tier 1 (Critical Priority)** for operational AI governance:

1. **Urgency**: 9/10 - Infrastructure must exist before risks materialize
2. **Neglectedness**: 8/10 - Conceptual work exists but operational systems lacking
3. **Tractability**: 7/10 - Technical solutions available, institutional barriers remain
4. **Leverage**: 8/10 - Small investment enables large risk reduction

### Resource Implications

Current global investment in AI risk monitoring: ~$15-40M annually
Estimated adequate funding level: ~$80-200M annually (3-5x increase)

Priority investments:
1. **AI Incident Database** ($8-20M/year): Foundation for lagging indicator tracking
2. **Independent behavioral evaluation** ($30-70M/year): Most critical detection capability
3. **Capability observatory** ($15-35M/year): Standardized leading indicators
4. **International coordination** ($10-25M/year): Cross-jurisdictional coverage

### Key Cruxes

| Crux | If True | If False | Current Assessment |
|------|---------|----------|-------------------|
| Warning signs are detectable before harm | Proactive response possible | Reactive response only | 60% detectable early |
| Pre-committed responses are credible | Tripwire framework viable | Responses fail at decision point | 35% currently credible |
| Monitoring does not trigger evasion | Detection remains effective | Adversarial adaptation defeats monitoring | 50% monitoring robust |
| International coordination achievable | Global coverage possible | Gaps in coverage inevitable | 40% achievable |
