...
ratings:
  ...
  completeness: 4
importance: 5
llmSummary: This model catalogs warning signs for detecting emerging AI risks,
  categorizing them by type (capability, behavioral, incident, research, social)
  and temporal position (leading vs lagging indicators). It identifies critical
  monitoring gaps, proposes specific tripwires with thresholds, and estimates
  that comprehensive monitoring infrastructure would cost $50-150M annually to
  provide 60-95% coverage of key indicators.
---
