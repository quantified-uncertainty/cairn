...
ratings:
  ...
  completeness: 5
importance: 74.5
llmSummary: "Analyzes when AI decisions become irreversible across technical, economic, social, political, and existential dimensions using exponential cost models. Estimates 25% probability of crossing infeasible-reversal thresholds by 2035, with critical intervention windows narrowing as lock-in accumulates through distributed decisions."
---
