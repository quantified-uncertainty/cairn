...
description: This model analyzes when AI decisions become permanently locked-in.
  It estimates 25% probability of crossing infeasible-reversal thresholds by
  2035, with expected time to major threshold at 4-5 years.
sidebar:
  order: 32
quality: 4
...
ratings:
  ...
  completeness: 5
importance: 5
llmSummary: This model analyzes when AI-related decisions transition from
  reversible to permanently locked-in, providing frameworks for identifying
  thresholds and estimating reversal costs across technical, economic, social,
  and political dimensions. It estimates 25% probability of crossing
  infeasible-reversal thresholds by 2035, with expected time to major threshold
  at 4-5 years.
---
...
- [Lock-in Irreversibility Model](/knowledge-base/models/lock-in-irreversibility/) - Provides deeper analysis of the specific mechanisms through which technological and institutional lock-in occurs, complementing this model's focus on threshold dynamics
- [Proliferation Risk Model](/knowledge-base/models/proliferation-risk-model/) - Analyzes how dangerous capabilities spread between actors, representing the technical irreversibility dimension
- [Expertise Atrophy Cascade](/knowledge-base/models/expertise-atrophy-cascade/) - Models the skills loss dynamics that drive social irreversibility as workforces become AI-dependent
- [Surveillance Infrastructure Dynamics](/knowledge-base/models/surveillance-infrastructure/) - Examines how surveillance technologies create political irreversibility through power consolidation
- [AI Capabilities Timeline Model](/knowledge-base/models/ai-capabilities-timeline/) - Provides context for when threshold-crossing capabilities may emerge
- [Coordination Failure Dynamics](/knowledge-base/models/coordination-failure/) - Analyzes why collective action to prevent irreversibility often fails despite shared interests
