...
llmSummary: "This model analyzes irreversible transitions in AI development
  across five mechanisms: value lock-in, political entrenchment, technical
  complexity, economic dependence, and cognitive changes. It provides a
  comprehensive framework for understanding when AI-related decisions become
  impossible to reverse, with mathematical formalism and specific timescales for
  different lock-in types."
---
