...
description: This model analyzes irreversible transitions in AI development. It
  identifies path dependencies and thresholds beyond which course correction
  becomes prohibitively costly or impossible.
sidebar:
  order: 24
quality: 4
...
ratings:
  ...
  completeness: 5
importance: 82.5
llmSummary: "This model analyzes irreversible transitions in AI development,
  identifying four key lock-in mechanisms: value lock-in (where AI systems
  permanently embed specific values costing $100M+ to change), political lock-in
  (enabling permanent authoritarian control through AI surveillance), economic
  lock-in, and technical lock-in. The framework provides mathematical
  formalization of irreversibility conditions and path dependence to help
  identify thresholds beyond which course correction becomes impossible."
...
Lock-in represents the transition from "difficult to fix" to "impossible to fix." Early decisions in AI development may foreclose options permanently.

| Dimension | Assessment |
|-----------|------------|
| **Potential severity** | Existential - determines long-term trajectory permanently |
| **Probability-weighted importance** | High priority - preserving optionality is time-sensitive |
| **Comparative ranking** | Top-tier for long-term impact; often underweighted due to temporal distance |

### Lock-in Risk Quantification by Domain

| Domain | Lock-in Probability (2030) | Reversibility if Locked | Time Until Threshold | Intervention Tractability |
|--------|---------------------------|------------------------|---------------------|--------------------------|
| Infrastructure dependence | 60-80% | Very Low | 3-5 years | Medium (requires alternatives) |
| Political entrenchment | 40-60% | Low | Variable | Low (requires political will) |
| Value embedding | 30-50% | Very Low | 5-10 years | Medium (requires training changes) |
| Skill atrophy | 70-90% | Low | 10-20 years | Low (generational) |
| Technical complexity | 50-70% | Very Low | 5-10 years | Low (inherent to progress) |

### Resource Implications

Priority investments to preserve optionality:
- Diversity maintenance (multiple approaches, actors, governance structures)
- Reversibility engineering (designing systems that can be modified)
- Decision delay mechanisms (pauses, circuit breakers)
- Lock-in detection and early warning systems

### Key Cruxes

- At what point does economic irreversibility become binding?
- Can political lock-in be prevented through institutional design?
- How quickly do value lock-ins propagate through AI training?
- What reversibility margins should we require for major AI deployments?
