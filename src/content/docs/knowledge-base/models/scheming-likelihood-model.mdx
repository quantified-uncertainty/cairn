...
quality: 4
importance: 5
llmSummary: "This model decomposes scheming probability into four conditional
  components: misalignment, situational awareness, instrumental rationality, and
  feasibility. It estimates current systems have 1.7% scheming probability
  rising to 51.7% for superhuman systems, with different mitigation strategies
