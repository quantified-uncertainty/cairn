...
sidebar:
  order: 5
quality: 3
llmSummary: Analyzes approaches for reducing AI risk by influencing frontier
  labs directly, including working at labs, shareholder activism, and
  whistleblowing. Provides detailed assessment of tradeoffs, with safety roles
  at labs paying $150-500K+ but carrying moral uncertainty about net impact.
