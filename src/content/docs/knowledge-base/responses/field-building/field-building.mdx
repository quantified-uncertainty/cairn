...
sidebar:
  order: 4
quality: 4
llmSummary: Comprehensive overview of AI safety field-building approaches
  including training programs (ARENA, MATS), funding (~$200M+/year from Open
  Philanthropy), community building, and academic establishment. Identifies key
  tensions between growth vs. quality and whether AI safety is
  talent-constrained vs. idea-constrained.
