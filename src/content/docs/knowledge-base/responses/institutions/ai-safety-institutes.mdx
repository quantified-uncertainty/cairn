...
llmSummary: Analyzes AI Safety Institutes as government institutions building
  technical capacity to evaluate AI systems, with detailed assessment of UK/US
  institutes having ~50-100+ staff each and securing pre-deployment model access
  from major labs. Concludes AISIs show promise for addressing information
  asymmetry between regulators and labs but face critical limitations around
  independence, authority, and scale mismatches.
