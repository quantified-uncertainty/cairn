...
llmSummary: "Government institutions for AI safety evaluation and research"
...
| [Racing Dynamics](/knowledge-base/risks/structural/racing-dynamics/) | Independent evaluation could slow unsafe deployments | Low-Medium |
...
- **[Compute Governance](/knowledge-base/responses/governance/policy-approaches/compute-governance/)**: Hardware-level governance as a complementary leverage point
- **[International Coordination](/knowledge-base/responses/governance/international/international-coordination/)**: Broader diplomatic frameworks that AISIs contribute to
