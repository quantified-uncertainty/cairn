...
The institute has secured pre-deployment access agreements with all major frontier AI labs, representing a significant diplomatic and technical achievement. These agreements provide the institute with early access to new models before public release, enabling evaluation of potentially dangerous capabilities before deployment. In November 2024, the UK and US institutes conducted <R id="a0bcc81243f8fbee">their first joint pre-deployment evaluation</R> of Anthropic's upgraded Claude 3.5 Sonnet, testing biological, cyber, and software development capabilities.

Beyond evaluation work, the UK institute developed <R id="fc3078f3c2ba5ebb">Inspect</R>, an open-source evaluation framework that provides modular tools for AI system assessment. Released in May 2024, Inspect is the first government-backed open source AI evaluation tool. It supports over 100 pre-built evaluations, multiple model APIs, and has received contributions from over 50 external contributors including other AI safety institutes, frontier labs, and major safety research organisations.

### United States AI Safety Institute

The US AI Safety Institute was <R id="7515ea53a1461224">established in February 2024</R> within the National Institute of Standards and Technology (NIST), with <R id="0694bc71bc9daac0">Elizabeth Kelly</R> (named one of TIME's 100 Most Influential People in AI 2024) serving as inaugural director. Kelly, a lawyer who was one of the lead drafters of Biden's AI executive order, assembled a consortium of 280+ members drawn from civil society, academia, frontier model labs, and industry verticals.

In August 2024, the US AISI <R id="627bb42e8f74be04">signed formal agreements</R> with both Anthropic and OpenAI to receive access to major new models before and after public release. This represented "an entirely new U.S. government capacity to directly test frontier AI models and systems before deployment." The institute completed its first joint evaluation with the UK AISI on Claude 3.5 Sonnet in November 2024, followed by an <R id="be88ea80f559e453">evaluation of OpenAI's o1 model</R> in December 2024.

In November 2024, the institute established the <R id="36f1ab33b8ba7130">Testing Risks of AI for National Security (TRAINS) Taskforce</R>, bringing together partners across the U.S. Government to develop new AI evaluation methods, benchmarks, and conduct joint national security risk assessments.

**Note on 2025 changes:** The Trump administration has significantly altered the institute's trajectory. In January 2025, Trump rescinded Biden's AI safety executive order. In February 2025, reports indicated <R id="dbfa4b8232438aa9">planned layoffs affecting NIST staff</R>. Director Elizabeth Kelly departed in early 2025. In June 2025, Commerce Secretary Howard Lutnick <R id="2e54dc9aa19c9dcc">announced rebranding</R> of the institute as the **Center for AI Standards and Innovation (CAISI)**, shifting focus from safety to standards development. Critics argue this "would undermine efforts to make sure that AI tools are safe and effective."
