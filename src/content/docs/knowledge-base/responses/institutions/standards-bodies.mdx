...
<InfoBox
  ...
  customFields={[
    { label: "Key Bodies", value: "ISO, IEEE, NIST, CEN-CENELEC" },
    { label: "Status", value: "Rapidly developing" },
    { label: "Relevance", value: "Standards increasingly referenced in law" },
  ]}
/>
...
<Sources sources={[
  { title: "ISO/IEC JTC 1/SC 42 Artificial Intelligence", url: "https://www.iso.org/committee/6794475.html", author: "ISO" },
  { title: "IEEE Ethically Aligned Design", url: "https://ethicsinaction.ieee.org/", author: "IEEE" },
  { title: "EU AI Act Standardisation", url: "https://digital-strategy.ec.europa.eu/en/policies/ai-standards", author: "European Commission" },
]} />
