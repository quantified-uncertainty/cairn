...
importance: 88.5
---
import {DataInfoBox, KeyPeople, Section, Backlinks, DisagreementMap, KeyQuestions, R} from '../../../../../components/wiki';
...
- **Interpretability-enhanced monitoring**: Leveraging [mechanistic interpretability](/knowledge-base/responses/alignment/interpretability/) tools to detect internal misalignment
...
|-----------------------|---------------|----------------------|---------------------|
| **[Mechanistic Interpretability](/knowledge-base/responses/alignment/interpretability/)** | High | Technical complexity | \$2-5M additional research |
| **[Scalable Oversight](/knowledge-base/responses/alignment/scalable-oversight/)** | High | Coordination requirements | 5-10 additional FTEs |
| **[Evaluations](/knowledge-base/responses/alignment/evals/)** | Medium-High | Standardization needs | \$1-3M protocol development |
| **[Constitutional AI](/knowledge-base/responses/alignment/constitutional-ai/)** | Medium | Different paradigm assumptions | Integration research needed |
