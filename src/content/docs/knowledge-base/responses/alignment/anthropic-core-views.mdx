...
sidebar:
  order: 1
quality: 82
llmSummary: "Anthropic invests $100-200M/year (15-25% of R&D) in safety research with the largest interpretability team (40-60 researchers), but faces $5B+ revenue pressures that create risks for long-term safety commitments. Their RSP framework has been adopted industry-wide, making their approach highly influential for AI safety prioritization despite ongoing debates about whether frontier access genuinely advances safety."
...
- **<R id="be36db0b02a6ae5b">Anthropic Valuation Reaches $61.5B</R>** - CNBC, March 2025
