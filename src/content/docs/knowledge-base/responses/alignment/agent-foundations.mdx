...
This research program was pioneered by the [Machine Intelligence Research Institute (MIRI)](/knowledge-base/organizations/safety-orgs/miri/) starting in 2013. Key contributions include [embedded agency](https://intelligence.org/embedded-agency/) (how agents reason about themselves within their environment), [logical induction](https://intelligence.org/2016/09/12/new-paper-logical-induction/) (managing uncertainty about mathematical truths), [functional decision theory](https://intelligence.org/2017/10/22/fdt/) (how agents should make decisions under uncertainty), and [formal corrigibility analysis](https://intelligence.org/files/Corrigibility.pdf) (conditions under which agents accept correction).
...
|-----------|------------|-----------|
| [Doomer](/knowledge-base/worldviews/doomer/) | Mixed | May need foundations for robust alignment, but pessimistic about tractability |
| [Long timelines](/knowledge-base/worldviews/long-timelines/) | Positive | More time for theoretical progress to compound |
| [Optimistic](/knowledge-base/worldviews/optimistic/) | Low priority | Empirical methods likely sufficient |
| [Governance-focused](/knowledge-base/worldviews/governance-focused/) | Low priority | Policy interventions more tractable in relevant timeframes |

---

## Core Research Areas

Agent foundations research spans several interconnected problem domains. The 2018 "[Embedded Agency](https://www.alignmentforum.org/s/Rm6oQRJJmhGCcLvxh)" framework by Abram Demski and Scott Garrabrant unified these into a coherent research agenda, identifying four core subproblems of embedded agency: decision theory, embedded world-models, robust delegation, and subsystem alignment.
...
The [embedded agency sequence](https://www.alignmentforum.org/s/Rm6oQRJJmhGCcLvxh) identifies four interconnected challenges:
...
**Subsystem Alignment**: How can an agent ensure its internal optimization processes remain aligned with its overall goals? This prefigured the [mesa-optimization](/knowledge-base/risks/accident/mesa-optimization/) concerns that later became central to alignment discourse.

### Logical Induction: A Landmark Result

[Logical induction](https://intelligence.org/2016/09/12/new-paper-logical-induction/) (Garrabrant et al., 2016) is widely considered agent foundations' most significant concrete achievement. The algorithm provides a computable method for assigning probabilities to mathematical statements, analogous to how Solomonoff induction handles empirical uncertainty.
...
[Corrigibility](https://intelligence.org/files/Corrigibility.pdf) (Soares et al., 2015) formalized the challenge of building AI systems that accept human correction. A corrigible agent should:
...
No complete solution exists. Stuart Armstrong's work at the Future of Humanity Institute continued exploring corrigibility, but fundamental obstacles remain. The problem connects to [instrumental convergence](/knowledge-base/risks/accident/instrumental-convergence/): almost any goal creates incentives to resist modification.
...
The [MIRI/Open Philanthropy exchange on decision theory](https://www.alignmentforum.org/posts/FBbHEjkZzdupcjkna/miri-op-exchange-about-decision-theory-1) reveals ongoing disagreement about whether this research direction is productive or has generated more puzzles than solutions.
...
**Current methods won't scale**: Techniques like RLHF work on current systems but may fail catastrophically on more capable ones. The [sharp left turn](/knowledge-base/risks/accident/sharp-left-turn/) hypothesis suggests capabilities may generalize while alignment doesn't—requiring foundational understanding of why.

**Deceptive alignment is fundamental**: [Deceptive alignment](/knowledge-base/risks/accident/deceptive-alignment/) and [mesa-optimization](/knowledge-base/risks/accident/mesa-optimization/) may require formal analysis rather than empirical debugging. These failure modes are precisely about systems that pass empirical tests while remaining misaligned.
...
**Alternatives to consider**: [Mechanistic interpretability](/knowledge-base/responses/alignment/interpretability/), [scalable oversight](/knowledge-base/responses/alignment/scalable-oversight/), [AI control](/knowledge-base/responses/alignment/ai-control/), governance research.
...
- **Embedded Agency** (Demski & Garrabrant, 2018): [AI Alignment Forum sequence](https://www.alignmentforum.org/s/Rm6oQRJJmhGCcLvxh) presenting the unified framework
- **Logical Induction** (Garrabrant et al., 2016): [MIRI announcement](https://intelligence.org/2016/09/12/new-paper-logical-induction/)
- **Corrigibility** (Soares et al., 2015): [PDF](https://intelligence.org/files/Corrigibility.pdf)
- **Functional Decision Theory** (Yudkowsky & Soares, 2017): [MIRI announcement](https://intelligence.org/2017/10/22/fdt/)
- **Agent Foundations Technical Agenda** (Soares & Fallenstein, 2017): [PDF](https://intelligence.org/files/TechnicalAgenda.pdf)

### Strategic and Meta-Level

- **MIRI 2024 Mission and Strategy Update**: [MIRI blog](https://intelligence.org/2024/01/04/miri-2024-mission-and-strategy-update/) explaining pivot away from agent foundations
- **MIRI/Open Philanthropy Exchange on Decision Theory**: [AI Alignment Forum](https://www.alignmentforum.org/posts/FBbHEjkZzdupcjkna/miri-op-exchange-about-decision-theory-1)
- **Science of Deep Learning vs. Agent Foundations**: [LessWrong post](https://www.lesswrong.com/posts/v6zZaR7aDD6vkuPmx/science-of-deep-learning-more-tractably-addresses-the-sharp) arguing for empirical approaches

### Value Learning and CIRL

- **Cooperative Inverse Reinforcement Learning** (Hadfield-Menell et al., 2016): [arXiv](https://arxiv.org/abs/1606.03137) - Formalizes value learning as cooperative game
- **Inverse Reinforcement Learning**: [AI Alignment Forum wiki](https://www.alignmentforum.org/w/inverse-reinforcement-learning)

### Related Concepts

- [Mechanistic Interpretability](/knowledge-base/responses/alignment/interpretability/) - Empirical alternative to theoretical foundations
- [Mesa-Optimization](/knowledge-base/risks/accident/mesa-optimization/) - Risk identified through agent foundations research
- [Deceptive Alignment](/knowledge-base/risks/accident/deceptive-alignment/) - Core problem agent foundations aims to address
