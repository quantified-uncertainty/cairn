...
<InfoBox
  type="intervention"
  title="Responses to AI Risk"
  customFields={[
    { label: "Scope", value: "Technical, governance, and societal responses" },
    { label: "Framework", value: "Importance × Tractability × Neglectedness" },
    { label: "Key Question", value: "What actions can reduce AI risk?" },
  ]}
/>
...
| **[Coordination Technologies](/knowledge-base/responses/epistemic-tools/coordination/)** | Tools for large-scale cooperation |
