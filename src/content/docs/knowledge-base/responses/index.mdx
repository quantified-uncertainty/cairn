...
|----------|-------------|
| **[Technical Approaches](/knowledge-base/responses/alignment/)** | Alignment research, interpretability, evaluations, AI control |
| **[Research Agendas](/knowledge-base/responses/alignment/research-agendas/)** | Specific research programs and their theories of change |
...
| **[Compute Governance](/knowledge-base/responses/governance/compute-governance/)** | Hardware-based mechanisms like export controls, compute monitoring |
