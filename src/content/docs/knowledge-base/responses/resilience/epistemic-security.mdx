...
sidebar:
  order: 1
quality: 87
llmSummary: "Comprehensive analysis of epistemic security (society's ability to distinguish truth from falsehood in AI-dominated information) with extensive quantitative evidence: human deepfake detection at 55.5% accuracy, commercial AI detectors at 78% AUC dropping to 50% on novel content, and average fraud losses exceeding $500K. Documents technical defenses (authentication, detection), institutional responses (inoculation, verification systems), and market growth (C2PA at $1.29B, 26% CAGR)."
