...
description: >-
  Society's ability to distinguish truth from falsehood in an AI-dominated
  information environment, encompassing technical defenses, institutional
  responses, and the fundamental challenge of maintaining shared knowledge
  systems essential for democracy, science, and coordination.
sidebar:
  order: 1
quality: 87
llmSummary: >-
  Comprehensive analysis of epistemic security (society's ability to distinguish
  truth from falsehood in AI-dominated information) with extensive quantitative
  evidence: human deepfake detection at 55.5% accuracy, commercial AI detectors
  at 78% AUC dropping to 50% on novel content, and average fraud losses
  exceeding $500K. Documents technical defenses (authentication, detection),
  institutional responses (inoculation, verification systems), and market growth
  (C2PA at $1.29B, 26% CAGR).
...
| **Human Detection Accuracy** | Near-chance (55.5%) | Meta-analysis of 56 studies found humans detect deepfakes at 55.5% accuracy; high-quality videos only 24.5% (<R id="5c1ad27ec9acc6f4">ScienceDirect</R>) |
...
| **Content Authentication Adoption** | Early stage, growing | C2PA market \$1.29B in 2024, growing 26% CAGR; 5,000+ CAI members; Meta, Google, OpenAI joined 2024 (<R id="ff89bed1f7960ab2">C2PA</R>) |
| **Inoculation Effectiveness** | Moderate (10-24% reduction) | Bad News game reduces susceptibility to disinformation by 10-24% across tactics; effects last 3+ months (<R id="82f99c43d60a4fa2">Cambridge</R>) |
