...
sidebar:
  order: 2
quality: 5
llmSummary: "Analyzes compute thresholds (10^25 FLOP in EU AI Act, 10^26 FLOP in US EO) as regulatory triggers for AI safety requirements, finding they provide tractable near-term governance but face obsolescence within 3-5 years due to ~4-5x annual compute growth and algorithmic efficiency improvements that decouple compute from capabilities."
