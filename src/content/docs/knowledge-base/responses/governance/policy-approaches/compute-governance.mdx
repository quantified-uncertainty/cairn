...
sidebar:
  order: 2
quality: 4
llmSummary: "Using hardware and computational infrastructure to regulate AI development"
...
| [Misuse - Bioweapons](/knowledge-base/risks/misuse/bioweapons/) | Prevents adversaries from training dangerous models | Medium |
| [Misuse - Cyberweapons](/knowledge-base/risks/misuse/cyberweapons/) | Same mechanism | Medium |
...
| [Deceptive Alignment](/knowledge-base/risks/accident/deceptive-alignment/) | Enables oversight through compute monitoring; doesn't directly prevent | Low |

**Note on effectiveness:** Compute governance is strongest against risks that require large training runs (proliferation, racing). It's less effective against risks from already-deployed models or risks that emerge from smaller-scale systems.
