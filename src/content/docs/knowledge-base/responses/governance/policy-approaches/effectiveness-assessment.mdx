...
<InfoBox
  ...
  customFields={[
    { label: "Key Question", value: "Which policies actually reduce AI risk?" },
    { label: "Challenge", value: "Counterfactuals are hard to assess" },
    { label: "Status", value: "Early, limited evidence" },
  ]}
/>
...
<Sources sources={[
  { title: "AI Governance: A Research Agenda", url: "https://www.governance.ai/research-paper/research-agenda", author: "GovAI" },
  { title: "Evaluating AI Governance", url: "https://cset.georgetown.edu/", author: "CSET Georgetown" },
]} />
