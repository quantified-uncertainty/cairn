...
<InfoBox
  ...
  title="AI Governance"
  customFields={[
    { label: "Scope", value: "Policy, regulation, coordination" },
    { label: "Actors", value: "Governments, international bodies, industry" },
    { label: "Mechanisms", value: "Laws, standards, agreements, oversight" },
  ]}
/>
