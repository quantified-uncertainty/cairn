...
sidebar:
  order: 7
quality: 3
llmSummary: Analyzes voluntary AI safety commitments from 15+ major companies
  including White House pledges and Responsible Scaling Policies, finding 40-60%
  meaningful implementation across 8 commitments with variable compliance and no
  enforcement mechanisms. Documents the evolution from voluntary pledges to more
  structured frameworks like Anthropic's ASL system and OpenAI's Preparedness
  Framework.
...
|-----------|------------|----------------------|
| **Adoption Rate** | High | 15+ major AI companies signed White House commitments |
| **Compliance Rate** | Variable | 40-60% meaningful implementation across 8 commitments |
| **Behavioral Change** | Modest | 20-35% of companies adopted new practices due to commitments |
| **Enforcement** | None | 0 penalties for non-compliance to date |
| **Durability** | Uncertain | 50-70% chance commitments hold under competitive pressure |
...
| Commitment Area | Compliance Level | Behavioral Change | Confidence |
|-----------------|------------------|-------------------|------------|
| Security testing | 70-80% | Moderate (red-teaming now standard) | Medium |
| Information sharing | 20-30% | Low (competitive concerns dominate) | Medium |
| Vulnerability reporting | 40-50% | Moderate (bug bounties exist at some labs) | Medium |
| Watermarking | 30-40% | Low (text watermarking technically limited) | Medium |
| Capability disclosure | 50-60% | Moderate (model cards common but often vague) | Medium |
| Societal risk research | 60-70% | Moderate (all labs have teams, varying rigor) | Low-Medium |
| Responsible development | N/A | Unverifiable (too vague) | Low |
| Beneficial applications | 40-50% | Low (secondary to commercial priorities) | Medium |

### Resource Requirements

| Initiative | Investment Needed | Timeline | Expected Impact |
|------------|------------------|----------|-----------------|
| Independent monitoring body | $5-15M/year | 1-2 years | 30-50% improvement in compliance visibility |
| Third-party audits (per company) | $500K-2M/year | 6-12 months | 20-40% increase in accountability |
| Industry coordination body | $3-10M/year | 1-2 years | Standardized practices, reduced racing |
| Transition to binding regulation | $20-100M (regulatory development) | 3-5 years | Legal enforcement; 2-3x effectiveness |
| Civil society oversight | $2-5M/year | Ongoing | Public accountability pressure |

### Key Uncertainties

| Uncertainty | Range of Estimates | Impact on Assessment |
|-------------|-------------------|---------------------|
| Commitment durability | 30-70% hold under competitive pressure | High - determines long-term value |
| Reputational cost of violation | Low-Medium (tech scandals often forgotten) | Medium - affects incentives |
| Transition to regulation timing | 2-5 years in major jurisdictions | High - voluntary may become mandatory |
| New entrant compliance | 20-50% of new labs adopt voluntarily | Medium - gaps undermine framework |
| International coordination | 10-40% alignment with non-US companies | Medium - limits global effectiveness |

### Historical Comparison

| Industry | Voluntary Phase Duration | Outcome | Lessons for AI |
|----------|-------------------------|---------|----------------|
| Pharmaceuticals | ~40 years (1900s-1940s) | Regulation after scandals | Proactive regulation preferable |
| Aviation | ~20 years (1920s-1940s) | Strong FAA regulation | Industry-regulator collaboration works |
| Finance | Cyclical (deregulation/crisis) | Mixed; ongoing tension | Voluntary fails during booms |
| Nuclear | Minimal voluntary phase | Immediate regulation | Catastrophic potential justifies strictness |

## Risks Addressed

| Risk | Mechanism | Effectiveness |
|------|-----------|---------------|
| [Bioweapons](/knowledge-base/risks/misuse/bioweapons/) | Commitment to CBRN testing and safeguards | Low |
| [Cyberweapons](/knowledge-base/risks/misuse/cyberweapons/) | Commitment to cybersecurity testing | Low |
| [Racing Dynamics](/knowledge-base/risk-factors/racing-dynamics/) | Establishes safety norms across labs | Low-Medium |
