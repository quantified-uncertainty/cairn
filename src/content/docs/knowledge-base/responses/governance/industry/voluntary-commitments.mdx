...
sidebar:
  order: 7
quality: 3
llmSummary: This page analyzes voluntary AI safety commitments from major labs,
  particularly the July 2023 White House commitments covering security testing,
  information sharing, and responsible development. It finds compliance rates of
  20-80% across different commitment areas, with security testing showing the
  highest adoption but information sharing remaining limited due to competitive
  pressures.
