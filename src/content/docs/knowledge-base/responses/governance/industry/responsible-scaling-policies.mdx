...
sidebar:
  order: 8
quality: 3
llmSummary: Comprehensive analysis of Responsible Scaling Policies (RSPs) by
  major AI labs, finding they provide structured risk management frameworks but
  with significant limitations including self-regulation conflicts, weak
  enforcement (0% external), and uncertain durability under competitive
  pressure. Estimates 10-25% risk reduction potential with moderate confidence,
  covering 60-70% of frontier development across 3-4 major labs.
