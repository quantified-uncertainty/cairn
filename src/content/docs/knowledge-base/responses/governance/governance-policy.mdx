...
sidebar:
  order: 3
quality: 3
llmSummary: This page comprehensively covers AI governance approaches including
  international coordination, national regulation, and industry standards. It
  estimates 5-25% x-risk reduction potential from governance with high
  uncertainty, noting ~500-1000 dedicated professionals working on governance
  globally.
