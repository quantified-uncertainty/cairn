...
sidebar:
  order: 6
quality: 82
llmSummary: "First comprehensive US state AI regulation targeting high-risk systems in consequential decisions (employment, housing, healthcare), with enforcement beginning June 2026 and penalties up to $20,000 per violation. Establishes tiered compliance framework distinguishing developers from deployers, requires NIST AI RMF alignment, and covers 12+ protected characteristics with exclusive AG enforcement."
...
| **Penalty Structure** | Up to $20,000 per violation | Violations counted per consumer; <R id="c053498946360387">50 affected consumers = \$1M potential liability</R> |
