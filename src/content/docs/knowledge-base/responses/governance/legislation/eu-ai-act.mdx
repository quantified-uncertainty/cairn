...
sidebar:
  order: 1
quality: 3
llmSummary: Comprehensive overview of the EU AI Act, the world's first major AI
  regulation framework with risk-based tiers and special provisions for
  foundation models above 10^25 FLOP. Provides detailed implementation timeline,
  enforcement mechanisms, and critical assessment of effectiveness for AI safety
  governance.
