...
sidebar:
  order: 15
quality: 3
llmSummary: This page analyzes failed AI governance proposals including
  California's SB 1047 veto and stalled federal legislation, identifying common
  failure patterns like industry opposition and definitional challenges. It
  finds that narrow, disclosure-focused proposals succeed more often than
  comprehensive liability frameworks, with less than 5% of federal AI bills
  passing.
