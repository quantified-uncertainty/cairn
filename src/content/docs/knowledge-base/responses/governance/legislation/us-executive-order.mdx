...
sidebar:
  order: 4
quality: 3
llmSummary: Comprehensive analysis of the October 2023 US Executive Order on AI,
  detailing compute-based reporting thresholds (10^26 FLOP for frontier models,
  10^23 for bio-capable models), establishment of the US AI Safety Institute,
  and cloud compute governance requirements. Assessment indicates medium
  regulatory scope covering 15-20 frontier developers globally but low
  enforcement strength and durability due to executive order limitations.
...
|-----------|------------|----------------------|
| Regulatory Scope | High | Covers ~15-20 frontier AI developers globally using US infrastructure |
| Enforcement Strength | Low-Medium | No direct fines; relies on contract/export leverage |
| Durability | Low | Can be revoked by next administration (50-70% persistence probability) |
| International Influence | Medium-High | 3-5 allied nations likely to adopt similar frameworks |
| Implementation Progress | Medium | ~60% of 90-day deliverables completed on schedule |
| Budget Adequacy | Low | AISI received ~$10M vs. estimated $50-100M needed |
...
|----------|-----------------|------------|
| Model training visibility | 100% of 10^26+ FLOP runs reported by major US labs | High |
| Safety testing adoption | 5-6 major labs now conduct standardized red-teaming | Medium |
| Government capacity building | AISI staffed with ~30-50 researchers (vs. 200+ needed) | Medium |
| International coordination | MOU signed with UK AISI; 2-3 other agreements pending | Medium |
| Threshold effectiveness | 0 reported attempts to evade via training splits | Low |
| Behavioral change | Unclear if labs doing more than pre-existing voluntary commitments | Low |

### Resource Requirements

| Investment Type | Estimated Need | Current Funding | Timeline to Impact |
|-----------------|---------------|-----------------|-------------------|
| AISI Full Operations | $50-100M/year | ~$10M allocated | 2-3 years to full capacity |
| Government AI Expertise | 500-1000 FTEs across agencies | ~100 FTEs hired | 3-5 years |
| Compliance Infrastructure | $5-20M per major lab | Labs self-funding | 6-12 months per lab |
| International Coordination | $10-20M/year for diplomatic efforts | Minimal dedicated funding | 2-4 years for treaties |
| Threshold Research | $5-10M for capability-FLOP studies | ~$2M via NIST | Ongoing |

### Key Uncertainties

| Uncertainty | Range of Estimates | Key Factors |
|-------------|-------------------|-------------|
| Political durability | 30-70% survives next transition | Administration priorities, industry lobbying |
| Threshold obsolescence | 2-5 years until 10^26 FLOP outdated | Algorithmic efficiency gains, new architectures |
| Enforcement effectiveness | 20-60% compliance with intent | Congressional action, agency capacity |
| Safety impact | 5-25% reduction in frontier risk | Actual safety improvements vs. compliance theater |
| International adoption | 2-8 major nations adopt similar | EU AI Act interaction, China response |

## Key Uncertainties (Detailed)
