...
sidebar:
  order: 4
quality: 87
llmSummary: "Executive Order 14110 (October 2023-January 2025) established compute-based reporting thresholds (10^26 FLOP for general models), created the US AI Safety Institute, and implemented cloud computing KYC requirements. The order was revoked after 15 months with ~85% completion rate; AISI was renamed CAISI and refocused from safety evaluation to innovation promotion, demonstrating the fragility of executive action for AI governance."
