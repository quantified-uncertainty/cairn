...
sidebar:
  order: 10
quality: 52
llmSummary: "US state AI legislation grew from ~40 bills in 2019 to 400+ in 2024, with Colorado enacting the most comprehensive risk-based framework (SB 21-205), California leading on deepfakes, and Illinois pioneering employment AI regulation. The failed California SB 1047 frontier AI bill demonstrates tensions between state innovation and federal preemption, with states effectively becoming de facto standard-setters in the absence of federal action."
