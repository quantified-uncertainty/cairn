...
sidebar:
  order: 5
quality: 4
llmSummary: "Detailed analysis of California's vetoed SB 1047 frontier AI safety legislation, including its compute thresholds, safety testing requirements, political journey, support/opposition dynamics, and implications for future AI regulation efforts."
