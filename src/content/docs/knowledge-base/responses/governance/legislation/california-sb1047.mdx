...
sidebar:
  order: 5
quality: 4
llmSummary: Comprehensive analysis of California's SB 1047, the most significant
  US AI safety legislation to date, which would have required safety testing and
  liability measures for AI models above 10^26 FLOP or $100M training cost
  before being vetoed by Governor Newsom. Documents the bill's requirements,
  political journey, stakeholder positions, and implications for future AI
  governance efforts.
