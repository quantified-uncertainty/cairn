...
sidebar:
  order: 7
quality: 3
llmSummary: The NIST AI Risk Management Framework is a voluntary US federal
  guidance for managing AI risks through four core functions (Govern, Map,
  Measure, Manage) and seven trustworthiness characteristics. While non-binding,
  it has gained significant influence with 40-60% of Fortune 500 companies
  referencing it and being mandated for federal agencies through executive
  order.
