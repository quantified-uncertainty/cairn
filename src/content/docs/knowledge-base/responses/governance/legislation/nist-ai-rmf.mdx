...
<InfoBox
  ...
  customFields={[
    ...
    { label: "Type", value: "Voluntary framework" },
    { label: "Referenced by", value: "US Executive Order, state laws" },
  ]}
/>
...
<Sources sources={[
  { title: "AI Risk Management Framework", url: "https://www.nist.gov/itl/ai-risk-management-framework", author: "NIST" },
  { title: "AI RMF Playbook", url: "https://airc.nist.gov/AI_RMF_Knowledge_Base/Playbook", author: "NIST" },
  { title: "Generative AI Profile (AI 600-1)", url: "https://www.nist.gov/publications/artificial-intelligence-risk-management-framework-generative-artificial-intelligence", author: "NIST", date: "July 2024" },
]} />
