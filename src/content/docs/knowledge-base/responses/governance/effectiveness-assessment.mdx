...
sidebar:
  order: 20
quality: 3
llmSummary: Systematically evaluates AI governance policy effectiveness across
  multiple approaches, finding that compute thresholds and export controls show
  moderate success (60-70% compliance) while voluntary commitments achieve less
  than 30% behavioral change, with only 15-20% of AI policies having measurable
  outcome data.
