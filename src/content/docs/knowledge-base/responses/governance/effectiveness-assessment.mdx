...
sidebar:
  order: 20
quality: 82
llmSummary: "Systematic analysis of AI governance policy effectiveness finds significant variation in outcomes: compute thresholds and export controls achieve 60-75% compliance with moderate behavioral change, while voluntary commitments show less than 30% substantive change despite 85%+ adoption. Critical finding that only 15-20% of AI policies have measurable outcome data, with less than 20% of evaluations meeting moderate evidence standards, revealing fundamental gaps in governance evaluation infrastructure."
