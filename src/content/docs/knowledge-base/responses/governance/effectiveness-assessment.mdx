...
sidebar:
  order: 20
quality: 3
llmSummary: This page systematically evaluates the effectiveness of different AI
  governance approaches using multiple evidence types and assessment frameworks.
  It finds that mandatory requirements with enforcement (like export controls
  and compute thresholds) achieve 60-70% compliance rates, while voluntary
  commitments show less than 30% behavioral change, though most policies are too
  new for rigorous assessment.
...
|-----------|------------|----------------------|
| **Evidence Quality** | Limited | Only 15-20% of AI policies have measurable outcome data |
| **Time Horizon** | Too early | Most policies less than 2 years old; meaningful assessment requires 3-5 years |
| **Best Performers** | Export controls, compute thresholds | 60-70% compliance rates where measured |
| **Worst Performers** | Voluntary commitments, vague principles | Less than 30% behavioral change achieved |
| **Research Gap** | Severe | Less than $5M/year spent on AI policy effectiveness research globally |
...
| Policy Type | Current Evidence | Estimated Effectiveness | Confidence |
|-------------|------------------|------------------------|------------|
| Mandatory disclosure | 40-50% compliance initially, improving | 20-30% behavioral change | Medium |
| Voluntary commitments | High adoption (~85% of frontier labs), low enforcement | 10-20% risk reduction | Low |
| Compute thresholds | 90%+ compliance with reporting | 30-40% coverage of risky development | Medium |
| Export controls | Significant short-term impact | 15-25% delay in adversary capabilities | Medium |
| Risk-based frameworks | Too early to measure | Potentially 40-60% if well-enforced | Low |
| AI Safety Institutes | Building capacity | 10-15% improvement in evaluation coverage | Low-Medium |

### Resource Requirements

| Policy Type | Investment Needed | Timeline to Effect | Expected Impact per $1M |
|-------------|------------------|-------------------|------------------------|
| Policy effectiveness research | $10-50M/year globally | 3-5 years | High (foundational) |
| Incident databases | $2-5M setup, $1M/year | 1-2 years | Medium-High |
| Compliance monitoring | $5-20M/year per jurisdiction | 1-3 years | Medium |
| Longitudinal studies | $1-3M per study | 5-10 years | Medium-High |
| Cross-jurisdiction comparison | $500K-2M per study | 2-4 years | High |

### Key Uncertainties

| Uncertainty | Range of Estimates | Impact on Assessment |
|-------------|-------------------|---------------------|
| Counterfactual development speed | Would labs have self-regulated anyway? (10-50% chance) | High |
| Enforcement sustainability | Will compliance persist? (30-70% probability over 5 years) | High |
| Regulatory arbitrage | How much activity shifts to unregulated jurisdictions? (10-40%) | Medium |
| Technology-regulation mismatch | How quickly do policies become obsolete? (1-3 year lag typical) | High |
| Industry capture probability | Regulations weakened by industry influence (40-60% of policies affected) | Medium-High |
