...
|--------------|------------------|---------------|-----------------|
| [OpenAI](/knowledge-base/organizations/labs/openai/) | ~100-150 | \$10-100M | Alignment, red teaming, policy |
...
> "Corporate safety efforts are fundamentally inadequate given the magnitude of [alignment challenges](/knowledge-base/risks/accident/). Economic incentives systematically undermine safety."
...
|--------|-----------|--------|
| <EntityLink id="misalignment-potential" /> | <EntityLink id="safety-culture-strength" /> | $300-500M annual safety spending (5-10% of R&D) but 30-40% safety team turnover |
