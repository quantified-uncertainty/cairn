...
description: Advocating for slowing or pausing frontier AI development until safety can be ensured.
sidebar:
  order: 3
quality: 3
...
| [Lock-in](/knowledge-base/risk-factors/lock-in/) | More time for value reflection | Low-Medium |
...
- [Compute Governance](/knowledge-base/responses/governance/policy-approaches/compute-governance/) - Hardware controls could enable enforcement
