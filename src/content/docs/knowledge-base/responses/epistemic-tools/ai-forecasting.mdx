...
sidebar:
  order: 2
quality: 3
llmSummary: This page analyzes AI-augmented forecasting approaches that combine
  AI information processing with human judgment. It finds AI matches median
  human forecasters on 60% of question types, with AI-human combinations
  achieving 5-15% Brier score improvements over humans alone at 50-200x lower
  cost.
