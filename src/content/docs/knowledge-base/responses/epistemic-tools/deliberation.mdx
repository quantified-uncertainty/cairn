...
sidebar:
  order: 4
quality: 82
llmSummary: "AI-assisted deliberation platforms like Polis and Anthropic's Constitutional AI demonstrate 15-35% opinion change rates among participants, with Taiwan's vTaiwan achieving 80% policy implementation from 26 issues and the EU Conference engaging 5+ million visitors. The methodology shows concrete feasibility for incorporating public input into AI governance, though manipulation resistance remains a concern."
