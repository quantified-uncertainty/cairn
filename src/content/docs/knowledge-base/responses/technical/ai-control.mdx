...
sidebar:
  order: 4
quality: 2
llmSummary: "Ensuring AI safety even with potentially misaligned systems"
...
| [Autonomous Replication](/knowledge-base/risks/accident/autonomous-replication/) | Containment prevents self-replication | High |
