...
sidebar:
  order: 4
quality: 3
llmSummary: AI Control focuses on maintaining safety when using potentially
  misaligned AI systems through monitoring, containment, and redundancy rather
  than relying on alignment. Research estimates 70-85% effectiveness for
  near-human-level AI with protocols showing 80-95% detection rates for
  adversarial actions in red-team studies.
