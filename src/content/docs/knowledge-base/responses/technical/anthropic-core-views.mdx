...
sidebar:
  order: 1
quality: 3
llmSummary: Comprehensive analysis of Anthropic's published AI safety
  philosophy, which argues safety research requires frontier access and
  estimates their ~$100-200M annual safety investment. Evaluates key claims like
  Constitutional AI and mechanistic interpretability with quantified assessments
  of their research output and influence.
