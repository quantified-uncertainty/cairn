...
The existing [Parameters](/knowledge-base/ai-transition-model/) → [Outcomes](/knowledge-base/ai-transition-model/outcomes/) hierarchy was too abstract. When we say "Technical Safety reduces Existential Catastrophe"—*how*? Through what pathways?
