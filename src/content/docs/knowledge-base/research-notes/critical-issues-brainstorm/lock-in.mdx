...
|-----------|--------------|-----------|
| [AI Control Concentration](/ai-transition-model/factors/misuse-potential/ai-control-concentration/) | Direct enabler | Higher → Higher risk |
| [Human Agency](/ai-transition-model/factors/civilizational-competence/human-agency/) | Ability to resist | Lower → Higher risk |
| [Governance Capacity](/ai-transition-model/factors/civilizational-competence/governance/) | Checks on power | Lower → Higher risk |
...
| [International coordination](/ai-transition-model/factors/civilizational-competence/international-coordination/) | Prevent unilateral dominance |
...
- [Value Lock-in (Parameter)](/ai-transition-model/scenarios/long-term-lockin/values/) — Quantitative parameter
