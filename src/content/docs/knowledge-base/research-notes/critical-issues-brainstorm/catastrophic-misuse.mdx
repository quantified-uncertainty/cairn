...
|-----------|--------------|-----------|
| [Misuse Potential](/ai-transition-model/factors/misuse-potential/) | Determines who wants to cause harm | Higher threat → Higher risk |
...
| [Safety-Capability Gap](/ai-transition-model/factors/misalignment-potential/safety-capability-gap/) | Time pressure on defense | Wider → Higher risk |
