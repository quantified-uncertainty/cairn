...
|-----------|--------------|-----------|
| [Racing Intensity](/ai-transition-model/factors/transition-turbulence/racing-intensity/) | Core driver | Higher → More failure |
| [Safety-Capability Gap](/ai-transition-model/factors/misalignment-potential/safety-capability-gap/) | Pressure to deploy | Wider → More failure |
| [Coordination Capacity](/ai-transition-model/factors/civilizational-competence/coordination-capacity/) | Ability to avoid | Weaker → More failure |
| [Regulatory Capacity](/ai-transition-model/factors/civilizational-competence/regulatory-capacity/) | External constraint | Lower → More failure |
...
- [Multipolar Competition](/knowledge-base/future-projections/multipolar-competition/) — Detailed scenarios
