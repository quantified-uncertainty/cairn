...
When we say "Technical Safety reduces Existential Catastrophe"—*how*? Through what pathways? The current diagram doesn't answer this.
...
| **State Misuse** | Nation-states | Authoritarian surveillance, AI-enabled warfare | Governance, Misuse Potential |
| **Non-State Misuse** | Terrorists, criminals | Bioweapons, cyberattacks | Misuse Potential |
...
|----------------|-----------|-----------------|
| **Loss of Control** | AI pursues goals humans can't correct | Existential Catastrophe |
| **Catastrophic Misuse** | Humans use AI for mass harm | Existential Catastrophe |
...
- [Parameters Overview](/ai-transition-model/) — Current hierarchy diagram
