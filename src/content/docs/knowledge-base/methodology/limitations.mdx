...
We claim the three outcomes (Existential Catastrophe, Steady State, Transition) are "partially independent." But we don't specify:
...
| Issue | Example |
|-------|---------|
| **Category labels don't match aggregates** | "Societal" parameters split across Epistemic Foundation, Societal Adaptability, and Misuse Potential |
| **Aggregates vary in coherence** | Technical Safety (5 tightly related params) vs. Misuse Potential (4 loosely related params) |
...
|-----------|------------|-----|
| Racing Intensity | Governance, Misuse Potential | Undermines governance AND increases threat |
