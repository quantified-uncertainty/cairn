...
|-----------|----------------|-----------------|
| Technical Safety | Can we build aligned AI? | Existential Catastrophe ↓ |
| Misuse Potential | What dangers exist? | Existential Catastrophe ↑ |
...
1. **Racing Intensity appears in two aggregates** (Governance, Misuse Potential)—suggesting it may be a higher-order construct
...
| Color | Meaning | Usage |
|-------|---------|-------|
| **Red** (`#ff6b6b`) | Risk, negative | Existential Catastrophe outcome, risk nodes |
