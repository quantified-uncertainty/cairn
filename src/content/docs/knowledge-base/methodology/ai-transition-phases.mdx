...
- **Existential Catastrophe** — probability of catastrophe
...
1. **Existential Catastrophe** is primarily about the *transition period*
...
flowchart TD
    ...
    subgraph Phase2["Phase 2: Existential Catastrophe Period"]
...
### Phase 2: Existential Catastrophe Period
...
**This is the period our "Existential Catastrophe" outcome primarily measures.**
...
**This is what our "Steady State Quality" / "Long-term Trajectory" outcome measures.**
...
## What Ends the Existential Catastrophe Period?
...
```
Critical Outcomes → Existential Catastrophe
                 → Steady State Quality
                 → Transition Smoothness
```

But temporally:
- **Existential Catastrophe** is about Phase 2 (the dangerous period)
...
1. **Existential Catastrophe** — Does catastrophe occur during the transition?
2. **Long-term Trajectory** — What's the expected value of the post-resolution world?

**Transition Turbulence as Critical Outcome**:
- Moves to Critical Outcomes layer
- Affects both Existential Catastrophe (rough transitions trigger catastrophes) and Long-term Trajectory (path dependence)
...
1. **Rename "Steady State Quality"** to **"Long-term Trajectory"** — doesn't assume steady state
...
- [Critical Outcomes](/ai-transition-model/scenarios/) — The intermediate scenarios
- [Ultimate Outcomes](/ai-transition-model/outcomes/) — What we ultimately care about
