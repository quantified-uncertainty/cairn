...
| **AI Adoption** | 65% of organizations using AI regularly ([McKinsey 2024](https://www.mckinsey.com/capabilities/quantumblack/our-insights/the-state-of-ai-2024)) | Widespread but uneven integration |
...
Current observations align with this trajectory. According to [Ethan Mollick's analysis](https://www.oneusefulthing.org/p/scaling-the-state-of-play-in-ai), Gen2 models (GPT-4 class) now have multiple competitors, while Gen3 models requiring \$1B+ training costs are emerging. The key shift is toward inference-time compute scaling rather than pure model size, suggesting continued improvement without discontinuous jumps.

- GPT-5, Claude 4, Gemini 2.0 show predictable improvements
- Performance gains roughly follow scaling laws, though [some researchers note](https://www.hec.edu/en/dare/tech-ai/ai-beyond-scaling-laws) diminishing returns on pure scaling
...
The EU AI Act provides the template for "muddle governance." The [phased implementation](https://artificialintelligenceact.eu/implementation-timeline/) stretches from February 2025 (prohibited systems) through August 2027 (full compliance), allowing adaptation time but creating enforcement gaps.
...
The [IMF projects](https://www.imf.org/en/blogs/articles/2024/01/14/ai-will-transform-the-global-economy-lets-make-sure-it-benefits-humanity) that AI will affect 40% of jobs globally, with advanced economies seeing higher exposure (60%). However, the [World Economic Forum](https://www.weforum.org/) anticipates net job creation: 170 million new jobs versus 92 million displaced by 2030.
...
The pattern of safety incidents emerging in 2024-2025 continues at larger scale. The [MIT AI Incident Tracker](https://airisk.mit.edu/ai-incident-tracker) documents harm severity and affected populations, while the [Future of Life Institute's 2025 AI Safety Index](https://futureoflife.org/ai-safety-index-summer-2025/) tracks leading companies' safety practices.
...
Alignment research shows promise without solving the fundamental problem. Anthropic's [2024 "alignment faking" research](https://alignment.anthropic.com/) found models could strategically preserve preferences under certain conditions, while their [2025 circuit tracing work](https://alignment.anthropic.com/2025/recommended-directions/) reveals shared conceptual spaces in model cognition. In summer 2025, [Anthropic and OpenAI conducted joint alignment evaluations](https://alignment.anthropic.com/2025/openai-findings/)—the first such cross-lab collaboration.
...
Building on the [international network of AI Safety Institutes](https://www.gov.uk/government/news/global-leaders-agree-to-launch-first-international-network-of-ai-safety-institutes-to-boost-understanding-of-ai) established at the Seoul Summit (2024), governance develops but remains fragmented. The [Bletchley-Seoul process](https://www.brookings.edu/articles/the-bletchley-park-process-could-be-a-building-block-for-global-cooperation-on-ai-safety/) creates a foundation for cooperation without achieving binding enforcement.
...
|------------|--------|-----------|----------------|
| 300M full-time jobs affected | [IMF 2024](https://www.imf.org/en/blogs/articles/2024/01/14/ai-will-transform-the-global-economy-lets-make-sure-it-benefits-humanity) | By 2030 | Most are task transformation, not job loss |
| Net +78M jobs globally | [WEF 2025](https://www.weforum.org/) | By 2030 | 170M created, 92M displaced |
| 35% cumulative GDP gains | [McKinsey/Goldman Sachs](https://www.mckinsey.com/capabilities/quantumblack/our-insights/the-state-of-ai-2024) | 10-year period | Advanced economies only |
| 0.7% TFP gains | [Acemoglu 2025](https://budgetmodel.wharton.upenn.edu/issues/2025/9/8/projected-impact-of-generative-ai-on-future-productivity-growth) | Over 10 years | Only 4.6% of tasks profitably replaced |
...
|--------------|----------|----------------|---------------|
| **EU** | Comprehensive risk-based ([AI Act](https://digital-strategy.ec.europa.eu/en/policies/regulatory-framework-ai)) | Phased 2025-2027 | Medium; strong on paper, enforcement uncertain |
...
| **International** | [Seoul process](https://www.industry.gov.au/publications/seoul-declaration-countries-attending-ai-seoul-summit-21-22-may-2024); AI Safety Institutes | Voluntary commitments | Low; limited enforcement |
...
- [IMF: AI Will Transform the Global Economy](https://www.imf.org/en/blogs/articles/2024/01/14/ai-will-transform-the-global-economy-lets-make-sure-it-benefits-humanity) (January 2024) - Analysis of AI's impact on 40% of global jobs
- [McKinsey: State of AI 2024](https://www.mckinsey.com/capabilities/quantumblack/our-insights/the-state-of-ai-2024) - 65% of organizations regularly using AI
- [Penn Wharton Budget Model: AI Productivity Impact](https://budgetmodel.wharton.upenn.edu/issues/2025/9/8/projected-impact-of-generative-ai-on-future-productivity-growth) - Conservative 0.7% TFP gains estimate

### Governance & International Cooperation
- [EU AI Act Implementation Timeline](https://artificialintelligenceact.eu/implementation-timeline/) - Phased approach through 2027
- [Seoul Declaration](https://www.industry.gov.au/publications/seoul-declaration-countries-attending-ai-seoul-summit-21-22-may-2024) - 27-nation commitment on AI safety
- [Brookings: Bletchley Park Process](https://www.brookings.edu/articles/the-bletchley-park-process-could-be-a-building-block-for-global-cooperation-on-ai-safety/) - Analysis of international cooperation potential
- [UK AI Safety Institutes Network](https://www.gov.uk/government/news/global-leaders-agree-to-launch-first-international-network-of-ai-safety-institutes-to-boost-understanding-of-ai) - Cross-border safety collaboration

### Capability & Scaling Analysis
- [Ethan Mollick: Scaling State of Play](https://www.oneusefulthing.org/p/scaling-the-state-of-play-in-ai) - Gen2/Gen3 model progression
- [HEC Paris: AI Beyond Scaling Laws](https://www.hec.edu/en/dare/tech-ai/ai-beyond-scaling-laws) - Diminishing returns analysis

### Safety Research & Incidents
- [MIT AI Incident Tracker](https://airisk.mit.edu/ai-incident-tracker) - Comprehensive incident database
- [Future of Life Institute: 2025 AI Safety Index](https://futureoflife.org/ai-safety-index-summer-2025/) - Company safety practices assessment
- [Anthropic Alignment Science](https://alignment.anthropic.com/) - Technical safety research
- [Anthropic-OpenAI Joint Evaluation](https://alignment.anthropic.com/2025/openai-findings/) - Cross-lab alignment testing

### International AI Safety Report
- [International AI Safety Report (2025)](https://www.gov.uk/government/publications/international-ai-safety-report) - 96 experts, 30 nations, commissioned assessment of AI threats
