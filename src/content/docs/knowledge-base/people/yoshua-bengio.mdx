...
sidebar:
  order: 7
quality: 3
llmSummary: Comprehensive profile of Yoshua Bengio's evolution from deep
  learning pioneer to AI safety advocate, documenting his transition to safety
  research at Mila, policy advocacy, and public statements including co-signing
  the 2023 AI extinction risk statement. Shows his middle-ground position
  supporting continued research with safety guardrails and regulatory oversight.
