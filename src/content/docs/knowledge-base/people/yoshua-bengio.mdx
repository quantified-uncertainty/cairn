...
sidebar:
  order: 7
quality: 3
llmSummary: Profile of Turing Award winner Yoshua Bengio, who transitioned from
  deep learning pioneer to AI safety advocate around 2018-2020. His shift
  brought significant credibility to AI risk concerns and influenced both the ML
  community and policymakers toward taking safety seriously.
