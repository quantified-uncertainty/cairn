...
sidebar:
  order: 7
quality: 78
llmSummary: "Comprehensive profile of Yoshua Bengio documenting his transition from deep learning pioneer to AI safety advocate, with 6 data tables tracking his risk assessments, career trajectory, research areas, and policy positions. Includes quantified timeline estimates (10-20 years to AGI, extinction risk possible within 15-20 years) and tracks his influence on redirecting Mila's research (40% pivot to safety)."
...
As Scientific Director of <R id="30a19999d89a4ec0">Mila</R>, one of the world's largest AI research institutes, Bengio has redirected substantial resources toward [AI safety research](/knowledge-base/responses/alignment/) since 2020. His co-signing of the 2023 AI extinction risk statement and subsequent policy advocacy have positioned him as a bridge between the technical AI community and policymakers concerned about existential risks.
...
- [Alignment difficulty](/knowledge-base/risks/accident/) as systems become more capable
...
- [AI Safety Research](/knowledge-base/responses/alignment/) - Technical approaches Bengio advocates
- [Alignment Difficulty](/knowledge-base/risks/accident/) - Core problem Bengio addresses
