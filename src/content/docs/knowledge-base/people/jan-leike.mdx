...
sidebar:
  order: 4
quality: 2
llmSummary: Comprehensive biographical profile of Jan Leike documenting his
  career progression from DeepMind to OpenAI (where he led the Superalignment
  team with 20% compute allocation) to Anthropic, focusing on his RLHF
  pioneering work and scalable oversight research. Details his May 2024
  departure from OpenAI over safety prioritization concerns and current role
  leading alignment research at Anthropic.
