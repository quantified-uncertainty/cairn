...
sidebar:
  order: 6
quality: 2
llmSummary: Comprehensive biographical page on Nick Bostrom, the Oxford
  philosopher who founded the Future of Humanity Institute and wrote
  'Superintelligence' (2014). Covers his foundational contributions to AI safety
  including the orthogonality thesis, instrumental convergence, and frameworks
  that established AI existential risk as an academic field.
