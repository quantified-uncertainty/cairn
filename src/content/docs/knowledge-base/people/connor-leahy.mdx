...
sidebar:
  order: 14
quality: 2
llmSummary: Provides detailed background on Connor Leahy, CEO of Conjecture AI
  safety company, including his transition from EleutherAI to founding a
  safety-focused organization and his views on short AGI timelines (2-5 years)
  and high existential risk. Documents his interpretability-first approach and
  public advocacy for AI safety urgency.
