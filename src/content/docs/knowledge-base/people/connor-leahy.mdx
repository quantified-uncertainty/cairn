...
sidebar:
  order: 14
quality: 2
llmSummary: Profile of Connor Leahy, CEO of Conjecture and co-founder of
  EleutherAI, who transitioned from capabilities research to AI safety work
  focused on interpretability and prosaic alignment. He advocates for very short
  AGI timelines (2-5 years) and emphasizes the urgent need for mechanistic
