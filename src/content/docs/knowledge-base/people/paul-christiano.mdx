...
sidebar:
  order: 2
quality: 3
llmSummary: Comprehensive profile of Paul Christiano covering his major AI
  alignment contributions (iterated amplification, AI safety via debate,
  scalable oversight) and current risk estimates (~10-20% P(doom), AGI in
  2030s-2040s). Well-structured reference material on a key alignment researcher
  but primarily biographical rather than actionable for prioritization
  decisions.
