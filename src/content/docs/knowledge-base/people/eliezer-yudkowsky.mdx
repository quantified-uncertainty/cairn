...
sidebar:
  order: 1
quality: 3
llmSummary: Co-founder of MIRI and foundational AI safety researcher who
  articulated core alignment problems and coined concepts like Coherent
  Extrapolated Volition. Known for extreme pessimism about alignment difficulty
  (>90% P(doom)) and advocacy for slowing/stopping AI development.
