...
import { InfoBox, KeyQuestions, EntityCard, EntityCards, Sources } from '../../../../components/wiki';
...
<EntityCards>
  <EntityCard
    ...
    link="/knowledge-base/future-projections/aligned-agi"
  ...
  <EntityCard
    ...
    link="/knowledge-base/future-projections/slow-takeoff-muddle"
  ...
  <EntityCard
    ...
    link="/knowledge-base/future-projections/misaligned-catastrophe"
  ...
  <EntityCard
    ...
    link="/knowledge-base/future-projections/multipolar-competition"
  ...
  <EntityCard
    ...
    link="/knowledge-base/future-projections/pause-and-redirect"
