...
sidebar:
  order: 2
quality: 4
llmSummary: Chronicles foundational AI safety concerns from 1950-2000,
  documenting how Turing (1950), Wiener (1960), and Good (1965) identified key
  risks like intelligence explosion, goal specification problems, and control
  challenges decades before modern AI safety research. Shows these early
  thinkers anticipated core problems like recursive self-improvement and
  alignment issues, though their warnings were largely philosophical rather than
  technical.
