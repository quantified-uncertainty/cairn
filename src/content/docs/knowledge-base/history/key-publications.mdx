...
sidebar:
  order: 6
quality: 3
llmSummary: Comprehensive survey of foundational publications that shaped AI
  safety, from Good's 1965 intelligence explosion paper through recent technical
  works. Covers key books like Superintelligence (2014) and Concrete Problems
  (2016), technical papers on alignment, and policy works, providing historical
