...
sidebar:
  order: 3
quality: 4
llmSummary: Documents the formation of organized AI safety research from
  2000-2015, tracing the founding of MIRI (originally SIAI), the LessWrong
  community, and early theoretical work including Yudkowsky's Friendly AI
  framework and Coherent Extrapolated Volition. Shows how AI safety transitioned
  from scattered warnings to a small but serious research field with dedicated
