...
description: The formation of organized AI safety research, from the Singularity
  Institute to Bostrom's Superintelligence
sidebar:
  order: 3
quality: 4
llmSummary: Comprehensive historical account of AI safety's institutional
  formation from 2000-2015, covering MIRI's founding, Yudkowsky's early work,
  LessWrong community building, and Bostrom's Superintelligence legitimizing the
  field. Documents the transition from scattered individuals to an organized
  research community with funding, academic credibility, and public awareness.
