...
This represents one of the most significant negative results for [alignment difficulty](/knowledge-base/risks/accident/) arguments.
...
- Anthropic accelerates [capabilities](/ai-transition-model/factors/ai-capabilities/) development more than safety research
