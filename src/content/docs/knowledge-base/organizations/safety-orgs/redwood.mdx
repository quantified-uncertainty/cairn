...
sidebar:
  order: 12
quality: 3
llmSummary: Redwood Research is an AI safety lab that has evolved from
  adversarial robustness work to mechanistic interpretability (developing causal
  scrubbing methods) to pioneering the 'AI control' research agenda. They focus
  on ensuring safety even with potentially misaligned AI systems through
  monitoring, containment protocols, and red-team testing approaches.
