...
sidebar:
  order: 13
quality: 5
llmSummary: "GovAI is a leading AI policy research organization that received $5.8M+ from Open Philanthropy (2023-2024), has placed alumni in DeepMind, OpenAI, Anthropic, and UK/US/EU governments, and directly influences EU AI Act implementation—Markus Anderljung serves as Vice-Chair for the GPAI Code of Practice Safety & Security chapter."
