...
sidebar:
  order: 14
quality: 1
llmSummary: CAIS is a nonprofit organization focused on reducing AI existential
  risks through technical research, field-building programs, and public
  advocacy. They organized the influential Statement on AI Risk signed by
  hundreds of researchers including AI leaders like Hinton, Bengio, and industry
  CEOs.
