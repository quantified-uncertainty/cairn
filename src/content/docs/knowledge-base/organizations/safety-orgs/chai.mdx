...
llmSummary: CHAI is UC Berkeley's AI alignment research center founded by Stuart
  Russell, focusing on 'human-compatible AI' that defers to human preferences
  rather than pursuing fixed objectives. The center has significantly
  legitimized AI safety research in academia and influenced the field through
  Russell's advocacy and student training.
