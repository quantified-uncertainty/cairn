...
sidebar:
  order: 14
quality: 3
llmSummary: Epoch AI is a research organization that provides empirical analysis
  of AI progress through comprehensive databases tracking compute trends,
  training datasets, and algorithmic efficiency. Their work has become
  foundational for AI governance and safety research, particularly their
  findings on exponential compute growth (6-month doubling times) and potential
  data exhaustion by the mid-2020s for high-quality text.
