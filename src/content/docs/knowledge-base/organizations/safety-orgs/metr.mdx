...
llmSummary: METR conducts dangerous capability evaluations for frontier AI
  models before deployment, testing for autonomous replication, cybersecurity
  abilities, CBRN knowledge, and manipulation capabilities. Their assessments
  directly inform deployment decisions at major labs like OpenAI, Anthropic, and
  DeepMind through integration with safety frameworks like RSPs.
