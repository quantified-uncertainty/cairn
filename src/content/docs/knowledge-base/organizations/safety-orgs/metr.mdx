...
sidebar:
  order: 15
quality: 82
llmSummary: "METR conducts pre-deployment dangerous capability evaluations for frontier AI models across autonomous replication, cybersecurity, CBRN, and manipulation domains, directly informing deployment decisions at major labs. Current models show concerning progress toward catastrophic capabilities (especially in cybersecurity and autonomous operation) but have not yet crossed critical thresholds, with METR serving as the primary empirical gatekeeper for AI safety."
lastEdited: "2025-12-28"
importance: 78.5
---
import {DataInfoBox, DisagreementMap, KeyPeople, KeyQuestions, Section, Backlinks, R} from '../../../../../components/wiki';
...
| **Team Size** | ~30 specialists (as of 2024) |
| **Key Partners** | OpenAI, Anthropic, Google DeepMind, UK AI Safety Institute, NIST AI Safety Institute Consortium |
| **Evaluation Focus** | Autonomous replication, cybersecurity, CBRN, manipulation, AI R&D capabilities |
| **Funding Model** | Non-profit; does not accept payment from labs for evaluations (maintains independence) |
...
| **MALT Dataset** | October 2025 | 10,919 reviewed transcripts for studying reward hacking and sandbagging; best monitors achieve 0.96 AUROC for detecting reward hacking | <R id="3ee11b82b7e1fd68">metr.org</R> |
...
|---------------------|----------|
| **Philosophy** | Assume dangerous until proven safe; elicit worst-case |
| **Elicitation** | Fine-tuning, scaffolding, adversarial prompting |
| **Thresholds** | Quantitative benchmarks comparing to human experts |
| **Quality control** | Multiple evaluators, cross-validation, reproducible protocols |

For general evaluation theory and scalable oversight approaches, see [Scalable Oversight](/knowledge-base/responses/alignment/scalable-oversight/).
...
|---------|-------------|------|
| **OpenAI** | [Preparedness Framework](/knowledge-base/responses/governance/industry/voluntary-commitments/) | Pre-deployment evaluations for cybersecurity, CBRN, persuasion, autonomy |
| **Anthropic** | [Responsible Scaling Policy](/knowledge-base/responses/governance/industry/responsible-scaling-policies/) | ASL threshold assessments, independent verification |
| **UK AISI** | [AI Safety Institute](/knowledge-base/organizations/government/uk-aisi/) | Methodology sharing, evaluator training |
| **US AISI** | [NIST Consortium](/knowledge-base/organizations/government/us-aisi/) | Executive Order implementation, standards development |

These partnerships have established external evaluation as industry standard practice, with METR's findings directly influencing deployment decisions. For detailed analysis of these frameworks, see [Voluntary Industry Commitments](/knowledge-base/responses/governance/industry/voluntary-commitments/) and [AI Safety Institutes](/knowledge-base/responses/institutions/ai-safety-institutes/).
