...
sidebar:
  order: 17
quality: 42
llmSummary: "The US AI Safety Institute, established in 2023 within NIST, serves as the federal government's central hub for AI safety evaluation and standard-setting, conducting frontier model assessments and developing technical standards, though it lacks direct regulatory authority. The institute represents a shift from private sector AI safety work to government-backed institutional oversight with indirect influence through standards development and coordination with regulatory agencies."
