...
sidebar:
  order: 17
quality: 3
llmSummary: Comprehensive overview of the US AI Safety Institute (established
  2023 within NIST) covering its mandate for AI safety standards, evaluations,
  and coordination with industry/international partners. Details the institute's
  key functions including pre-deployment evaluations of frontier models,
  development of safety standards, and its role as the primary US government
  institution for AI safety oversight.
