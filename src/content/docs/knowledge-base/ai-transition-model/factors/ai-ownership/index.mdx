...
Also affects:
- **[AI Takeover](/knowledge-base/ai-transition-model/scenarios/ai-takeover/)**: Concentrated ownership could help or hurt depending on the actor
- **[Human-Caused Catastrophe](/knowledge-base/ai-transition-model/scenarios/human-catastrophe/)**: Depends on who controls AI and their intentions
