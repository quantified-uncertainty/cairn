...
### Ultimate Outcomes
- [Existential Catastrophe](/knowledge-base/ai-transition-model/outcomes/existential-catastrophe/) — Turbulence can trigger catastrophes
- [Long-term Trajectory](/knowledge-base/ai-transition-model/outcomes/long-term-trajectory/) — Turbulence shapes achievable futures
