...
flowchart TD
    subgraph Technical["Misalignment Potential"]
    ...
    subgraph Threats["Misuse Potential"]
    ...
    AR -->|reduces| ACUTE[Existential Catastrophe]
...
|-----------|--------------|-----------|
| [Misalignment Potential](/knowledge-base/ai-transition-model/factors/misalignment-potential/) | ↓↓↓ Decreases risk | Aligned, interpretable, overseen systems are less likely to cause catastrophe |
| [Misuse Potential](/knowledge-base/ai-transition-model/factors/misuse-potential/) | ↑↑↑ Increases risk | Higher bio/cyber exposure, concentration, and racing all elevate existential catastrophe |
...
- [Misalignment Potential](/knowledge-base/ai-transition-model/factors/misalignment-potential/)
- [Misuse Potential](/knowledge-base/ai-transition-model/factors/misuse-potential/)
