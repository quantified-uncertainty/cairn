...
Long-term Trajectory measures the expected quality of the world *after the existential catastrophe period resolves*—whatever equilibrium or trajectory humanity ends up on. This is about the **destination** (or ongoing trajectory), distinct from whether we survive to reach it ([Existential Catastrophe](/knowledge-base/ai-transition-model/outcomes/existential-catastrophe/)).
...
- [Existential Catastrophe](/knowledge-base/ai-transition-model/outcomes/existential-catastrophe/) — The other Ultimate Outcome
