...
### Structural Scenarios That Affect This

| Structural Scenario | Effect on Long-term Trajectory |
|---------------------|--------------------------------|
...
- [Long-term Lock-in](/knowledge-base/ai-transition-model/scenarios/long-term-lockin/) — Key Structural Scenario for long-term trajectory
