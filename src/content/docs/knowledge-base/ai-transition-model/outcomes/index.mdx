...
- **Different Structural Scenarios affect different Ultimate Outcomes**
...
## How Structural Scenarios Flow to Ultimate Outcomes
...
| Structural Scenario | Affects Existential Catastrophe | Affects Long-term Trajectory |
|---------------------|--------------------------------|------------------------------|
...
Each structural scenario has sub-variants with different probability estimates. See the [Structural Scenarios](/knowledge-base/ai-transition-model/scenarios/) section for details.
