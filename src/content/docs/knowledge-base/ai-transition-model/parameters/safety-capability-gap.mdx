...
**Contributes to:** [Misalignment Potential](/knowledge-base/ai-transition-model/factors/misalignment-potential/) (inverse — wider gap means lower safety capacity)

**Primary outcomes affected:**
- [Existential Catastrophe](/knowledge-base/ai-transition-model/outcomes/existential-catastrophe/) ↑↑↑ — A wide gap means deploying systems we don't understand how to make safe
