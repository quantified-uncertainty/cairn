...
**Contributes to:** [Misuse Potential](/knowledge-base/ai-transition-model/factors/misuse-potential/)

**Primary outcomes affected:**
- [Existential Catastrophe](/knowledge-base/ai-transition-model/outcomes/existential-catastrophe/) ↑↑ — Concentrated control creates single points of failure/capture
