...
- [Existential Catastrophe](/knowledge-base/ai-transition-model/outcomes/existential-catastrophe/) ↓↓ — Strong safety culture ensures safety practices persist under pressure
