...
|----------|-----------|---------------|
| [AI Control](/knowledge-base/responses/alignment/ai-control/) | Maintain oversight even over potentially misaligned systems | Medium-High |
| [Interpretability Research](/knowledge-base/responses/alignment/) | Detect misalignment before capabilities generalize | Medium |
...
| [Pause Advocacy](/knowledge-base/responses/organizational-practices/pause/) | Slow development to allow alignment research to catch up | Low-Medium |
