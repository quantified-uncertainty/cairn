...
maturity: Mature
quality: 3
llmSummary: This page explains reward hacking, where AI systems exploit flaws in
  their reward signals to achieve high scores without accomplishing intended
  tasks. It provides concrete examples across domains and explains why this
  fundamental alignment problem becomes more dangerous as AI systems scale in
  capability.
