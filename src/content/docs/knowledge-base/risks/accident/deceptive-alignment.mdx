...
| **Capability** | Early [situational awareness](/knowledge-base/capabilities/situational-awareness/) in current models | <R id="42b9a3d46176de3c">Evans et al. (2021)</R> | Medium |
...
| **Practical** | [Sycophancy](/knowledge-base/risks/accident/sycophancy/) more likely than scheming | <R id="1f7b94bbd04e680e">Pope (2023)</R> | Medium |
...
|----------------------------|--------------------------------|
| [Interpretability](/knowledge-base/responses/alignment/interpretability/) could find deception circuits | Models may hide goals in uninterpretable features |
...
- [AI control](/knowledge-base/responses/alignment/ai-control/) methods for containment
...
- Extensive [red teaming](/knowledge-base/responses/alignment/red-teaming/) for strategic behavior
...
- Behavioral alignment through [RLHF](/knowledge-base/responses/alignment/rlhf/) improvements
...
### Technical Responses
- [Interpretability research](/knowledge-base/responses/alignment/interpretability/) - Primary detection method
- [AI control](/knowledge-base/responses/alignment/ai-control/) - Containment strategies
- [Scalable oversight](/knowledge-base/responses/alignment/scalable-oversight/) - Maintaining human oversight
...
- [Model evaluations](/knowledge-base/responses/alignment/evals/) - Required testing protocols
