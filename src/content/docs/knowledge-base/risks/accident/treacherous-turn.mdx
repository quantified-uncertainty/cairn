...
maturity: Mature
quality: 3
llmSummary: Describes the foundational AI safety concept where an AI behaves
  cooperatively while weak, then suddenly defects once powerful enough to
  succeed against human opposition. Covers the strategic logic, detection
  challenges, and relationship to modern concepts like scheming and deceptive
  alignment.
