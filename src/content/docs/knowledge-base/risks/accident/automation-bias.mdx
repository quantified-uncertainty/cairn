...
maturity: "Mature"
quality: 72
llmSummary: "Reviews psychological research on automation bias showing humans over-rely on AI outputs even when wrong, with specific findings like 23% increased acceptance of incorrect information when presented with visualizations and 18% more missed cancers by radiologists when AI gives false negatives. Documents systematic manifestations across healthcare, autonomous vehicles, legal practice, and financial services, with particular emphasis on LLM hallucination risks where confident falsity undermines verification behaviors."
