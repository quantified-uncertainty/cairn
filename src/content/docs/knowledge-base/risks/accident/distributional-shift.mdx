...
maturity: Mature
quality: 3
llmSummary: Distributional shift is identified as one of the most common causes
  of AI system failure when deployed in contexts different from training, with
  particular safety concerns in high-stakes domains where failures may be silent
  and confident. The page outlines four main types of shift (covariate, prior
  probability, concept drift, temporal) and discusses mitigation strategies
  including out-of-distribution detection and robust training techniques.
