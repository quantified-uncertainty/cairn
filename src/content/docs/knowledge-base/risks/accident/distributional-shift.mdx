...
maturity: Mature
quality: 3
llmSummary: This page explains how AI systems fail when deployed in contexts
  different from their training data, covering types like covariate shift and
  concept drift. It identifies this as a fundamental ML problem that can cause
  silent failures in high-stakes domains and outlines detection and mitigation
  approaches.
