...
maturity: Neglected
quality: 4
llmSummary: This page examines psychological harms from AI interactions,
  including parasocial relationships, AI-induced delusions, manipulation through
  personalization, and reality confusion from synthetic content. It provides
  comprehensive coverage of documented cases, vulnerable populations, and
  mitigation approaches across technical and regulatory domains.
