...
maturity: "Neglected"
quality: 68
llmSummary: "Analyzes systemic risk where declining institutional trust creates self-reinforcing collapse, finding current trust at concerning levels (media 32%, federal government 16%) and identifying AI capabilities for synthetic evidence and coordinated disinformation as unprecedented acceleration factors that could trigger cascade failures beyond institutions' capacity to rebuild credibility."
