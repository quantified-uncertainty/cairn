...
maturity: "Emerging"
quality: 78
llmSummary: "Analyzes how AI systems shape human preferences through recommendation engines, targeted advertising, and conversational AI, documenting escalation from implicit (2010-2023) to potentially autonomous manipulation (2030+). Provides mechanisms, real-world examples across domains (political, consumer, relationships), and technical/regulatory/individual defenses with their limitations."
lastEdited: "2025-12-24"
todo: "Add more recent research on preference manipulation effectiveness; expand on regulatory approaches beyond EU/California; include neuroscience evidence on preference formation"
importance: 62.5
causalLevel: "pathway"
---
