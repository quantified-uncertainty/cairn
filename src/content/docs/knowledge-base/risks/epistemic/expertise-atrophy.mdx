...
maturity: "Neglected"
quality: 72
llmSummary: "Analyzes how AI dependence causes skill atrophy across professions (aviation, medicine, programming), documenting a 5-phase progression from augmentation to generational knowledge loss over 15-30 years. Provides evidence from Air France 447 crash, taxi driver hippocampal changes, and declining Stack Overflow traffic, with concrete defenses including mandatory manual practice and AI-free assessments."
