...
maturity: Neglected
quality: 3
llmSummary: This page examines how humanity might gradually lose capabilities
  and agency through AI dependence, covering skill atrophy, knowledge loss, and
  decision-making outsourcing. It provides concrete examples like GPS reducing
  navigation skills and coding assistants affecting programming abilities, while
  exploring prevention strategies and debates about whether capability loss is
