...
maturity: Growing
quality: 3
llmSummary: Examines how AI could enable permanent entrenchment of values,
  political systems, or power structures through enhanced surveillance and
  control capabilities. Argues the current period is critical since early AI
  development decisions may become irreversible, making this a distinct category
  of existential risk.
