...
sidebar:
  order: 5
quality: 4
llmSummary: This page analyzes how AI could enable permanently stable
  authoritarian regimes through comprehensive surveillance, predictive dissent
  detection, and automated enforcement that closes off historical pathways to
  liberation. It examines current evidence from China/Russia and potential
  pathways including democratic backsliding and AI-assisted coups.
