...
sidebar:
  order: 5
quality: 88
llmSummary: "Comprehensive analysis showing 72% of global population (5.7 billion) now lives under autocracy with AI surveillance deployed in 80+ countries, documenting how AI systems may permanently foreclose traditional pathways for regime change through comprehensive surveillance, predictive policing, and automated enforcement. Provides extensive quantified evidence across China's Sharp Eyes system, democratic backsliding patterns, and four distinct pathways to authoritarian lock-in."
...
|-----------|--------------|
| [Authoritarian Tools](/knowledge-base/risks/misuse/authoritarian-tools/) | The capabilities that enable this risk |
