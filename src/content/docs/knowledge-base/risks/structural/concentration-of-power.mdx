...
description: >-
  AI enabling unprecedented accumulation of power by small groups—with compute
  requirements exceeding $100M for frontier models and 5 firms controlling 80%+
...
quality: 91
llmSummary: >-
  Concentration of power is the risk of AI enabling unprecedented control by few
  organizations. This is a short reference page—see Power Distribution parameter
...
> **For comprehensive analysis**, see [AI Control Concentration](/ai-transition-model/factors/misuse-potential/ai-control-concentration/), which covers:
...
See [AI Control Concentration](/ai-transition-model/factors/misuse-potential/ai-control-concentration/) for detailed analysis.
...
### Primary Reference
- **[AI Control Concentration](/ai-transition-model/factors/misuse-potential/ai-control-concentration/)** — Comprehensive parameter page with mechanisms, measurement, and interventions
...
### Related Parameters
- [Regulatory Capacity](/ai-transition-model/factors/civilizational-competence/regulatory-capacity/) — Government ability to constrain concentration
- [Coordination Capacity](/ai-transition-model/factors/civilizational-competence/coordination-capacity/) — Multi-actor cooperation on governance
- [Institutional Quality](/ai-transition-model/factors/civilizational-competence/institutional-quality/) — Checks and balances strength
