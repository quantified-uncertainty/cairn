...
> **For comprehensive analysis**, see [Human Agency](/ai-transition-model/factors/civilizational-competence/human-agency/), which covers:
...
See [Human Agency](/ai-transition-model/factors/civilizational-competence/human-agency/) for detailed intervention analysis.
...
### Primary Reference
- **[Human Agency](/ai-transition-model/factors/civilizational-competence/human-agency/)** — Comprehensive parameter page with dimensions, benchmarks, threats, supports, and scenarios
...
- [AI Control Concentration](/ai-transition-model/factors/misuse-potential/ai-control-concentration/) — Who holds decision-making power
