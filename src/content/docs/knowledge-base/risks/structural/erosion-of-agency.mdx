...
maturity: Neglected
quality: 3
llmSummary: This page analyzes how AI systems may erode human agency through
  algorithmic curation, behavioral prediction, and automated decisions that
  reduce meaningful choice. It explores current manifestations like social media
  algorithms and hiring systems, while examining whether this represents a
  qualitative shift in human autonomy.
