---
title: "Bioweapons"
description: "AI-assisted biological weapon development represents one of the most severe near-term AI risks. Current evidence suggests limited AI uplift for sophisticated attackers, but increasing capabilities in biosecurity evasion and the potential for lab automation could shift this balance."
sidebar:
  order: 1
maturity: "Growing"
quality: 78
llmSummary: "Comprehensive analysis of AI-assisted bioweapons risk using attack chain modeling and expert elicitation, finding 0.02%-3.6% compound attack probability with mixed evidence on AI uplift. Microsoft research shows AI-designed toxins evading 75%+ of DNA synthesis screening, while RAND 2024 found no statistically significant AI assistance in attack planning."
