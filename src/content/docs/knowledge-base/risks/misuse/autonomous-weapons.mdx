...
maturity: Mature
quality: 3
llmSummary: This page examines lethal autonomous weapons systems (LAWS) across
  the spectrum of human control, covering moral objections, reliability
  concerns, and escalation risks. It includes recent case studies like Ukraine's
  all-drone attack in 2024 and Libya's Kargu-2 incident, showing how AI is
  lowering barriers to warfare.
