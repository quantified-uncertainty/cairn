...
|----------|-----------|---------------|
| [EU AI Act](/knowledge-base/responses/governance/legislation/eu-ai-act/) | Bans real-time biometric identification in public spaces (with exceptions) | Medium-High (within EU) |
| [US State Legislation](/knowledge-base/responses/governance/legislation/us-state-legislation/) | City/state bans on government facial recognition (San Francisco, etc.) | Low-Medium (fragmented) |
| [Export Controls](/knowledge-base/responses/governance/compute-governance/export-controls/) | US Entity List restricts Chinese surveillance company access to American components | Medium |
| [GDPR](/knowledge-base/responses/governance/legislation/eu-ai-act/) | Requires consent for biometric processing; grants data access/deletion rights | Medium (EU only) |
