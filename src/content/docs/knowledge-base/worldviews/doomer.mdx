...
importance: 4
quality: 4
llmSummary: This page comprehensively outlines the AI doomer worldview, which
  predicts 30-90% probability of AI existential catastrophe by 2100 based on
  short AGI timelines (10-15 years), fundamental alignment difficulty, and
  inadequate coordination. It covers core beliefs, key proponents like
  Yudkowsky, strongest arguments including orthogonality thesis and instrumental
  convergence, and strategic implications for career choices.
---
import { EstimateBox, Tags } from '../../../../components/wiki';
