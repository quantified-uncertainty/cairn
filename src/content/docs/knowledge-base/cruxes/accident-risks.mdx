...
sidebar:
  order: 1
quality: 3
llmSummary: Comprehensive overview of key disagreements that drive different
  views on AI accident risks, covering 11 fundamental cruxes from
  mesa-optimization to reward hacking. Provides structured analysis of expert
  positions, probability ranges, and strategic implications for each crux.
