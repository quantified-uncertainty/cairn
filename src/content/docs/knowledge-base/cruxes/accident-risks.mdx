...
importance: 84.5
---
import {Crux, CruxList, R} from '../../../../components/wiki';
...
|----------|-------------|-------------|----------------------|
| **Mesa-optimizers likely in advanced systems** | 35-55% | <R id="c2babc67e1fad58b">Evan Hubinger</R>, some [MIRI](/knowledge-base/organizations/safety-orgs/miri/) researchers | Prioritize inner alignment research, interpretability for detecting mesa-optimizers |
...
|-------|------------|---------------|
| **Mesa-Optimization** | <R id="c4858d4ef280d8e6">Risks from Learned Optimization</R> | [MIRI](/knowledge-base/organizations/safety-orgs/miri/), [OpenAI](/knowledge-base/organizations/labs/openai/) |
| **Deceptive Alignment** | <R id="e5c0904211c7d0cc">Sleeper Agents</R> | [Anthropic](/knowledge-base/organizations/labs/anthropic/) |
| **Scalable Oversight** | <R id="61da2f8e311a2bbf">AI Safety via Debate</R>, <R id="683aef834ac1612a">Constitutional AI</R> | [OpenAI](/knowledge-base/organizations/labs/openai/), [Anthropic](/knowledge-base/organizations/labs/anthropic/) |
| **Interpretability** | <R id="426fcdeae8e2b749">Scaling Monosemanticity</R> | [Anthropic](/knowledge-base/organizations/labs/anthropic/) |

### 2024 Key Research

| Paper | Authors/Org | Key Finding |
|-------|-------------|-------------|
| [Sleeper Agents](https://arxiv.org/abs/2401.05566) | Anthropic | Backdoors persist through safety training |
| [Simple Probes Can Catch Sleeper Agents](https://www.anthropic.com/research/probes-catch-sleeper-agents) | Anthropic | Linear classifiers detect defection (>99% AUROC) |
| [Me, Myself, and AI: SAD Benchmark](https://arxiv.org/abs/2407.04694) | Academic | Systematic situational awareness measurement |
| [On Scalable Oversight with Weak LLMs](https://arxiv.org/abs/2407.04622) | DeepMind/Academic | Debate outperforms consultancy across tasks |
| [Safetywashing Analysis](https://arxiv.org/abs/2407.21792) | Academic | Safety benchmarks correlate with capabilities |
| [AI Alignment: Comprehensive Survey](https://arxiv.org/abs/2310.19852) | Ji et al. | RICE framework: Robustness, Interpretability, Controllability, Ethicality |

### AI Safety Indices and Surveys

- [FLI AI Safety Index 2024](https://futureoflife.org/document/fli-ai-safety-index-2024/) - 85-question evaluation across seven categories
- [AI Impacts: Surveys of AI Risk Experts](https://wiki.aiimpacts.org/uncategorized/ai_risk_surveys) - Historical compilation of expert surveys
- [Existential Risk Survey Results (EA Forum)](https://forum.effectivealtruism.org/posts/8CM9vZ2nnQsWJNsHx/existential-risk-from-ai-survey-results) - Detailed survey analysis
...
In August 2024, the [US AI Safety Institute announced agreements](https://www.nist.gov/news-events/news/2024/08/us-ai-safety-institute-signs-agreements-regarding-ai-safety-research) with both OpenAI and Anthropic for pre-deployment model access and collaborative safety research. Key elements:
...
Anthropic and OpenAI have begun [collaborative alignment evaluation exercises](https://alignment.anthropic.com/2025/openai-findings/), sharing tools including:
...
- **Alignment auditing agents** using the [Petri framework](https://www.anthropic.com/research/petri-open-source-auditing)
