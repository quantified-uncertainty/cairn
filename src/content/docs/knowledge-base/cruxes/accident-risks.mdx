...
description: Key uncertainties that determine views on AI accident risks and
  alignment difficulty
sidebar:
  order: 1
quality: 3
llmSummary: Systematically maps key uncertainties driving AI accident risk
  assessments, covering foundational questions like mesa-optimization likelihood
  (35-55% vs 15-25%), deceptive alignment probability (30-50% vs 15-30%), and
  alignment difficulty tractability. Provides structured framework with
  probability ranges and research holders for prioritizing alignment research
  directions.
