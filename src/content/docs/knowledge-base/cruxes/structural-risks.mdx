...
description: Key uncertainties that determine views on AI-driven structural
  risks and their tractability
sidebar:
  order: 3
quality: 3
llmSummary: Presents structured analysis of key uncertainties (cruxes) that
  determine prioritization views on AI structural risks, including whether these
  risks are distinct from other AI risks, inevitability of racing dynamics, and
  feasibility of coordination mechanisms. The cruxes framework provides
  probability ranges and implications for different positions on foundational
  questions like US-China coordination (15-50% achievable) and winner-take-all
  dynamics (30-45% likely).
