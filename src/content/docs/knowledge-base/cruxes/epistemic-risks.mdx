...
sidebar:
  order: 4
quality: 3
llmSummary: This page identifies and analyzes 9 key epistemic cruxes that
  determine priorities for addressing AI-driven epistemic risks. It covers
  critical uncertainties like whether detection can keep pace with generation
  (currently losing), whether content authentication will achieve adoption, and
  whether institutional trust can be rebuilt after collapse.
