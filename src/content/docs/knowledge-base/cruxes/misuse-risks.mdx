...
sidebar:
  order: 2
quality: 78
llmSummary: "Synthesizes expert assessments across 13 cruxes determining AI misuse risk priorities, finding mixed evidence on capability uplift (30-45% significant vs 35-45% modest) and uncertain offense-defense balance across bioweapons, cyber, and autonomous weapons domains. Includes quantified probability ranges, 5-7 external citations with URLs, multiple data tables comparing evidence and assessments across domains."
...
Current evidence remains mixed across domains. The <R id="0fe4cfa7ca5f2270">RAND biological uplift study</R> found no significant capability increase for bioweapons development, while <R id="2b6675e423040e53">CNAS analyses</R> suggest more concerning possibilities. Similarly, while AI-powered cyberattacks remain largely commodity-level, the potential for scaling and sophistication growth creates significant uncertainty about future threat landscapes.
...
|--------|-------------------|----------------------|-------------------|
| **Bioweapons** | <R id="8d846d942ebf47da">Kevin Esvelt warnings</R>, theoretical pathogen design | <R id="0fe4cfa7ca5f2270">RAND study</R> no significant uplift | Contested |
...
*Source: <R id="91138237c53ce8d6">CyberSeek</R> workforce data and <R id="4c2168269b12c393">MITRE ATT&CK</R> framework analysis*
...
| **Regulatory Response** | <R id="1ad6dc89cded8b0c">EU AI Act</R>, US executive orders | Federal legislation likely | Political pressure, incident triggers |
