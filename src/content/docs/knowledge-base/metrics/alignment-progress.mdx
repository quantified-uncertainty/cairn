...
importance: 5
quality: 4
llmSummary: Comprehensive survey of 10 key alignment progress metrics including
  interpretability coverage, RLHF effectiveness, jailbreak resistance, and
  deceptive alignment detection. Finds mixed progress with jailbreak resistance
  improving (ChatGPT 4.5 blocks 97% of attempts) but concerning findings like 7%
  shutdown resistance in OpenAI o3 and 20-60% lying rates under pressure.
---
## Overview
...
### Interpretability
- [Anthropic's Groundbreaking AI Interpretability Research](https://customgpt.ai/ai-interpretability-research-from-anthropic/)
...
- [Understanding Mechanistic Interpretability in AI Models](https://intuitionlabs.ai/articles/mechanistic-interpretability-ai-llms)
...
- [The Energy Loss Phenomenon in RLHF](https://arxiv.org/abs/2501.19358v1)
- [InfoRM: Mitigating Reward Hacking in RLHF](https://arxiv.org/abs/2402.09345)
...
- [Cost-Effective Constitutional Classifiers](https://alignment.anthropic.com/2025/cheap-monitors/)
...
### Jailbreaking
- [New LLM jailbreak method with 65% success rate](https://www.scworld.com/news/new-llm-jailbreak-method-with-65-success-rate-developed-by-researchers)
...
- [JailbreakBench: LLM robustness benchmark](https://jailbreakbench.github.io/)
...
- [Research Areas in Interpretability (UK AISI)](https://www.alignmentforum.org/posts/dgcsY8CHcPQiZ5v8P/research-areas-in-interpretability-the-alignment-project-by)
...
- [Scalable Oversight and Weak-to-Strong Generalization](https://www.alignmentforum.org/posts/hw2tGSsvLLyjFoLFS/scalable-oversight-and-weak-to-strong-generalization)
...
### Alignment Tax
- [The Safety Tax: How AI alignment reduces reasoning by up to 32%](https://www.academia.edu/130248074/The_Safety_Tax_How_AI_alignment_reduces_reasoning_by_up_to_32_)
- [AI Alignment Strategies from a Risk Perspective](https://arxiv.org/html/2510.11235v1)
- [Alignment Tax (AI Alignment Forum)](https://www.alignmentforum.org/w/alignment-tax)

### Red-Teaming
- [Red teaming LLMs exposes harsh truth about AI security](https://venturebeat.com/security/red-teaming-llms-harsh-truth-ai-security-arms-race)
- [ChatGPT 4.5 Jailbreaking & Red Teaming Analysis](https://www.holisticai.com/red-teaming/chatgpt-4-5-jailbreaking-red-teaming)
- [GPT-4.5 vs Claude 3.7 - Advanced Redteaming Analysis](https://blog.virtueai.com/2025/03/01/gpt-4-5-vs-claude-3-7-advanced-redteaming-analysis/)
- [Anthropic vs. OpenAI red teaming methods](https://venturebeat.com/security/anthropic-vs-openai-red-teaming-methods-reveal-different-security-priorities)

### Model Honesty
- [LLM-Honesty-Survey (2025-TMLR)](https://github.com/SihengLi99/LLM-Honesty-Survey)
- [BeHonest: Benchmarking Honesty in Large Language Models](https://arxiv.org/html/2406.13261v3)
- [The MASK Benchmark](https://arxiv.org/pdf/2503.03750)
- [Evaluating Truthfulness: Benchmarking LLM Accuracy](https://www.willowtreeapps.com/craft/evaluating-truthfulness-a-deeper-dive-into-benchmarking-llm-accuracy)

### Corrigibility
- [Shutdown Resistance in Large Language Models](https://arxiv.org/html/2509.14260v1)
- [Addressing corrigibility in near-future AI systems](https://link.springer.com/article/10.1007/s43681-024-00484-9)
- [Shutdown-seeking AI](https://link.springer.com/article/10.1007/s11098-024-02099-6)
