...
importance: 5
quality: 4
llmSummary: This comprehensive tracking page documents AI capabilities across 11
  domains including language understanding, coding, mathematics, and scientific
  discovery from 2020-2025. Key findings include rapid benchmark saturation
  (MMLU reaching 92.3%, HumanEval reaching 96.3%), exponential context window
  growth (250x increase to 1M+ tokens), and persistent gaps in robustness and
  long-horizon task completion despite strong benchmark performance.
---
## Overview
