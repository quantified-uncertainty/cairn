...
importance: 3
quality: 4
llmSummary: This comprehensive economic metrics page tracks AI investment ($202B
  VC funding in 2025), labor impacts (14% displacement vs 120K jobs created),
  and productivity gains (McKinsey estimates 2.6-4.4 trillion annual value). It
  shows rapid private market growth (OpenAI at $500B valuation) but limited
