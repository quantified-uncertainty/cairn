...
importance: 5
quality: 4
llmSummary: This page tracks 10 critical metrics of AI lab behavior including
  commitment compliance (53% average), safety team turnover, model release
  acceleration, and disclosure delays. It documents concerning trends like
  compressed evaluation timelines, high-profile safety departures from OpenAI,
  and transparency failures including Google's missing Gemini 2.5 Pro model
  card.
---
## Overview
...
- [Do AI Companies Make Good on Voluntary Commitments to the White House?](https://arxiv.org/abs/2508.08345) - August 2025 compliance study
- [Anthropic's Responsible Scaling Policy](https://www.anthropic.com/responsible-scaling-policy)
- [Anthropic's Responsible Scaling Policy Update Makes a Step Backwards](https://www.safer-ai.org/post/anthropics-responsible-scaling-policy-update-makes-a-step-backwards) - SaferAI analysis
- [Responsible Scaling: Comparing Government Guidance and Company Policy](https://www.iaps.ai/research/responsible-scaling) - Institute for AI Policy and Strategy
- [2025 AI Safety Index](https://futureoflife.org/ai-safety-index-summer-2025/) - Future of Life Institute
- [AI Safety Index Winter 2025](https://futureoflife.org/ai-safety-index-winter-2025/)
- [AI industry timelines to AGI getting shorter, but safety becoming less of a focus](https://fortune.com/2025/04/15/ai-timelines-agi-safety/)
- [OpenAI: Red Teaming GPT-4o, Operator, o3-mini, and Deep Research](https://control-plane.io/case-studies/openai-red-teaming/) - ControlPlane
- [Advancing red teaming with people and AI](https://openai.com/index/advancing-red-teaming-with-people-and-ai/) - OpenAI
- [AI Red Teaming | Offensive Testing for AI Models](https://www.hackerone.com/product/ai-red-teaming) - HackerOne
- [AI Red Teaming: Applying Software TEVV for AI Evaluations](https://www.cisa.gov/news-events/news/ai-red-teaming-applying-software-tevv-ai-evaluations) - CISA
- [AI models can be dangerous before public deployment](https://metr.org/blog/2025-01-17-ai-models-dangerous-before-public-deployment/) - METR
- [Pre-Deployment Evaluation of OpenAI's o1 Model](https://www.nist.gov/news-events/news/2024/12/pre-deployment-evaluation-openais-o1-model) - NIST
...
- [Google's Gemini 2.5 Pro missing key safety report in violation of promises](https://fortune.com/2025/04/09/google-gemini-2-5-pro-missing-model-card-in-apparent-violation-of-ai-safety-promises-to-us-government-international-bodies/)
- [British lawmakers accuse Google of 'breach of trust' over delayed Gemini 2.5 Pro safety report](https://fortune.com/2025/08/29/british-lawmakers-accuse-google-deepmind-of-breach-of-trust-over-delayed-gemini-2-5-pro-safety-report/)
...
- [AI Model Release Timeline](https://aiflashreport.com/model-releases) - AI Flash Report
- [Timeline of AI model releases in 2024](https://simonwillison.net/2024/Dec/31/2024-ai-releases/)
- [2025 LLM Year in Review](https://karpathy.bearblog.dev/year-in-review-2025/) - Andrej Karpathy
...
- [The Gap Between Open and Closed AI Models Might Be Shrinking](https://time.com/7171962/open-closed-ai-models-epoch/) - Time, Epoch AI report
- [Open vs. Closed LLMs in 2025: Strategic Tradeoffs for Enterprise AI](https://medium.com/data-science-collective/open-vs-closed-llms-in-2025-strategic-tradeoffs-for-enterprise-ai-668af30bffa0)
- [OpenAI's recent departures force leaders to reaffirm safety commitment](https://www.axios.com/2024/05/20/openai-safety-jan-leike-sam-altman) - Axios
- [Top OpenAI researcher resigns, saying company prioritized 'shiny products' over AI safety](https://fortune.com/2024/05/17/openai-researcher-resigns-safety/)
- [OpenAI dissolves Superalignment AI safety team](https://www.cnbc.com/2024/05/17/openai-superalignment-sutskever-leike.html) - CNBC
- [The OpenAI Safety Exodus: 25+ Senior Researchers Departed](https://fourweekmba.com/the-openai-safety-exodus-25-senior-researchers-departed-superalignment-team-disbanded/)
- ["The OpenAI Files" reveals deep leadership concerns about Sam Altman and safety failures](https://fortune.com/2025/06/20/openai-files-sam-altman-leadership-concerns-safety-failures-ai-lab/)
- [The Fight to Protect AI Whistleblowers](https://onlabor.org/the-fight-to-protect-ai-whistleblowers/)
- [Anthropic: Compliance framework for California SB 53](https://www.anthropic.com/news/compliance-framework-SB53)
