...
- [Racing dynamics](/knowledge-base/risks/structural/racing-dynamics/) intensify as [AGI timelines](/ai-transition-model/timelines/) compress
...
- **Pessimists**: Need 10x more researchers given [AI risk timeline](/ai-transition-model/timelines/)
...
- **Governance focus**: Prioritize [policy interventions](/knowledge-base/responses/governance/), [coordination](/ai-transition-model/coordination/)
