...
|----------------|--------|------------|-------------|
| <R id="dd0cf0ff290cc68e">Open Philanthropy</R> | ~$90M annually | Technical safety, governance | High |
...
|---------|---------|----------|-------|
| <R id="6cdea76b4414a41a">Vitalik Buterin PhD Fellowship</R> | $40K/year + tuition | 5 years | AI safety PhD research |
...
- [Racing dynamics](/knowledge-base/risks/structural/racing-dynamics/) intensify as [AGI timelines](/understanding-ai-risk/core-argument/timelines/) compress
