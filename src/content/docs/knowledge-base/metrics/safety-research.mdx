...
importance: 4
quality: 4
llmSummary: "This page comprehensively tracks AI safety field metrics including
  researcher headcount (~1,100 FTEs in 2025), funding (~$400M annually), and
  resource allocation. Key finding: safety research remains severely
  under-resourced with a 10,000:1 capabilities-to-safety spending ratio."
---
## Overview
...
According to the [AI Safety Field Growth Analysis 2025](https://forum.effectivealtruism.org/posts/7YDyziQxkWxbGmF3u/ai-safety-field-growth-analysis-2025):
...
[80,000 Hours](https://80000hours.org/career-reviews/ai-safety-researcher/) notes this may be an undercount, as it only includes organizations explicitly branded as "AI safety." They estimate **several thousand people** now work on major AI risks when including researchers at major labs and academia.
...
From [Open Philanthropy grants database](https://www.openphilanthropy.org/):
...
**Comprehensive survey**: "[AI Alignment: A Comprehensive Survey](https://arxiv.org/abs/2310.19852)" (2023, updated 2025) identifies four core principles (RICE):
- Robustness
- Interpretability
- Controllability
- Ethicality
...
**CAIS support**: [Center for AI Safety](https://forum.effectivealtruism.org/posts/M9f4wvKB3CkaKyMgR/aisn-45-center-for-ai-safety-2024-year-in-review) supported **77 papers** in AI safety research through compute cluster in 2024
...
**Vitalik Buterin PhD Fellowship** ([Future of Life Institute](https://futureoflife.org/grant-program/phd-fellowships/)):
...
From [NeurIPS 2024 Fact Sheet](https://media.neurips.cc/Conferences/NeurIPS2024/NeurIPS2024-Fact_Sheet.pdf):
...
From [ICML 2024 Fact Sheet](https://media.icml.cc/Conferences/ICML2024/ICML2024_Fact_Sheet.pdf):
...
- [Open Philanthropy: Progress in 2024 and Plans for 2025](https://www.openphilanthropy.org/research/our-progress-in-2024-and-plans-for-2025/)
- [Open Philanthropy Grants Database](https://www.openphilanthropy.org/grants/)
- [An Overview of the AI Safety Funding Situation (LessWrong)](https://www.lesswrong.com/posts/WGpFFJo2uFe5ssgEb/an-overview-of-the-ai-safety-funding-situation)
- [NeurIPS 2024 Fact Sheet](https://media.neurips.cc/Conferences/NeurIPS2024/NeurIPS2024-Fact_Sheet.pdf)
...
- [Top 10 AI Research Papers of April 2025 (AryaXAI)](https://www.aryaxai.com/article/top-10-ai-research-papers-of-april-2025-advancing-explainability-ethics-and-alignment)

### Fellowships & Training Programs
- [Future of Life Institute: PhD Fellowships](https://futureoflife.org/grant-program/phd-fellowships/)
...
- [Center for AI Safety 2024 Year in Review (EA Forum)](https://forum.effectivealtruism.org/posts/M9f4wvKB3CkaKyMgR/aisn-45-center-for-ai-safety-2024-year-in-review)

### Conference Data
- [Our World in Data: AI Conference Attendance](https://ourworldindata.org/grapher/attendance-major-artificial-intelligence-conferences)
