...
sidebar:
  order: 9
quality: 3
llmSummary: Comprehensive review of AI researcher surveys and forecasting data
  on timelines, extinction risk, and safety priorities. Finds median P(doom) of
  5-10% among experts, AGI timelines shortened from 50 years to ~15 years
  (2020-2024), and wide disagreement with estimates ranging from less than 0.01% to over 99%
  across individuals.
