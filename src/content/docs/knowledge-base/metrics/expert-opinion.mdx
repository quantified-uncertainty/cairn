...
- Range: under 0.01% to over 99% across individual researchers
...
1. **Wide Disagreement**: Expert P(doom) ranges from under 0.01% to over 99%, with median ~5-10% but high sensitivity to framing
