...
importance: 4
quality: 4
llmSummary: Comprehensive tracking of AI hardware metrics including GPU
  production (2M H100s in 2024), training compute (4-5x annual growth), and cost
  trends (10x annual efficiency gains). Shows GPU manufacturing doubling every
  10 months and training costs declining from $100M+ for GPT-4 to potentially
  under $1M by 2026-2027.
---
## Overview
...
**Sources**: [Epoch AI GPU production tracking](https://epoch.ai/data-insights/nvidia-chip-production), [Tom's Hardware H100 projections](https://www.tomshardware.com/news/nvidia-to-reportedly-triple-output-of-compute-gpus-in-2024-up-to-2-million-h100s)
...
**Sources**: [LessWrong GPU estimates](https://www.lesswrong.com/posts/bdQhzQsHjNrQp7cNS/estimates-of-gpu-or-equivalent-resources-of-large-ai-players), [Epoch AI computing capacity](https://epoch.ai/data-insights/computing-capacity)
...
**Sources**: [Epoch AI model database](https://epoch.ai/data-insights/models-over-1e25-flop), [Our World in Data AI training](https://ourworldindata.org/grapher/artificial-intelligence-training-computation), [Epoch AI tracking](https://epoch.ai/blog/tracking-large-scale-ai-models)
...
**Sources**: [Epoch AI training costs](https://epoch.ai/blog/trends-in-the-dollar-training-cost-of-machine-learning-systems), [ARK Invest AI training analysis](https://www.ark-invest.com/articles/analyst-research/ai-training), [Our World in Data GPU performance](https://ourworldindata.org/grapher/gpu-price-performance)
...
**Sources**: [Epoch AI algorithmic progress](https://epoch.ai/blog/algorithmic-progress-in-language-models), [OpenAI efficiency research](https://openai.com/index/ai-and-efficiency/), [ArXiv algorithmic progress paper](https://arxiv.org/abs/2511.21622)
...
**Sources**: [IEA Energy and AI Report](https://www.iea.org/reports/energy-and-ai/energy-demand-from-ai), [Pew Research data center energy](https://www.pewresearch.org/short-reads/2025/10/24/what-we-know-about-energy-use-at-us-data-centers-amid-the-ai-boom/), [DOE data center report](https://www.energy.gov/articles/doe-releases-new-report-evaluating-increase-electricity-demand-data-centers)
...
**Sources**: [SEMI fab capacity report](https://www.semi.org/en/news-media-press-releases/semi-press-releases/global-semiconductor-fab-capacity-projected-to-expand-6%25-in-2024-and-7%25-in-2025-semi-reports), [TrendForce Samsung 2nm](https://www.trendforce.com/news/2025/12/23/news-samsung-set-to-benefit-from-tsmcs-n-2-rule-as-amd-google-reportedly-eye-u-s-2nm-production/)
...
**Sources**: [Epoch AI inference allocation](https://epoch.ai/blog/optimally-allocating-compute-between-inference-and-training), [A&M training demand analysis](https://www.alvarezandmarsal.com/insights/rethinking-ai-demand-part-1-ai-data-centers-are-experiencing-surge-training-demand-what)
...
**Sources**: [Epoch AI compute allocation theory](https://epoch.ai/blog/optimally-allocating-compute-between-inference-and-training), [Epoch AI OpenAI compute spend](https://epoch.ai/data-insights/openai-compute-spend)
...
**Sources**: [Juma GPT-4 cost breakdown](https://juma.ai/blog/how-much-did-it-cost-to-train-gpt-4), [Fortune AI training costs](https://fortune.com/2024/04/04/ai-training-costs-how-much-is-too-much-openai-gpt-anthropic-microsoft/), [ArXiv training costs](https://arxiv.org/html/2405.21015v1)
...
**Sources**: [PatentPC AI chip market stats](https://patentpc.com/blog/the-ai-chip-market-explosion-key-stats-on-nvidia-amd-and-intels-ai-dominance), [TechInsights Q1 2024](https://www.techinsights.com/blog/data-center-ai-chip-market-q1-2024-update), [CNBC Nvidia market analysis](https://www.cnbc.com/2024/06/02/nvidia-dominates-the-ai-chip-market-but-theres-rising-competition-.html)
...
**Sources**: [Tom's Hardware China AI chip production](https://www.tomshardware.com/tech-industry/artificial-intelligence/chinas-chip-champions-ramp-up-production-of-ai-accelerators-at-domestic-fabs-but-hbm-and-fab-production-capacity-are-towering-bottlenecks), [SemiAnalysis Huawei production](https://newsletter.semianalysis.com/p/huawei-ascend-production-ramp), [WCCFtech Huawei capacity](https://wccftech.com/chinas-huawei-can-make-750000-advanced-ai-chips-despite-us-sanctions-says-report/)
...
**Sources**: [SMM ASML lead times](https://news.metal.com/newscontent/101557143/the-delivery-time-of-asml-arf-equipment-has-been-extended-to-2-years-the-shortage-of-semiconductor-equipment-is-increasing), [TrendForce ASML EUV analysis](https://www.trendforce.com/insights/asml-euv), [Tom's Hardware ASML capacity](https://www.tomshardware.com/news/asml-only-60-percent-of-chipmaking-tool-orders-can-be-fulfilled)
...
**Primary Sources**:
- [Epoch AI](https://epoch.ai/) - GPU production, training compute, model database
- [IEA Energy and AI Report](https://www.iea.org/reports/energy-and-ai/) - Data center power consumption
- [SEMI](https://www.semi.org/) - Fab capacity and equipment
- [Our World in Data](https://ourworldindata.org/artificial-intelligence) - Long-term trends
- [Stanford AI Index](https://aiindex.stanford.edu/) - Comprehensive annual metrics
