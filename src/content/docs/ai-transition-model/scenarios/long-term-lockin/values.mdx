...
|--------|-------|----------------|
| **Changeability** | 30/100 | Very difficult to change once values are locked in |
| **X-risk Impact** | 50/100 | Moderate direct existential risk |
| **Trajectory Impact** | 95/100 | Extremely high impact on long-term future quality |
| **Uncertainty** | 65/100 | High uncertainty about which values get locked |
