...
| Variant | Description |
|---------|-------------|
| [**Values**](/ai-transition-model/scenarios/long-term-lockin/values/) | Permanent entrenchment of particular value systems |
| [**Power**](/ai-transition-model/scenarios/long-term-lockin/power/) | Concentration of power that becomes impossible to reverse |
| [**Epistemics**](/ai-transition-model/scenarios/long-term-lockin/epistemics/) | Permanent degradation or ossification of collective reasoning |
...
|--------|--------------|-----------|
| [Civilizational Competence](/ai-transition-model/factors/civilizational-competence/) | Shapes character | Determines whether lock-in is beneficial or harmful |
