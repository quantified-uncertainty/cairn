...
|-----------|---------------------|
| [Safety-Capability Gap](/ai-transition-model/parameters/safety-capability-gap/) | Larger gap → less smooth transition |
| [Human Agency](/ai-transition-model/parameters/human-agency/) | Higher → more human-led transition |
| [Human Expertise](/ai-transition-model/parameters/human-expertise/) | Higher → humans can meaningfully participate |
| [Societal Adaptability](/ai-transition-model/parameters/adaptability/) | Higher → better handling of disruption |
| [Racing Intensity](/ai-transition-model/parameters/racing-intensity/) | Higher → faster, less controlled transition |
| [Coordination Capacity](/ai-transition-model/parameters/coordination-capacity/) | Higher → better collective management |
...
- Effectively equivalent to [AI Takeover - Gradual](/ai-transition-model/scenarios/ai-takeover/gradual/) if values misaligned
...
### Existing Pages
- [Long-term Trajectory](/ai-transition-model/outcomes/long-term-trajectory/) — The ultimate outcome this affects
- [Transition Turbulence](/ai-transition-model/factors/transition-turbulence/) — Related critical outcome
- [Societal Adaptability](/ai-transition-model/parameters/adaptability/) — Key aggregate for this outcome
