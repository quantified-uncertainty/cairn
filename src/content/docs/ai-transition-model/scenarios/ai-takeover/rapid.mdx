...
|--------|-------|----------------|
| **Changeability** | 40/100 | Moderately difficult to prevent once in motion |
| **X-risk Impact** | 95/100 | Extremely high existential risk |
| **Trajectory Impact** | 85/100 | Very high impact on long-term future |
| **Uncertainty** | 70/100 | High uncertainty about likelihood |

---

## Polarity

**Inherently negative.** There is no positive version of this scenario. A "fast transition" where AI rapidly improves the world would be categorized under [Power Transition](/ai-transition-model/scenarios/long-term-lockin/power/) with positive character, not here. This page specifically describes the catastrophic takeover pathway.
