...
|--------|-------|----------------|
| **Changeability** | 35/100 | Difficult to prevent rogue actors |
| **X-risk Impact** | 70/100 | High existential risk potential |
| **Trajectory Impact** | 45/100 | Moderate long-term impact |
| **Uncertainty** | 65/100 | High uncertainty about capability democratization |
