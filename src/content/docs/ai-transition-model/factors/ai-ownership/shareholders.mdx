...
description: "Who captures economic value from AI development and exercises governance influence. Current ownership concentrates AI equity among a small group, creating potential for unprecedented wealth accumulation."
sidebar:
  order: 3
...
|--------|-------|----------------|
| **Changeability** | 30/100 | Difficult to restructure ownership |
| **X-risk Impact** | 25/100 | Lower direct existential impact |
| **Trajectory Impact** | 60/100 | Significant long-term effects |
| **Uncertainty** | 40/100 | Moderate uncertainty |
