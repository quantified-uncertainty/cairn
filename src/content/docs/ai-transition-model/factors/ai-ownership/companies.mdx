...
description: "Corporate concentration in AI where four organizations control frontier development and five firms control 80%+ of AI cloud infrastructure. Creates distinct risks and safety incentive tensions."
sidebar:
  order: 2
...
|--------|-------|----------------|
| **Changeability** | 35/100 | Moderately difficult to alter |
| **X-risk Impact** | 50/100 | Substantial existential relevance |
| **Trajectory Impact** | 70/100 | High long-term effects |
| **Uncertainty** | 45/100 | Moderate uncertainty |
