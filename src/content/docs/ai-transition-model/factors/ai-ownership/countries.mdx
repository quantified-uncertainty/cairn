...
description: "Geographic concentration of advanced AI capabilities shapes trajectory through effects on geopolitical stability, international coordination, and benefit distribution. US attracts $67.2B in AI investment (8.7x China)."
sidebar:
  order: 1
...
|--------|-------|----------------|
| **Changeability** | 25/100 | Geopolitical structures change slowly |
| **X-risk Impact** | 45/100 | Moderate direct existential impact |
| **Trajectory Impact** | 65/100 | Significant long-term effects |
| **Uncertainty** | 50/100 | Moderate uncertainty |
