...
|-----------|------|---------------|
| [Biological Threat Exposure](/ai-transition-model/parameters/biological-threat-exposure/) | AI-enabled bioweapon risk | Contested (defense may win) |
| [Cyber Threat Exposure](/ai-transition-model/parameters/cyber-threat-exposure/) | AI-enabled cyber attack risk | High (60% face AI attacks) |
| [AI Control Concentration](/ai-transition-model/parameters/ai-control-concentration/) | Single point of failure / capture risk | Increasing concentration |
...
|---------|--------|-----------|
| [Existential Catastrophe](/ai-transition-model/outcomes/existential-catastrophe/) | ↑↑↑ Primary | Direct increase in catastrophic event probability |
| [Transition Turbulence](/ai-transition-model/factors/transition-turbulence/) | ↑ Secondary | Major incidents cause disruption during transition |
| [Long-term Trajectory](/ai-transition-model/outcomes/long-term-trajectory/) | ↑ Secondary | Concentrated power shapes long-term distribution |
