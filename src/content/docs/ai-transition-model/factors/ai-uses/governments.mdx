...
description: "Government use of AI for surveillance, military, and administration—with profound implications for civil liberties, warfare, democratic governance, and the citizen-state relationship."
sidebar:
  order: 3
...
|--------|-------|----------------|
| **Changeability** | 40/100 | Moderately changeable through policy |
| **X-risk Impact** | 55/100 | Significant existential relevance |
