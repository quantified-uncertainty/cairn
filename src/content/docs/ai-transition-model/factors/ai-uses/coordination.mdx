...
description: "AI tools for coordination—with potential to enhance humanity's collective capacity or undermine democratic deliberation and international cooperation."
sidebar:
  order: 4
...
|--------|-------|----------------|
| **Changeability** | 45/100 | Moderately changeable |
| **X-risk Impact** | 40/100 | Moderate existential relevance |
| **Trajectory Impact** | 65/100 | Significant long-term effects |
| **Uncertainty** | 55/100 | Moderate-high uncertainty |
