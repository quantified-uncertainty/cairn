...
description: "AI systems used to accelerate AI research itself, creating feedback loops that could lead to rapid and unpredictable capability gains. Perhaps the most consequential and uncertain factor in the AI transition."
sidebar:
  order: 1
...
|--------|-------|----------------|
| **Changeability** | 35/100 | Moderately difficult to influence |
| **X-risk Impact** | 85/100 | Very high existential relevance |
| **Trajectory Impact** | 90/100 | Extremely high long-term effects |
| **Uncertainty** | 70/100 | High uncertainty about dynamics |
