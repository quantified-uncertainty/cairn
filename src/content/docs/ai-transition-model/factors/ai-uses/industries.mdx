...
description: "Integration of AI into economic industries with implications for productivity, employment, systemic risk, and long-term trajectory. 60-70% of financial trades are now algorithmic."
sidebar:
  order: 2
...
ratings:
  ...
  uncertainty: 35
---
import {Mermaid, Backlinks, FactorRatings, FactorKeyDebates, FactorRelatedContent} from '../../../../../components/wiki';
...
<FactorRatings client:load nodeId="ai-uses" subItemLabel="Industries" />
...
<FactorKeyDebates client:load nodeId="ai-uses" subItemLabel="Industries" />

---

<FactorRelatedContent client:load nodeId="ai-uses" subItemLabel="Industries" />
