...
description: "Risk from novel attack vectors that have not yet been anticipated—cases where AI enables entirely new categories of harm that fall outside existing threat models. By definition, we cannot enumerate these threats precisely."
...
|--------|-------|----------------|
| **Changeability** | 20/100 | Very difficult—can't prevent unknown threats directly |
| **X-risk Impact** | 70/100 | High potential if novel threat emerges unexpectedly |
| **Trajectory Impact** | 55/100 | Moderate effects on long-term preparation |
| **Uncertainty** | 85/100 | Extremely high by definition |
