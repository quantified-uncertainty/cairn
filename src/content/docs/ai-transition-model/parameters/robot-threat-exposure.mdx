...
description: "The degree to which AI-controlled physical systems—particularly lethal autonomous weapons systems (LAWS)—enable deliberate harm at scale. AI-guided drones already achieve 70-80% hit rates versus 10-20% for manually-piloted systems."
...
|--------|-------|----------------|
| **Changeability** | 40/100 | Moderately difficult to change once deployed |
| **X-risk Impact** | 60/100 | Significant but not primary existential pathway |
| **Trajectory Impact** | 50/100 | Moderate long-term effects on AI governance |
| **Uncertainty** | 65/100 | High uncertainty about proliferation and escalation |
