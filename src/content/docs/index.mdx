...
<CardGrid>
  ...
  <Card title="📈 Key Debates" icon="list-format">
    [Core disagreements](/knowledge-base/debates/) comparing different positions and approaches.
  </Card>
...
1. [FAQ: Common questions](/getting-started/faq/)
2. [Core argument overview](/understanding-ai-risk/core-argument/)
3. [Glossary of terms](/getting-started/glossary/)
...
1. [Key debates](/knowledge-base/debates/) - Strongest arguments on each side
2. [Research agendas](/knowledge-base/responses/alignment/research-agendas/) - Compare approaches
3. [AI safety history](/knowledge-base/history/) - Evolution of the field
