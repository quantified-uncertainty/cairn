...
<CardGrid>
  ...
  <Card title="📐 Key Parameters" icon="setting">
    ...
    - [All parameters](/knowledge-base/parameters/) (alignment robustness, racing intensity, societal trust)
...
3. [Key Parameters](/knowledge-base/parameters/) - The variables that matter
...
1. [Key Parameters](/knowledge-base/parameters/) - The variables that matter for AI outcomes
