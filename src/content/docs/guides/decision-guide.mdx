...
importance: 82.5
quality: 71
llmSummary: "Provides decision-focused guidance for three key audiences (CS students, policymakers, AI researchers) using probability thresholds and action matrices to map beliefs to career/policy choices. Includes concrete belief thresholds (e.g., >30% P(TAI by 2045) justifies safety career) and uncertainty-indexed recommendations, though lacks quantitative evidence for the frameworks themselves."
---
import {InfoBox, R} from '../../../components/wiki';
...
### Resources
- <R id="c5cca651ad11df4d">80,000 Hours AI Safety Career Guide</R>
- <R id="8947e0fe3e55f7df">AI Safety Camp</R>
- <R id="ba3a8bd9c8404d7b">MATS Program</R>
...
### Resources
- <R id="f35c467b353f990f">GovAI Research</R>
- <R id="f0d95954b449240a">CSET at Georgetown</R>
- <R id="43b5094cbf8e4036">AI Now Institute</R> (alternative perspective)
...
### Resources
- <R id="5fa46de681ff9902">Anthropic's Core Views on AI Safety</R>
...
### Resources
- <R id="3db44e0305263f27">Open Philanthropy AI Safety Grantmaking</R>
- <R id="a01514f7c492ce4c">Survival and Flourishing Fund</R>
