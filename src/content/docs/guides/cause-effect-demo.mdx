...
importance: 2
quality: 4
llmSummary: This is an interactive demo showcasing a cause-effect graph
  visualization tool for mapping AI safety risk factors. The demo includes 7
  interconnected nodes representing causes, intermediate factors, and effects in
  AI existential risk, with features like auto-layout, expandable details
  panels, and visual encoding of relationship strength and confidence.
---
