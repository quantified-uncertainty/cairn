...
<CauseEffectGraph
  ...
  initialEdges={[
    { id: 'e1-4', source: '1', target: '4', data: { impact: 0.8 } },
    { id: 'e2-4', source: '2', target: '4', data: { impact: 0.9 } },
    { id: 'e3-4', source: '3', target: '4', data: { impact: 0.6 } },
    { id: 'e4-5', source: '4', target: '5', data: { impact: 0.7 } },
    { id: 'e4-6', source: '4', target: '6', data: { impact: 0.75 } },
    { id: 'e5-7', source: '5', target: '7', data: { impact: 0.5 } },
    { id: 'e6-7', source: '6', target: '7', data: { impact: 0.6 } },
    { id: 'e3-6', source: '3', target: '6', data: { impact: 0.3 }, style: { strokeDasharray: '5,5' } }
  ]}
/>

## Features

- **Auto-layout**: Nodes are automatically positioned using the dagre algorithm for clean hierarchical display
- **Impact-weighted edges**: Edge thickness and opacity reflect the strength of the causal relationship, with percentage labels
...
- **Directional arrows**: Clear arrows show the direction of causation
- **Confidence levels**: Each node shows its estimated confidence percentage
