...
importance: 2
quality: 4
llmSummary: This style guide provides comprehensive formatting and design rules
  for creating effective Mermaid diagrams in the wiki. It emphasizes vertical
  layouts over horizontal ones for mobile readability and includes color coding
  standards, diagram type selection guidance, and common design patterns.
---
