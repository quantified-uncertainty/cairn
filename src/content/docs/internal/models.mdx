...
importance: 5
quality: 5
llmSummary: This is an internal style guide that establishes formatting
  requirements and methodological principles for analytical models in the
  knowledge base. It mandates executive summaries, strategic prioritization
  content, and specific structural elements to ensure models answer 'how
  important is this and what should we do about it?'
---
