...
importance: 0
quality: 72
llmSummary: "Comprehensive technical documentation for a SQLite-based content management system that indexes MDX articles, tracks external citations, and generates AI summaries using Anthropic's API. The system includes complete database schema, CLI commands, cost estimates (~$2-3 for 311 articles with Haiku), and API documentation for programmatic access."
---
