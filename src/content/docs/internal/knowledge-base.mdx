...
|----------|-----------|---------------|
| [Response](/path/) | How it helps | High/Medium/Low |
...
|------|-----------|---------------|
| [Risk](/path/) | How it helps | High/Medium/Low |
...
- **[Compute Governance](/knowledge-base/responses/governance/policy-approaches/compute-governance/)** - Detailed policy response with good structure
