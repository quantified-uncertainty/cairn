---
title: Compute Governance Interventions
...
See also: [Compute Governance Policy Overview](/policies/compute-governance/)
...
<Section title="Related Entries">
  <EntityCards>
    <EntityCard
      ...
      category="policy"
      title="Compute Governance Policy"
      description="Policy overview of compute governance approaches"
    />
    <EntityCard
      id="govai"
      category="lab"
