...
importance: 3
quality: 2
llmSummary: A glossary page that provides definitions for key AI safety terms
  with hover functionality for use across the wiki. The actual glossary content
  is dynamically loaded through a component rather than being directly visible
  in the source.
---
