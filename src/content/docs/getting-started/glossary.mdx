...
importance: 45
quality: 2
llmSummary: A comprehensive glossary providing definitions for key AI safety,
  alignment, and governance terms with interactive hover functionality. Covers
  core concepts, technical terms, risk scenarios, and organizational frameworks
  to support understanding across the wiki.
---
