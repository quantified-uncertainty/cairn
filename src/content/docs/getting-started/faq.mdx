...
importance: 42
quality: 58
llmSummary: "FAQ addressing common AI safety questions and misconceptions, covering basic definitions, risk mechanisms, expert consensus, and common objections. Provides accessible entry point with brief explanations and pointer to deeper resources, but lacks quantitative analysis or comprehensive citations."
---
import {InfoBox, KeyQuestions, Section, Tags, Sources, DisagreementMap, R} from '../../../components/wiki';
...
- <R id="af9593f4824ee2c7">2023 Expert Survey on AI Risk</R>
...
**Deeper resources**:
- [Risk categories overview](/knowledge-base/risks/)
...
**Deeper resources**:
- [AI risk overview](/knowledge-base/risks/)
- Toby Ord's "The Precipice"
- [AI safety history](/knowledge-base/history/)
...
**Deeper resources**:
- [Mechanistic Interpretability](/knowledge-base/responses/alignment/interpretability/)
...
**Deeper resources**:
- <R id="2b5b647a1d82adfc">Inner Alignment Problem</R>
- [Mesa-Optimization](/knowledge-base/risks/accident/mesa-optimization/)
...
**Deeper resources**:
- [Deceptive Alignment](/knowledge-base/risks/accident/deceptive-alignment/)
- <R id="e5c0904211c7d0cc">Sleeper Agents paper</R>
