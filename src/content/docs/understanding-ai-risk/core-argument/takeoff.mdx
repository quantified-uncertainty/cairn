...
Recent modeling work has begun to quantify takeoff dynamics more precisely. [Tom Davidson's compute-centric framework](https://www.openphilanthropy.org/research/what-a-compute-centric-framework-says-about-takeoff-speeds/) at Open Philanthropy provides the most rigorous analysis to date.

### Key Quantitative Estimates

| Parameter | Estimate | Range | Source |
|-----------|----------|-------|--------|
| Time from 20% to 100% cognitive automation | ~3 years | 1-10 years | [Davidson (2024)](https://www.openphilanthropy.org/research/what-a-compute-centric-framework-says-about-takeoff-speeds/) |
...
| AI researcher productivity multiplier | 6.25x | 4-10x | [AI 2027 survey](https://ai-2027.com/research/takeoff-forecast) of OpenAI/DeepMind staff |
| Pre-2024 capability improvement rate | 8 pts/year | — | [Epoch AI](https://epoch.ai/data-insights/ai-capabilities-progress-has-sped-up) |
| Post-2024 capability improvement rate | 15 pts/year | — | [Epoch AI](https://epoch.ai/data-insights/ai-capabilities-progress-has-sped-up) |
...
<DisagreementMap
  ...
  positions={[
    ...
    { actor: "Tom Davidson", position: "Moderate-fast", estimate: "<1 year post-AGI", confidence: "medium" },
...
**Eliezer Yudkowsky** [argues](https://intelligence.org/2021/11/22/yudkowsky-and-christiano-discuss-takeoff-speeds/) that recursive self-improvement "should either flatline or blow up. You would need exactly the right law of diminishing returns to fly through the extremely narrow soft takeoff keyhole."

**Sam Altman** wrote in 2025 that ["we are past the event horizon; the takeoff has started"](https://blog.samaltman.com/the-gentle-singularity) and that once AGI is achieved, "the path to ASI will likely be rapid."

**Tom Davidson's** [compute-centric model](https://www.openphilanthropy.org/research/what-a-compute-centric-framework-says-about-takeoff-speeds/) predicts less than one year from AGI to superintelligence, "primarily due to the massive amounts of AI labor available to do AI R&D once we have AGI."

**Paul Christiano** [defines slow takeoff](https://sideways-view.com/2018/02/24/takeoff-speeds/) as "GWP doubles in 4 years before the start of the first 1-year GWP doubling"—which he notes is "like the Industrial Revolution, but 10x-100x faster." He gives ~33% probability to fast takeoff.

**Robin Hanson** [predicts](https://hanson.gmu.edu/aigrow.pdf) "slow, slow, slow and then all of a sudden"—with gradual automation until a transition point, after which the economy may double every month or faster.
...
[Epoch AI's research](https://epoch.ai/data-insights/ai-capabilities-progress-has-sped-up) provides empirical evidence of accelerating capabilities:
...
The [acceleration roughly coincides](https://epoch.ai/data-insights/ai-capabilities-progress-has-sped-up) with the rise of reasoning models (like o1, o3) and increased focus on reinforcement learning at frontier labs. This suggests that methodological breakthroughs can produce step-changes in capability improvement rates.

### The Emergence Debate

A [key area of contention](https://cset.georgetown.edu/article/emergent-abilities-in-large-language-models-an-explainer/) among researchers is whether capabilities emerge discontinuously or gradually:
...
The [Future of Life Institute notes](https://futureoflife.org/ai/are-we-close-to-an-intelligence-explosion/) that even if emergence is partially illusory, "serious gaps remain in our ability to predict the future of LLMs. New training techniques, datasets, and prompting techniques keep researchers on their toes."

### Signs Pointing Toward Fast Takeoff

**Rapid capability gains**: GPT-3 (2020) to GPT-4 (2023) showed dramatic capability improvements. [Sam Altman stated in 2025](https://blog.samaltman.com/the-gentle-singularity) that "we are past the event horizon; the takeoff has started."
...
**Acceleration of progress**: [Epoch AI data](https://epoch.ai/data-insights/ai-capabilities-progress-has-sped-up) shows capability improvement nearly doubled in 2024.

**AI for AI research**: Models increasingly useful for ML research itself. A [survey of OpenAI/DeepMind researchers](https://ai-2027.com/research/takeoff-forecast) found median estimate of 6.25x productivity boost from best-performing researchers.

### Signs Pointing Toward Slow Takeoff

**Deployment lag**: Frontier models take years to fully integrate into applications.

**Reliability issues**: Models still have fundamental limitations (hallucination, reasoning). [FrontierMath benchmark](https://epoch.ai/frontiermath/the-benchmark) shows frontier models solve less than 2% of advanced math problems.
...
**Diminishing returns**: [Recent 2025 papers](https://futureoflife.org/ai/are-we-close-to-an-intelligence-explosion/) show that self-improvement yields smaller returns each round and often stalls on harder tasks.
...
- **[What a Compute-Centric Framework Says About Takeoff Speeds](https://www.openphilanthropy.org/research/what-a-compute-centric-framework-says-about-takeoff-speeds/)** — Tom Davidson's Open Philanthropy report (2024), the most rigorous quantitative model of takeoff dynamics
- **[AI Capabilities Progress Has Sped Up](https://epoch.ai/data-insights/ai-capabilities-progress-has-sped-up)** — Epoch AI analysis showing 90% acceleration in capability improvement rates in 2024
- **[Takeoff Speeds](https://sideways-view.com/2018/02/24/takeoff-speeds/)** — Paul Christiano's foundational 2018 post defining the slow takeoff position
- **[Yudkowsky and Christiano Discuss Takeoff Speeds](https://intelligence.org/2021/11/22/yudkowsky-and-christiano-discuss-takeoff-speeds/)** — MIRI transcript of the key 2021 debate

### Expert Perspectives

- **[The Gentle Singularity](https://blog.samaltman.com/the-gentle-singularity)** — Sam Altman's 2025 blog post arguing "we are past the event horizon"
- **[Economic Growth Given Machine Intelligence](https://hanson.gmu.edu/aigrow.pdf)** — Robin Hanson's economic modeling of AI-driven growth
- **[Are We Close to an Intelligence Explosion?](https://futureoflife.org/ai/are-we-close-to-an-intelligence-explosion/)** — Future of Life Institute's 2025 analysis of recursive self-improvement evidence

### Empirical Evidence

- **[Emergent Abilities in Large Language Models: An Explainer](https://cset.georgetown.edu/article/emergent-abilities-in-large-language-models-an-explainer/)** — CSET Georgetown overview of the emergence debate
- **[AI 2027 Takeoff Forecast](https://ai-2027.com/research/takeoff-forecast)** — Survey of OpenAI/DeepMind researchers on AI R&D acceleration
- **[FrontierMath Benchmark](https://epoch.ai/frontiermath/the-benchmark)** — Epoch AI's benchmark showing current capability limits
