...
} from "./tables/accident-risks-columns";
...
import { riskCategoryColors, getBadgeClass } from "./tables/shared/table-view-styles";
import {
  accidentRisks,
  riskCategories,
  type AccidentRisk,
...
export default function AccidentRisksTableView() {
  ...
  // Group risks by category for grouped view
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      <TableViewHeader
        ...
        breadcrumbs={[
          { label: "Accident Risks", href: "/knowledge-base/risks/accident/" },
