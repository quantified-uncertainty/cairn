    ...
    <>
      ...
      <div className="mx-page">
        <div className="mx-header">
          ...
          <nav>
            <a href="/knowledge-base/responses/safety-approaches/table">Approaches</a>
            <a href="/knowledge-base/architecture-scenarios/table">Architectures</a>
            <a href="/knowledge-base/responses/safety-generalizability/matrix" className="active">Matrix</a>
          </nav>
        </div>
