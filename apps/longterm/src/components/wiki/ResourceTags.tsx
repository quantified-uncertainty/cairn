...
const tagColors: Record<string, { bg: string; text: string }> = {
  ...
  cybersecurity: { bg: 'rgba(33, 150, 243, 0.12)', text: '#1565c0' },
  llm: { bg: 'rgba(0, 188, 212, 0.12)', text: '#0097a7' },
  agi: { bg: 'rgba(255, 87, 34, 0.12)', text: '#d84315' },
  deception: { bg: 'rgba(139, 0, 0, 0.12)', text: '#8b0000' },
  compute: { bg: 'rgba(96, 125, 139, 0.12)', text: '#455a64' },
};
...
export function ResourceTags({
  ...
  const sizeStyles = {
    ...
    md: { fontSize: '10px', padding: '2px 6px' },
  };
  const style = sizeStyles[size];

  return (
    <span
      className={`resource-tags ${className}`}
      style={{
        display: 'inline-flex',
        alignItems: 'center',
        gap: '3px',
