    ...
    <>
      ...
      <div className="st-page">
        <div className="st-header">
          ...
          <nav>
            <a href="/knowledge-base/responses/safety-generalizability/graph">Graph</a>
            <a href="/knowledge-base/responses/safety-generalizability/table" className="active">Table</a>
