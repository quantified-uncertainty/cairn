...
importance: 72.5
llmSummary: Comprehensive analysis of whistleblower protections for AI safety, documenting how current US laws inadequately cover AI risks while employment contracts (NDAs, non-disparagement) suppress disclosure. Reviews proposed AI Whistleblower Protection Act, EU AI Act protections, and best practices for labs, arguing that insider information is critical for oversight given information asymmetries between companies and external observers.
