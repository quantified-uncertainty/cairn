...
importance: 72.5
llmSummary: Comprehensive analysis of whistleblower protections for AI safety, documenting how current US laws inadequately cover AI risks while employment contracts (NDAs, non-disparagement) suppress disclosure. The AI Whistleblower Protection Act (S.1792), introduced with bipartisan support in May 2025, would provide comprehensive protections including 2x back pay and prohibition of forced arbitration. EU AI Act Article 87 provides explicit protections from August 2026. Key 2024 cases (Aschenbrenner termination, SEC complaint against OpenAI, "Right to Warn" letter) demonstrate urgent need for reform.
