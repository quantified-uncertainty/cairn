...
description: "The EA/x-risk biosecurity portfolio spans far beyond AI capability restrictions—encompassing DNA synthesis screening, pathogen-agnostic surveillance, medical countermeasures, AI capability evaluations, and governance reform. Open Philanthropy alone has directed $230M+ toward biosecurity across 140+ grants, with the majority funding resilience and detection infrastructure rather than LLM restrictions."
sidebar:
  label: Overview
  order: 0
quality: 55
