...
sidebar:
  order: 8
quality: 91
llmSummary: Responsible Scaling Policies are voluntary industry frameworks establishing capability thresholds (e.g., ASL-3 requires 30%+ bioweapon development time reduction) that trigger safety evaluations before deployment. Current RSPs provide estimated 10-25% risk reduction across 60-70% of frontier development, limited by 30-50% evaluation gaps, 0% external enforcement, and 20-60% abandonment risk under competitive pressure.
