...
sidebar:
  order: 1
quality: 91
llmSummary: The EU AI Act establishes the world's first comprehensive AI regulation with risk-based governance, requiring models greater than 10^25 FLOP to undergo mandatory red-teaming and safety assessments, with penalties up to €35M or 7% global revenue. Implementation occurs in phases through 2027—prohibited practices banned Feb 2025, GPAI rules effective Aug 2025, high-risk systems Aug 2026. The EU AI Office (125+ staff) directly enforces GPAI provisions, while 27 national authorities handle high-risk systems. Industry response is mixed, with Microsoft and OpenAI signing the Code of Practice while Meta refused. The "Brussels Effect" shows limited global adoption, with only Canada and Brazil drafting similar frameworks.
