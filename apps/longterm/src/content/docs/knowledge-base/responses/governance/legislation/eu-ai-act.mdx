...
title: EU AI Act
description: >-
  The world's first comprehensive AI regulation framework, establishing
  risk-based governance with specific provisions for frontier AI models above
  10^25 FLOP, including mandatory red-teaming and safety assessments, with
  maximum penalties of €35M or 7% global revenue.
sidebar:
  order: 1
quality: 88
llmSummary: >-
  Comprehensive analysis of the EU AI Act's risk-based regulatory framework,
  documenting specific requirements including mandatory red-teaming for models
  >10^25 FLOP, enforcement mechanisms with penalties up to €35M/7% revenue, and
  implementation timeline through 2027. Identifies critical limitations
  including compute threshold gaming risk (73% of researchers expect this within
  2-3 years) and existential risk gaps.
...
| **Existential Risk Gap** | Focus on near-term harms vs. [catastrophic risks](/ai-transition-model/outcomes/existential-catastrophe) | Medium-High |
...
- Legal compliance teams established at <R id="04d39e8bd5d50dd5">OpenAI</R>, [Anthropic](/knowledge-base/organizations/labs/anthropic/), and [DeepMind](/knowledge-base/organizations/labs/deepmind/)
