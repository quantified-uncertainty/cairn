...
description: >-
  Comprehensive analysis of AI regulation across US states, tracking the
  evolution from ~40 bills in 2019 to 1,000+ in 2025. States are serving as
  policy laboratories with enacted laws in Colorado, Texas, Illinois,
  California, and Tennessee covering employment, deepfakes, and consumer
  protection, creating a complex patchwork that may ultimately drive federal
  uniformity.
sidebar:
  order: 10
quality: 80
llmSummary: >-
  US state AI legislation grew from ~40 bills in 2019 to 1,080+ in 2025, with
  Colorado enacting the most comprehensive risk-based framework (SB 24-205,
  effective June 2026), Texas passing TRAIGA (effective January 2026),
  California leading on deepfakes, and Illinois pioneering employment AI
  regulation. The vetoed California SB 1047 frontier AI bill demonstrates
  tensions between state innovation and federal preemption. Of 1,080 bills
  introduced in 2025, only 118 (11%) became law, with deepfakes seeing the
  highest passage rate (68 of 301 bills enacted).
