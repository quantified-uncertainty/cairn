...
|---------------------|---------------|---------------|
| **Supporters** | <EntityLink id="cais">Center for AI Safety</EntityLink>, <EntityLink id="anthropic">Anthropic</EntityLink> (initially), Elon Musk, 113+ AI lab employees, LA Times editorial board | Safety testing requirements modest; potential catastrophic risks justify precaution |
