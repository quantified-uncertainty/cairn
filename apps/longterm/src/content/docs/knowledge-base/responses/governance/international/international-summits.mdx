...
sidebar:
  order: 8
quality: 91
llmSummary: Three international AI safety summits (2023-2025) achieved formal recognition of catastrophic AI risks from 28+ countries and established 10+ AI Safety Institutes with $100-400M combined budgets, with 16-20 companies signing Frontier AI Safety Commitments covering approximately 80% of frontier AI development capacity. However, all commitments remain voluntary and non-binding with zero enforcement mechanisms, and growing divergence is evident as US/UK refused to sign the Paris 2025 declaration—suggesting only 15-30% probability contribution toward binding frameworks by 2030. The UK AISI leads with ~$65M annual budget (10x the US), while the EU AI Act remains the only binding governance framework.
