...
sidebar:
  order: 8
quality: 58
llmSummary: Three international AI safety summits (2023-2025) achieved formal recognition of catastrophic AI risks from 28+ countries and established 10+ AI Safety Institutes with $100-400M combined budgets, with 16 companies signing Frontier AI Safety Commitments. However, all commitments remain voluntary and non-binding, with growing divergence evident as US/UK refused to sign the Paris 2025 declaration, suggesting 15-30% probability contribution toward binding frameworks by 2030.
