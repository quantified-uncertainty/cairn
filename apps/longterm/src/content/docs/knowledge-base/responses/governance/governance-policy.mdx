...
| **Industry Adoption** | 60-80% frontier labs | <EntityLink id="anthropic">Anthropic</EntityLink>, <EntityLink id="openai">OpenAI</EntityLink>, <EntityLink id="deepmind">Google DeepMind</EntityLink>, Meta have RSPs; 8% of Anthropic staff on security-adjacent work |
