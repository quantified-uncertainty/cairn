...
sidebar:
  order: 3
quality: 91
llmSummary: Comprehensive analysis of AI governance interventions estimating 5-25% x-risk reduction potential through coordinated policy approaches, with 30-50% chance of meaningful regulation by 2027. Reviews EU AI Act (enforcement began August 2025, penalties up to 7% revenue), US AISI restructuring (renamed CAISI June 2025, $82.7M FY2025 request), export controls (70% reduction in China chip access), and RSP adoption across 60-80% of frontier labs, concluding governance is tractable but faces verification challenges and US-China coordination barriers.
...
metrics:
  ...
  diagrams: 1
---
import {DataInfoBox, EstimateBox, DisagreementMap, KeyQuestions, Backlinks, R, EntityLink, DataExternalLinks, Mermaid} from '../../../../../components/wiki';
