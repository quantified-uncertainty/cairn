...
| **Implementation Maturity** | Early Stage | EU AI Act first full enforcement powers granted December 2025 (Finland); most frameworks still in pilot phases |
...
| **G7 Hiroshima Reporting Framework** | 19 organizations (incl. Amazon, Anthropic, Google, Microsoft, OpenAI) | First reports published Feb 2025 | Operational | [OECD](https://www.oecd.org/en/about/news/press-releases/2025/02/oecd-launches-global-framework-to-monitor-application-of-g7-hiroshima-ai-code-of-conduct.html) |
...
| **US AI Safety Institute Consortium** | 280+ organizations | 5 working groups (risk management, synthetic content, evaluations, red-teaming, security) | Active | [NIST](https://www.nist.gov/news-events/news/us-ai-safety-institute-consortium-holds-first-plenary-meeting-reflect-progress-2024) |
