...
description: The world's first legally binding international treaty on AI,
  establishing human rights standards for AI systems across their lifecycle
importance: 65
...
ratings:
  ...
  completeness: 8
quality: 65
llmSummary: The Council of Europe's AI Framework Convention represents the first
  legally binding international AI treaty, establishing human rights-focused
  ...
  historically significant for AI governance, it addresses human rights risks
  rather than technical AI safety or existential risks.
metrics:
  wordCount: 3067
  citations: 46
  tables: 7
...
The convention will enter into force on the first day of the month following three months after **five signatories**, including at least **three Council of Europe member states**, complete ratification.[^32] As of the research data (through late 2024), no ratifications have been reported, with the focus remaining on securing signatures and beginning domestic ratification processes.
