...
importance: 72.5
llmSummary: Hardware-enabled governance mechanisms (HEMs) embed monitoring and control capabilities into AI chips to enable ongoing verification of use after deployment, complementing export controls. RAND analysis identifies attestation-based licensing as most feasible with 5-10 year implementation timeline, but significant privacy risks, attack surfaces, and authoritarian abuse potential limit appropriate use cases to export control verification and large training run detection. Location verification has been successfully prototyped on Nvidia H100 chips, and BIS now requires location verification capability for NVEU authorization.
...
|-----------|-----------------|--------------|----------------|-------|
| Chip modifications | $50-200M | $5-20M/year maintenance | Manufacturers | Similar to existing security feature development |
| Landmark server network | $20-100M | $5-50M/year | Governments or public-private partnership | Depends on geographic coverage |
| Verification infrastructure | $50-200M | $10-50M/year | Governments | Software, personnel, legal framework |
| Enforcement systems | $10-50M | $10-30M/year | Governments | Investigation, penalties, coordination |
| Compliance systems | $1-5M per company | $0.5-2M/year per company | Operators | Integration with existing IT infrastructure |

For comparison, the [U.S. and EU have each invested approximately $50 billion](https://www.governance.ai/analysis/computing-power-and-the-governance-of-artificial-intelligence) through their Chips Acts in semiconductor manufacturing subsidies.
