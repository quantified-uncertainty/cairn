...
sidebar:
  order: 4
quality: 65
llmSummary: "Comprehensive analysis of AI safety field-building showing growth from 400 FTEs (2022) to 1,100 FTEs (2025) at 21-30% annually, with training programs achieving 37% career conversion at $5K-40K per career change against $110-130M/year philanthropic funding. Identifies critical bottleneck: talent pipeline over-optimized for researchers while neglecting operations, policy, and organizational roles."
