...
description: >-
  Fellowships, PhD programs, research mentorship, and career transition pathways
  for growing the AI safety research workforce, including MATS, Anthropic
  Fellows, SPAR, and academic programs.
sidebar:
  order: 3
quality: 82
...
llmSummary: >-
  ...
  Fellows, SPAR, academic PhDs) showing the field produces 100-200 new safety
  researchers annually against growing need. Documents program structures,
  selection criteria, and strategic bottlenecks including limited mentor
  bandwidth and retention challenges.
