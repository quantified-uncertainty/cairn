...
| **Confidence Interval** | Vaughn Tan | Self-service webapp using LLMs as Socratic mirror for making subjective arguments rigorous. Currently used by college students with interest from startups and governments. |
...
| **AI Policy Simulation** | Alexander van Grootel, Emma Kumleben | AI aiding institutional decision-making through strategic foresight and forecasting for AGI transition navigation |
...
| **Worker-Owned Startups** | Ben Sklaroff | Governance models for worker-owned startup structures |
| **Agent Strategy Arena** | Joshua Levy | Platform for scalable, grounded evaluations of AI agents' prediction accuracy |
| **AI Discourse Sensemaking** | Matthew Brooks, Emma Kumleben, Niki Dupuis | Using LLMs to map opinion landscapes and detect polarization; built semi-automated argument mapper |
