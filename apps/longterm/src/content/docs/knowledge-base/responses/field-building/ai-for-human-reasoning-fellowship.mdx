...
| **Forecasting & Scenarios** | Prediction markets, strategic foresight, scenario planning | Deliberation Markets, Deep Future, Sentinel |
...
Built an AI system that writes Community Notes for X (formerly Twitter). Achieved a significant milestone: the world's first AI-written Community Note to be approved through X's rating system. The bot's notes have been viewed over 2 million times.[^3]
...
| Project | Fellow(s) | Description |
|---------|-----------|-------------|
| **Future Visions Hub** | Sofia Vanhanen | Group decision-making software and epistemic infrastructure for collective sensemaking about desirable futures |
| **Confidence Interval** | Vaughn Tan | Self-service webapp using LLMs as Socratic mirror for making subjective arguments rigorous |
| **Negotiation Station** | Kai Sandbrink | AI tools for high-stakes negotiations between nations/corporations as trusted mediators |
| **AI Policy Simulation** | Alexander van Grootel, Emma Kumleben | AI aiding institutional decision-making through strategic foresight and forecasting |
| **Virtuous** | Paul de Font-Reaulx | Epistemic evaluations for frontier models; developing DeliberationBench |
| **RiskWatch** | Alyssia Jovellanos, Martin Ciesielski-Listwan | Risk Threat Observatory enabled by prediction markets |
...
| Nuno Sempere | <EntityLink id="samotsvety">Samotsvety</EntityLink>, <EntityLink id="quri">QURI</EntityLink> |
...
All fellows presented their work at a demo day. Video presentations are available on YouTube with auto-generated transcripts.

| Project | Presenter(s) | Video | Summary |
|---------|--------------|-------|---------|
| **Collective Agency** | Blake Borgeson | [Watch](https://www.youtube.com/watch?v=P_uMaOzBH_Q) | Framework for increasing humanity's collective agency through AI intermediaries. Presented motifs for group collaboration: facilitators, orchestrators, and AI intermediaries that help groups through collaboration phases (understand, explore, decide, coordinate). Advocates for "shovel-ready wisdom"—ideas for better collective processes ready to become technology. |
| **Pivotal** | Anand Shah, Parker Whitfill, Kai Sandbrink, Ben Sklaroff | [Watch](https://www.youtube.com/watch?v=9lX6cwiw0Ac) | Multi-agent orchestration tool for team coordination. Integrates with existing software to automate scheduling, action items, and organizational workflows. |
| **Polis 2.0** | Colin Megill, Maximilian Kroner Dale | [Watch](https://www.youtube.com/watch?v=EzVN2IJhP7Q) | Successor to Taiwan's Polis collective response system. Surveyed 1,000+ quota-sampled Americans who voted 90,000+ times on 1,300+ statements about AI concerns. Found bridging consensus on deep fakes, data privacy, and education—with Democrats favoring regulation and Republicans skeptical of government overreach but united on accountability. New features include semantic topic clustering and LLM-generated consensus summaries. |
| **Deliberation Markets** | Siddarth Srinivasan | [Watch](https://www.youtube.com/watch?v=OA-nLfXV7Ks) | Novel prediction market where you write explanations instead of buying contracts. An LLM reads your reasoning, synthesizes it into a probability, and trades on that belief. Incentivizes quality explanations by rewarding arguments that persuade the LLM toward eventual ground truth. Live demo showed the system updating market probability from 32% to 65% based on a single well-reasoned argument. |
| **Community Notes AI** | Nathan Young, Robert Gordon | [Watch](https://www.youtube.com/watch?v=yqpcsat1Mxw) | Built AI that writes Community Notes for X (Twitter). Achieved world's first AI-written note approved through X's rating system—notes now viewed 2.5M+ times. Key insight: early notes have 25-50% impact on reshares; late notes have almost none. Plans to expand to TikTok, Chrome extensions, and Perplexity. Estimates \$150K-\$500K needed to scale. |
| **Open Note Network** | Steve Isley | [Watch](https://www.youtube.com/watch?v=jqss-3RYjaE) | AI Community Notes paired with long-form fact-checking website. Links short-form social media corrections to comprehensive analysis. |
| **AI for Epistemic Commons** | Herbie Bradley | [Watch](https://www.youtube.com/watch?v=Q-2Ci4Ajmh8) | Research on "Community Notes everywhere" for browsers and AI-assisted Wikipedia editing. Built evaluations measuring model capability to fix errors and expand articles. |
| **Evidentry** | Agita Pasaribu | [Watch](https://www.youtube.com/watch?v=NOYGvoB3pk4) | Coalition infrastructure to combat non-consensual AI-generated intimate imagery. Connects survivors, platforms, and regulators with multi-detector aggregation and streamlined verification workflows. |
| **Worker-Owned Startups** | Ben Sklaroff | [Watch](https://www.youtube.com/watch?v=20yWMxAx6QI) | Governance models for worker-owned startup structures. |
| **Society Library** | Jamie Joyce | [Watch](https://www.youtube.com/watch?v=xsvCYhcxDX4) | Semi-automated pipeline producing 600+ page intelligence reports with multiple viewpoints. Researching how structured datasets can benchmark LLM truth-seeking capabilities. |
| **AI Discourse Sensemaking** | Matthew Brooks, Emma Kumleben, Niki Dupuis | [Watch](https://www.youtube.com/watch?v=vqDRlSWTOUQ) | Using LLMs to map opinion landscapes and detect polarization. Built semi-automated argument mapper for understanding internet discourse. |
| **Confidence Interval** | Vaughn Tan | [Watch](https://www.youtube.com/watch?v=ErYC-F7lJac) | Self-service webapp using LLMs as "Socratic mirror" to make subjective arguments rigorous. Currently used by college students; interest from startups and governments. |
| **Virtuous** | Paul de Font-Reaulx | [Watch](https://www.youtube.com/watch?v=TZSCkqxl8q8) | Epistemic evaluations for frontier models. Developing DeliberationBench to assess how models influence users' political views. |
| **Epistemic Evals** | Alejandro Botas | [Watch](https://www.youtube.com/watch?v=6CVBHgyo-V0) | Evaluated outputs for epistemic quality (Reasoning/Clarity/Value). Built leaderboard testing model sensitivity to epistemically irrelevant contexts. |
| **DeliberationBench** | Max Kroner Dale, Luke Hewitt, Paul de Font-Reaulx | [Watch](https://www.youtube.com/watch?v=T3JAWlc1dq0) | AI persuasiveness benchmark using Deliberative Polls as normative reference. Tested in 4,000-person randomized experiment. |
| **Forecasting & Provenance** | Alyssia Jovellanos, Martin Ciesielski-Listwan | [Watch](https://www.youtube.com/watch?v=m5h8Sx8kx18) | Experiments in epistemic infrastructure including Image Epistemics, Epistemics Arena, and RiskWatch threat observatory. |
| **Agent Strategy Arena** | Joshua Levy | [Watch](https://www.youtube.com/watch?v=qkvFfS_nTI8) | Platform for scalable, grounded evaluations of AI agents' prediction accuracy. |
| **AI Policy Simulation** | Alexander van Grootel, Emma Kumleben | [Watch](https://www.youtube.com/watch?v=_xtHcBQGYpE) | AI-assisted strategic foresight for institutional decision-making. Analyzes 2nd/3rd order effects for AGI transition navigation. |
| **Deep Future** | Gordon Brander | [Watch](https://www.youtube.com/watch?v=r_vdUeoKbJE) | AI agent for scenario planning, described as "deep research for strategic foresight." Uses methods from RAND/US military scenario planning. Demo showed identifying 38 driving forces for "How will AI agents transform the web by 2030?" and generating strategic reports with opportunities, threats, and early warning signals. Plans to compress week-long scenario workshops into 10-15 minutes. |
...
| **AI Safety Training Programs** | Complementary fellowship in different focus area |
