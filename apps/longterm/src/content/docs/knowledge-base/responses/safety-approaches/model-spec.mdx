...
description: >-
  Model specifications are explicit written documents defining desired AI behavior,
  values, and boundaries. Pioneered by Anthropic and OpenAI, they improve transparency
  and enable external scrutiny while providing clear guidelines for training and
  deployment, though enforcement remains a key challenge.
sidebar:
  order: 7
quality: 75
importance: 72
...
llmSummary: >-
  Model specifications explicitly define desired AI behavior through written
  documents, improving transparency and enabling external accountability.
  With Anthropic's Claude Model Spec and OpenAI's Model Spec as leading examples,
  investment runs $10-30M/year. Key limitation: specs define target behavior but
  don't ensure genuine compliance, especially for sophisticated systems.
...
- **[Constitutional AI](/knowledge-base/responses/alignment/constitutional-ai/)**: Specs inform constitutional principles
- **[RLHF](/knowledge-base/responses/safety-approaches/rlhf/)**: Specs guide rater instructions
