...
- **[RLHF](/knowledge-base/responses/safety-approaches/rlhf/)**: CIRL provides theoretical foundation; RLHF is practical approximation
- **[Reward Modeling](/knowledge-base/responses/safety-approaches/reward-modeling/)**: CIRL explains why learned rewards should include uncertainty
