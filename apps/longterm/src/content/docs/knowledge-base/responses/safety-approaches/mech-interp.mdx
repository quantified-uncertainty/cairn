...
| Metric | Value | Notes |
|--------|-------|-------|
| **Annual Investment** | $50-150M/year | Anthropic (~$50M+), DeepMind, independents |
...
- **[Representation Engineering](/knowledge-base/responses/safety-approaches/representation-engineering/)**: Uses interpretability findings to steer behavior
- **[Process Supervision](/knowledge-base/responses/safety-approaches/process-supervision/)**: Interpretability could verify reasoning matches shown steps
