...
description: Strategic overview of AI safety interventions, their risk coverage, and how they address parameters in the AI Transition Model
sidebar:
  order: 1
...
importance: 87.5
quality: 72
llmSummary: Provides a strategic framework for AI safety resource allocation by mapping 13+ interventions against 4 risk categories, evaluating each on ITN dimensions, and identifying portfolio gaps (epistemic resilience severely neglected, technical work over-concentrated in frontier labs). Recommends rebalancing from very high RLHF investment toward evaluations (very high priority), AI control and compute governance (both high priority), with epistemic resilience increasing from very low to medium allocation.
ratings:
  novelty: 6.5
  rigor: 6.5
  actionability: 7.5
...
|-----------|--------|-------|
| Tractability | Medium-High | Varies widely by intervention type; evaluations and compute governance more tractable than international coordination |
| Scalability | High | Portfolio approach scales across risk categories and timelines |
| Current Maturity | Medium | Core interventions established; significant gaps in epistemic resilience and post-incident recovery |
| Time Horizon | Near-Long | Near-term interventions (evaluations, control) complement long-term work (interpretability, governance) |
| Funding Level | ~$110-130M/year | [Global AI safety funding in 2024](https://coefficientgiving.org/research/ai-safety-and-security-need-more-funders/), representing less than 2% of total AI investment |
| Key Funders | Open Philanthropy, Jaan Tallinn, AI Safety Fund | [Open Philanthropy deployed $63.6M in 2024](https://www.openphilanthropy.org/research/our-progress-in-2024-and-plans-for-2025/)—nearly 60% of all external AI safety funding |
...
The following table estimates 2024 funding levels by intervention area and compares them to recommended allocations based on neglectedness and impact potential. Total external AI safety funding was approximately [$110-130 million in 2024](https://coefficientgiving.org/research/ai-safety-and-security-need-more-funders/), with [Open Philanthropy providing ~60%](https://www.openphilanthropy.org/research/our-progress-in-2024-and-plans-for-2025/) of this amount.

| Intervention Area | Est. 2024 Funding | % of Total | Recommended Shift | Key Funders |
|-------------------|------------------:|:----------:|:-----------------:|-------------|
| **RLHF/Training Methods** | $25-35M | ~25% | Decrease to 20% | Frontier labs (internal), academic grants |
| **Interpretability** | $15-25M | ~18% | Maintain | Open Philanthropy, [Superalignment Fast Grants](https://openai.com/index/superalignment-fast-grants/) ($10M) |
| **Evaluations & Evals Infrastructure** | $12-18M | ~13% | Increase to 20% | [CAIS ($8.5M)](https://www.openphilanthropy.org/research/our-progress-in-2024-and-plans-for-2025/), UK AISI, labs |
| **AI Control Research** | $8-12M | ~9% | Increase to 15% | [Redwood Research ($6.2M)](https://www.openphilanthropy.org/research/our-progress-in-2024-and-plans-for-2025/), Anthropic |
| **Compute Governance** | $6-10M | ~7% | Increase to 12% | Government programs, policy organizations |
| **Field Building & Talent** | $10-15M | ~11% | Maintain | 80,000 Hours, MATS, various fellowships |
| **Governance & Policy** | $8-12M | ~9% | Increase to 12% | Open Philanthropy policy grants, government initiatives |
| **International Coordination** | $3-5M | ~4% | Increase to 8% | [UK/EU government initiatives (~$14M total)](https://www.lesswrong.com/posts/WGpFFJo2uFe5ssgEb/an-overview-of-the-ai-safety-funding-situation) |
| **Epistemic Resilience** | $2-4M | ~3% | Increase to 8% | Very few dedicated funders |
...
|----------|---------------|--------|-------------------|
| **Climate vs AI safety** | Climate philanthropy: ~$9-15B; AI safety: ~$130M | ~100x disparity despite comparable catastrophic potential | Increase AI safety funding to at least $500M-1B annually |
| **Capabilities vs safety** | [~$200B in AI data center capex (2024)](https://coefficientgiving.org/research/ai-safety-and-security-need-more-funders/) vs ~$130M safety | ~1500:1 ratio | Redirect 0.5-1% of capabilities spending to safety |
| **Funder concentration** | Open Philanthropy: 60% of external funding | Single point of failure; limits diversity | [Diversify funding sources](https://www.insidephilanthropy.com/home/whos-funding-ai-regulation-and-safety); new initiatives like [Humanity AI ($500M)](https://www.insidephilanthropy.com/home/whos-funding-ai-regulation-and-safety) |
...
|-------------------|---------------|------|------------|
| **Funder concentration** | [Open Philanthropy provides ~60% of external funding](https://www.openphilanthropy.org/research/our-progress-in-2024-and-plans-for-2025/) | Strategy changes affect entire field | Cultivate diverse funding sources |
...
| **Frontier lab dependence** | Most technical safety at Anthropic, OpenAI, DeepMind | Conflicts of interest; limited independent verification | Increase funding to [MIRI ($4.1M)](https://www.openphilanthropy.org/research/our-progress-in-2024-and-plans-for-2025/), Redwood, ARC |
...
| Robustness Criterion | Current Status | Gap Assessment |
|---------------------|----------------|----------------|
| **Cover multiple failure modes** | Accident risks well-covered; epistemic risks neglected | Medium gap |
| **Prevention and resilience** | ~95% prevention, ~5% resilience | Large gap |
| **Near-term and long-term balance** | Reasonable balance; evaluations + control + interpretability | Small gap |
| **Independent research capacity** | Frontier labs dominate; independents underfunded | Medium gap |
| **Support multiple worldviews** | Most interventions robust across scenarios | Small gap |
| **Geographic diversity** | Concentrated in US/UK | Medium gap |
| **Funder diversity** | [Single funder provides 60%](https://www.openphilanthropy.org/research/our-progress-in-2024-and-plans-for-2025/) | Large gap |
...
|--------|------|-----------|
| [Open Philanthropy Progress 2024](https://www.openphilanthropy.org/research/our-progress-in-2024-and-plans-for-2025/) | Funder Report | Primary data on AI safety funding levels and priorities |
...
| [Superalignment Fast Grants](https://openai.com/index/superalignment-fast-grants/) | Grant Program | OpenAI's $10M technical safety funding initiative |
