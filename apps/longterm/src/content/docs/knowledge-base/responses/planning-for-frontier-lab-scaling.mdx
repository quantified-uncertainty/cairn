...
<DataInfoBox entityId="planning-for-frontier-lab-scaling" ratings={frontmatter.ratings} />
...
**The central insight**: You cannot match frontier lab spending. Instead, you must identify the specific leverage points where modest investment can disproportionately influence outcomes. The 2025-2028 window is critical because spending patterns are being established, IPOs create new accountability mechanisms, and the pre-TAI period may be the last window for meaningful external influence on AI development trajectory.
