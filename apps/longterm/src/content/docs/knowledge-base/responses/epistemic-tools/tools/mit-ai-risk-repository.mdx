...
| **Misinformation** | Deepfakes, manipulation | AI-generated disinformation |
| **Malicious Actors & Misuse** | Cyberattacks, weapons | Autonomous weapons |
| **Human-Computer Interaction** | Overreliance, manipulation | Automation bias |
...
| **EU AI Act Categories** | Regulatory compliance | Regulatory risks | Legislative cycle |
| **<EntityLink id="stampy-aisafety-info">AISafety.info</EntityLink>** | Public education | Conceptual | Community-driven |
