...
| **Funding** | Open Philanthropy (supported through mid-2027) |
...
ForecastBench is supported by Open Philanthropy grants to FRI:
...
- [Open Philanthropy Grant](https://www.openphilanthropy.org/grants/forecasting-research-institute-forecasting-benchmark/)
