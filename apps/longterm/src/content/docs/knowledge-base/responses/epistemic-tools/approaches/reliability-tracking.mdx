...
*Part of the [Design Sketches for Collective Epistemics](/knowledge-base/responses/epistemic-tools/approaches/collective-epistemics-design-sketches/) series by Forethought Foundation.*
...
| Platform | What It Tracks | Key Metrics | Status |
|----------|---------------|-------------|--------|
| **<EntityLink id="metaculus">Metaculus</EntityLink>** | Probabilistic predictions with public [track record page](https://www.metaculus.com/questions/track-record/) | Brier score of 0.107 for binary questions resolved in 2021; also runs quarterly [AI Forecasting Benchmark Tournaments](https://www.metaculus.com/aib/) (\$30K prizes) | Active; largest forecasting platform |
| **[Good Judgment Open](https://www.gjopen.com/)** | Public forecasting tournaments; top performers recruited as Superforecasters | Public leaderboards; free to join | Active |
| **[Manifold Markets](https://manifold.markets/)** | Play-money prediction market with public [calibration page](https://manifold.markets/calibration) | 89K+ sampled trades showing probability-outcome alignment | Active |
| **[Polymarket](https://www.polymarket.com/)** | Real-money prediction market with defined resolution criteria | \$2B+ trading volume; CFTC-licensed path | Active |
| **[Fatebook](https://fatebook.io/)** | Low-friction personal prediction tracking with Brier scores, calibration charts | Slack/Discord integrations; private-by-default | Active |
| **[PredictionBook](https://predictionbook.com/)** | Personal predictions with calibration graphs | Aggregate data shows good calibration except at 90%+ confidence | Active (legacy) |
| **[Calibration City](https://calibration.city/)** | Cross-platform comparison across Kalshi, Manifold, Metaculus, and Polymarket | 130,000+ markets compared (launched Jan 2024) | Active |
| **ForecastBench** | AI forecasting system benchmark | Tracks AI prediction accuracy | Active |

### Pundit and Public Figure Accountability Projects

| Project | Approach | Outcome |
|---------|----------|---------|
| **PunditTracker** (2013-?) | Cataloged and scored pundit predictions across finance, politics, sports. Letter grades for pundits with 25+ graded calls. | Showed most pundits performed at or below chance; now defunct |
| **[PunditFact](https://www.politifact.com/punditfact/)** | PolitiFact/Poynter Institute—dedicated to checking claims by pundits, columnists, talk show hosts | Active; uses Truth-O-Meter scale |
| **[PolitiFact](https://www.politifact.com/)** | Six-level "Truth-O-Meter" for political claims; maintains campaign promise trackers (Obameter, Trump-O-Meter, Biden Promise Tracker) | Active since 2007; Pulitzer Prize 2009 |
| **Washington Post Fact Checker** | "Pinocchio" rating (1-4 scale); built database of 30,573 false/misleading statements during Trump's first term | Glenn Kessler departed July 2025 after 14 years |
| **[FactCheck.org](https://www.factcheck.org/)** | Nonpartisan monitoring by Annenberg Public Policy Center (UPenn) | Active |
| **[FiveThirtyEight](https://projects.fivethirtyeight.com/checking-our-work/)** | Maintained public "Checking Our Work" transparency page evaluating own model calibration | Legacy (Silver left 2023); model moved to Silver Bulletin |
| **Hamilton College Study (2011)** | Evaluated 472 predictions from 26 major pundits over 16 months | Found pundits predicted no more accurately than a coin toss |
| **[Holden Karnofsky compilation](https://www.cold-takes.com/prediction-track-records-i-know-of/)** | "Prediction Track Records I Know Of" (2021)—links to documented track records | Reference compilation |
...
- **Overview**: [Design Sketches for Collective Epistemics](/knowledge-base/responses/epistemic-tools/approaches/collective-epistemics-design-sketches/) — parent page with all five proposed tools
