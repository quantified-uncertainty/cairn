...
|------|-------------|----------|
| **[FallacyCheck](https://dl.acm.org/doi/10.1145/3771882.3774253)** | LLM-based browser extension (Chrome/Firefox) using inoculation theory—poses contextual questions rather than labeling. Detects 13 fallacy types. Presented at MUM 2024. | LLM-based; proactive questioning |
| **[Skeptic Reader](https://www.skepticreader.domesticstreamers.com/)** | Chrome/Firefox extension by Domestic Data Streamers using GPT-4o. Analyzes web text and video transcripts, scores balance, logical coherence, and objectivity. | LLM-based; scoring approach |
| **[FallacyFilter](https://chromewebstore.google.com/detail/fallacyfilter-bias-fallac/eecmbjkpkifngjfchnnpiafopomkpick)** | AI-powered Chrome extension detecting biases and logical fallacies in online text | LLM-based; browser extension |
| **[IBM Project Debater](https://aclanthology.org/2021.emnlp-demo.31.pdf)** | AI system with corpus-wide argument mining across 10 billion sentences. Publicly released APIs for claim detection, evidence detection, argument quality assessment, and stance classification. | NLP pipeline; APIs available |
| **[Kialo](https://www.kialo-edu.com/)** | World's largest argument mapping platform. 1M+ users, 400K+ discussions across 49 languages. Visualizes arguments as hierarchical pro/con trees. | Human-driven argumentation |
| **[Grammarly](https://www.grammarly.com/)** | Writing assistant that flags some rhetorical issues (tone, clarity) | Rule-based + ML; commercial |
| **[Ad Fontes Media](https://adfontesmedia.com/)** | Rates news sources on reliability and bias axes | Human rating; media-level |
| **[Ground News](https://ground.news/)** | Shows how different outlets cover the same story; "Blindspot" feature highlights lopsided coverage | Aggregation-based |
| **[Logically.ai](https://www.logically.ai/)** | AI-powered fact-checking and harmful content detection | Commercial platform |
| **[fallacycheck.com](https://fallacycheck.com/)** | Crawls thousands of internet pages from news, editorials, and social media, automatically identifying logical fallacies at scale | Automated web crawling |
...
**Author rhetoric profiles**: Aggregate rhetoric patterns across an author's or organization's body of work. "This author uses emotional language 3x more than the domain average" or "This organization's press releases consistently use absolute safety claims." This connects rhetoric highlighting to [reliability tracking](/knowledge-base/responses/epistemic-tools/approaches/reliability-tracking/).
