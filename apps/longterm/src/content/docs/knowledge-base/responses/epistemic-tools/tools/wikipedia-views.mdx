...
description: Suite of tools and analytics systems for tracking Wikipedia
  pageview statistics, created by the Wikimedia Foundation and independent
  researchers like Vipul Naik
importance: 25
...
ratings:
  ...
  completeness: 6
quality: 38
llmSummary: This article provides a comprehensive overview of Wikipedia pageview
...
This gap significantly distorts trend analysis. Desktop declines from 2013-2014 appeared steeper than they actually were because growing mobile usage went unmeasured. Analysts like <EntityLink id="issa-rice">Issa Rice</EntityLink> and Vipul Naik emphasized that apparent pageview drops largely reflected measurement flaws rather than declining interest.[^40] Even established articles in leading categories showed 50-67% declines from 2013-2014 when examining desktop data alone, but these drops were partially or fully offset by mobile growth.[^41]
