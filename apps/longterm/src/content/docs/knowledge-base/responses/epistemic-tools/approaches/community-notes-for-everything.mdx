...
|---------|-----------|--------|
| <EntityLink id="community-notes">X Community Notes</EntityLink> | Proves bridging consensus model works at scale | Active; open-source algorithm |
| Meta Community Notes | Facebook/Instagram adopting similar model (announced Jan 2025) | Rolling out in US |
| Wikipedia Talk Pages | Crowdsourced verification with editorial consensus | Mature but labor-intensive |
| Google Knowledge Panels | AI-generated contextual information alongside search results | Active |
| ClaimBuster | AI-powered claim detection and fact-check matching | Academic project |
| Full Fact AI tools | Automated fact-checking claim detection | Active non-profit |
