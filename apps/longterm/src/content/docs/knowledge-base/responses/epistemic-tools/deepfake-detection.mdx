...
|-----------|------------|----------|
| **Tractability** | Medium-Low | Best commercial detectors achieve 78-87% accuracy in-the-wild vs. 96%+ in controlled settings; [detection performance drops 45-50%](https://arxiv.org/abs/2503.02857) on real-world deepfakes |
