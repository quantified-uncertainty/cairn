...
| **Funding** | Open Philanthropy grants to FRI (part of \$16M+ total) |
...
The XPT was conducted by <EntityLink id="fri">FRI</EntityLink> with funding from Open Philanthropy:
