...
description: >-
  This response uses AI to facilitate large-scale democratic deliberation on AI
  governance and policy. Evidence shows 15-35% opinion change rates among
  participants, with Taiwan's vTaiwan achieving 80% policy implementation from
  26 issues. The EU's Conference on the Future of Europe engaged 5+ million
  visitors, while Anthropic's Constitutional AI experiment incorporated input
  from 1,094 participants into Claude's training, demonstrating feasibility at
  scale.
sidebar:
  order: 4
quality: 82
llmSummary: >-
  AI-assisted deliberation platforms like Polis and Anthropic's Constitutional
  AI demonstrate 15-35% opinion change rates among participants, with Taiwan's
  vTaiwan achieving 80% policy implementation from 26 issues and the EU
  Conference engaging 5+ million visitors. The methodology shows concrete
  feasibility for incorporating public input into AI governance, though
  manipulation resistance remains a concern.
...
| **AI Governance Relevance** | High | <R id="3c862a18b467640b">Anthropic's Constitutional AI</R> trained model on 1,094 participants' deliberated principles |
