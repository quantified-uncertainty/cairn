...
| Tool | Core Function | Key Mechanism |
|------|--------------|---------------|
| [Community Notes for Everything](/knowledge-base/responses/epistemic-tools/approaches/community-notes-for-everything/) | Cross-platform context layer | AI-generated consensus-vetted annotations on any internet content |
| [Rhetoric Highlighting](/knowledge-base/responses/epistemic-tools/approaches/rhetoric-highlighting/) | Automated manipulation detection | Flagging persuasive-but-misleading sentences and citation misrepresentation |
| [Reliability Tracking](/knowledge-base/responses/epistemic-tools/approaches/reliability-tracking/) | Actor track record assessment | Topic-specific accuracy scores based on historical statements |
| [Epistemic Virtue Evals](/knowledge-base/responses/epistemic-tools/approaches/epistemic-virtue-evals/) | AI honesty benchmarking | Standardized tests for calibration, sycophancy resistance, and manipulation avoidance |
| [Provenance Tracing](/knowledge-base/responses/epistemic-tools/approaches/provenance-tracing/) | Knowledge genealogy infrastructure | Transparent chains showing claim origins, methodology, and reliability |
