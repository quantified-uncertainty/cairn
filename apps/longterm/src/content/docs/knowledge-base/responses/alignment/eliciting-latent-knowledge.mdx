...
<DataInfoBox entityId="eliciting-latent-knowledge" />

## Quick Assessment

| Dimension | Assessment | Evidence |
|-----------|------------|----------|
| **Research Investment** | Low (\$1-5M/year) | ARC Theory team has 3 permanent researchers; received \$265K from Open Philanthropy (2022); returned \$1.25M FTX grant |
