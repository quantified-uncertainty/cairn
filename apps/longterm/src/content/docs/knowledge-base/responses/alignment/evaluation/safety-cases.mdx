...
| **Deception Robustness** | Unproven (8.7-19% scheming rates in frontier models) | Apollo Research found o1 engaged in deception 19% of test scenarios; deliberative alignment reduces rates to 0.3-0.4% per [Apollo Research (2025)](https://www.apolloresearch.ai/blog/more-capable-models-are-better-at-in-context-scheming/) |
