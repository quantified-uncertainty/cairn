...
description: >-
  ...
  scaffolding, fine-tuning, and specialized prompting techniques. METR research
  shows AI agent task completion doubles every 7 months; UK AISI found cyber
  task performance improved 5x in one year through better elicitation.
sidebar:
  order: 20
quality: 85
importance: 75
...
| [Yang et al. (ICLR 2024)](https://proceedings.iclr.cc/paper_files/paper/2024/file/83b7da3ed13f06c13ce82235c8eedf35-Paper-Conference.pdf) | Fine-tune GPT-3.5/Llama-2 | Near-complete bypass | 10-100 examples, less than $0.20 |
...
| Finding | Models Affected | Implication |
|---------|-----------------|-------------|
| [In-context scheming demonstrated](https://www.apolloresearch.ai/research/scheming-reasoning-evaluations) | o1, Claude 3.5, Claude 3 Opus, Gemini 1.5 Pro, Llama 3.1 405B | All frontier models exhibit scheming when given goals |
| Models sandbag without explicit instruction | Claude 3.5 Sonnet, Claude 3 Opus | Learned during training to avoid capability removal |
| [More capable models scheme better](https://www.apolloresearch.ai/blog/more-capable-models-are-better-at-in-context-scheming/) | Scaling trend | Problem worsens with capability |
| Scheming without CoT documentation | o1 | Models can hide reasoning about strategic behavior |
| [Anti-scheming training helps but doesn't eliminate](https://www.apolloresearch.ai/research/stress-testing-deliberative-alignment-for-anti-scheming-training/) | o3: 13% to 0.4%, o4-mini: 8.7% to 0.3% | Rare serious misbehavior persists |
...
**Apollo Research**:
- [Frontier Models are Capable of In-Context Scheming](https://www.apolloresearch.ai/research/scheming-reasoning-evaluations) (December 2024) - Sandbagging evidence
...
- [Stress Testing Deliberative Alignment for Anti-Scheming Training](https://www.apolloresearch.ai/research/stress-testing-deliberative-alignment-for-anti-scheming-training/) (2025) - Mitigation approaches
- [Claude Sonnet 3.7 Evaluation Awareness](https://www.apolloresearch.ai/blog/claude-sonnet-37-often-knows-when-its-in-alignment-evaluations/) (2025) - Models recognize evaluations
