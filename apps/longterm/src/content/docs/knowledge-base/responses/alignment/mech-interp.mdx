...
llmSummary: Mechanistic interpretability reverse-engineers neural networks to understand internal computations, with $500M+ annual investment across major labs (over 40% of AI safety funding). Anthropic extracted 30M+ features from Claude 3 Sonnet, but DeepMind deprioritized SAE research in March 2025 after finding linear probes outperform. Amodei predicts "MRI for AI" in 5-10 years; practical tests showed 3/4 teams detected planted misalignment.
...
| **Current Investment** | $500M+ combined | Anthropic, OpenAI, DeepMind internal safety research; interpretability represents over 40% of AI safety funding ([2025 analysis](https://quickmarketpitch.com/blogs/news/ai-safety-investors)) |
| **Time Horizon** | 5-10 years | Amodei predicts "MRI for AI" achievable by 2030-2035, but warns AI may outpace interpretability |
| **Field Status** | Active debate | MIT Technology Review named mechanistic interpretability a [2026 Breakthrough Technology](https://www.technologyreview.com/2026/01/12/1130003/mechanistic-interpretability-ai-research-models-2026-breakthrough-technologies/); DeepMind pivoted away from SAEs in March 2025 |
...
|--------------|------------------|------------------------|-------------|
| **Anthropic** | SAEs, circuits, safety applications | $50-100M+ (internal) | [Scaling Monosemanticity](https://transformer-circuits.pub/2024/scaling-monosemanticity/) (2024), [Circuits July 2025 update](https://transformer-circuits.pub/2025/july-update/index.html) |
| **OpenAI** | SAE scaling, GPT-4 interpretability | $30-50M+ (internal) | [16M latent autoencoder on GPT-4](https://cdn.openai.com/papers/sparse-autoencoders.pdf), public training code release |
| **DeepMind** | Model diffing, deception detection | $20-40M+ (internal) | [SAE deprioritization](https://deepmindsafetyresearch.medium.com/negative-results-for-sparse-autoencoders-on-downstream-tasks-and-deprioritising-sae-research-6cadcfc125b9), pivot to pragmatic interpretability |
| **EleutherAI** | Open-source tools | ~$5M (grants) | TransformerLens, community resources |
| **Academic/Independent** | Theoretical foundations | $48M Bay Area, $32M London/Oxford (2024) | [Open Problems survey](https://arxiv.org/abs/2501.16496) |

**Total estimated field investment:** $500M+ annually combined across internal safety research at major labs, with mechanistic interpretability and constitutional AI representing over 40% of total AI safety funding.
...
| **Academic (MIT, Oxford, Berkeley)** | Theoretical foundations | Bay Area: $48M, London/Oxford: $32M (2024 funding) | Various institutions |
