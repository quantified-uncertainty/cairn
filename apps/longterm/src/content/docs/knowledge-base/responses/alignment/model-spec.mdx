...
llmSummary: Model specifications are explicit written documents defining AI behavior (Anthropic's Claude Soul Document, OpenAI's Model Spec with 6+ versions in 2025, Meta's Llama Model Cards) that improve transparency and enable external scrutiny. Current investment estimated at $10-30M/year with medium safety benefit. By 2025, all major frontier labs publish specs, with 78% of enterprises using AI. Key challenge remains the spec-reality gap—specifications don't guarantee implementation, with sophisticated systems potentially gaming compliance.
...
| **Adoption** | Widespread (2025) | Anthropic, OpenAI, Google DeepMind, Meta all publish model documentation |
...
| **Enterprise AI Spending** | $37B in 2025 | 3.2x increase from $11.5B in 2024 ([Menlo Ventures](https://menlovc.com/perspective/2025-the-state-of-generative-ai-in-enterprise/)) |
...
| [State of Enterprise AI 2025](https://menlovc.com/perspective/2025-the-state-of-generative-ai-in-enterprise/) | Menlo Ventures | Enterprise AI surged from $1.7B to $37B since 2023 |
