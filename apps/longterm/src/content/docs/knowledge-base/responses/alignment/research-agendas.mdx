...
|--------------|---------------|------------|---------------|--------------|----------|
| **<EntityLink id="anthropic">Anthropic</EntityLink>** | ≈\$100M+ (safety research) | ≈15 red team + growing safety org | Constitutional AI, Interpretability | High (empirical validation) | 2-5 years |
...
| **<EntityLink id="redwood-research">Redwood Research</EntityLink>** | ≈\$5-10M annually (\$21M total raised) | Small team + Constellation (30k sqft) | AI Control protocols | High (practical protocols) | Near-term |
