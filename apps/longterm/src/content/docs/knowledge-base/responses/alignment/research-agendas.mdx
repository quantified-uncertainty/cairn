...
| **MIRI** | \$7M (2025), \$10M reserves | ≈7 FTE comms, pivoting to governance | <EntityLink id="agent-foundations">Agent Foundations</EntityLink>, Policy | Low (fundamental theory) | Long-term/governance |
