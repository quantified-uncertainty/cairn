...
|----------|---------------|-----------------|----------|
| AI-specific methodology development | $5-10M/year | High - Foundation for all else | 2-3 years |
| Templates for common deployment scenarios | $2-5M/year | Medium - Practical adoption enabler | 1-2 years |
| Evidence achievability research | $10-20M/year | Critical - Determines viability | 3-5 years |
| Pilot programs with frontier labs | $5-10M/year | High - Real-world learning | Ongoing |
| Safety case expertise training | $2-3M/year | Medium - Builds human capital | 2-4 years |
| Interpretability for safety cases | $20-50M/year | Critical if feasible - Only path to robust deception resistance | 5-10+ years |
