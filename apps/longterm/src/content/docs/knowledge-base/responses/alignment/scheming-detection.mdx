...
|-----------|--------|-------|
| **Tractability** | Medium | Behavioral tests work; robust internal detection remains hard |
| **Scalability** | Medium-High | Methods apply to most language models with reasoning |
| **Current Maturity** | Low-Medium | Active research at major labs; no production-ready solutions |
| **Time Horizon** | 2-5 years | Deliberative alignment shows promise; probes need validation |
| **Key Proponents** | Apollo Research, Anthropic, OpenAI | Apollo leads evals; Anthropic leads interpretability |
| **Confidence** | Medium | Detection possible but not robust against sophisticated deception |
...
| Organization | Focus Area | Key Outputs |
|--------------|-----------|-------------|
| **Apollo Research** | Scheming evaluations, safety cases | Frontier scheming paper, stress testing methodology |
| **Anthropic** | Sleeper agents, probes, interpretability | Sleeper agents paper, defection probes |
| **OpenAI** | Deliberative alignment, joint evals | Anti-scheming training, detection methods |
| **UK AISI / US AISI** | Evaluation protocols | Pre-deployment standards |
| **METR** | Dangerous capability evals | Evaluation frameworks |
