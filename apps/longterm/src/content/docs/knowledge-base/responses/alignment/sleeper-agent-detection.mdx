...
| **Current Research Investment** | $5-15M/year | Primary labs: Anthropic, Redwood Research, ARC; academic contributions limited |
...
|--------------|------------|------------------------|-------------|
| Anthropic Interpretability | SAEs, feature extraction, sleeper agents | $3-5M | Scaling Monosemanticity, Sleeper Agents paper |
| Redwood Research | AI control, alignment faking | $2-4M | Causal scrubbing, control protocols |
| Apollo Research | Scheming evaluations | $1-2M | In-context scheming paper |
| ARC (Alignment Research Center) | ELK, model evaluations | $2-3M | Eliciting Latent Knowledge framework |
