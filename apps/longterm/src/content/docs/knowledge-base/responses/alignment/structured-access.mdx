...
llmSummary: Structured access (API-only deployment) provides meaningful safety benefits through monitoring, intervention capability, and controlled proliferation, with detection rates of 80-95% for misuse patterns. However, effectiveness depends on maintaining capability gaps with open-weight models, which have collapsed from 17.5 to 0.3 percentage points on MMLU (2023-2025), reducing the control window from 12-18 months to 3-6 months.
ratings:
  novelty: 4.5
  rigor: 6.5
  actionability: 7
...
The effectiveness of structured access depends on frontier capabilities remaining closed. The gap has been [collapsing rapidly](https://fourweekmba.com/the-open-model-convergence-how-the-frontier-gap-collapsed-to-6-months/):

| Year | MMLU Gap (Closed vs Open) | Chatbot Arena Gap | Time to Parity |
|------|--------------------------|-------------------|----------------|
| 2023 | ~17.5 percentage points | ~8% | 12-18 months |
| 2024 | ~5 percentage points | ~4% | 6-9 months |
| 2025 | ~0.3 percentage points | ~1.7% | 3-6 months |

| Scenario | Probability (2026) | Structured Access Value | Implications |
|----------|-------------------|------------------------|--------------|
| **Frontier gap large (>6 months)** | 15-25% | High | Control remains meaningful |
...
API-based deployment enables comprehensive usage monitoring that would be impossible with open-weight releases. According to [industry surveys](https://www.moesif.com/blog/technical/api-development/How-to-Track-the-Usage-of-AI-APIs-The-Ultimate-Guide/), over 75% of enterprises experienced API-related security incidents in 2024, underscoring the importance of robust monitoring infrastructure.
...
Anthropic has implemented [sweeping new restrictions](https://www.anthropic.com/rsp-updates) that illustrate the evolution of structured access:

| Policy | Implementation | Rationale |
|--------|---------------|-----------|
| **Chinese entity block** | Global, regardless of incorporation | Prevent military/intelligence misuse |
| **50% ownership threshold** | Indirect ownership counts | Close subsidiary loopholes |
...
|--------|-----------------|------|
| [Structured Access: An Emerging Paradigm for Safe AI Deployment](https://arxiv.org/abs/2201.05159) | Defined structured access framework; chapter in Oxford Handbook of AI Governance | 2022 |
| [Structured Access for Third-Party Research on Frontier AI Models](https://cdn.governance.ai/Structured_Access_for_Third-Party_Research.pdf) | Taxonomy of system access; researcher interview findings | 2023 |
