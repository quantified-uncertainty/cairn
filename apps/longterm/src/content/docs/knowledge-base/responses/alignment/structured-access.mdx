...
<DataInfoBox entityId="structured-access" />

## Quick Assessment

| Dimension | Assessment | Evidence |
|-----------|------------|----------|
| **Market Adoption** | High (dominant for frontier) | 100% of frontier models (GPT-4, Claude, Gemini) use API-only; [enterprise LLM spend reached $8.4B](https://natlawreview.com/press-releases/enterprise-llm-spend-reaches-84b-anthropic-overtakes-openai-according-new) by mid-2025 |
...
**Key finding:** With a single top-of-the-line gaming GPU like NVIDIA's RTX 5090 (under $2,500), anyone can locally run models matching the [absolute frontier from 6-12 months ago](https://epoch.ai/data-insights/consumer-gpu-model-gap).
...
|--------|-------------|------|
| [Menlo Ventures Enterprise LLM Report](https://natlawreview.com/press-releases/enterprise-llm-spend-reaches-84b-anthropic-overtakes-openai-according-new) | Enterprise LLM spend reached $8.4B; Anthropic leads with 32% market share | 2025 |
