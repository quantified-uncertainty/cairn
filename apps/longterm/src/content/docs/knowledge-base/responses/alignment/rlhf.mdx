...
llmSummary: RLHF and Constitutional AI are the dominant techniques for aligning current language models, with InstructGPT (1.3B) outperforming GPT-3 (175B) in human evaluations. However, fundamental scalability limitations emerge at superhuman capability levels where human evaluation becomes unreliable, with effectiveness estimates of 20-40% risk reduction for current systems but uncertain scaling beyond human-level capabilities.
