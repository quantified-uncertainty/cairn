...
See the **[Safety Approaches Comparison Table](/knowledge-base/responses/safety-approaches/table/)** for a detailed side-by-side analysis of 27 safety techniques, evaluating each on safety uplift, capability uplift, differential progress, and recommendations for research investment.
...
- [Architecture Scenarios](/knowledge-base/architecture-scenarios/table/) - Different AI architecture paradigms and their safety properties
