...
description: >-
  ...
  or capability scaling. The EU AI Act mandates conformity assessments for high-risk systems with
  fines up to EUR 35M, while NIST's TEVV framework and UK AISI's Inspect tools provide evaluation
  infrastructure. Third-party evaluators like METR test autonomous capabilities, though only 3 of 7
  major labs substantively test for dangerous capabilities according to the 2025 AI Safety Index.
importance: 65
quality: 85
