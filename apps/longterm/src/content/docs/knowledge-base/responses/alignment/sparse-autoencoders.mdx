...
description: >-
  ...
  activations using sparsity constraints. Anthropic's 2024 research extracted 34
  million features from Claude 3 Sonnet with 90% interpretability scores, while
  OpenAI trained 16 million latent SAEs on GPT-4. Safety applications include
  detecting deception and manipulation features, though DeepMind's 2025 research
  found SAEs underperform simple probes on some downstream tasks.
sidebar:
  order: 12
quality: 85
importance: 75
