...
sidebar:
  order: 9
quality: 49
llmSummary: Comprehensive analysis of expert beliefs shows AI researchers estimate 5-10% median extinction risk but with extreme disagreement (0.01%-99% range), AGI timelines compressed from 50+ years in 2020 to ~15 years by 2024, and only 2% of AI research focuses on safety despite 70% of researchers believing it deserves higher priority. Systematic underestimation of capability progress by both domain experts and superforecasters raises concerns about timeline-dependent safety strategies.
...
| **Expert Disagreement** | Extreme (0.01-99%) | Range spans from Yann LeCun (less than 1%) to Roman Yampolskiy (99%); 6x gap persisted through [XPT tournament](https://forecastingresearch.org/xpt) |
| **AGI Timeline Consensus** | 2027-2031 median | [Metaculus](https://www.metaculus.com/questions/3479/date-weakly-general-ai-is-publicly-known/) median dropped from 50+ years (2020) to ~5 years (2024) |
...
**Update Frequency**: Major surveys (AI Impacts, Metaculus) updated annually; expert forecasts available continuously via prediction markets
