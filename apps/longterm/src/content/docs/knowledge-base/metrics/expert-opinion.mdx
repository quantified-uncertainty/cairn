...
sidebar:
  order: 9
quality: 72
llmSummary: "Analysis of expert surveys (2,778 researchers) reveals median 5-10% AI extinction risk but extraordinary disagreement (0.01%-99% range), AGI timeline compression from 50+ years to ~15 years post-ChatGPT, and persistent gap where 70% of researchers prioritize safety but only 2% of research addresses it. Forecasting accuracy concerns emerge from systematic underestimation of capability progress."
