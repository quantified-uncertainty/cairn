...
importance: 72.5
quality: 60
llmSummary: Comprehensive analysis tracking US-China AI competition across six dimensions finds US maintains overall lead (12:1 private investment advantage, 57% of top talent) but gap narrowing as China produces 47% of top researchers and retains 90% domestically. International governance shows 87% framework convergence across 47 countries but scores only 4.4/10 effectiveness due to non-binding nature and 53-point implementation gap, while military AI spending grows 15-20% annually and Chinese surveillance AI deployed in 80+ countries.
ratings:
  novelty: 3.5
  rigor: 6.5
  actionability: 5
...
metrics:
  ...
  diagrams: 0
---
import {R, DataExternalLinks} from '../../../../components/wiki';
