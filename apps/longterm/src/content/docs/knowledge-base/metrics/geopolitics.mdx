...
importance: 72.5
quality: 91
llmSummary: Comprehensive analysis tracking US-China AI competition across six dimensions finds US maintains overall lead (12:1 private investment advantage, 74% of global AI supercomputing, 57% of top talent) but gap narrowing dramatically—model performance differential fell from 20% to 0.3% (2023-2025) and DeepSeek captured 13% global LLM market share in 2 months. International governance shows 87% framework convergence across 47 OECD countries but scores only 4.4/10 effectiveness due to non-binding nature and 53-point implementation gap. Military AI market growing 19.5% CAGR from \$11.5B (2025) to \$28.7B (2030), with autonomous weapons market reaching \$27B by 2029. Chinese surveillance AI deployed in 80+ countries; Hikvision/Dahua control 34% of global surveillance camera market.
ratings:
  novelty: 4
  rigor: 7.5
  actionability: 6
...
metrics:
  ...
  diagrams: 1
---
import {R, DataExternalLinks, Mermaid} from '../../../../components/wiki';
