...
**Data Quality**: Mixed - High quality for jailbreaking/red-teaming metrics, medium for RLHF/honesty measures, low for <EntityLink id="interpretability-coverage">interpretability coverage</EntityLink> and corrigibility testing
