...
|-----------------|-------------------|-------------|-------------|-----------------|---------------|
| **Mechanistic Interpretability** | <EntityLink id="anthropic">Anthropic</EntityLink>, <EntityLink id="deepmind">Google DeepMind</EntityLink> | Early research | Feature extraction at scale | 3/10 | <R id="e724db341d6e0065">Sparse autoencoders on Claude 3 Sonnet</R> |
