...
3. [Interpretability](/knowledge-base/responses/alignment/interpretability/)
4. [Alignment research](/knowledge-base/responses/alignment/alignment/)
...
- [Racing dynamics](/knowledge-base/risks/structural/racing-dynamics/) intensify as [AGI timelines](/knowledge-base/forecasting/agi-timeline) compress
- Insufficient safety research to address [alignment difficulty](/knowledge-base/risks/accident/)
...
- **Pessimists**: Need 10x more researchers given [AI risk timeline](/knowledge-base/forecasting/agi-timeline)

**Research prioritization**:
- **Technical focus**: Emphasize [interpretability](/knowledge-base/responses/alignment/interpretability/), [alignment](/knowledge-base/responses/alignment/alignment/)
- **Governance focus**: Prioritize [policy interventions](/knowledge-base/responses/governance/), [coordination](/ai-transition-model/parameters/international-coordination)
