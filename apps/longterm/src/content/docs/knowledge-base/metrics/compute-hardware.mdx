...
llmSummary: Comprehensive synthesis finding NVIDIA holds 80-90% AI accelerator market share, training compute grows 4-5x annually, algorithmic efficiency doubles every 8 months (faster than Moore's Law), and AI power consumption reached 40 TWh in 2024 (15% of data centers, projected 945 TWh by 2030). China lags 1-2 node generations with SMIC 7nm vs TSMC 3nm, constrained by 20-50% yields and HBM supply exhaustion expected end-2025.
ratings:
  novelty: 4.2
  rigor: 6.8
  actionability: 6.5
...
metrics:
  ...
  diagrams: 1
---
import {R, Mermaid, DataExternalLinks} from '../../../../components/wiki';
...
|-----------|------------|----------|
| **Data Completeness** | High for public metrics | <R id="b029bfc231e620cc">Epoch AI</R>, <R id="a2dfd6cfecb65be8">IEA reports</R>, company filings |
