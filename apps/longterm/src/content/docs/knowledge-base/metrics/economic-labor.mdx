...
importance: 42
quality: 50
llmSummary: "Comprehensive compilation of AI economic metrics showing $202B in VC investment (2025), 30% job automation risk by 2030, and McKinsey's $1.6-4.4T annual economic value estimate for GenAI. Data extensively sourced from Stanford AI Index, McKinsey, BLS, and OECD with explicit uncertainty ranges and methodological notes."
ratings:
  novelty: 2
  rigor: 5.5
  actionability: 3
