...
llmSummary: "Comprehensive tracking of 10 measurable indicators of AI lab safety practices finds concerning trends: 53% average compliance with voluntary commitments, evaluation windows compressed from months to days, 25+ senior safety departures from OpenAI in 2024, and major models released without promised safety documentation. The open-closed capability gap has narrowed from 16 months to 3 months (2024-2025)."
ratings:
  novelty: 6.5
  rigor: 7
  actionability: 6
