...
importance: 42.5
quality: 52
llmSummary: Comprehensive synthesis of 2023-2025 public opinion data showing AI concern rising rapidly (37%→50%), but only 12% aware of existential risk unprompted despite 69% supporting development pause. Trust in AI declining across metrics (companies 50%→47%, systems 31% trust), with 62% lacking confidence in government regulation, though 80% want safety prioritized over speed.
ratings:
  novelty: 3.5
  rigor: 6.5
  actionability: 4
