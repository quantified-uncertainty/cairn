...
sidebar:
  order: 8
quality: 57
llmSummary: Comprehensive review of AI persuasion capabilities showing GPT-4 achieves 15-20% political opinion shifts and personalized messaging is 2.3x more effective than generic approaches. Documents critical risks for deceptive alignment (AI convincing operators not to shut down), democratic interference, and mass manipulation with both technical countermeasures and policy approaches.
