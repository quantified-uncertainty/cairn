...
sidebar:
  order: 8
quality: 62
llmSummary: "GPT-4 demonstrates superhuman persuasion in controlled settings (64% win rate, 81% higher odds with personalization), with post-training optimization boosting effectiveness 51% while significantly decreasing factual accuracy. AI chatbots showed 4x the impact of political ads in 2024 elections, with frontier models classified in elevated risk \"yellow zone\" by safety evaluations."
