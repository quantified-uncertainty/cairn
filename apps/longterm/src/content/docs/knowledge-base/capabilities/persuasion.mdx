...
sidebar:
  order: 8
quality: 91
llmSummary: Comprehensive review of AI persuasion capabilities showing GPT-4 achieves 64% win rate against humans in debates with personalization (Nature Human Behaviour 2025), while post-training optimization boosts persuasiveness by 51% at the cost of factual accuracy (Science 2025). Documents critical risks for deceptive alignment, democratic interference, and mass manipulation, with evidence from 76,977-participant studies and real-world election impacts in 38+ countries.
...
|----------|---------|--------|--------|
| Biden robocall deepfake | US (Jan 2024) | 25,000 voters targeted; $6M FCC fine | [Recorded Future](https://www.recordedfuture.com/research/targets-objectives-emerging-tactics-political-deepfakes) |
...
Notable enforcement: The FCC issued a $6 million fine for the [2024 Biden robocall deepfake](https://www.recordedfuture.com/research/targets-objectives-emerging-tactics-political-deepfakes), with criminal charges filed against the responsible consultant.
