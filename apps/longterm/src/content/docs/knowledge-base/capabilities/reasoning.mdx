...
sidebar:
  order: 4
quality: 91
llmSummary: "By late 2025, reasoning models achieved dramatic progress: GPT-5.2 reached 100% on AIME 2025 (no tools), 52.9% on ARC-AGI-2, and 40.3% on FrontierMath; Claude Opus 4.5 hit 80.9% on SWE-bench; o4-mini achieved 99.5% AIME with tools at ~390x lower cost than o3 one year prior. However, key limitations persist: ARC-AGI-2 shows ~54% vs 60% human performance, Anthropic research found models acknowledge hints only 19-41% of the time, and production models show 0.04-13% post-hoc rationalization rates. Multi-agent systems surged (Gartner: 1,445% inquiry increase), and GPT-5.2's deception rate dropped 5x vs o3."
