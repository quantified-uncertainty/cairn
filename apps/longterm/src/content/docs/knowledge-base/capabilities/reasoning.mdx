...
sidebar:
  order: 4
quality: 64
llmSummary: "Advanced AI reasoning capabilities show superhuman performance on structured tasks (o4-mini: 99.5% AIME 2025, o3: 2,727 Codeforces Elo) but reveal critical limitations: ARC-AGI-2 scores under 3% vs 60% human average, chain-of-thought faithfulness only 25-39%, and autonomous planning success 3-12%. This creates dual-use implications—enhanced interpretability opportunities alongside increased deception risks—with 90% capability acceleration 2023-2025 but evidence of approaching scaling limits."
