...
sidebar:
  order: 4
quality: 65
llmSummary: "Current AI reasoning models achieve superhuman performance on structured tasks (o4-mini: 99.5% AIME 2025, o3: 2,727 Codeforces Elo) but show critical limitations: ARC-AGI-2 reveals <3% vs 60% human performance on harder abstract reasoning, autonomous planning succeeds only 3-12%, and chain-of-thought faithfulness is merely 25-39%. This creates both interpretability opportunities and deception risks, with Epoch AI showing 90% capability acceleration 2023-2025 but evidence suggesting current approaches may be hitting limits."
