...
sidebar:
  order: 1
quality: 57
llmSummary: "Comprehensive technical overview documenting LLM progression from GPT-2 (1.5B parameters, 2019) to o3 (87.5% ARC-AGI, 2024), with quantified capability metrics, scaling laws (performance ∝ N^0.076), and risk assessments across persuasion (82% agreement increase), hallucination (8-45% rates), and emerging autonomous capabilities. Training costs growing 2.4x annually toward $1B by 2027, with paradigm shift to inference-time scaling in o1/o3 enabling PhD-level reasoning but at 6x cost and 30x slower speed."
