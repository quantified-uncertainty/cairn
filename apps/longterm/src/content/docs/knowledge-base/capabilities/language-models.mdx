...
sidebar:
  order: 1
quality: 91
llmSummary: Comprehensive analysis of LLM capabilities showing predictable scaling laws (10x compute → 1.4x performance) alongside unpredictable emergence, with training costs growing 2.4x annually (projected to exceed $1B by 2027) while inference costs dropped 280x since 2022. Documents progression from GPT-2 (1.5B, 2019) through o3 (2024) achieving 87.7% on GPQA Diamond and 87.5% on ARC-AGI (near human baseline), though only 3% on ARC-AGI-2. Covers the 2024-2025 shift to inference-time scaling, with Stanford AI Index 2025 showing benchmark improvements of 18-67 percentage points in one year and US-China performance gap narrowing from 17.5 to 0.3 points on MMLU.
...
| **Inference Cost Trend** | 280x reduction since 2022 | GPT-3.5-equivalent dropped from $20 to $0.07 per million tokens ([Stanford HAI](https://hai.stanford.edu/ai-index/2025-ai-index-report)) |
...
| **Safety Maturity** | Moderate | Constitutional AI, RLHF established; [responsible scaling policies](https://www.anthropic.com/news/anthropics-responsible-scaling-policy) implemented by major labs |
