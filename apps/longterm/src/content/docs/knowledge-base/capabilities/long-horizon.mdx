...
sidebar:
  order: 6
quality: 70
llmSummary: "METR research shows AI task completion horizons doubling every 7 months (accelerated to 4 months in 2024-2025), with Claude 3.7 achieving ~1 hour autonomy and Claude Opus 4.5 reaching 80.9% on SWE-bench Verified. The capability transition from 1-hour to week-long autonomy (projected 2027-2028) creates critical safety risks through oversight breakdown (100-1000x decision volume increase), goal drift, and power accumulation pathways, with 80% of deploying organizations already reporting risky agent behaviors."
