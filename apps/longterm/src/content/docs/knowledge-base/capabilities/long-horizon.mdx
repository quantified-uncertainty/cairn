...
sidebar:
  order: 6
quality: 66
llmSummary: Long-horizon autonomy (AI operating autonomously for hours to weeks) represents a critical safety threshold where current systems achieve 1-2 hour reliability with 43.8% success on real software tasks, but days-to-weeks operation remains out of reach. The capability fundamentally transforms oversight mechanisms (100-1000x more decisions to review) and enables power accumulation pathways, with capability development projected to outpace safety research by 1-2 years through 2025-2027.
...
|--------------|-------------|-------------------|---------------------|
| <EntityLink id="openai">OpenAI</EntityLink> | GPT-4, o1 series | 2-4 hours with scaffolding | Advanced reasoning, tool use |
| <EntityLink id="anthropic">Anthropic</EntityLink> | Claude 3.5, Computer Use | 1-3 hours | Computer control, safety focus |
| <EntityLink id="deepmind">DeepMind</EntityLink> | Gemini, AlphaCode | Experimental long-horizon | Research agent prototypes |
