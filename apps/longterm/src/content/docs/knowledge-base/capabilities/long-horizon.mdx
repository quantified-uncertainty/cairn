...
sidebar:
  order: 6
quality: 65
llmSummary: "METR research demonstrates AI task horizons doubling every 7 months (accelerated to 4 months in 2024-2025), with current systems achieving ~1-2 hour autonomous operation. Claude Opus 4.5 reaches 80.9% on SWE-bench Verified; extrapolation suggests week-long autonomy by 2027-2028, creating severe oversight challenges as 80% of organizations already report risky agent behaviors."
