...
sidebar:
  order: 6
quality: 91
llmSummary: Long-horizon autonomy (AI operating autonomously for hours to weeks) represents a critical safety threshold where current systems achieve 1-2 hour reliability with 80.9% success on SWE-bench Verified (Claude Opus 4.5), but days-to-weeks operation remains out of reach. METR research shows task horizons doubling every 7 months since 2019, accelerating to 4-month doubling in 2024-2025. The capability fundamentally transforms oversight mechanisms (100-1000x more decisions to review) and enables power accumulation pathways, with capability development projected to outpace safety research by 1-2 years through 2025-2027. 80% of organizations already report risky AI agent behaviors.
