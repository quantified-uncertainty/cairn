...
sidebar:
  order: 10
quality: 66
llmSummary: "AI systems achieved superhuman performance in protein structure prediction (214M structures via AlphaFold), materials discovery (2.2M crystals in 17 days vs. 800 years traditional), and drug discovery (80-90% Phase I success vs. 40-65% baseline), with Sakana's AI Scientist producing peer-reviewed papers for $15 each. Timeline compression from 5+ years to 18 months in drug discovery and near-doubling of AI capability improvement rates (8→15 points/year) create urgent dual-use governance challenges, particularly for bioweapons development and recursive AI self-improvement."
