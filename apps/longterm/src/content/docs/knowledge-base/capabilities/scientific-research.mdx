...
sidebar:
  order: 10
quality: 66
llmSummary: "AI scientific research capabilities have achieved superhuman performance in protein folding (AlphaFold: 214M structures), materials discovery (GNoME: 2.2M crystals in 17 days vs. 800 years traditional), and drug development (80-90% Phase I success vs. 40-65% baseline, 18-month vs. 5+ year timelines). Sakana's AI Scientist produces peer-reviewed papers for $15 each, while dual-use risks create severe biosecurity concerns and could compress AI development timelines by enabling recursive self-improvement."
