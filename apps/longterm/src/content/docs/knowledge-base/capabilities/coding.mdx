...
sidebar:
  order: 9
quality: 59
llmSummary: "AI coding capabilities reached 70-76% on curated benchmarks (SWE-bench Verified) but only 23-44% on complex tasks, with 46% of code now AI-written across 15M+ developers and 55.8% faster development cycles. Critical risks include 45% vulnerability rate in AI code, compressed AI development timelines (2-5x acceleration), and emerging recursive self-improvement pathways as AI systems increasingly contribute to their own development infrastructure."
