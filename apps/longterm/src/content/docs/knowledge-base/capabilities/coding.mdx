...
sidebar:
  order: 9
quality: 59
llmSummary: "AI coding capabilities have reached 70-76% on curated benchmarks (23-44% on complex tasks) with 46% of code now AI-written, creating 55.8% faster development cycles that compress AI safety timelines. Major risks include 45% vulnerability rates in AI code, emerging recursive self-improvement pathways as AI contributes to its own development infrastructure, and dual-use concerns around automated exploit generation."
