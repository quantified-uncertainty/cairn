...
sidebar:
  order: 7
quality: 70
llmSummary: "Comprehensive analysis of AI self-improvement trajectories from current AutoML systems to theoretical intelligence explosion scenarios. Evidence shows AlphaEvolve achieving 23-32.5% training speedups (2025), Darwin Godel Machine improving SWE-bench from 20% to 50% via self-modification, and METR measuring 7-month doubling time for AI task completion horizons. ~50% estimated probability that software feedback loops could drive accelerating progress, though compute bottlenecks and diminishing returns suggest constraints on explosive takeoff. ICLR 2026 Workshop on Recursive Self-Improvement signals growing academic attention to this capability trajectory."
...
| **Competitive programming** | o3 (2024-2025) | 2706 ELO (top 200 globally) | Exceeds most professional programmers | Near saturation |
