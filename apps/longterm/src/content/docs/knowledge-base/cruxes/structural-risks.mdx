...
ratings:
  ...
  actionability: 6.5
  completeness: 7.1
llmSummary: "Comprehensive analysis of 12 structural risk cruxes with quantified probability ranges: US-China coordination 15-50% feasible, winner-take-all dynamics 30-45% likely, racing manageable at 35-45%. Positions on foundational questions (whether structural risks are distinct from accident/misuse at 40-55%) cascade into concrete intervention priorities across governance, technical safety, and defensive measures."
...
metrics:
  ...
  diagrams: 1
---
import {Crux, CruxList, Mermaid, R, DataExternalLinks} from '../../../../components/wiki';
