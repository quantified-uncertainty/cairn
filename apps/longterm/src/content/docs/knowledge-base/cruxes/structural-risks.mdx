...
ratings:
  ...
  actionability: 6.5
  completeness: 6
llmSummary: "Analyzes 12 cruxes across structural AI risks using probability ranges: finds US-China coordination achievable at 15-30%, winner-take-all dynamics at 30-45% likely, and racing dynamics manageable at 35-45%. Provides decision framework linking foundational positions (whether structural risks are distinct) to strategic priorities (governance interventions vs. technical solutions vs. defensive measures)."
