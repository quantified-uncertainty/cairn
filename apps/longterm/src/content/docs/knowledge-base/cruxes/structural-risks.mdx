...
ratings:
  ...
  actionability: 4
  completeness: 4
llmSummary: "Analyzes 12 key uncertainties determining views on AI structural risks, finding US-China coordination at 15-50% probability, winner-take-all dynamics at 30-45% likely, and racing dynamics manageable at 35-45%. Provides decision framework showing how positions on foundational questions cascade into different strategic priorities (governance interventions vs. defensive measures vs. technical safety focus)."
