...
sidebar:
  order: 1
quality: 91
llmSummary: Comprehensive synthesis of AI safety research cruxes based on 2019-2025 surveys and empirical research, revealing that safety researchers estimate 35-55% vs 15-25% probability for mesa-optimization and 30-50% vs 15-30% for deceptive alignment. Key 2024-2025 findings include Sleeper Agents persistence through safety training, detection probes achieving greater than 99% AUROC, situational awareness advancing rapidly (Sonnet 4.5 detects evaluation 58% of time), and process supervision deployed in OpenAI o1 models (78.2% vs 72.4% on MATH). Provides actionable research prioritization matrix and investment allocation data ($70-115M annually in AI safety research).
...
|-----------|------------|----------|
| **Consensus Level** | Low (20-40 percentage point gaps) | [2025 Expert Survey](https://arxiv.org/html/2502.14870v1): Only 21% of AI experts familiar with "instrumental convergence"; 78% agree technical researchers should be concerned about catastrophic risks |
...
| **Mesa-Optimization** | 15-55% probability | Theoretical concern; no clear empirical detection in frontier models per [MIRI research](https://intelligence.org/learned-optimization/) |
| **Deceptive Alignment** | 15-50% probability | [Anthropic Sleeper Agents (2024)](https://arxiv.org/abs/2401.05566): Backdoors persist through safety training; 99% AUROC detection with probes |
| **Situational Awareness** | Emerging rapidly | [SAD Benchmark](https://situational-awareness-dataset.org/): Claude 3.5 Sonnet best performer; Sonnet 4.5 detects evaluation 58% of time |
| **Research Investment** | ~$30-60M/year | [Open Philanthropy](https://www.openphilanthropy.org/funding-for-ai-alignment-projects-working-with-deep-learning-systems/): $16.6M in alignment grants; [OpenAI Superalignment](https://openai.com/index/superalignment-fast-grants/): $10M fast grants |
...
|---------------|-------------------|-------------|-----------------|
| **Interpretability** | $20-30M | [Open Philanthropy](https://www.openphilanthropy.org/), Anthropic, OpenAI | 80-120 |
...
| **Control & Containment** | $5-10M | Redwood Research, academic groups | 20-30 |
| **Governance Research** | $10-15M | GovAI, CSET, FHI | 40-60 |
| **Total AI Safety** | ~$70-115M | Multiple | 260-400 |

For context, U.S. private sector AI investment exceeded [$109 billion in 2024](https://www.nitrd.gov/ai-rd-investments/), while federal AI R&D was approximately $3.3 billion. Safety-specific research represents less than 0.1% of total AI investment—a ratio many safety researchers consider dangerously low given the stakes involved.
