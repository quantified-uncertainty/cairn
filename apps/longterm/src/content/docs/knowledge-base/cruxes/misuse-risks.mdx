...
sidebar:
  order: 2
quality: 91
llmSummary: Comprehensive synthesis of 13 key uncertainties determining AI misuse risk prioritization, structured around capability uplift (30-45% see significant vs 35-45% modest), offense-defense balance across domains, and mitigation effectiveness. Integrates quantified evidence from 2024-2025 studies including RAND's bio uplift finding (no significant difference), OpenAI's cyber capability jump (27%→87% on CTF benchmarks in 4 months), deepfake fraud rising 2,137% since 2022, and AI incident reports growing 8x since 2022, with probability distributions for each crux position.
...
|-----------|------------|----------|
| **Overall Severity** | High | AI misuse incidents rose 8x since 2022; deepfakes responsible for 6.5% of all fraud ([AI Incident Database](https://incidentdatabase.ai/)) |
| **Current Uplift Evidence** | Mixed | RAND 2024 bioweapons study found no significant uplift; OpenAI cyber CTF scores improved 27% to 87% in 4 months ([RAND](https://www.rand.org/pubs/research_reports/RRA2977-2.html), [OpenAI](https://openai.com/index/strengthening-cyber-resilience/)) |
...
| **Disinformation Risk** | High | Deepfake fraud up 2,137% since 2022; human detection accuracy only 24.5% ([UNESCO](https://www.unesco.org/en/articles/deepfakes-and-crisis-knowing)) |
