...
sidebar:
  order: 2
quality: 61
llmSummary: "Comprehensive survey of 13 key uncertainties determining AI misuse risk prioritization, synthesizing evidence from RAND (no significant bio uplift in 2024 red-team), OpenAI (cyber CTF 27%→87% in 4 months), and deepfake research (8M projected files by 2025, human detection 24.5%). Finds mixed evidence on capability uplift (30-45% see significant vs 35-45% modest), cyber offense accelerating faster than defense, and deepfake detection losing to generation—informing whether to prioritize access restrictions vs defensive investment."
