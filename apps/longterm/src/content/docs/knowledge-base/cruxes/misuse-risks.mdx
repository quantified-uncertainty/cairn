...
sidebar:
  order: 2
quality: 68
llmSummary: Comprehensive synthesis of 13 key uncertainties determining AI misuse risk prioritization, structured around capability uplift (30-45% see significant vs 35-45% modest), offense-defense balance across domains, and mitigation effectiveness. Integrates quantified evidence from 2024-2025 studies including RAND's bio uplift finding (no significant difference), OpenAI's cyber capability jump (27%→76% on CTF benchmarks in 3 months), and deepfake proliferation (500K→8M files), with probability distributions for each crux position.
...
metrics:
  ...
  diagrams: 0
---
import {Crux, CruxList, DataInfoBox, Backlinks, R, EntityLink, DataExternalLinks} from '../../../../components/wiki';
