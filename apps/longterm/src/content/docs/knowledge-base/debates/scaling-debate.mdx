...
llmSummary: "The scaling debate between optimists (Altman, Amodei) and skeptics (LeCun, Chollet, Marcus) is partially resolving toward 'scaling-plus': pure pretraining hit ceilings (GPT-5 delayed 2 years), but reasoning models (o1, o3) opened new scaling regimes. Key evidence: o3 achieved 87.5% on ARC-AGI-1, but ARC-AGI-2 remains under 5% for all models while humans score 100%. About 75% of AI experts believe pure LLM scaling won't reach AGI, though many believe scaling reasoning could work."
ratings:
  novelty: 5.5
  rigor: 6.5
  actionability: 5
...
| **Investment Level** | \$500B+ committed through 2029 | [Stargate Project](https://openai.com/index/announcing-the-stargate-project/): OpenAI, SoftBank, Oracle joint venture |
