...
importance: 54
quality: 33
llmSummary: "Comprehensive overview of AGI timeline predictions ranging from 2-5 years (short timelines, ~25% probability) to never with current approaches (~10% probability), with median expert opinion around 2030-2040. Key cruxes include whether scaling alone suffices, data wall constraints, and trust in lab leader predictions, with wide uncertainty reflecting deep disagreement on fundamental questions about intelligence and progress trajectories."
ratings:
  novelty: 2.5
  rigor: 3.5
  actionability: 4
...
metrics:
  ...
  diagrams: 0
---
import {DisagreementMap, InfoBox, KeyQuestions, TimelineViz, DataExternalLinks} from '../../../../components/wiki';
