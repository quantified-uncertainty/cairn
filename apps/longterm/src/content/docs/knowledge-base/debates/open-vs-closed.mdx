...
description: The safety implications of releasing AI model weights publicly versus keeping them proprietary. The 2024 NTIA report concluded evidence is insufficient to warrant restrictions on open-weight models, while Carnegie research finds emerging consensus that open release is a positive feature despite risks.
sidebar:
  order: 3
importance: 58.5
quality: 3
lastEdited: "2025-01-28"
llmSummary: Comprehensive overview of the open vs closed source AI debate, mapping key positions from major labs and technical cruxes around safety guardrails, leakage likelihood, and capability thresholds. Presents staged release and structured access as middle-ground proposals, with different implications for misuse (favors closed), accidents (mixed), and power concentration (favors open).
ratings:
  novelty: 2.5
  rigor: 3
  actionability: 4.5
  completeness: 5
---
import {ComparisonTable, DisagreementMap, InfoBox, KeyQuestions, DataExternalLinks} from '../../../../components/wiki';
...
**EU AI Act:** Takes a risk-based approach with stricter rules for "foundation models" regardless of openness. France, Germany, and Italy initially opposed applying strict rules to open models, citing innovation concerns.
