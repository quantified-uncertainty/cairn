...
llmSummary: Comprehensive analysis of the open vs closed source AI debate with quantified market data (11-13% enterprise open-source share, down from 19%), safety research (jailbreak-tuning removes guardrails in hours; 100% bypass rates for some attacks), and regulatory landscape (NTIA cautiously pro-open; EU exemptions for non-systemic models). Maps stakeholder positions and presents middle-ground proposals with effectiveness estimates.
ratings:
  novelty: 4
  rigor: 5
  actionability: 5
...
| **Global AI spending** | $37B in 2025 | [Menlo Ventures](https://menlovc.com/perspective/2025-the-state-of-generative-ai-in-the-enterprise/) | 3.2x YoY increase from $11.5B |
| **DeepSeek R1 training cost** | Under $6 million | [World Economic Forum](https://www.weforum.org/stories/2025/02/open-source-ai-innovation-deepseek/) | 90-95% below Western frontier models |
