...
importance: 92.5
quality: 70
llmSummary: "Comprehensive formal argument for AI existential risk structured around four premises: capabilities will advance (strong evidence from scaling laws), alignment is hard (moderate-strong evidence from reward hacking and orthogonality thesis), misaligned AI is dangerous (instrumental convergence, capability advantage), and alignment may not be solved in time (key uncertainty). Expert surveys find median 5-14% extinction probability by 2100; Anthropic predicts powerful AI by late 2026/early 2027. Safety funding (~$180-200M/year) represents <1% of capabilities investment (~$100B+/year)."
