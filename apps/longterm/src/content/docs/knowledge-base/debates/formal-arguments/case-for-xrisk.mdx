...
importance: 85
quality: 64
llmSummary: "Comprehensive formal argument for AI x-risk structured around four premises: capabilities will advance, alignment is hard, misalignment is dangerous, and we may not solve it in time. Expert surveys find median 5-14% extinction probability by 2100, with safety funding (~$180-200M annually) representing less than 1% of capabilities investment ($100B+)."
