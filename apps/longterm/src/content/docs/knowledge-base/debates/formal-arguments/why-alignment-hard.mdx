...
|--------|------------------|---------------|--------|
| <EntityLink id="eliezer-yudkowsky">Eliezer Yudkowsky</EntityLink> (MIRI) | ≈95% | Optimization generalizes while corrigibility is "anti-natural"; current approaches orthogonal to core difficulties | <R id="361870712c6c16e3"><EntityLink id="lesswrong">LessWrong</EntityLink> surveys</R> |
