...
llmSummary: "Comprehensive synthesis of skeptical arguments against AI x-risk from prominent researchers (LeCun, Marcus, Ng, Brooks), estimating existential risk at ~2% based on conjunction of challenged premises: scaling plateaus (AAAI: 76% doubt AGI via scaling), alignment-by-default from RLHF, human control mechanisms, and tractable safety progress. Analyzes six types of skepticism, survey data (median 5% p(doom)), and methodological critiques of x-risk community reasoning."
ratings:
  novelty: 3.5
  rigor: 4
  actionability: 2.5
...
metrics:
  ...
  diagrams: 2
---
import {InfoBox, Mermaid, R, DataExternalLinks} from '../../../../../components/wiki';
