...
llmSummary: "Comprehensive overview of the AI pause debate sparked by FLI's 2023 open letter (33,000+ signatures), mapping positions from e/acc opposition to Yudkowsky's indefinite pause. Expert support is moderate (35% favor slower development) while public support is high (72%). Key cruxes include multilateral coordination feasibility and safety progress during pauses. Identifies middle-ground alternatives (RSPs adopted by Anthropic/OpenAI/DeepMind, compute governance, Seoul Summit commitments) as having more traction than pause proposals. Historical precedents (Asilomar 1975, nuclear treaties) offer mixed lessons. 2025 developments: US Senate rejected 10-year moratorium 99-1; 1,000+ state AI bills; EU AI Act proceeding without pause. Concludes current conditions for effective pause (multilateral buy-in, verification, enforcement) are largely unmet."
ratings:
  novelty: 4
  rigor: 6
  actionability: 5
...
metrics:
  ...
  diagrams: 1
---
import {DisagreementMap, InfoBox, KeyQuestions, DataExternalLinks, Mermaid} from '../../../../components/wiki';
...
In March 2023, the [Future of Life Institute](https://futureoflife.org/open-letter/pause-giant-ai-experiments/) published an open letter calling for a 6-month pause on training AI systems more powerful than GPT-4. The letter garnered over 33,000 signatures, including Turing Award winners Yoshua Bengio and prominent figures like Elon Musk and Steve Wozniak. It ignited fierce debate: Is pausing AI development necessary for safety, or counterproductive and infeasible?
...
| Alternative Adoption | **Medium** | RSPs adopted by Anthropic, OpenAI, Google DeepMind; [EU AI Act](https://digital-strategy.ec.europa.eu/en/policies/regulatory-framework-ai) proceeding |
