...
llmSummary: "Comprehensive comparison of government regulation versus industry self-governance for AI, documenting that AI lobbying surged 141% to 648 companies in 2024, EU AI Act imposes fines up to €35M/7% turnover, and RAND found significant regulatory capture risk with industry dominating US policy conversations. Concludes hybrid approaches combining government accountability with industry technical expertise are most realistic, though international coordination remains weak."
ratings:
  novelty: 3.5
  rigor: 6
  actionability: 4.5
...
| **Industry Lobbying** | Surging | [648 companies lobbied on AI in 2024](https://www.opensecrets.org/news/2024/06/lobbying-on-ai-reaches-new-heights-in-2024/) vs. 458 in 2023 (141% increase); OpenAI spending rose from \$160K to \$1.76M |
