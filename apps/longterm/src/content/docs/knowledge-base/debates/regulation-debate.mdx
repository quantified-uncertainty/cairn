...
llmSummary: "Comprehensive analysis of AI regulation debate with quantified evidence: EU AI Act penalties up to €35M/7% turnover (2024), US federal AI regulations doubled to 59 in 2024, AI lobbying surged 141% (648 companies), and voluntary commitments cover 16 companies but remain unenforceable. RAND study documents regulatory capture concerns. Compares approaches across US, EU, China, UK with specific penalty structures and compliance requirements."
ratings:
  novelty: 4
  rigor: 5
  actionability: 5
...
metrics:
  ...
  diagrams: 1
---
import {ComparisonTable, DisagreementMap, InfoBox, KeyQuestions, DataExternalLinks, Mermaid} from '../../../../components/wiki';
...
|-----------|------------|----------|
| **Regulatory Activity** | Rapidly increasing | [US federal agencies introduced 59 AI regulations in 2024](https://hai.stanford.edu/ai-index/2025-ai-index-report)—more than double 2023; EU AI Act entered force August 2024 |
| **Industry Lobbying** | Surging | [648 companies lobbied on AI in 2024](https://www.opensecrets.org/news/2024/06/lobbying-on-ai-reaches-new-heights-in-2024/) vs. 458 in 2023 (141% increase); OpenAI spending rose from $260K to $1.76M |
...
| [OpenAI lobbying spend](https://www.technologyreview.com/2025/01/21/1110260/openai-ups-its-lobbying-efforts-nearly-seven-fold/) | $260,000 | $1.76 million | +577% |
| OpenAI + Anthropic + Cohere combined | $610,000 | $2.71 million | +344% |
