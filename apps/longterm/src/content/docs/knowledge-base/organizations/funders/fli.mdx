...
sidebar:
  order: 7
quality: 72
llmSummary: "Documents FLI as a high-profile AI safety advocacy organization that has distributed $25M+ in grants and organized influential initiatives like the Asilomar AI Principles (5,700+ signatories) and 2023 pause letter (33,000+ signatories). Covers founding history (2014 launch at MIT), major conferences (Puerto Rico 2015, Asilomar 2017), grant programs ($7M in first round to 37 projects including MIRI, Berkeley, FHI), policy work (EU AI Act, UN autonomous weapons), and controversies ($665.8M Buterin donation, pause letter criticism from Gebru and Mitchell)."
...
| **Open Phil Supplement** | \$1.186M | Additional projects | Open Philanthropy | High-quality proposals exceeding initial funding |
...
| **Philanthropy** | Founder, [Survival and Flourishing Fund](/knowledge-base/organizations/funders/sff); co-founder, Cambridge Centre for the Study of Existential Risk (CSER) |
...
| **Open Philanthropy** | \$1.9M total | Various | Supplemental grant funding, operational support |
...
|--------|--------|---------|
| **Open Philanthropy** | \$1.186M (2015) | Supplement to Musk grants (high-quality proposals exceeded funding) |
| **Open Philanthropy** | Additional grants | Various operational support |
...
| Aspect | FLI | MIRI | CAIS | Open Philanthropy | CSER |
|--------|-----|------|------|-------------------|------|
...
FLI occupies a distinct niche: high-profile public advocacy combined with grantmaking and policy engagement. While MIRI focuses on technical research and Open Philanthropy on behind-the-scenes grantmaking, FLI prioritizes visibility and discourse-shaping. This creates both advantages (media influence, policy access) and disadvantages (controversy, perception of sensationalism).
...
- [Open Philanthropy: FLI AI Risk Reduction Grant (2015)](https://www.openphilanthropy.org/grants/future-of-life-institute-artificial-intelligence-risk-reduction/)
