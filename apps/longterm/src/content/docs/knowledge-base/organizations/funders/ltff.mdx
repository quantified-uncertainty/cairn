...
description: "LTFF is a regranting program under EA Funds that has distributed over $20 million since 2017, with approximately $10 million going to AI safety work. The fund provides fast, flexible funding primarily to individual researchers through grants with a median size of $25K, compared to Open Philanthropy's median of $257K. In 2023, LTFF granted $6.67M total with a 19.3% acceptance rate. The fund has been an early funder of notable projects including Manifold Markets ($200K in 2022), David Krueger's AI safety lab at Cambridge ($200K), and numerous MATS scholars, serving as a crucial stepping stone for researchers before receiving larger institutional grants."
sidebar:
  order: 3
quality: 72
llmSummary: "LTFF has distributed over $20M since 2017, with ~$10M going to AI safety. The fund provides fast, flexible funding to individuals with median grants of $25K (vs Open Phil's $257K median). In 2023-2024, LTFF granted $5.36M with 19.3% acceptance. Notable grants include Manifold Markets ($200K), David Krueger's Cambridge lab ($200K), and MATS scholars. The fund is managed by permanent fund managers (Caleb Parikh as interim chair, Oliver Habryka, Linchuan Zhang) plus rotating guest managers. LTFF serves as a crucial stepping stone for researchers—many grantees later join Anthropic, DeepMind, or receive Open Phil funding."
...
| **Grant Size** | Small | Median \$25K (vs Open Phil median \$257K) |
...
| **Pipeline Role** | Critical | Many grantees later join major labs or receive Open Phil funding |
...
LTFF has weathered significant funding disruption following the FTX collapse in late 2022, which affected the broader EA funding ecosystem. The fund has since stabilized with approximately 40-50% of funding coming from Open Philanthropy and the remainder from direct donations and other institutional sources. Despite these challenges, LTFF has maintained steady grantmaking volume of approximately \$5-8 million annually.
...
| **Large organizational grants** | Better suited to Open Phil or SFF |
...
| **2023-present** | Caleb Parikh (interim) | Asya stepped down to reduce Open Phil overlap |

Asya Bergal [stepped down from the chair role](https://forum.effectivealtruism.org/posts/ee8Pamunhqabucwjq/long-term-future-fund-ask-us-anything-september-2023) in late 2023 to reduce overlap between Open Philanthropy (where she works as a Program Associate) and LTFF.
...
|--------|------------------|--------------|-------|-------------------|
| **Open Philanthropy** | \$70M+ (2022) | \$257K | Organizations, large projects | Proactive research, RFPs |
...
| **Organization seeking \$500K+ annual budget** | Open Phil or SFF | Too large for LTFF; need institutional funder |
...
| **Policy/governance organization** | Open Phil | Needs diverse funder base for credibility |
...
| **Large academic lab funding** | Open Phil or SFF | \$200K+ grants more common there |

### Funding Relationships

| Relationship | Description |
|--------------|-------------|
| **LTFF ← Open Phil** | ~40-50% of LTFF funding comes from Open Phil regranting |
| **LTFF → Open Phil** | Many LTFF grantees later receive Open Phil funding |
...
flowchart TD
    ...
    OUTCOMES --> OP[Open Phil Grant<br/>\$100K-\$1M+]
...
| **Institutional Funding** | ~40-50% from Open Phil | ~80% from Open Phil |
...
|----------|-------------|----------|
| **Speed** | Much faster than major foundations | 21-day target vs months at Open Phil |
...
| **Individual Focus** | Less suited for large organizations | Refer to Open Phil or SFF for large orgs |
| **Concentration** | Heavy AI safety focus; other x-risks less funded | Apply to specialized funds for non-AI work |
| **Funding Dependency** | ~40-50% from Open Phil | Diversified direct donation base |
...
|-----------|-------------|
| **Grantmaker Bottleneck** | As [Open Phil staff noted](https://forum.effectivealtruism.org/posts/XdhwXppfqrpPL2YDX/an-overview-of-the-ai-safety-funding-situation), "a key bottleneck is that they currently don't have enough qualified AI Safety grantmakers to hand out money fast enough" |
...
|--------|------------|-------|
| **Open Philanthropy** | ~40-50% | Regranting arrangement; largest single source |
...
- [Open Philanthropy AI Safety Grants](https://www.openphilanthropy.org/focus/potential-risks-advanced-artificial-intelligence/)
