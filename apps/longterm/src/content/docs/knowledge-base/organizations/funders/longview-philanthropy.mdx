...
sidebar:
  order: 6
quality: 72
llmSummary: "Longview Philanthropy has directed $140M+ to longtermist causes since 2018, with $89M+ specifically for AI risk reduction. Founded by Natalie Cargill (former Oxford scholar and human rights barrister), the organization serves UHNW donors through bespoke advisory while operating public funds including the Emerging Challenges Fund and Frontier AI Fund. Key funders include Open Philanthropy ($20M+ in grants), Justin Rockefeller, and the Crowley family. Their AI grantmaking team (led by Aidan O'Gara and Zach Freitas-Groff) has funded METR, CHAI, FAR AI, and policy work on the EU AI Act. Longview became independent from Effective Ventures Foundation with separate UK (Longview Inc. Ltd) and US (Longview Philanthropy USA Inc.) entities."
...
| **Key Funders** | [Open Philanthropy](https://www.openphilanthropy.org/grants/longview-philanthropy-general-support-october-2024/) (\$21M+ in grants), Justin Rockefeller, Crowley family | Major OP grants in 2023 (\$4M) and 2024 (\$16M) |
...
| **Key Funders** | [Open Philanthropy](https://www.openphilanthropy.org/grants/longview-philanthropy-general-support-october-2024/), Justin Rockefeller, Martin & Tom Crowley, Likith Govindaiah, Rafael Albert, Ben Delo |
...
|------------|-------------|-----------------|
| **Annual Retreat** | Multi-day gathering of philanthropists and experts | Talks from Open Philanthropy, FHI, DeepMind |
...
### Open Philanthropy Relationship

[Open Philanthropy](https://www.openphilanthropy.org/) is Longview's largest institutional funder:
...
|--------|---------------------------|
| **Open Philanthropy** | Primary operational funder (\$21M+); complementary grantmaking serving different donor types |
...
Longview explicitly [targets grants that major donors like Open Philanthropy are unwilling or unable to make](https://forum.effectivealtruism.org/posts/ZuRmENHzmivjxNafG/longview-s-emerging-challenges-fund-can-effectively-absorb), minimizing displacement effects:
...
flowchart LR
    subgraph Large["Major Foundations"]
        OP[Open Philanthropy<br/>Moskovitz/Tuna]
        SFF[SFF<br/>Tallinn]
    end
...
| **Network Access** | Retreats with Open Philanthropy, FHI, DeepMind; Nordic philanthropist convening |
...
| Limitation | Context |
|------------|---------|
| **Scale** | \$50M/year vs. Open Philanthropy's \$500M+; still building capacity |
| **Donor Concentration** | Dependent on small number of UHNW clients |
| **OP Dependency** | \$21M+ in operational support from Open Philanthropy |
...
| **2023** | [\$4M+ Open Philanthropy general support grant](https://www.openphilanthropy.org/grants/longview-philanthropy-general-support/) |
...
| **Oct 2024** | [\$16M Open Philanthropy general support grant](https://www.openphilanthropy.org/grants/longview-philanthropy-general-support-october-2024/) |
