...
|--------------|------|---------------------|---------------|--------------|
| <EntityLink id="organizations/funders/coefficient-giving">Coefficient Giving</EntityLink> | Foundation | \$200M+ | AI safety, biosecurity, farm animal welfare | <EntityLink id="anthropic">Anthropic</EntityLink>, <EntityLink id="miri">MIRI</EntityLink>, Redwood, ARC |
| <EntityLink id="organizations/funders/sff">Survival and Flourishing Fund</EntityLink> | Donor Lottery | \$30-40M | AI safety, x-risk | MIRI, ARC Evals, SERI, <EntityLink id="cais">CAIS</EntityLink> |
