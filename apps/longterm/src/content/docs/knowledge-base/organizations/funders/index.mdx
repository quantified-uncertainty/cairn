...
|--------------|------|---------------------|---------------|--------------|
| <EntityLink id="organizations/funders/coefficient-giving">Coefficient Giving</EntityLink> | Foundation | \$200M+ | AI safety, biosecurity, farm animal welfare | Anthropic, MIRI, Redwood, ARC |
...
|--------|------------------|------------------|------------------|
| <EntityLink id="organizations/funders/dustin-moskovitz">Dustin Moskovitz</EntityLink> | Facebook co-founder | \$500M+ lifetime | Coefficient Giving, Good Ventures |
| <EntityLink id="organizations/funders/jaan-tallinn">Jaan Tallinn</EntityLink> | Skype co-founder | \$50M+ annually | SFF, direct grants |
