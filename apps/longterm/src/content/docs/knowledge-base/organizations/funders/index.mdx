...
|--------------|------|---------------------|---------------|--------------|
| [Coefficient Giving](/knowledge-base/organizations/funders/coefficient-giving/) | Foundation | \$200M+ | AI safety, biosecurity, farm animal welfare | Anthropic, MIRI, Redwood, ARC |
...
|--------|------------------|------------------|------------------|
| [Dustin Moskovitz](/knowledge-base/organizations/funders/dustin-moskovitz/) | Facebook co-founder | \$500M+ lifetime | Coefficient Giving, Good Ventures |
