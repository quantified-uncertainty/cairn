...
sidebar:
  order: 10
quality: 72
llmSummary: "Jaan Tallinn (born 1972, Estonia) is a billionaire programmer who co-founded Skype and Kazaa, then became one of the world's largest individual AI safety funders. His 2024 giving exceeded $51M (86% to AI via SFF), with lifetime giving estimated at $150M+. Co-founded CSER (2012, Cambridge) with Martin Rees and Huw Price, and FLI (2014) with Max Tegmark. Led Anthropic's $124M Series A (2021), was early DeepMind investor/board member (exited at Google acquisition, 2014). Discovered AI risk through Eliezer Yudkowsky's writings (2009), met Yudkowsky, and has since argued AI poses existential threat: 'I've not met anyone in AI labs who says the risk is less than 1% of blowing up the planet.' Signed 2023 FLI pause letter, 2023 CAIS extinction statement. Investment philosophy: backs AI companies to 'have a voice of concern from the inside' while funding safety research. Net worth ~$900M-1B (largely in crypto)."
...
|-----------|------------|----------|
| **Giving Scale** | Major Individual Donor | \$51M+ in 2024; \$150M+ lifetime; 2nd largest individual AI safety funder after Open Philanthropy |
| **Primary Vehicle** | [Survival and Flourishing Fund](/knowledge-base/organizations/funders/sff/) | S-process algorithmic allocation; \$34.33M distributed in 2025 round |
...
| **Primary Giving Vehicles** | [Survival and Flourishing Fund](/knowledge-base/organizations/funders/sff/), [Lightspeed Grants](https://lightspeedgrants.org/) |
...
flowchart TD
    JT[Jaan Tallinn<br/>~\$900M-1B net worth] --> SFF[Survival and Flourishing Fund<br/>Primary vehicle since 2019]
...
Tallinn is the primary funder of [SFF](/knowledge-base/organizations/funders/sff/), which has become one of the largest sources of AI safety funding:
...
SFF is the second largest funder of AI safety after Open Philanthropy. Notable 2024-2025 recipients include: Center for AI Policy, Center for AI Safety, MIRI, FAR AI, MATS Research, METR (Model Evaluation and Threat Research), Palisade Research, SecureBio, and Apollo Research.
...
| **Board Seat Deferral** | Argued for Luke Muehlhauser (former MIRI ED, now at Open Phil) to join board instead |
...
| **Speculative Bets** | Willing | Higher risk tolerance than Open Philanthropy |
...
| Aspect | Jaan Tallinn | Dustin Moskovitz | Vitalik Buterin | Open Philanthropy |
|--------|--------------|------------------|-----------------|-------------------|
| **Entity Type** | Individual | Individual | Individual | Foundation |
| **Net Worth** | ~\$900M-1B | ~\$10B+ | ~\$1B+ | ~\$20B+ (GiveWell assets) |
| **Annual AI Safety Giving** | ~\$50M | ~\$200M (via Open Phil) | ~\$50M (variable) | ~\$150M+ |
| **Lifetime AI Safety** | ~\$100M+ | ~\$500M+ (via Open Phil) | ~\$100M+ | ~\$500M+ |
| **Primary Vehicle** | SFF, Lightspeed | Open Philanthropy | Direct, FLI | Open Philanthropy |
| **AI Focus %** | 86% | ~40% of Open Phil | Variable (25-75%) | ~40% of giving |
...
|--------|------|------------------------------|
| **Open Philanthropy** | Largest funder; conservative due diligence | Tallinn funds faster, riskier bets |
