...
sidebar:
  order: 5
quality: 72
llmSummary: "Coefficient Giving (formerly Open Philanthropy, rebranded November 2025) is the largest funder of AI safety work globally, having directed $336M+ to AI safety out of $4B+ total grants since 2014. The organization restructured into 13 cause-specific funds including the Navigating Transformative AI Fund, which deployed ~$46M in AI safety funding in 2023 alone. Major 2024 grants include Center for AI Safety ($8.5M), Redwood Research ($6.2M), and MIRI ($4.1M). The 2025 Technical AI Safety RFP offers $40M+ across 21 research areas. Coefficient also funds regranting platforms like Manifund and the Long-Term Future Fund to enable faster, more distributed grant decisions."
...
Coefficient Giving is widely considered the largest funder of AI safety work globally. Since 2014, approximately \$336 million (12% of total grants) has gone to AI safety research and governance, with roughly \$46 million deployed in 2023 alone—making it the dominant external funder in a field where most safety research happens inside frontier AI labs. The organization's [Navigating Transformative AI Fund](https://coefficientgiving.org/funds/navigating-transformative-ai/) supports technical AI safety research, AI governance and policy work, and capacity building, with a [\$40 million Technical AI Safety RFP](https://coefficientgiving.org/funds/navigating-transformative-ai/request-for-proposals-technical-ai-safety-research/) launched in 2025 covering 21 research areas.
...
Open Philanthropy began supporting AI safety work in 2015, when the field was nascent and institutional support was minimal. Early grants helped establish foundational organizations including the [Machine Intelligence Research Institute](https://www.openphilanthropy.org/grants/machine-intelligence-research-institute-ai-safety-retraining-program/) (MIRI), the [Center for Human-Compatible AI](https://humancompatible.ai/) at UC Berkeley, and the [Future of Humanity Institute](https://www.fhi.ox.ac.uk/) at Oxford. By 2023, AI safety had become Open Philanthropy's largest longtermist cause area, reflecting growing concern about advanced AI risks among the leadership team.
