...
llmSummary: The OpenAI Foundation holds 26% equity (~\$130B) in OpenAI Group PBC
  with governance control, but faces fundamental tensions between its paper
  wealth and actual charitable impact. Critics argue the share-selling incentive
  problem—where liquidating assets to fund grants would depress valuations—may
  lead to corporate foundation dynamics prioritizing brand management over
  independent philanthropy. Key indicators to watch include disbursement rates,
  willingness to fund critical AI safety research, and board independence.
metrics:
  wordCount: 5100
  citations: 59
  tables: 8
...
**Corporate Foundation Dynamics**: San Francisco Foundation CEO Fred Blackwell articulated the core concern: "Will it have the independence to be bold, take risks, and challenge the industry—or will it look and operate more like a corporate foundation that makes safe grants that merely advance the OpenAI brand?"[^53] Corporate foundations typically serve their parent companies' interests rather than pursuing independent charitable missions.
...
- <EntityLink id="anthropic-investors">Anthropic Investors</EntityLink> — Analysis of Anthropic's funding and investor ecosystem
