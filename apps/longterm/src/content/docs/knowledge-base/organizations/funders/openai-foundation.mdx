...
**Important:** The October 2025 agreement with California AG Rob Bonta includes a provision requiring board composition to change over time. Specifically, **within one year (by October 2026), the nonprofit foundation's board must include at least two members who do NOT also serve on the for-profit OpenAI Group's board.** This requirement addresses the conflict-of-interest concerns about complete board overlap.[^77b]

This is a material constraint that could shift the governance dynamics—if enforced. Key questions to monitor:
- Will OpenAI add genuinely independent directors with philanthropic experience?
- Will the new directors have meaningful influence, or be outvoted by the 7+ overlapping members?
- Will the CA AG enforce this requirement if OpenAI delays or nominates conflicted individuals?
