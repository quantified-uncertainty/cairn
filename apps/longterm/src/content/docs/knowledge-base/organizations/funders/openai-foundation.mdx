...
ratings:
  ...
  completeness: 9
quality: 87
llmSummary: The OpenAI Foundation holds 26% equity (~\$130B) in OpenAI Group PBC
  with governance control, but detailed analysis of board member incentives
  reveals strong bias toward capital preservation over philanthropic deployment.
  Of nine board members, only two (Desmond-Hellmann, Seligman) have meaningful
  nonprofit experience, while four (Taylor, Summers, Ogunlesi, Altman) have
  direct financial conflicts favoring stock appreciation. Base case spending
  projection is \$3-8B over 10 years (2-6% of stake), far below the \$25B pledge.
  Includes cost-effectiveness analysis of pressure strategies, finding advocacy
  may be among the most leveraged philanthropic opportunities at ~\$0.0001/\$ deployed.
metrics:
  wordCount: 12500
  citations: 79
  tables: 30
...
The October 2025 agreement with California AG Rob Bonta includes a provision requiring board composition to change over time. Specifically, **within one year (by October 2026), the nonprofit foundation's board must include at least two members who do NOT also serve on the for-profit OpenAI Group's board.**[^77b]

**However, this is a weak requirement:**

| Metric | Current | After Requirement |
|--------|---------|-------------------|
| Board size | 9 members | 9+ members |
| Dual-board overlap | 8 of 9 (89%) | 7+ of 9+ (≈78%) |
| Independent members | 1 (Kolter, non-voting) | 2-3 |
| Votes needed to block | 5 | Still 5 |

**Why 2 independent members changes little:**
- With 9 members, 2 independents are only **22% of votes**—easily outvoted on any issue
- The 7 overlapping members still control all major decisions
- OpenAI could add 2 members with no philanthropic experience who happen to not be on the for-profit board
- Nothing requires the independents to have different incentives (could be investors, tech executives, etc.)

**Comparison:** The Gates Foundation board has 4 members—all with philanthropic backgrounds. The Ford Foundation board has 16 members with term limits and significant independent representation. Two nominally independent members on a 9-person board dominated by for-profit interests is minimal.
...
#### [Larry Summers](https://en.wikipedia.org/wiki/Lawrence_Summers) - Strong Capital Preservation Bias

| Factor | Assessment |
|--------|------------|
| **Primary Role** | Economist, former [U.S. Treasury Secretary](https://en.wikipedia.org/wiki/United_States_Secretary_of_the_Treasury), former [Harvard](https://en.wikipedia.org/wiki/Harvard_University) President |
| **Endowment Philosophy** | At Harvard, pushed aggressive investment over spending, lost ≈\$2B in 2008 crisis |
| **2016 Position** | Argued Harvard should *reduce* payout rate from 5% given low interest rates |
| **Direct Conflicts** | Advisor to [Andreessen Horowitz](https://en.wikipedia.org/wiki/Andreessen_Horowitz) (major OpenAI investor); advisor to [D.E. Shaw](https://en.wikipedia.org/wiki/D._E._Shaw_%26_Co.) hedge fund |

Summers' track record shows consistent preference for growing endowments rather than spending them. At Harvard, he pushed the university's cash into aggressive investments against internal warnings. His advisory relationships with [a16z](https://en.wikipedia.org/wiki/Andreessen_Horowitz) (OpenAI investor) and [D.E. Shaw](https://en.wikipedia.org/wiki/D._E._Shaw_%26_Co.) create multiple financial interests aligned with OpenAI stock appreciation. His minor philanthropic exposure ([Center for Global Development](https://en.wikipedia.org/wiki/Center_for_Global_Development) board chair) is vastly outweighed by finance sector ties.[^62]

**Spending Inclination: Low.** Historical preference for capital growth over deployment. Multiple conflicts with investor interests.
...
| **[Larry Summers](https://en.wikipedia.org/wiki/Lawrence_Summers)** | Economist; multiple board seats | Treasury Secretary → Harvard President → Obama economic advisor | **Limited**: CGD board chair; prefers endowment growth over spending | **High**: Advisor to a16z (OpenAI investor) and D.E. Shaw hedge fund | **Low** |
...
- **Members with meaningful philanthropic experience:** 2 of 9 (Desmond-Hellmann, Seligman)
- **Members with high financial conflicts:** 4 of 9 (Taylor, Summers, Ogunlesi, Altman)
- **Members likely to support aggressive spending:** 0-2 of 9
- **Members likely to prioritize stock preservation:** 5-6 of 9
