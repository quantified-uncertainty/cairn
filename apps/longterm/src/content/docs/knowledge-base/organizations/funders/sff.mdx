...
sidebar:
  order: 1
quality: 72
llmSummary: "SFF distributed $34.33M in 2025 with 86% ($29M) to AI safety, using an S-process mechanism where multiple recommenders' preferences are algorithmically aggregated. The S-process favors funding projects that at least one recommender is excited about, rather than consensus picks. Total historical giving exceeds $100M since 2019. Major 2025 grantees included MIRI, METR, Center for AI Safety, and university programs. New for 2025: Matching Pledge Program and three specialized tracks (Main, Freedom, Fairness). SFF also runs a Speculation Grants program with ~35 grantors and ~$16M budget for expedited funding. Primary funder Jaan Tallinn (Skype/Kazaa co-founder, ~$900M net worth) is also a co-founder of CSER and FLI, board member at CAIS, and UN AI Advisory Body member."
...
|--------------|------------|-------|
| **[MIRI](https://intelligence.org/)** | Technical alignment research | Longstanding SFF grantee; founded by Eliezer Yudkowsky |
| **[METR](https://metr.org/)** (formerly ARC Evals) | Frontier model evaluations | Leading dangerous capability evaluations; budget rapidly growing |
...
In the broader context of AI safety funding, Tallinn's contributions through SFF and direct giving represent approximately 15-20% of total philanthropic AI safety funding, second only to Open Philanthropy. [Analysis of the AI safety funding landscape](https://forum.effectivealtruism.org/posts/XdhwXppfqrpPL2YDX/an-overview-of-the-ai-safety-funding-situation) estimates global AI safety research funding reached \\$110-130 million in 2024, with Tallinn contributing approximately \\$20 million through his personal foundation plus additional amounts through SFF.
...
|--------|----------------|-------------|-------|------------|----------------|
| **[Open Philanthropy](https://www.openphilanthropy.org/)** | ~\\$63.6M | Staff-driven | Months | Large (\\$1M+) | Moderate |
...
| **[Coefficient Giving](https://coefficientgiving.com/)** | Variable | Staff-driven | Months | Medium | Moderate |
...
| Dimension | SFF | Open Philanthropy | LTFF |
|-----------|-----|-------------------|------|
...
| **Independence from OP** | Full | N/A | Partial (40% OP funded in 2022) |
...
**Post-FTX Importance**: After the collapse of FTX and the Future Fund in late 2022, SFF became even more critical to the longtermist funding ecosystem. The Future Fund had been positioned as a major new funder with similar cause priorities; its disappearance increased reliance on SFF and Open Philanthropy.

**LTFF Relationship**: LTFF has received funding from both SFF and Open Philanthropy, making it partially downstream of these larger funders. [About 40% of LTFF's 2022 funding came from Open Philanthropy](https://forum.effectivealtruism.org/posts/zt6MsCCDStm74HFwo/ea-funds-organisational-update-open-philanthropy-matching-and). LTFF typically makes smaller grants (\\$10K-\\$500K) compared to SFF's median ~\\$100K and often funds individuals or very early-stage projects.
...
|----------|-------------|----------|
| **Scale** | Second-largest AI safety funder after Open Philanthropy | \\$100M+ total; \\$34M in 2025 alone |
