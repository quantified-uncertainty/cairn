...
description: "Comprehensive analysis of EA-aligned capital at Anthropic with critical caveats. At $350B valuation: founders ($39-59B pledged, but only 2/7 have strong EA connections—Dario and Daniela), investors Tallinn ($2-6B conservative) and Moskovitz ($3-9B), plus employee pledges. CRITICAL: Matching program reduced from 3:1@50% to 1:1@25% for new employees. Risk-adjusted expected value: $25-70B (wide range reflects cause allocation uncertainty)."
quality: 62
lastEdited: "2026-02-03"
importance: 78
llmSummary: "Comprehensive model of EA-aligned capital at Anthropic with critical caveats. At $350B valuation: founders ($39-59B pledged, but only 2/7—Dario and Daniela Amodei—have strong documented EA connections; Chris Olah and Jack Clark are safety-focused but lack EA pledges; Brown, Kaplan, McCandlish have no EA connections). This means 71% of founder equity may go to non-EA causes. Investors: Jaan Tallinn ($2-6B conservative; expressed ambivalence about Anthropic), Dustin Moskovitz ($3-9B). CRITICAL: Matching program reduced from 3:1@50% to 1:1@25% for new employees. Risk-adjusted expected value: $25-70B (wide range reflects cause allocation uncertainty). $20-40B legally bound in DAFs. Model limitations: valuation uncertainty ($300-340B on secondary markets), acquisition scenario (15-25% probability). Timeline: employee capital 2027-2030; founder capital 2030-2040."
ratings:
  novelty: 5
  rigor: 5
  actionability: 6
