...
sidebar:
  order: 4
quality: 72
llmSummary: "Manifund is a charitable regranting platform (501(c)(3)) founded in 2022 by Austin Chen and Rachel Weinberg, distributing $2M+ annually through three mechanisms: expert regranting ($50K-400K budgets to AI safety specialists), impact certificates (experimental retroactive funding), and ACX Grants (Scott Alexander's rationalist funding program). The platform provides fiscal sponsorship for unregistered projects with 5% fee, moves grants in under one week, and hosts 10 regrantors for 2025 with $2.25M total budget. Connected to Manifold Markets prediction platform and hosts annual Manifest conference (600 attendees in 2024)."
...
| Dimension | Manifund | Long-Term Future Fund | Open Philanthropy | SFF |
|-----------|----------|----------------------|-------------------|-----|
...
| **Mainstream Adoption** | OpenPhil essay contest participants declined certificates |
...
Several Manifund-funded projects have subsequently received larger grants from Open Philanthropy and other major funders, validating the "quick regrants induce further funding" thesis.
