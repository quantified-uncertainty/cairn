...
description: Philanthropic initiative founded by Eric and Wendy Schmidt focused
  on supporting exceptional talent in science, technology, and society through
  grants, fellowships, and networks.
importance: 65
...
ratings:
  ...
  completeness: 8
quality: 60
llmSummary: Schmidt Futures is a major philanthropic initiative founded by Eric
  Schmidt that has committed substantial funding to AI safety research ($135M
  across AI2050 and AI Safety Science programs) while also supporting talent
  development and scientific research across multiple domains. The organization
  has faced some ethical controversies around government influence but
  represents a significant funding source for AI safety work, though its
