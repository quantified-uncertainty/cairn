...
- **<EntityLink id="justin-shovelain">Justin Shovelain</EntityLink>**: Co-founder and CEO of <EntityLink id="convergence-analysis">Convergence Analysis</EntityLink> (an existential risk strategy research group) and AI safety advisor who has worked with <EntityLink id="miri">MIRI</EntityLink>, CFAR, and <EntityLink id="ea-global">EA Global</EntityLink> since 2009
