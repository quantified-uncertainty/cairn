...
sidebar:
  order: 4
quality: 72
llmSummary: Meta AI (formerly FAIR) is Meta's artificial intelligence research division founded in December 2013 by Mark Zuckerberg and Yann LeCun. The lab pioneered open-source AI infrastructure (PyTorch powers 63% of training models globally) and released LLaMA models downloaded over 1 billion times. Meta invested $66-72B in AI infrastructure in 2025, with projections of $115-135B in 2026, targeting AGI by 2027 and superintelligence by 2029. However, the research lab has faced significant talent exodus (50%+ of original LLaMA authors departed within 6 months), organizational restructuring prioritizing products over research, and criticism for inadequate safety frameworks. Chief AI Scientist Yann LeCun publicly dismisses existential risk as "complete B.S." and estimates P(doom) at effectively zero, creating tension with safety-focused labs. The February 2025 Frontier AI Framework addresses CBRN risks but independent analysts found no testable plan for maintaining human control over highly capable AI systems.
