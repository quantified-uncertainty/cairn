...
The company's early work on [deep reinforcement learning](/ai-transition-model/factors/ai-capabilities/) with Atari games demonstrated that general-purpose algorithms could master diverse tasks through environmental interaction alone.
...
This racing dynamic concerns safety researchers who worry about [coordination failures](/ai-transition-model/parameters/international-coordination/).
