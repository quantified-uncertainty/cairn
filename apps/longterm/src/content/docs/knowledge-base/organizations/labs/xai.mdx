...
---
import {DataInfoBox, Section, DisagreementMap, KeyQuestions, DataExternalLinks} from '@components/wiki';
...
xAI represents Elon Musk's return to AI development after co-founding <EntityLink id="openai">OpenAI</EntityLink> in 2015 and subsequently departing in 2018 over disagreements about direction. The company combines frontier AI capabilities development with Musk's particular views on AI safety, free speech, and the risks of what he calls "AI alignment gone wrong" - meaning AI systems constrained by political correctness.
