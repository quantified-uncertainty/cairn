...
Total financing has reached over \$37 billion from 83 investors. [TapTwice Digital](https://taptwicedigital.com/stats/anthropic) For detailed analysis of investor composition and founder donation pledges, see <EntityLink id="anthropic-investors">Anthropic (Funder)</EntityLink>.
