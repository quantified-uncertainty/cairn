...
sidebar:
  order: 1
quality: 91
llmSummary: Anthropic is an AI safety company valued at ~$350B with ~1,200 employees and $33.7B raised that developed Constitutional AI (82% reduction in harmful outputs) and achieved major interpretability breakthrough (16M features extracted from Claude). In May 2025, became first major lab to activate ASL-3 protections after internal evaluations showed they could no longer rule out CBRN uplift for novices. Revenue growth of 10x annually ($100M→$1B→$10B over 2023-2025) creates pressure toward profitability (expected 2028). Critical uncertainties include whether commercial pressure will undermine safety priorities and whether RSP governance gaps (ASL-4 not publicly defined) reduce accountability.
...
metrics:
  ...
  diagrams: 1
---
import {DataInfoBox, DisagreementMap, EstimateBox, KeyPeople, KeyQuestions, Section, Backlinks, R, EntityLink, DataExternalLinks, Mermaid} from '../../../../../components/wiki';
