...
For extended valuation scenarios (2-10x growth to \$700B-\$3.5T), see <EntityLink id="anthropic-ipo">Anthropic IPO</EntityLink>. For implications on EA-aligned philanthropic capital, see <EntityLink id="anthropic-investors">Anthropic (Funder)</EntityLink>.
