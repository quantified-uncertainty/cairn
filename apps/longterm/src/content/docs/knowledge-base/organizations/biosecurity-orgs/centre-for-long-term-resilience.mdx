...
description: UK-based think tank focused on extreme risks from AI, biosecurity,
  and improving government risk management through policy research and direct
  advisory work
importance: 72
...
ratings:
  ...
  completeness: 8
quality: 63
llmSummary: The Centre for Long-Term Resilience is a UK-based think tank that
  has demonstrated concrete policy influence on AI and biosecurity risks,
  including contributing to the UK's AI Strategy and Biological Security
  Strategy while receiving substantial EA-aligned funding totaling over £10M.
  The organization operates as a government-adjacent policy advisor with
  documented wins but limited quantitative impact measurement.
balanceFlags:
