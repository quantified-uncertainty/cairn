...
description: International partnership financing and coordinating vaccine
  development against epidemic and pandemic threats, launched in 2017 with the
  100 Days Mission.
importance: 45
...
ratings:
  ...
  completeness: 7
quality: 53
llmSummary: CEPI is an international vaccine development partnership founded in
  2017 that addresses market failures in pandemic preparedness by funding
  vaccines for diseases with limited commercial viability. While achieving
  notable success during COVID-19, the organization faces ongoing criticism for
  weakening equitable access policies under pharmaceutical industry pressure and
  maintaining insufficient transparency in its agreements.
metrics:
  wordCount: 2856
  citations: 71
  tables: 5
