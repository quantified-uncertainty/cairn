...
MATS mentors come from leading organizations including Anthropic, Google DeepMind, Redwood Research, OpenAI, <EntityLink id="miri">MIRI</EntityLink>, ARC (<EntityLink id="arc">Alignment Research Center</EntityLink>), CHAI, CAIS, and the Centre on Long-Term Risk.[^53] Selected examples include:
