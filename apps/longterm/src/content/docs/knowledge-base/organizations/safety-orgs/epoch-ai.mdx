...
sidebar:
  order: 14
quality: 48
llmSummary: Epoch AI provides empirical AI progress tracking showing compute doubling every 6 months (10,000x increase 2012-2022), high-quality training data exhaustion by mid-2020s, and algorithmic efficiency gains of 2x every 6-12 months. Their databases directly inform US Executive Order 10^26 FLOPs threshold and export controls, serving as critical infrastructure for compute governance approaches.
...
- **Multimodal shift**: <EntityLink id="language-models">Language models</EntityLink> may pivot to image/video data
...
| Compute governance | Standardized international monitoring | Enhanced <EntityLink id="export-controls">export controls</EntityLink> |
| Timeline updates | Narrower uncertainty bounds | More precise <EntityLink id="agi-timeline">AGI timeline</EntityLink> estimates |
