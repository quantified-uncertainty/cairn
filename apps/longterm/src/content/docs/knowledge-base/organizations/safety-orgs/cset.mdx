...
sidebar:
  order: 10
quality: 72
llmSummary: CSET is Georgetown's AI policy think tank with 50+ staff and $100M+ funding from Open Philanthropy. Founded in 2019 by Jason Matheny (former IARPA director), it produces data-driven research on AI national security, operates the Emerging Technology Observatory (10 public tools, 8 datasets), and has significant policy influence through 80+ annual publications, congressional testimony, and hundreds of government briefings. Key research areas include U.S.-China AI competition, export controls, AI workforce, military AI applications, and cybersecurity.
...
| **Primary Funder** | Open Philanthropy (initial \$15M, additional \$12M+) |
...
| **Previous Role** | Senior Research Analyst, Open Philanthropy |
...
Toner's appointment reflects CSET's dual focus on U.S.-China competition and AI safety/governance issues. Her experience at Open Philanthropy and Oxford's Centre for the Governance of AI positions her to bridge the AI safety and national security communities.

### Key Leadership Team

| Person | Role | Background |
|--------|------|------------|
| Helen Toner | Interim Executive Director | Open Philanthropy, Oxford GovAI, TIME 100 AI |
...
| **Total Open Philanthropy** | | **\$100M+** | Through 2025 |
...
|------|------|------------|-------------|
| Helen Toner | Interim Executive Director | Open Philanthropy, Oxford GovAI, Beijing researcher | U.S.-China competition, AI governance |
...
3. **Funder Concentration**: Heavy reliance on Open Philanthropy, though diversifying
...
4. [Open Philanthropy Grant to Georgetown CSET](https://www.openphilanthropy.org/grants/georgetown-university-center-for-security-and-emerging-technology/)
