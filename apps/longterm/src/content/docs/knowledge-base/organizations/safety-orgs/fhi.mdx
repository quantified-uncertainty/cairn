...
sidebar:
  order: 5
quality: 72
llmSummary: "Documents the Future of Humanity Institute (2005-2024), the pioneering Oxford research center that established existential risk as an academic field and incubated the AI safety research community. Covers founding by Nick Bostrom, key researchers (Toby Ord, Anders Sandberg, Stuart Armstrong, Eric Drexler, Carl Shulman), major publications (Superintelligence, The Precipice), spin-offs (GovAI, CSER connections), $20M+ in Open Philanthropy funding, policy impact (UN, UK government), and closure circumstances including the Faculty of Philosophy's 2020 hiring freeze and 2024 shutdown amid bureaucratic conflicts."
...
| **Total Funding** | \$10M+ from Open Philanthropy | Plus £1M from Elon Musk, ERC grants, Leverhulme Trust |
...
| **Major Funders** | Open Philanthropy (\$10M+), Elon Musk (£1M), ERC, Leverhulme Trust |
...
flowchart TD
    ...
    subgraph Peak["Peak Period (2014-2020)"]
        ...
        P4[£13.3M Open Philanthropy grant 2018]
    end
...
| £13.3M Open Philanthropy grant | 2018 | Largest grant in Faculty of Philosophy history |
| _The Precipice_ published | March 2020 | First book-length treatment of existential risk for popular audience |

In 2018, FHI received a series of awards totaling up to £13.3 million over three years from Open Philanthropy, the largest donation in the history of the Faculty of Philosophy at Oxford. This funding supported work on risks from advanced AI, biosecurity and pandemic preparedness, and macrostrategy.
...
Total Open Philanthropy funding exceeded \$10 million over FHI's lifetime.
...
- [Open Philanthropy: FHI General Support](https://www.openphilanthropy.org/grants/future-of-humanity-institute-general-support/)
- [Open Philanthropy: FHI Work on Global Catastrophic Risks](https://www.openphilanthropy.org/grants/future-of-humanity-institute-work-on-global-catastrophic-risks/)
