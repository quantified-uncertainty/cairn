...
importance: 35.5
---
import {DataInfoBox, KeyPeople, Section, Backlinks, R, EntityLink} from '../../../../../components/wiki';
...
- **Research Alignment**: <EntityLink id="miri">MIRI</EntityLink>, <EntityLink id="chai">CHAI</EntityLink>, <EntityLink id="redwood">Redwood Research</EntityLink>
