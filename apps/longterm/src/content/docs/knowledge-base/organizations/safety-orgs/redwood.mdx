...
sidebar:
  order: 12
quality: 40
llmSummary: Redwood Research is a 15-person AI safety lab that pioneered the 'AI control' paradigm (safety without full alignment) and causal scrubbing methodology for interpretability. Their control approach has gained industry interest, with 150+ citations for causal scrubbing and ~$5M annual budget, training 20+ researchers now at major labs.
