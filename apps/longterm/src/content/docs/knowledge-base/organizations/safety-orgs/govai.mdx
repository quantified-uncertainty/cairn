...
sidebar:
  order: 13
quality: 82
llmSummary: "GovAI has produced foundational compute governance research cited in EU AI Act (10^25 FLOP threshold) and US Executive Order, trained 100+ AI governance researchers now at DeepMind/OpenAI/Anthropic/government, and directly influences EU AI Act implementation via Vice-Chair role (Anderljung). With ~$1.8M/year from Open Philanthropy and ~20 staff, it bridges academic research with direct regulatory participation across UK/US/EU."
lastEdited: "2025-12-28"
importance: 62.5
---
import {DataInfoBox, KeyPeople, Section, Backlinks, Mermaid, DataExternalLinks} from '../../../../../components/wiki';
...
GovAI's theory of impact centers on producing foundational research that shapes how governments and industry approach AI governance, while simultaneously training the next generation of AI governance professionals. Their 2018 research agenda helped define the nascent field of AI governance, and their subsequent work on compute governance has become a cornerstone of regulatory thinking in the US, UK, and EU. The organization receives substantial support from Open Philanthropy, with grants totaling over \$1.8 million in 2023-2024 alone.
...
| Primary Funder | Open Philanthropy (\$1.8M+ in 2023-2024) |
...
GovAI is primarily funded by Open Philanthropy, which has provided substantial support for AI governance work.
...
1. **Funding concentration**: Heavy reliance on Open Philanthropy creates potential vulnerability
...
- [Open Philanthropy GovAI Grant 2024](https://www.openphilanthropy.org/grants/govai-general-support-2024/)
