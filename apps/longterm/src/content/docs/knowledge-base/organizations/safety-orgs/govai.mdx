...
sidebar:
  order: 13
quality: 43
llmSummary: GovAI is an AI policy research organization with ~15-20 staff, funded primarily by Open Philanthropy ($1.8M+ in 2023-2024), that has trained 100+ governance researchers through fellowships and currently holds Vice-Chair position in EU GPAI Code drafting. Their compute governance research has influenced regulatory thresholds across US, UK, and EU, with alumni now occupying key positions in frontier labs, think tanks, and government.
