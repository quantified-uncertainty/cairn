...
| **Mechanistic Interpretability** | 2022-2023 | Understanding model internals | Causal scrubbing methodology | Adopted by <EntityLink id="anthropic">Anthropic</EntityLink>, 150+ citations |
...
| Alignment Faking in Large Language Models | Anthropic collab | Dec 2024 | LLMs strategically hiding misalignment | [Anthropic](https://www.anthropic.com/research/alignment-faking) |
| Stress-Testing Capability Elicitation | NeurIPS 2024 | May 2024 | Password-locked models | [arXiv](https://arxiv.org/abs/2405.19550) |
...
| 2022 | Survival and Flourishing Fund | \$1.3M | General support | [Buck's blog](https://blog.redwoodresearch.org/p/the-inaugural-redwood-research-podcast) |
...
An anonymous 2023 critique published on the EA Forum raised concerns about the organization's leadership lacking senior ML research experience. Critics noted that the CTO (Buck Shlegeris) had 3 years of software engineering experience with limited ML background, and that the most experienced ML researcher had 4 years at OpenAI—comparable to a fresh PhD graduate.[^31][^32] However, UC Berkeley professor Jacob Steinhardt defended Shlegeris as conceptually strong, viewing him "on par with a research scientist at a top ML university."[^33]
