...
**Timeline Estimates**: Leahy has consistently expressed [short AI timeline](/ai-transition-model/timelines/) views, suggesting AGI within years rather than decades.
...
| **Timeline Alignment** | High | Critical if [AGI timelines](/ai-transition-model/timelines/) short |
