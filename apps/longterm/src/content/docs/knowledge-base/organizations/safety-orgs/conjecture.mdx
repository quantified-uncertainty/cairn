...
**Timeline Estimates**: Leahy has consistently expressed [short AI timeline](/knowledge-base/forecasting/agi-timeline) views, suggesting AGI within years rather than decades.
...
| **Timeline Alignment** | High | Critical if [AGI timelines](/knowledge-base/forecasting/agi-timeline) short |
