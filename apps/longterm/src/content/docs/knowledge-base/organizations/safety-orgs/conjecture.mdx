...
|----------|------------|---------|------------|
| **Prosaic Alignment** | Train powerful LLMs, align post-hoc | RLHF, <EntityLink id="constitutional-ai">Constitutional AI</EntityLink> | Behavioral testing |
...
| **<EntityLink id="redwood">Redwood</EntityLink>** | <EntityLink id="ai-control">AI control</EntityLink> | Interpretability for control |
