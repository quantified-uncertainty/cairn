...
importance: 38.5
---
import {DataInfoBox, EstimateBox, KeyPeople, KeyQuestions, Section, R, EntityLink, DataExternalLinks} from '../../../../../components/wiki';
...
| **<EntityLink id="redwood">Redwood</EntityLink>** | AI control | Interpretability for control |
...
| **Alignment Approaches** | <EntityLink id="why-alignment-hard">Why Alignment is Hard</EntityLink> | <R id="2e0c662574087c2a">AI Alignment Forum</R> |
