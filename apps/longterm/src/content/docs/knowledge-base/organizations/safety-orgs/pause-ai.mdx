...
Pause AI was founded in **May 2023** when Joep Meindertsma, a software engineer and CEO of a software firm, put his job on hold to launch the movement.[^3] Meindertsma's concerns about existential risks from artificial general intelligence (AGI) were first sparked by reading philosopher Nick Bostrom's 2014 book *Superintelligence: Paths, Dangers, Strategies*.[^3] After years of following AI safety research, he concluded that alignment work was falling dangerously behind capability advances and organized direct action accordingly.
...
[^5]: Web research: IMPACT section
[^6]: Web research: PEOPLE section - Maxime Fournes
[^7]: Web research: PEOPLE section - National leadership
[^8]: Web research: OVERVIEW section - Core proposal
[^9]: Web research: CRITICISM section - Industry opposition
[^10]: Web research: AI-SAFETY section
[^11]: Web research: AI-SAFETY section - AI alignment challenges
[^12]: Web research: AI-SAFETY section - Research approaches
[^13]: Web research: COMMUNITY DISCUSSIONS section - LessWrong
[^14]: Web research: COMMUNITY section - Criticisms
[^15]: Web research: COMMUNITY section - Palisade Research
[^16]: Web research: IMPACT section - Limited policy success
[^17]: Web research: FUNDING section - Federal actions
[^18]: Web research: NEWS section - DeepSeek R1
[^19]: Web research: CRITICISM section - California AB 489/SB 243
[^20]: Web research: CRITICISM section - UC Berkeley experts
[^21]: Web research: FUNDING-OP section
