...
:::note[Page Scope]
This is the **canonical source** for Anthropic valuation analysis. For company overview, see <EntityLink id="anthropic">Anthropic</EntityLink>. For IPO timeline, see <EntityLink id="anthropic-ipo">Anthropic IPO</EntityLink>. For EA capital analysis, see <EntityLink id="anthropic-investors">Anthropic (Funder)</EntityLink>.
