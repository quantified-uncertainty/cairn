...
sidebar:
  order: 3
quality: 91
llmSummary: "FRI conducts forecasting methodology research, led by Chief Scientist Philip Tetlock (author of Expert Political Judgment and Superforecasting). Their XPT tournament (169 participants) found superforecasters severely underestimated AI progress—giving 2.3% to AI achieving IMO gold (achieved July 2025), vs 8.6% from domain experts. Superforecasters estimated 0.38% AI extinction probability by 2100 vs 3% from domain experts. Key outputs: XPT methodology for high-stakes debates, ForecastBench for LLM evaluation (ICLR 2025) showing LLMs may match superforecasters by November 2026, and FRI-ONN nuclear risk study estimating 5% median probability of nuclear catastrophe by 2045. Funded by over $16M from Open Philanthropy."
...
| **Funding** | Over [\$16M from Open Philanthropy](https://www.openphilanthropy.org/focus/forecasting/) (2021-present) |
...
The [Forecasting Research Institute](https://forecastingresearch.org/) develops advanced forecasting methods to improve decision-making on high-stakes issues, with particular emphasis on existential risks and AI development. Founded in 2021 with [initial support from Open Philanthropy](https://www.openphilanthropy.org/grants/forecasting-research-institute-science-of-forecasting/) and led by Chief Scientist Philip Tetlock—whose research established the field of superforecasting—FRI represents the next generation of forecasting research, moving from establishing accuracy standards to channeling forecasting into real-world policy relevance.
...
<Mermaid client:load chart={`
flowchart TD
    XPT[Existential Risk<br/>Persuasion Tournament] --> S1[Stage 1: Initial Forecasts]
    S1 --> S2[Stage 2: Anonymous Debate]
    S2 --> S3[Stage 3: Adversarial Collaboration]
    S3 --> S4[Stage 4: Final Forecasts]

    S1 --> SUPER[Superforecasters]
    S1 --> EXPERT[Domain Experts]

    SUPER --> TEAMS[Team Formation]
    EXPERT --> TEAMS

    TEAMS --> DEBATE[Constructive Debate]
    DEBATE --> UPDATE[Forecast Updates]
    UPDATE --> CONSENSUS[Points of Agreement]
    UPDATE --> DISAGREE[Points of Disagreement]

    style XPT fill:#e6f3ff
    style CONSENSUS fill:#ccffcc
    style DISAGREE fill:#ffcccc
`} />
...
|-------|----------|---------|
| **Stage 1** | Anonymous probability judgments | Establish baseline forecasts without social influence |
| **Stage 2** | Explain reasoning | Expose assumptions and evidence |
| **Stage 3** | Adversarial collaboration | Structured debate to identify cruxes |
| **Stage 4** | Final forecasts | Update based on debate outcomes |

### XPT Participants

| Group | Number | Selection Criteria |
|-------|--------|-------------------|
| **Superforecasters** | 89 | Top performers from Good Judgment Project with track records of predictive accuracy |
| **Domain Experts** | 80 | Specialists recruited via organizations, academic departments, and research labs |
| **Total** | 169 | Incentivized participation with monetary rewards for persuasion and accuracy |

The [domain experts](https://forum.effectivealtruism.org/posts/un42vaZgyX7ch2kaj/announcing-forecasting-existential-risks-evidence-from-a) were selected to cover the major risk categories:
...
| **Funding** | Supported by Open Philanthropy until mid-2027 |
...
FRI's work is primarily funded by [Open Philanthropy](https://www.openphilanthropy.org/focus/forecasting/), which launched forecasting as an independent cause area in 2024.

### Open Philanthropy Grants to FRI
...
**Total Open Philanthropy funding: Over \$16 million**
...
| **October 2021** | FRI founded with \$175K Open Philanthropy planning grant |
| **June-October 2022** | XPT tournament conducted (169 participants, 4 months) |
| **2022** | Open Philanthropy provides \$1.3M multi-year grant |
| **August 2023** | XPT working paper released |
| **2023** | Open Philanthropy provides \$10M general support grant |
...
- [Open Philanthropy Forecasting Grants](https://www.openphilanthropy.org/focus/forecasting/) - Funding history
