...
| <EntityLink id="organizations/epistemic-orgs/fri">Forecasting Research Institute</EntityLink> | Forecasting methodology research | XPT Tournament, ForecastBench, Superforecaster Studies |
| <EntityLink id="organizations/epistemic-orgs/quri">QURI</EntityLink> | Epistemic tools development | Squiggle Language, Squiggle Hub, Metaforecast |
| <EntityLink id="organizations/epistemic-orgs/manifold">Manifold</EntityLink> | Prediction markets platform | AI Markets, Manifest Conference, Manifund |
