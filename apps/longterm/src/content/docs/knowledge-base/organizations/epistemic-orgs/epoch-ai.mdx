...
sidebar:
  order: 1
quality: 91
llmSummary: "Epoch AI (founded 2022, ~34 staff) is the authoritative source for AI development data, maintaining databases tracking 3,200+ ML models from 1950-present. Key findings: training compute grows 4.4x/year with 7-month doubling time for global AI chip capacity (15M+ H100-equivalents); projected data exhaustion 2026-2032 without synthetic data innovation; US holds ~75% of AI supercomputer capacity. Their Epoch Capabilities Index shows 90% acceleration in AI progress since April 2024. Policy impact: EU AI Act and US EO 14110 compute thresholds (10^25 FLOP) directly cite Epoch data. FrontierMath benchmark (350 problems, 60+ mathematicians including Fields medalist) shows frontier models solve less than 2% vs o3's ~10-25%. Funded by Open Philanthropy (~7M USD through 2025)."
...
| **Industry Usage** | Widespread | OpenAI commissioned [FrontierMath](https://epoch.ai/frontiermath/about); Google DeepMind collaborated on [ECI methodology](https://epoch.ai/benchmarks/eci) |
| **Funding** | Stable | ~\$7M through 2025 via [Open Philanthropy grants](https://www.openphilanthropy.org/grants/epoch-ai-general-support-2025/) |
...
| **Primary Funders** | Open Philanthropy (\$6.3M+ in grants), Carl Shulman (\$100K), individual donors |
...
From its founding, Epoch was fiscally sponsored and operationally supported by Rethink Priorities, whose Special Projects team provided critical infrastructure for the growing organization. At founding, Epoch had a staff of 13 people (9 FTEs). Open Philanthropy provided early support with a \$1.96M grant for general support, followed by additional grants totaling over \$6M through 2025.
...
Epoch AI has raised approximately \$7 million through September 2025, primarily from Open Philanthropy grants.
...
Open Philanthropy has cited Epoch as producing "world-class work that is widely read, used, and shared."
...
| **<EntityLink id="our-world-in-data">Our World in Data</EntityLink>** | Data visualization | Curates authoritative sources | Broad topic coverage; accessibility | Uses Epoch data |
...
| **Funding concentration** | Heavy reliance on Open Philanthropy creates potential dependency |
...
| 2022 | First Open Philanthropy grant (\$1.96M) |
...
| 2023 | Additional Open Philanthropy grants (\$4.3M); House of Lords evidence submission |
