...
sidebar:
  order: 5
quality: 91
llmSummary: "Manifold is a play-money prediction market platform founded by Austin Chen (ex-Google, UC Berkeley), James Grugett (Carnegie Mellon, YC F24), and Stephen Grugett (Yale, CEO) in December 2021. Users trade Mana currency on user-created markets. Platform statistics: ~2,000 daily active users at 2024 peak, 200,000 monthly visitors, 100,000+ markets created. 2024 election Brier scores: Polymarket 0.0296, Manifold 0.0342 (p<0.05 difference). AGI timeline markets estimate 47% probability of AGI by 2028, higher than Metaculus (~30%). Hosts Manifest conference annually (250 attendees 2023, 600 in 2024) with speakers including Nate Silver, Robin Hanson, Scott Alexander, Eliezer Yudkowsky. Related Manifund platform distributed 2M USD+ in 2023 via regranting and impact certificates. Sweepcash sunset March 28, 2025. Platform calibration shows good alignment with diagonal on calibration charts for markets with 15+ traders."
