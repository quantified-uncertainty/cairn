...
sidebar:
  order: 4
quality: 91
llmSummary: "QURI (Quantified Uncertainty Research Institute) develops tools for probabilistic reasoning, with Squiggle as their main project—a programming language for uncertainty estimation featuring native distribution types (normal, lognormal, beta), Monte Carlo sampling, and the intuitive 'a to b' syntax for lognormal distributions. Key products: Squiggle Hub (collaborative modeling platform), Metaforecast (cross-platform forecast aggregator covering 2,100+ questions from 10+ platforms), SquiggleAI (LLM-powered model generation using Claude Sonnet 4.5), and RoastMyPost (LLM blog evaluator with fact-checking, spell-checking, and fallacy detection). Founded by Ozzie Gooen, former FHI Research Scholar and creator of Guesstimate. QURI has received $850K+ funding from SFF, Future Fund, and LTFF, fiscally sponsored by Rethink Priorities. Squiggle 0.10.0 released January 2025 with compile-time type inference, Web Worker support, and unit type annotations."
...
| **Open Source** | Fully | All projects MIT licensed on [GitHub](https://github.com/quantified-uncertainty); monorepo includes Squiggle, Hub, and Metaforecast |
...
flowchart TD
    ...
    TOOLS --> ROAST[RoastMyPost<br/>Blog evaluation]
...
The website was created by QURI (Ozzie and Tomáš) to make the research more navigable. The review covers alignment, control, capability restraint, and risk awareness work, processing every arXiv paper on alignment and all Alignment Forum posts. The project was funded by OpenPhil Coefficient Giving.
...
| **Fermi estimates for cause prioritization** | SquiggleAI, Squiggle | Open Philanthropy, 80,000 Hours |
...
| **2024** | [RoastMyPost launch](https://forum.effectivealtruism.org/posts/BdufL4GZmeBht3fak/announcing-roastmypost-llms-eval-blog-posts-and-more) | LLM blog evaluation tool |
