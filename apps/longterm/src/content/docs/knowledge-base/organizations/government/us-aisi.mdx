...
sidebar:
  order: 17
quality: 54
llmSummary: The US AI Safety Institute (AISI), established November 2023 within NIST with $10M budget and 280+ consortium members, conducts pre-deployment evaluations of frontier models (first joint US-UK evaluation of Claude 3.5 Sonnet in November 2024) and develops safety standards, though it lacks direct regulatory authority. Renamed to Center for AI Standards and Innovation (CAISI) in June 2025 with shift from safety-first to innovation/competitiveness focus.
