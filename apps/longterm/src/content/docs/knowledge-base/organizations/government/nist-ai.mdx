...
| **Head of AI Safety** | Paul Christiano | Former <EntityLink id="openai">OpenAI</EntityLink> leader and founder of the <EntityLink id="arc">Alignment Research Center</EntityLink>, a nonprofit focused on AI alignment research[^42] |
