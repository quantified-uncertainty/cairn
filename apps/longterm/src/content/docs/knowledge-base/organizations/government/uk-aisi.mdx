...
**Methodology:** The Institute has built evaluation expertise by learning from and collaborating with organizations like METR, <EntityLink id="apollo-research">Apollo Research</EntityLink>, and ARC. Their approach includes both pre-deployment and post-deployment testing, with a focus on red-teaming and adversarial evaluation techniques.
