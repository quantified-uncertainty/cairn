...
sidebar:
  order: 2
quality: 30
llmSummary: This comprehensive historical survey documents early AI safety warnings from 1950-2000, covering Turing's 1950 control concerns, Wiener's goal specification problem (1960), Good's intelligence explosion theory (1965), and Vinge's singularity concept (1993). The piece establishes that core AI safety concepts were articulated decades before organized research began, but lacks primary source citations and quantitative analysis.
