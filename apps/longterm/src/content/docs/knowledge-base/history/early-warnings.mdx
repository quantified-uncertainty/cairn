...
sidebar:
  order: 2
quality: 48
llmSummary: "Chronicles early AI safety thinking from Turing (1950) through I.J. Good's intelligence explosion concept (1965), showing how foundational concerns about machine control, goal specification, and recursive self-improvement emerged decades before modern AI safety research. Documents prescient warnings from Turing, Wiener, Good, and Asimov that were largely ignored until recent decades."
