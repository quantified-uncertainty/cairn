...
sidebar:
  order: 2
quality: 33
llmSummary: "Chronicles early AI safety warnings from Turing (1950) through Vinge (1993), documenting how foundational concepts like intelligence explosion (Good, 1965) and the goal specification problem (Wiener, 1960) were established but dismissed for decades. The piece thoroughly catalogs who said what when, but offers no quantitative analysis of why warnings failed or what made them prescient."
