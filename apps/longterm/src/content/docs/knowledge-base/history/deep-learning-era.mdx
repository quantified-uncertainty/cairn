...
sidebar:
  order: 4
quality: 30
llmSummary: "Chronicles AI safety field development 2012-2020 through major milestones (AlexNet, AlphaGo, GPT series) and institutional formation (DeepMind, OpenAI, early safety research). Documents field growth from ~100 to ~500-1000 researchers and $10M to $50-100M/year funding, while noting capabilities consistently outpaced safety work."
...
metrics:
  ...
  diagrams: 0
---
import {DataInfoBox, DataExternalLinks, Mermaid} from '../../../../components/wiki';
