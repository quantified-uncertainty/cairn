...
sidebar:
  order: 4
quality: 28
llmSummary: Chronicles major AI milestones 2012-2020 (AlexNet, AlphaGo, GPT series) and emergence of safety field from ~100 to ~1,000 researchers with ~$50-100M/year funding, but identifies persistent capabilities-safety gap. Documents founding of DeepMind (2010) and OpenAI (2015), timeline acceleration (Go mastered decade early), and key research frameworks like Concrete Problems (2016).
