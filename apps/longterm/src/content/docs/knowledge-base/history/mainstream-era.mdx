...
sidebar:
  order: 5
quality: 40
llmSummary: Chronicles AI safety's transition from niche concern to mainstream policy priority (2020-present), documenting ChatGPT's unprecedented growth (100M users in 2 months), the OpenAI governance crisis, and first international agreements. While funding grew ~100x and governments established AI Safety Institutes, the capabilities-safety gap widened despite progress, with no comprehensive alignment solution and jailbreaking remaining easy.
