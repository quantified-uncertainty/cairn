...
sidebar:
  order: 3
quality: 31
llmSummary: "Comprehensive historical narrative documenting AI safety's institutional formation from 2000-2015, covering MIRI's founding, LessWrong community building, and Bostrom's Superintelligence bringing academic legitimacy. While thorough on events and key concepts (orthogonality thesis, instrumental convergence), it lacks original analysis or actionable insights for current prioritization work."
