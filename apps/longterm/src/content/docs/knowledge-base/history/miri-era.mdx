...
sidebar:
  order: 3
quality: 33
llmSummary: "Chronicles the formation of organized AI safety research from 2000-2015, covering MIRI's founding, key intellectual developments (orthogonality thesis, instrumental convergence), the LessWrong community, Bostrom's Superintelligence (2014), and the emergence of funding. Documents the transition from scattered warnings to a legitimate research field with institutions and hundreds of researchers."
...
**<EntityLink id="coefficient-giving">Coefficient Giving</EntityLink>** (then Open Philanthropy, formerly Good Ventures + GiveWell Labs):
