...
llmSummary: "Comprehensive synthesis of AGI timeline forecasts showing dramatic acceleration: expert median dropped from 2061 (2018) to 2047 (2023), Metaculus from 50 years to 5 years since 2020, with lab leaders converging on 2026-2029. Key uncertainty factors include definition disputes (10-20 year variance), scaling law continuation, and alignment difficulty, with 50% probability estimates ranging from 2027 (Metaculus) to 2047 (expert surveys)."
ratings:
  novelty: 3.5
  rigor: 6.5
  actionability: 5
