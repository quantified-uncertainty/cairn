...
llmSummary: Comprehensive synthesis of AGI timeline forecasts showing dramatic shortening since 2020. Expert median dropped from 2061 (2018) to 2047 (2023), while Metaculus now predicts November 2027 median (1,700+ forecasters). Lab leaders converge on 2026-2029 with Sam Altman claiming "we know how to build AGI," Dario Amodei predicting 2026-2027, and $100B training clusters planned by 2027. Key uncertainties remain around definitions, scaling limits, and paradigm requirements.
ratings:
  novelty: 4
  rigor: 6.5
  actionability: 5.5
