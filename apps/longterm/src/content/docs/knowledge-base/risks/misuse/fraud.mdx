...
description: >-
  AI enables automated fraud at unprecedented scale - voice cloning from 3
  seconds of audio, personalized phishing, and deepfake video calls, with losses
  projected to reach $40B by 2027
sidebar:
  order: 6
maturity: Growing
quality: 78
llmSummary: >-
  Comprehensive analysis of AI-enabled fraud showing $16.6B in 2024 US losses
  (33% increase) with projections to $40B globally by 2027, documenting voice
  cloning requiring only 3 seconds of audio and deepfake capabilities enabling
  sophisticated attacks like the $25.6M Arup case. Provides detailed technical
  capabilities, case studies, and countermeasures with 70-85% detection
  effectiveness.
...
- <R id="0b328aa40a8d8a4b">Reality Defender</R> - Real-time deepfake detection
...
- <R id="373effab2c489c24">EU AI Act</R> includes deepfake disclosure requirements
- <R id="54dbc15413425997">NIST AI Risk Management Framework</R> addresses authentication challenges
...
- [Authentication collapse](/knowledge-base/risks/epistemic/authentication-collapse/) - Fundamental breakdown of identity verification
