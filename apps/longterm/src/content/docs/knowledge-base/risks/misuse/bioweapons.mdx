...
maturity: Growing
quality: 68
llmSummary: "Comprehensive analysis of AI-assisted bioweapons risk, synthesizing empirical evidence showing mixed results: RAND 2024 found no significant AI uplift for planning (p>0.05), while Microsoft 2024 showed AI-designed toxins evaded 75%+ of DNA screening. By 2025, both OpenAI and Anthropic activated elevated safety measures, with OpenAI expecting next-gen models to reach 'high-risk' classification and Anthropic activating ASL-3 protections—marking significant industry assessment shift despite continued debate over whether knowledge or wet-lab capability is the true bottleneck."
