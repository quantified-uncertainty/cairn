...
maturity: "Growing"
quality: 70
llmSummary: "Comprehensive synthesis of AI-bioweapons evidence through 2025, including RAND's finding of no significant AI uplift (2024) versus frontier labs' assessments that next-gen models will reach 'high-risk' classification. Key uncertainties: whether knowledge or wet-lab capability is the bottleneck (65% favor capability), current uplift estimates (0.02-3.6% attack probability), and whether Microsoft's finding that AI-designed toxins evade 75%+ of screening represents a fundamental defensive failure."
