...
maturity: Mature
quality: 91
llmSummary: Comprehensive analysis of AI-enabled mass surveillance documenting China's 600M camera deployment, 40% global market share by Hikvision/Dahua, and 1-1.8M Uyghur detentions through ethnic targeting. NIST studies show 10-100x higher facial recognition errors for Black/Asian faces. Carnegie AIGS Index shows 97 of 179 countries deploying AI surveillance (29% increase since 2019). EU AI Act prohibited practices took effect Feb 2025, banning untargeted biometric databases and emotion recognition in workplaces.
