...
maturity: Mature
quality: 46
llmSummary: Comprehensive analysis of AI-enabled mass surveillance documenting China's 600M camera deployment, 40% global market share by Hikvision/Dahua, and 1-2M Uyghur detentions through ethnic targeting. NIST studies show 10-100x higher facial recognition errors for Black/Asian faces, with 75+ countries deploying AI surveillance despite fragmented governance responses (EU AI Act bans, US state restrictions, Entity List export controls).
