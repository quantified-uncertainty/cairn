...
> **For comprehensive analysis**, see [Economic Stability](/ai-transition-model/parameters/economic-stability), which covers:
...
See [Economic Stability](/ai-transition-model/parameters/economic-stability) for detailed analysis.
...
### Primary Reference
- **[Economic Stability](/ai-transition-model/parameters/economic-stability)** — Comprehensive parameter page with current state, threats, supports, and scenarios
...
### Related Parameters
- [Human Expertise](/ai-transition-model/parameters/human-expertise) — Skills at risk of atrophy
- [Societal Trust](/ai-transition-model/parameters/societal-trust) — Economic disruption erodes trust
