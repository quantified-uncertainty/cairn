...
> **For comprehensive analysis**, see [Human Agency](/ai-transition-model/parameters/human-agency), which covers:
...
See [Human Agency](/ai-transition-model/parameters/human-agency) for detailed intervention analysis.
...
### Primary Reference
- **[Human Agency](/ai-transition-model/parameters/human-agency)** — Comprehensive parameter page with dimensions, benchmarks, threats, supports, and scenarios
