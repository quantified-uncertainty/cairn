...
maturity: Growing
quality: 55
llmSummary: Analysis of coordination failures in AI development using game theory, documenting how competitive dynamics between nations (US $100B vs China investment in 2024) and labs systematically undermine safety measures. SaferAI 2025 assessments found no major lab exceeded 35% risk management maturity ('weak' rating), while DeepSeek-R1's release demonstrated 100% attack success rates and 12x higher hijacking susceptibility, intensifying racing dynamics.
