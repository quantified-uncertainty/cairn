...
description: >-
  AI-enabled authoritarianism represents one of the most severe structural AI
  risks. Current evidence shows 72% of the global population living under
  autocracy (highest since 1978), with AI surveillance exported to 80+ countries
  and 15 consecutive years of declining internet freedom globally.
sidebar:
  order: 5
quality: 88
llmSummary: >-
  Comprehensive analysis showing 72% of global population (5.7 billion) now
  lives under autocracy with AI surveillance deployed in 80+ countries,
  documenting how AI systems may permanently foreclose traditional pathways for
  regime change through comprehensive surveillance, predictive policing, and
  automated enforcement. Provides extensive quantified evidence across China's
  Sharp Eyes system, democratic backsliding patterns, and four distinct pathways
  to authoritarian lock-in.
...
- <R id="3cdd7b9ca13fb4db">ASPI report</R> (November 2024) describes China as "the world leader in adopting generative AI" for surveillance and "public opinion management"
