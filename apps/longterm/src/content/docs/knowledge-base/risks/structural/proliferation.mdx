...
maturity: Growing
quality: 91
llmSummary: Comprehensive analysis showing AI capability gaps between frontier and open-source models decreased from ~18 months to ~6 months (2022-2024) and to 1.7% on some benchmarks by 2025. Hugging Face grew to 2M+ models; DeepSeek R1 matched OpenAI o1 performance. US export controls reduced China's compute share from 37% to 14% but Chinese models achieved near-parity through efficiency gains. Examines proliferation drivers, case studies (LLaMA leak, Mistral leak, DeepSeek release), and competing governance strategies.
