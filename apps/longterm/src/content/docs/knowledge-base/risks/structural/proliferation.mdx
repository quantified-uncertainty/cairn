...
maturity: Growing
quality: 59
llmSummary: Comprehensive analysis showing AI capability gaps between frontier and open-source models decreased from ~18 months to ~6 months (2022-2024), creating governance challenges through inevitable diffusion. Examines proliferation drivers (publication norms, economic incentives, efficiency gains), concrete case studies (LLaMA leak, state adoption), and competing governance strategies (compute controls vs. futility thesis).
