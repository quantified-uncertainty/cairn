...
| **Regulatory Impact** | Severe if unaddressed | <EntityLink id="eu-ai-act">EU AI Act</EntityLink>, RSPs, and compute governance depend on capability thresholds that sandbagging can circumvent |
