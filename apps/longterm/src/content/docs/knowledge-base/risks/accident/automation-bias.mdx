...
maturity: Mature
quality: 91
llmSummary: Comprehensive analysis of automation bias in AI systems, documenting cross-domain impacts (healthcare accuracy drops 69 percentage points with incorrect AI guidance, 392 NHTSA-reported ADAS crashes, $5,000 legal sanctions for AI-generated fake citations). Covers psychological mechanisms (System 1/2 dynamics, authority bias), hallucination rates (23-79% depending on context), skill degradation research showing 30% of US workers at risk, and mitigation strategies including training that reduces commission but not omission errors.
...
| Legal | Lawyers sanctioned for AI fake citations | $5,000 fine per attorney | [Mata v. Avianca 2023](https://caselaw.findlaw.com/court/us-dis-crt-sd-new-yor/2335142.html) |
