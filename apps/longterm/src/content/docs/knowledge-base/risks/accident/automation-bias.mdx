...
maturity: Mature
quality: 40
llmSummary: Analyzes automation bias - the tendency to over-trust AI outputs - through psychological mechanisms, cross-domain examples (healthcare, autonomous vehicles, legal), and the LLM hallucination problem (69% hallucination rate in medical queries). Identifies skill degradation and adversarial exploitation as key risks but lacks quantified interventions or decision frameworks for prioritization.
