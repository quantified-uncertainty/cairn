...
description: >-
  The tendency to over-trust AI systems and accept their outputs without
  appropriate scrutiny, leading to error propagation, skill degradation, and
  compromised decision-making in human-AI collaboration.
sidebar:
  order: 27
maturity: Mature
quality: 72
llmSummary: >-
  Reviews psychological research on automation bias showing humans over-rely on
  AI outputs even when wrong, with specific findings like 23% increased
  acceptance of incorrect information when presented with visualizations and 18%
  more missed cancers by radiologists when AI gives false negatives. Documents
  systematic manifestations across healthcare, autonomous vehicles, legal
  practice, and financial services, with particular emphasis on LLM
  hallucination risks where confident falsity undermines verification behaviors.
...
---
import {DataInfoBox, DataExternalLinks} from '../../../../../components/wiki';
