...
The paper was authored by a team of <EntityLink id="anthropic">Anthropic</EntityLink> researchers including Logan Graham, Jared Kaplan, Sören Mindermann, Ryan Greenblatt, Buck Shlegeris, Nicholas Schiefer, and Ethan Perez.[^1] The research was published on arXiv (2401.05566) in January 2024 and is hosted on Anthropic's research page.[^1][^5]
