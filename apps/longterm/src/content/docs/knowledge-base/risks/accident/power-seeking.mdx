...
| **<EntityLink id="deceptive-alignment">Deceptive Alignment</EntityLink>** | Confirmed in lab settings | [Anthropic alignment faking (Dec 2024)](https://www.anthropic.com/research/alignment-faking): 78% alignment-faking reasoning after RLHF training against the behavior |
