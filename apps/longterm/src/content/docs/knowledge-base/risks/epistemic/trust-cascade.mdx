...
description: >-
  A systemic risk where declining trust in institutions creates a cascading
  collapse, potentially accelerated by AI, where no trusted entity remains
  capable of rebuilding trust in others, threatening societal coordination and
  governance.
sidebar:
  order: 20
maturity: Neglected
quality: 68
llmSummary: >-
  Analyzes systemic risk where declining institutional trust creates
  self-reinforcing collapse, finding current trust at concerning levels (media
  32%, federal government 16%) and identifying AI capabilities for synthetic
  evidence and coordinated disinformation as unprecedented acceleration factors
  that could trigger cascade failures beyond institutions' capacity to rebuild
  credibility.
...
---
import {DataInfoBox, KeyQuestions, R, DataExternalLinks} from '../../../../../components/wiki';
