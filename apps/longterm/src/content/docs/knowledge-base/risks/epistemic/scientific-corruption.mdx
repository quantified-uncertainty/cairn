...
maturity: Emerging
quality: 49
llmSummary: Documents AI-enabled scientific fraud with evidence that ~2% of submissions are from paper mills, 300,000+ fake papers exist, and detection tools are losing an arms race against AI generation. Projects 2027-2030 scenarios ranging from controlled degradation (40% probability) to epistemic collapse (20% probability) affecting medical treatments and policy decisions.
