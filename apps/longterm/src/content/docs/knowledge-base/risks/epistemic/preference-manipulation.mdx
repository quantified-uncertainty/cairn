...
> **For comprehensive analysis**, see [Preference Authenticity](/ai-transition-model/parameters/preference-authenticity), which covers:
...
See [Preference Authenticity](/ai-transition-model/parameters/preference-authenticity) for detailed intervention analysis.
...
### Primary Reference
- **[Preference Authenticity](/ai-transition-model/parameters/preference-authenticity)** — Comprehensive parameter page with mechanisms, measurement, and interventions
