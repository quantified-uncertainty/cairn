...
maturity: Growing
quality: 91
llmSummary: "Analyzes trust erosion as an AI risk, documenting how declining institutional confidence (US government: 73% in 1958 → 17% in 2025) undermines coordination on existential risks. Identifies the 'liar's dividend' as a key mechanism where deepfake possibility undermines all evidence—research across 15,000 participants shows politicians claiming 'fake news' gain support vs. apologizing. AI scale asymmetry (34M images/day, 8M deepfakes projected by 2025) outpaces verification capacity. Media literacy interventions show d=0.60 effect size; C2PA standard fast-tracked to ISO 22144."
