...
> **For comprehensive analysis**, see [Human Expertise](/ai-transition-model/parameters/human-expertise), which covers:
...
See [Human Expertise](/ai-transition-model/parameters/human-expertise) for detailed analysis.
...
### Primary Reference
- **[Human Expertise](/ai-transition-model/parameters/human-expertise)** — Comprehensive parameter page with mechanisms, domains, and interventions
...
### Related Parameters
- [Human Agency](/ai-transition-model/parameters/human-agency) — Expertise enables meaningful choice
- [Human Oversight Quality](/ai-transition-model/parameters/human-oversight-quality) — Expertise foundation for oversight
- [Epistemic Health](/ai-transition-model/parameters/epistemic-health) — Collective knowledge maintenance
