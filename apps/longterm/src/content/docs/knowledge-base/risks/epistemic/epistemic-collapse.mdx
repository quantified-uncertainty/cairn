...
llmSummary: >-
  ...
  factual consensus, accelerated by AI-generated synthetic content that overwhelms
  verification systems and erodes institutional trust.
...
- <EntityLink id="echo-chambers" /> dominate online dynamics across major platforms[^9]
...
- Public adaptation and <EntityLink id="media-literacy" /> improvements
...
**Platform Responses**
- <EntityLink id="content-moderation" /> scaling with AI assistance
...
- <EntityLink id="media-literacy" /> programs for critical evaluation skills
