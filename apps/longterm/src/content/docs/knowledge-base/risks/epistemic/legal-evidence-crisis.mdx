...
quality: 72
llmSummary: >-
  Documents how AI-generated content threatens legal systems' ability to verify
  evidence authenticity, creating both fake evidence admission risks and 'liar's
  dividend' problems where real evidence is dismissed. Provides comprehensive
  taxonomy of evidence types at risk with multiple data tables showing current
  developments (2019-2024) and failure modes of authentication technologies.
