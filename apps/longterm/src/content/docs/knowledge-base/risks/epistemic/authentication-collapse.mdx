...
maturity: Emerging
quality: 91
llmSummary: Analyzes authentication collapse—when verification systems fail to distinguish AI-generated from human content. Documents declining detection accuracy (human accuracy 24.5% for video, 55% overall in meta-analysis of 56 papers; AI detectors drop 50% on novel fakes). WEF Global Risks 2025 ranks misinformation as top global risk; economic costs reach $78-89B annually. C2PA/Content Credentials (6,000+ members) and hardware attestation offer partial solutions, but arms race dynamics favor generators.
...
metrics:
  ...
  diagrams: 0
---
import {DataInfoBox, KeyQuestions, R, DataExternalLinks, Mermaid} from '../../../../../components/wiki';
...
|-----------|------------|----------|
| **Severity** | High | [WEF Global Risks Report 2025](https://www.weforum.org/stories/2025/07/financial-impact-of-disinformation-on-corporations/) ranks misinformation/disinformation as top global risk |
| **Likelihood** | High (70-85%) | Human deepfake detection at 24.5% for video, 55% overall ([meta-analysis](https://www.sciencedirect.com/science/article/pii/S2451958824001714)); detection tools drop 50% on novel fakes |
