...
quality: 70
llmSummary: >-
  Reality fragmentation occurs when society splits into incompatible information
  environments with fundamentally different beliefs about basic facts, not just
  opinions. This epistemic risk undermines democratic governance and social
  coordination by eliminating shared truth foundations.
lastEdited: "2026-01-31"
importance: 30
seeAlso: reality-coherence
causalLevel: outcome
pageType: risk-analysis
...
| <EntityLink id="trust-erosion" /> | *Do people trust institutions?* | Declining confidence in authorities and expertise |
| <EntityLink id="misinformation" /> | *Are false claims spreading?* | Individual false narratives rather than systemic fragmentation |
...
- <EntityLink id="motivated-reasoning" /> overrides truth-seeking
...
- Creates vulnerability to <EntityLink id="information-warfare" /> and manipulation
...
- <EntityLink id="filter-bubbles" /> become increasingly isolated
...
- Can <EntityLink id="media-literacy" /> programs reduce fragmentation?
...
- <EntityLink id="polarization" />: Social divisions enabling reality fragmentation
- <EntityLink id="information-warfare" />: Deliberate exploitation of fragmented reality
- <EntityLink id="social-media-manipulation" />: Platforms amplifying fragmentation
- <EntityLink id="institutional-trust" />: Trust erosion enabling competing realities
