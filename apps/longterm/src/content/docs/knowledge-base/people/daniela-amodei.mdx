...
llmSummary: "Profile documents Daniela Amodei's role as President of Anthropic, overseeing business operations and policy strategy while scaling responsible AI deployment ($7.3B raised). Shows how she bridges commercial viability with safety priorities through enterprise partnerships, policy engagement, and responsible scaling frameworks."
---
import {Backlinks, R, EntityLink} from '../../../../components/wiki';

## Overview

Daniela Amodei is Co-founder and President of <EntityLink id="anthropic">Anthropic</EntityLink>, one of the leading AI safety-focused labs developing Constitutional AI and Claude models. As President, she oversees business operations, policy strategy, and commercial deployment while ensuring alignment with Anthropic's safety mission. Her leadership has been instrumental in Anthropic's growth from a safety research lab to a \$1.1 billion company that has raised over \$7.3 billion in funding.
