...
| **Experience** | 16+ years in x-risk research (since 2009); worked with MIRI, CFAR, <EntityLink id="ea-global">EA Global</EntityLink>, <EntityLink id="founders-fund">Founders Fund</EntityLink> |
