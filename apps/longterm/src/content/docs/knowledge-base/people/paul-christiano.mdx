...
|-------|------------------|------------------|-------------|
| [Alignment difficulty](/knowledge-base/risks/accident/) | Prosaic solutions sufficient | Need fundamental breakthroughs ([MIRI](/knowledge-base/organizations/safety-orgs/miri/)) | Different research priorities |
| [Takeoff speeds](/ai-transition-model/takeoff/) | Gradual, time to iterate | Fast, little warning | Different preparation strategies |
...
### Long-term (2032-2040)
- Approach to [transformative AI](/ai-transition-model/factors/ai-capabilities/)
