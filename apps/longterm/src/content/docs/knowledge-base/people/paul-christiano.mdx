...
importance: 23.5
---
import {DataInfoBox, DisagreementMap, EstimateBox, Backlinks, R, EntityLink, DataExternalLinks} from '../../../../components/wiki';
...
### Long-term (2032-2040)
- Approach to <EntityLink id="__index__/ai-transition-model/factors/ai-capabilities">transformative AI</EntityLink>
