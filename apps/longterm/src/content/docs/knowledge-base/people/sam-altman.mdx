...
Former board member <EntityLink id="helen-toner">Helen Toner</EntityLink> later provided detailed explanations for the board's decision:
...
| **Safety processes** | Provided "inaccurate information" about safety procedures | <EntityLink id="helen-toner">Helen Toner</EntityLink> |
...
For a detailed analysis of Altman's predictions and their accuracy, see the **[full track record page](/knowledge-base/people/track-records/sam-altman-predictions/)**.
