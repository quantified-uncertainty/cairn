...
sidebar:
  order: 10
quality: 40
llmSummary: "Comprehensive biographical profile of Open Philanthropy's co-CEO who has directed $300M+ toward AI safety, developing influential frameworks like the 'Most Important Century' thesis (~15% transformative AI by 2036, 50% by 2060) and the bio anchors methodology. Documents his strategic decisions including the $580M Anthropic investment and field growth from ~20 to ~400 FTE researchers, though offers limited novel analysis beyond aggregating public information."
...
|---------------|---------------|----------------|-----------|
| Technical alignment | \$100M+ | <EntityLink id="anthropic">Anthropic</EntityLink>, <EntityLink id="redwood">Redwood Research</EntityLink> | Direct work on making AI systems safer |
...
- <EntityLink id="miri">MIRI funding</EntityLink>: Early support for foundational AI alignment research
...
Based on public statements and Open Phil priorities from 2023-2024, Karnofsky's views reflect a combination of timeline estimates derived from technical forecasting and strategic assessments about field readiness and policy urgency:
...
| Field adequacy (2024) | Still severely underfunded | Despite directing over \$100M toward AI safety and growing the field from approximately 20 to 400+ FTE researchers, Open Philanthropy continues aggressive hiring and grantmaking. This assessment reflects the belief that the scale of the challenge—ensuring safe development of transformative AI—far exceeds current resources and talent devoted to it. |
| Policy urgency (2024) | High priority | Open Phil has significantly increased governance focus, funding policy research, placing fellows in government positions, and supporting regulatory frameworks. This shift recognizes that technical alignment work alone is insufficient—institutional and policy responses are critical to managing AI development trajectories and preventing racing dynamics. |
...
- <EntityLink id="nick-bostrom">Nick Bostrom</EntityLink> - Author of "Superintelligence," early influence on Open Phil AI focus
- <EntityLink id="eliezer-yudkowsky">Eliezer Yudkowsky</EntityLink> - MIRI founder, recipient of early Open Phil AI safety grants
