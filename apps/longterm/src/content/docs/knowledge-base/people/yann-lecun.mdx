...
sidebar:
  order: 9
quality: 72
llmSummary: Comprehensive profile of Yann LeCun documenting his foundational contributions to deep learning (CNNs, backpropagation) alongside his consistent skepticism of AI existential risk claims. Covers his technical arguments that LLMs cannot achieve AGI, his advocacy for open-source AI, his debates with fellow Turing laureates Hinton and Bengio, and his 2025 departure from Meta to pursue world model research at AMI Labs.
...
<DataInfoBox entityId="yann-lecun" />
...
| **No Self-Preservation** | AI need not have survival drives | Instrumental convergence may produce such drives |
...
### Predictions About AI Progress

LeCun has made several specific predictions about the trajectory of AI development:

| Prediction | Timeline | Status |
|------------|----------|--------|
| **LLMs will plateau** | 2023-2025 | Ongoing debate |
| **World models will surpass LLMs** | 3-5 years | Not yet validated |
| **Current GenAI will be obsolete** | 3-5 years | Speaking at Davos 2025 |
| **Human-level AI via new architectures** | Decades, if ever | Long-term prediction |

At the World Economic Forum in Davos (January 2025), LeCun stated: "Nobody in their right mind would use [current GenAI systems] anymore, at least not as the central component of an AI system" within three to five years, predicting a revolution in AI architectures.
