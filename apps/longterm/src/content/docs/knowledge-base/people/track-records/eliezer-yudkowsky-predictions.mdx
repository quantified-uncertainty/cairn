...
| Date | Claim | Type | Status | Source |
|------|-------|------|--------|--------|
| 2022-23 | OpenAI should run on custom chips to prevent code theft | In-person conversation | N/A (advice) | [Bloomberg](https://www.bloomberg.com/news/newsletters/2023-03-08/openai-ceo-sam-altman-s-twitter-feud-with-ai-doomer-eliezer-yudkowsky-explained) |
