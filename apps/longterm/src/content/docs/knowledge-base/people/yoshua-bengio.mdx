...
importance: 25
---
import {DataInfoBox, EstimateBox, Backlinks, R, EntityLink} from '../../../../components/wiki';

<DataInfoBox entityId="yoshua-bengio" />

## Overview

Yoshua Bengio is one of the three "Godfathers of AI" who won the 2018 Turing Award alongside <EntityLink id="geoffrey-hinton">Geoffrey Hinton</EntityLink> and Yann LeCun for foundational work in deep learning. His transformation from pure capabilities researcher to AI safety advocate represents one of the most significant shifts in the field, bringing immense credibility to AI risk concerns.
...
- **Partnership with <EntityLink id="anthropic">Anthropic</EntityLink>**: Constitutional AI research
