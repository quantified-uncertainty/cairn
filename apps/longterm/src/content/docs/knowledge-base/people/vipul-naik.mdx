...
| **Key Projects** | <EntityLink id="donations-list-website">Donations List Website</EntityLink> (tracking \$72.8B), Contract Work Portal (\$255K funded), <EntityLink id="wikipedia-views">Wikipedia Views</EntityLink>, Open Borders advocacy |
