...
sidebar:
  order: 1
quality: 48
llmSummary: "Biographical overview of Eliezer Yudkowsky covering his foundational role in AI safety (co-founding MIRI in 2000, developing CEV), current views (>90% P(doom), extreme pessimism on alignment difficulty), and influence on the field through community building and problem formulation. No quantitative analysis of his specific contributions' impact on current prioritization decisions."
lastEdited: "2025-12-24"
importance: 22
---
import {DataInfoBox, Section, DisagreementMap, Backlinks, DataExternalLinks} from '../../../../components/wiki';
