...
sidebar:
  order: 1
quality: 26
llmSummary: Comprehensive biographical profile of Eliezer Yudkowsky covering his foundational contributions to AI safety (CEV, early problem formulation, agent foundations) and notably pessimistic views (>90% p(doom)). Documents his strategic positions favoring capability slowdown and international coordination, while noting his polarizing status in the field.
