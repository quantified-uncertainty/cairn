...
quality: 72
importance: 70
llmSummary: Comprehensive profile of Evan Hubinger documenting his foundational theoretical contributions (mesa-optimization, inner alignment, deceptive alignment) at MIRI, his empirical alignment stress-testing work at Anthropic (sleeper agents, alignment faking, sycophancy to subterfuge), and his unique research approach using model organisms of misalignment. Covers career trajectory from Harvey Mudd through OpenAI to Anthropic leadership, key publications with 3,400+ citations, and strategic perspectives on prosaic alignment.
