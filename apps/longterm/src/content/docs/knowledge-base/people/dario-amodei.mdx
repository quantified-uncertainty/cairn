...
sidebar:
  order: 3
quality: 72
llmSummary: "Dario Amodei (Anthropic CEO) estimates 10-25% catastrophic AI risk with AGI timeline 2026-2030, advocating 'race to the top' through Constitutional AI and Responsible Scaling Policies with defined capability thresholds (ASL-1 to ASL-5). His empirical alignment approach contrasts with pause advocates, demonstrating safety-commercial viability with $7B+ funding."
...
| AGI Timeline | High probability | 2026-2030 | Substantial chance this decade | <R id="f1247f92ea8d022a">Senate Testimony 2023</R> |
...
- <R id="68ecccf07cda51c7">Training a Helpful and Harmless Assistant with RLHF (2022)</R>
...
- [Alignment](/knowledge-base/risks/accident/) is hard but solvable with sustained effort
...
### Timeline and [Takeoff](/ai-transition-model/takeoff/) Scenarios
...
- [Racing dynamics](/knowledge-base/risks/structural/racing-dynamics/) make responsible scaling impossible
...
| <R id="ec456e4a78161d43">80,000 Hours Podcast</R> | 2023 | AI safety career advice | Shaped researcher priorities |
