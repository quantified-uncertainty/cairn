...
---
import {DataInfoBox, Backlinks, DataExternalLinks} from '@components/wiki';
...
Dan Hendrycks is the director of the <EntityLink id="cais">Center for AI Safety</EntityLink> (CAIS) and a prominent researcher focused on catastrophic and existential risks from AI. He has made significant contributions to both technical AI safety research and public awareness of AI risks.
