...
The long-timelines worldview predicts significantly longer development horizons than short-timelines perspectives, fundamentally altering strategic priorities for AI safety research and intervention planning.

| Expert/Source | Estimate | Reasoning |
|---------------|----------|-----------|
| Long-timelines view | 20-40+ years | Based on historical patterns of AI overoptimism, fundamental limitations of current deep learning paradigms, and skepticism that scaling alone will achieve general intelligence. Current systems lack robust generalization, abstract reasoning, and common sense understanding that may require paradigm shifts beyond incremental improvements. Multiple independent bottlenecks (compute costs, data availability, algorithmic breakthroughs) likely slow progress substantially. |
