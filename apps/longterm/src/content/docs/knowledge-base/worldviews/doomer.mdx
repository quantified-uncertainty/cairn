...
importance: 52
quality: 45
llmSummary: Comprehensive overview of the "doomer" worldview in AI safety, characterized by short timelines (10-15 years to AGI), fundamental alignment difficulty, and high existential risk (30-90% P(doom)). Covers core technical arguments (orthogonality thesis, instrumental convergence, one-shot problem), key proponents (Yudkowsky, MIRI), and implications for prioritization (focus on agent foundations, pause advocacy, deception detection over incremental approaches like RLHF).
ratings:
  novelty: 2.5
  rigor: 4
  actionability: 5.5
...
metrics:
  ...
  diagrams: 0
---
import {EstimateBox, Tags, R, DataExternalLinks} from '../../../../components/wiki';
