...
description: >-
  This model analyzes institutional adaptation rates to AI. It finds
  institutions change at 10-30% of needed rate per year while AI creates 50-200%
  annual gaps, with regulatory lag historically spanning 15-70 years.
relatedRisks:
  - lock-in
...
importance: 62.5
llmSummary: >-
  Analyzes institutional adaptation rates to AI using comparative historical
  data (15-70 year regulatory lags) and quantitative models showing institutions
  change at 10-30% of needed rate while AI creates 50-200% annual gaps. Provides
  systematic framework across domains (employment, information integrity) with
  specific timeline estimates for adaptation stages.
...
- [Racing Dynamics Model](/knowledge-base/risks/structural/racing-dynamics/) - Competitive pressures on institutions
