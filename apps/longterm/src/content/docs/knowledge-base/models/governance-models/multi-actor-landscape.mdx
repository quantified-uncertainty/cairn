...
ratings:
  ...
  completeness: 6.5
importance: 73.5
llmSummary: "Quantitative model showing actor identity determines 40-60% of AI x-risk variance. US-China capability gap collapsed from 9.26% to 1.70% (2024-2025), open-source within 1.70% of frontier. Estimates combined x-risk at 25% across four pathways (singleton 8%, conflict 6%, misuse 7%, authoritarian lock-in 5%)."
