...
ratings:
  ...
  completeness: 6.5
importance: 72.5
llmSummary: Analysis of how AI x-risk depends on which actors develop TAI, using 2024-2025 data showing US-China capability gap narrowed from 9.26% to 1.70% and open-source closed to within 1.70% of frontier. Estimates actor identity determines 40-60% of risk variance, with combined x-risk at ~25% across four pathways (unaligned singleton 8%, multi-agent conflict 6%, authoritarian lock-in 5%, catastrophic misuse 7%).
