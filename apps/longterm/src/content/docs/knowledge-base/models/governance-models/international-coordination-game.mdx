...
Critical dependencies include [capabilities development timelines](/ai-transition-model/timelines/) that determine available coordination windows, [alignment difficulty](/knowledge-base/risks/accident/) that sets stakes for cooperation versus racing, and [takeoff speeds](/ai-transition-model/takeoff/) that influence whether coordination can adapt to rapid capability changes.
