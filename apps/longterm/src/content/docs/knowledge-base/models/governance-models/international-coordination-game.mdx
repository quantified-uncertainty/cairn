...
ratings:
  ...
  completeness: 6.5
importance: 74.5
llmSummary: "Game-theoretic analysis demonstrates defection dominates in US-China AI coordination when cooperation probability falls below 50%, with formal payoff matrices showing mutual racing (2,2) as Nash equilibrium despite Pareto-optimal cooperation (4,4). Models identify verification asymmetry (85-95% for compute, 5-15% for algorithms) and assigns 60-70% probability to continued deterioration through 2030, with three intervention priorities: Track 2 diplomacy ($10-20M/year), verification technology ($50-200M over 5 years), and middle power coordination."
