...
ratings:
  ...
  actionability: 7
importance: 42.5
llmSummary: "Model analyzes public AI risk opinion evolution, finding major incidents shift opinion 10-25 percentage points with 6-12 month half-life, while elite opinion has 3-5x stronger policy influence than public opinion. Recommends prioritizing elite engagement over mass public campaigns, with current US concern at 48% (2024) vs 25% (2020)."
...
metrics:
  ...
  tables: 28
  diagrams: 1
clusters: ["governance", "epistemics", "ai-safety"]
---
