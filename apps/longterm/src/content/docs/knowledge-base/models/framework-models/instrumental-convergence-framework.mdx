...
---
import {DataInfoBox, Mermaid, Backlinks, R, EntityLink} from '../../../../../components/wiki';
...
|----------|------------|---------------|
| Strong convergence | <R id="2ccf0b6518e285d6">Stuart Russell</R>, <EntityLink id="nick-bostrom">Nick Bostrom</EntityLink> | Mathematical inevitability, biological precedents |
...
| <EntityLink id="redwood">Redwood Research</EntityLink> | Empirical alignment | Goal gaming detection |
