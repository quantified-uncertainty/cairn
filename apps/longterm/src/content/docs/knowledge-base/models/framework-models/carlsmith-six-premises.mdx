...
quality: 85
importance: 83.5
llmSummary: "Carlsmith's six-premise framework decomposes AI x-risk into conditional probabilities (P1: 65% advanced AI by 2070, P2: 80% deployment incentives, P3: 40% alignment harder, P4: 65% power-seeking, P5: 40% disempowerment, P6: 95% catastrophe), yielding ~5% risk, updated to >10%. Superforecasters estimated ~0.4% combined risk, with largest disagreements on P3 (alignment difficulty) and P4 (power-seeking likelihood)."
...
In 2023, Carlsmith worked with [Good Judgment's superforecasters](https://goodjudgment.com/superforecasting-ai/) to test his estimates. The project ran from August to October 2022, with a follow-up round in spring 2023, funded by Open Philanthropy. Key findings from <R id="8d9f2fea7c1b4e3a">the comparison study</R>:
...
| P2 (Incentives) | <EntityLink id="__index__/ai-transition-model/factors/misuse-potential">Misuse Potential</EntityLink> |
| P3 (Alignment) | <EntityLink id="__index__/ai-transition-model/factors/misalignment-potential">Misalignment Potential</EntityLink> |
| P4 (Power-Seeking) | <EntityLink id="__index__/ai-transition-model/factors/misalignment-potential">Misalignment Potential</EntityLink> |
...
### External Resources
- <R id="6e597a4dc1f6f860">Original report (2022)</R> — Full 80-page Open Philanthropy report, also available on [arXiv](https://arxiv.org/abs/2206.13353)
