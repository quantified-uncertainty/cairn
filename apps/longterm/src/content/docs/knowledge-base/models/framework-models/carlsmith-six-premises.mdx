...
description: >-
  Joe Carlsmith's probabilistic decomposition of AI existential risk into six
  conditional premises. Originally estimated ~5% risk by 2070, updated to >10%.
  The most rigorous public framework for structured x-risk estimation.
ratings:
  novelty: 3
  rigor: 5
  actionability: 4
...
importance: 90
llmSummary: >-
  Carlsmith's 2022 report decomposes AI x-risk into six conditional premises:
  (1) advanced AI developed by 2070 (65%), (2) strong deployment incentives
  (80%), (3) alignment harder than misalignment (40%), (4) misaligned AI seeks
  power (65%), (5) power-seeking scales to disempowerment (40%), (6)
  disempowerment is catastrophic (95%). Combined estimate: >10% existential
  catastrophe by 2070. Superforecaster comparison showed P3 and P4 as key
  cruxes.
