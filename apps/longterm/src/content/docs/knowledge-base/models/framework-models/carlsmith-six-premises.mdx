...
quality: 64
importance: 82
llmSummary: "Carlsmith's six-premise framework decomposes AI x-risk into conditional probabilities (P1: 65% advanced AI by 2070, P2: 80% deployment, P3: 40% alignment harder, P4: 65% power-seeking, P5: 40% disempowerment, P6: 95% catastrophe), yielding ~5% combined risk, updated to >10%. Superforecasters estimate ~0.4% (10-25x lower), with largest disagreements on P3 (alignment difficulty) and P4 (power-seeking likelihood)."
