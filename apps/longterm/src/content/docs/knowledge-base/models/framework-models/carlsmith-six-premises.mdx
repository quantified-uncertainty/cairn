...
| P3 focus | [Alignment Robustness](/ai-transition-model/parameters/alignment-robustness) parameter |
| P4 focus | [Power-Seeking Conditions](/knowledge-base/models/power-seeking-conditions/) model |
| P2 dynamics | [Racing Intensity](/ai-transition-model/parameters/racing-intensity) parameter |
