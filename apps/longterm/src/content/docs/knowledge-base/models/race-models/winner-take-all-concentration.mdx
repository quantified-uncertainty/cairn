...
ratings:
  ...
  completeness: 7
importance: 72.5
llmSummary: Mathematical model of AI capability concentration showing net loop gain G≈1.2-2.0 (above 1.0 threshold for self-reinforcing concentration), driven by data flywheels (1.3-1.6x amplification), compute advantages (1.2-2.0x), talent concentration (1.1-1.4x), and network effects (1.0-1.3x). Projects top 4 actors controlling 85-92% market share by 2030 (HHI 2,800-4,000+) with 35% probability of accelerating concentration, identifying high-leverage interventions including antitrust enforcement and public compute infrastructure ($3-10M per 1% HHI reduction).
...
- <EntityLink id="economic-disruption-impact" label="Economic Disruption Impact" /> — Inequality consequences of AI concentration
