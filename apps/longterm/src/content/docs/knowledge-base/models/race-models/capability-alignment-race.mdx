...
|-------------|-------|---------------|----------|
| <EntityLink id="anthropic">Anthropic</EntityLink> | Constitutional AI | \$500M | Constitutional training |
| <EntityLink id="deepmind">DeepMind</EntityLink> | Alignment team | \$100M | Scalable oversight |
| <EntityLink id="miri">MIRI</EntityLink> | Agent foundations | \$15M | Theoretical foundations |
...
- <EntityLink id="open-vs-closed">Open vs. Closed</EntityLink>: Model release policies and proliferation speed
