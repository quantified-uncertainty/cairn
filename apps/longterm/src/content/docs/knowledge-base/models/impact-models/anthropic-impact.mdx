...
<DataInfoBox entityId="anthropic-impact" ratings={frontmatter.ratings} />
...
1. Anthropic is one of three frontier AI labs (with <EntityLink id="openai">OpenAI</EntityLink> and <EntityLink id="google-deepmind">Google DeepMind</EntityLink>)
