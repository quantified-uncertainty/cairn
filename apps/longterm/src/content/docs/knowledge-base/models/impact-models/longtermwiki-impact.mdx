...
description: "Rigorous Fermi estimation of LongtermWiki's potential value, grounded in base rates from GiveWell, 80k Hours, think tanks, and knowledge infrastructure projects. Central estimate: $100-500K/yr effective value with high uncertainty."
sidebar:
  order: 40
quality: 55
ratings:
...
<DataInfoBox entityId="longtermwiki-impact" ratings={frontmatter.ratings} />
