...
ratings:
  ...
  completeness: 6
importance: 62.5
llmSummary: "This model quantifies how AI surveillance creates chilling effects on expression and political participation, estimating 50-70% reduction in dissent within months and 80-95% within 1-2 years under comprehensive surveillance. It provides measurement frameworks across multiple domains and estimates 10-20 year minimum recovery timelines, with specific funding recommendations ($1-2B/year for counter-surveillance tools)."
