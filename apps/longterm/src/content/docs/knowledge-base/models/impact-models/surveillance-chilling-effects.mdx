...
description: >-
  This model quantifies AI surveillance impact on expression and behavior. It
  estimates 50-70% reduction in dissent within months, reaching 80-95% within
  1-2 years under comprehensive surveillance.
sidebar:
  order: 28
quality: 72
...
importance: 45
llmSummary: >-
  Uses empirical data from China, Russia, and Hong Kong to quantify surveillance
  chilling effects, finding 50-70% reduction in dissent within months and 80-95%
  within 1-2 years. Provides measurement framework across self-reports, content
  analysis, and behavioral proxies with specific correlation coefficients (r =
  -0.7 to -0.85).
