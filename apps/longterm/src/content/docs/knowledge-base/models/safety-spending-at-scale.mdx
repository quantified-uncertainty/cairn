...
flowchart LR
    ...
    PHD -->|"60% stay in safety"| WORK[Safety Workforce<br/>~200-350 new/yr]
    WORK -->|"Over 5 years"| TOTAL[Total: ~3,000-5,000]

    style UG fill:#e0e0e0
    style TOTAL fill:#ccffcc
`} />

The fundamental bottleneck for scaling safety spending is human capital. The current pipeline produces approximately 200-350 new safety researchers per year. To absorb \$5-10B/year productively, the field would need 10,000-15,000 researchers—implying a 3-5x increase in the pipeline sustained over several years.
...
1. **Commit to a minimum safety allocation** (5% of total spending, rising to 10% as budgets grow)
2. **Fund independent safety research** (at least 20% of safety budget should go to external, independent researchers)
3. **Publish safety spending transparently** (annual reports with verifiable figures)
4. **Provide model access** (safety researchers need access to frontier models to do useful work)
...
1. **Mandate minimum safety spending** (analogous to R&D tax requirements or safety regulations in other industries)
2. **Fund public safety evaluation infrastructure** (independent testing analogous to FDA)
3. **Invest in academic safety programs** through research grants, center funding, and fellowship programs
4. **Create international coordination mechanisms** to prevent a regulatory race to the bottom
