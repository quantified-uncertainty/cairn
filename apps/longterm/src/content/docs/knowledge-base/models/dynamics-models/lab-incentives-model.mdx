...
relatedRisks:
  ...
  - lock-in
importance: 64.5
llmSummary: Analyzes how competitive pressure, investor demands, and reputation effects shape AI lab safety decisions, estimating misaligned incentives contribute 10-25% of total AI risk. Provides concrete intervention recommendations (whistleblower protections, third-party audits, liability frameworks) and argues most current work focuses on wrong leverage points (visible announcements vs. structural changes).
