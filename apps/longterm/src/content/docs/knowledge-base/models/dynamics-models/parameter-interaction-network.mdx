...
ratings:
  ...
  completeness: 5
importance: 58
llmSummary: This model maps causal relationships between 22 AI safety parameters, identifying 7 feedback loops and showing epistemic-health and institutional-quality as highest-leverage intervention points through network analysis with 4 clusters (epistemic→governance→technical→exposure).
