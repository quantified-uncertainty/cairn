...
description: >-
  This model analyzes game-theoretic dynamics of AI competition traps. It
  estimates 20-35% probability of partial coordination, 5-10% of catastrophic
  competitive lock-in, with compute governance offering 20-35% risk reduction.
sidebar:
  order: 21
quality: 88
...
importance: 82.5
llmSummary: >-
  Game-theoretic analysis showing AI competition systematically drives unsafe
  outcomes even when actors prefer safety, with cooperation probability dropping
  from 81% (2 actors) to 21% (15 actors). Estimates 5-10% catastrophic lock-in
  risk within 3-7 years, with compute governance offering 20-35% risk reduction
  as highest-leverage intervention.
...
| **Mar 2023** | <R id="f5041642fb213c07">Anthropic Claude release</R> | Matches accelerated timeline | Constitutional AI insufficient buffer |
| **Jul 2023** | <R id="69c685f410104791">Meta Llama 2 open-source</R> | Capability diffusion escalation | Open weights proliferation |
...
|-----------|--------------------------|----------------------------|----------------|----------|
| **[Compute governance](/knowledge-base/responses/governance/compute-governance/)** | High | 20-35% risk reduction | <R id="0748954ed8e210a3">Export controls</R> only | 2-5 years |
