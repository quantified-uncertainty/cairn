...
ratings:
  ...
  completeness: 7
importance: 72.5
llmSummary: Game-theoretic analysis shows cooperation probability drops from 81% (2 actors) to 21% (15 actors), estimating 20-35% probability of partial coordination and 5-10% risk of catastrophic competitive lock-in. Compute governance identified as highest-leverage intervention offering 20-35% risk reduction, with current indicators showing deployment cycles compressed from 18-24 months to 3-6 months.
