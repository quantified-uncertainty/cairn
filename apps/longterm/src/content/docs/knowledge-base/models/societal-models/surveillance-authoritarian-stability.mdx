...
ratings:
  ...
  completeness: 6.5
importance: 62
llmSummary: "This model synthesizes historical regime collapse data (Geddes dataset: military regimes last 9 years, single-party 30 years) with evidence from 80+ countries adopting Chinese surveillance technology to project that AI-enabled authoritarian regimes may be 2-3x more durable than historical autocracies, reducing 20-year collapse probability from 35-50% to 10-20% through preemptive suppression and elite monitoring. Key uncertainty is whether economic collapse and elite defection pathways remain viable despite surveillance."
