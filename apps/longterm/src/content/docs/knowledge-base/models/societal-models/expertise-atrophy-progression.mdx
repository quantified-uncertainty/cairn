...
ratings:
  ...
  completeness: 6
importance: 58.5
llmSummary: "Five-phase model of AI-induced skill loss shows humans declining to 50-70% baseline capability in Phase 3 (years 5-15), with irreversibility occurring at Phase 4 transition (10-30 years) when last pre-AI experts retire and infrastructure assumes AI. Navigation and HFT already at Phase 4; programming/radiology approaching critical threshold in 10-20 years."
