...
ratings:
  ...
  completeness: 6
importance: 62.5
llmSummary: Five-phase model of AI-driven skill atrophy from augmentation to irreversible loss, finding humans decline to 50-70% baseline capability in Phase 3 (5-15 years) with critical irreversibility threshold at Phase 3→4 transition (10-30 years from AI introduction). Identifies high-leverage interventions including mandatory skill maintenance and protected training pipelines, with domain-specific timelines showing navigation/HFT already at Phase 4 while programming/radiology at Phase 2-3.
