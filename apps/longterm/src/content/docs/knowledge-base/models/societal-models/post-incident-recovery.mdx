...
ratings:
  ...
  completeness: 5.5
importance: 42.5
llmSummary: This model analyzes recovery from AI incidents across five types (contained technical to alignment failures), finding that clear attribution enables 3-5x faster detection, preserved expertise can reduce recovery time 50-100x, and recommends allocating 5-10% of safety resources to recovery planning focused on trust/epistemic recovery and skill preservation.
