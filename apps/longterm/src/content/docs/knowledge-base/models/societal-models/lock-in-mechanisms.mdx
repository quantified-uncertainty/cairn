...
This model provides a quantitative framework for assessing AI-enabled lock-in risk, complementing the comprehensive mechanism analysis in [Lock-in Risk](/knowledge-base/risks/structural/lock-in/).

**For detailed coverage of mechanisms, current trends, and responses, see [Lock-in Risk](/knowledge-base/risks/structural/lock-in/).**
...
For intervention analysis, see [Lock-in Risk: Responses](/knowledge-base/risks/structural/lock-in/#responses-that-address-this-risk).
