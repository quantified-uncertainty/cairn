...
ratings:
  ...
  completeness: 5
importance: 42
llmSummary: "This model analyzes AI-enabled consensus manufacturing, estimating 15-40% shifts in perceived opinion distribution and 5-15% actual opinion shifts from sustained campaigns, with detection rates of only 30-50% for sophisticated operations. The analysis covers mechanisms (synthetic majority illusion, authority amplification), vulnerabilities across platforms and populations, and intervention strategies ranging from platform architecture changes to media literacy programs."
