...
ratings:
  ...
  completeness: 5
importance: 48.5
llmSummary: Model analyzes AI-enabled consensus manipulation, estimating 15-40% shifts in perceived opinion distribution and 5-15% actual opinion shifts from sustained campaigns. Identifies detection effectiveness at 30-50% for sophisticated operations and proposes platform architecture changes and verification infrastructure as highest-leverage interventions.
