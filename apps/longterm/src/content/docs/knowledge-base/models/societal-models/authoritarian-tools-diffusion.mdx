...
ratings:
  ...
  completeness: 7.3
importance: 68.5
llmSummary: "Analysis of AI surveillance diffusion to authoritarian regimes finding semiconductor supply chains are the highest-leverage intervention point (5-10 year delay achievable), but this advantage erodes as domestic manufacturing develops. Estimates 80+ countries have adopted Chinese surveillance tech, with 20-40% reduction in successful protests and 30-50% increase in regime longevity, though comprehensive export controls face major coordination challenges."
...
metrics:
  ...
  tables: 21
  diagrams: 1
clusters: ["ai-safety", "governance", "cyber"]
---
