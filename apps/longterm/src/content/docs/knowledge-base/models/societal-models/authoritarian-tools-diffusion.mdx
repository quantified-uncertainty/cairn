...
ratings:
  ...
  completeness: 7.3
importance: 72.5
llmSummary: This model analyzes AI surveillance diffusion to authoritarian regimes through five pathways (commercial sales, development assistance, joint ventures, indigenous development, illicit acquisition), finding semiconductor supply chains offer highest leverage for 5-10 years before erosion. Quantifies regime stability enhancement at 20-40%, estimates 80+ countries have Chinese surveillance tech in a $30-50B market, and ranks six intervention strategies by effectiveness.
