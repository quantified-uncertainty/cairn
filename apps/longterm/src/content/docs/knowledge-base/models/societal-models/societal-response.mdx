...
ratings:
  ...
  completeness: 6
importance: 58.5
llmSummary: "Quantifies societal response capacity to AI at 20-25% of needed levels, finding a 3-5 year institutional lag with only 35% probability institutions respond in time. Estimates $550M-1.1B/year investment needed to close gaps in regulatory capacity (20% current), legislative speed (24+ month median), and international coordination (30% effective)."
