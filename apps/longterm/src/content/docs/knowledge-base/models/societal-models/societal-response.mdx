...
ratings:
  ...
  completeness: 4
importance: 72.5
llmSummary: Quantifies societal response capacity to AI developments across 20+ variables (public concern ~50%, institutional capacity ~20-25%, safety funding ~$1B/year), arguing collective response determines outcomes more than technical factors. Models causal relationships between incidents, public opinion, institutional capacity, and coordination effectiveness with specific confidence intervals. Drawing on 2025 Pew and Gallup surveys showing 97% support for AI regulation but only 20-25% institutional readiness.
...
| Safety research funding | \$1-2B/year | \$0.5-3B | Medium | [Open Philanthropy](https://www.openphilanthropy.org/request-for-proposals-technical-ai-safety-research/), government budgets |
