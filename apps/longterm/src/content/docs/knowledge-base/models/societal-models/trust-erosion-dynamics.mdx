...
description: >-
  This model analyzes how AI systems erode institutional trust. It identifies
  authentication failure and expertise displacement as key mechanisms driving
  erosion.
sidebar:
  order: 34
quality: 68
...
importance: 52
llmSummary: >-
  This model analyzes five mechanisms by which AI erodes institutional, expert,
  information, interpersonal, and technology trust, with quantitative thresholds
  showing US media trust at 24% (near critical 25% threshold) and interpersonal
  trust declining from 48% (2010) to 38% (2025). Trust erodes 3-10x faster than
  it builds, creating cascading effects across trust types.
