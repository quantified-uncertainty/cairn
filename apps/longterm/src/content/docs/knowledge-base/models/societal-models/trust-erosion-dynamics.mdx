...
ratings:
  ...
  completeness: 5.5
importance: 62
llmSummary: Framework analyzing how AI erodes trust through five mechanisms (deepfakes, disinformation, surveillance, expert displacement, authentication collapse), finding trust erodes 3-10x faster than it builds and estimating US institutional trust at 18-30% approaching critical thresholds. Proposes interventions including authenticity infrastructure and institutional reform, though acknowledges rebuilding takes generations.
