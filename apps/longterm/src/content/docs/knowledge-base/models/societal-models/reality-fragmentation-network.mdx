...
ratings:
  ...
  completeness: 5.5
importance: 52.5
llmSummary: Models reality fragmentation as network partitioning from AI personalization, projecting fragmentation index increase from current F≈0.60-0.70 to F≈0.85-0.95 by 2035, with coordination failure thresholds at F>0.75. Recommends algorithmic diversity mandates ($100-300M, reduces F by 0.05-0.10) and shared reality zones ($50-150M), identifying 3-10x funding gaps across intervention categories.
