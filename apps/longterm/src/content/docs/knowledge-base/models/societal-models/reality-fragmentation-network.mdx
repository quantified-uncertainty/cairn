...
ratings:
  ...
  completeness: 4.5
importance: 42.5
llmSummary: "This model analyzes AI-driven reality fragmentation as a network problem, projecting society will move from current F=0.60-0.70 to F=0.85-0.95 by 2035, with critical thresholds at F=0.85 preventing collective coordination. Recommends $500M-1B/year in platform mitigation (currently $50-200M) and algorithmic diversity mandates to reduce F by 0.05-0.10."
