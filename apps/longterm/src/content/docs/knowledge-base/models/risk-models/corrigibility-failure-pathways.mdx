...
description: >-
  This model maps pathways from AI training to corrigibility failure, with
  quantified probability estimates (60-90% for capable optimizers) and
  intervention effectiveness (40-70% reduction). It analyzes six failure
  mechanisms including instrumental convergence, goal preservation, and
  deceptive corrigibility with specific mitigation strategies.
ratings:
  novelty: 4
  rigor: 4
  actionability: 5
...
importance: 85.5
llmSummary: >-
  Systematically maps six pathways to corrigibility failure with quantified
  probabilities (60-90% for capable optimizers without intervention) and
  intervention effectiveness (40-70% reduction). Provides risk matrices across
  capability levels, pathway interaction multipliers (2-4x), and evidence-based
  mitigation strategies for each failure mechanism.
...
| **Severe Failure Probability** | 5-15% | 25-50% | 50-75% | [Capabilities timeline](/knowledge-base/forecasting/agi-timeline) |
...
| Assessment Factor | Rating | Evidence |
|-------------------|---------|----------|
| **Probability (Advanced AI)** | 20-50% | <R id="683aef834ac1612a">Anthropic's Constitutional AI research</R> |
...
For advanced AI systems approaching [AGI capabilities](/ai-transition-model/factors/ai-capabilities/):
...
| **Difficult but Achievable** | 45% | <R id="afe2508ac4caf5ee">Anthropic team</R>, [Redwood Research](/knowledge-base/organizations/safety-orgs/redwood/) | Constitutional AI, iterated training |
...
|--------------|------------|---------------|
| [MIRI](/knowledge-base/organizations/safety-orgs/miri/) | Theoretical foundations | <R id="ee872736d7fbfcd5">Agent Foundations research</R> |
| [Anthropic](/knowledge-base/organizations/labs/anthropic/) | Constitutional AI methods | <R id="f771d4f56ad4dbaa">Safety research publications</R> |
| [Redwood Research](/knowledge-base/organizations/safety-orgs/redwood/) | Empirical safety training | <R id="42e7247cbc33fc4c">Alignment research</R> |
