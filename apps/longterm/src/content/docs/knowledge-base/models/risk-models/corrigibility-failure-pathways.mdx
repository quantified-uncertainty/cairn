...
For advanced AI systems approaching <EntityLink id="__index__/ai-transition-model/factors/ai-capabilities">AGI capabilities</EntityLink>:
...
| **Difficult but Achievable** | 45% | <R id="afe2508ac4caf5ee">Anthropic team</R>, <EntityLink id="redwood">Redwood Research</EntityLink> | Constitutional AI, iterated training |
...
- <EntityLink id="redwood">Redwood Research</EntityLink>: Empirical corrigibility training
...
| <EntityLink id="redwood">Redwood Research</EntityLink> | Empirical safety training | <R id="42e7247cbc33fc4c">Alignment research</R> |
