...
These assumptions warrant continued investigation as <EntityLink id="__index__/ai-transition-model/factors/ai-capabilities">AI capabilities</EntityLink> advance and our understanding of alignment difficulty deepens.
