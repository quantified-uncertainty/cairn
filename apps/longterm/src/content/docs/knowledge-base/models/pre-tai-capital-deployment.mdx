...
<DataInfoBox entityId="pre-tai-capital-deployment" ratings={frontmatter.ratings} />

## Overview

The frontier AI industry is deploying capital at a scale with few historical precedents. In 2025 alone, the five largest AI-adjacent companies (Microsoft, Google, Amazon, Meta, and Oracle) committed over \$300 billion in combined capital expenditure, much of it directed toward AI infrastructure.[^1][^2] Individual AI labs are raising and spending at scales that would have seemed implausible even two years earlier: <EntityLink id="openai">OpenAI</EntityLink> anchors the \$500 billion Stargate project, <EntityLink id="anthropic">Anthropic</EntityLink> has raised \$37B+ at a \$350B valuation on \$9B ARR, and Google has committed \$75B in 2025 capex largely for AI.[^3][^4][^5]
...
|----------|-------------|----------------|---------------------|-----------------------|
| **Big Tech Capex** (AI-related) | ≈\$180B | ≈\$320B | \$250-400B/year | \$1.2-2.0T |
...
Current safety spending across the industry is approximately \$500M-1B/year, representing roughly 1-3% of total AI lab spending.[^9] This is widely considered inadequate given the stakes.

| Lab | Estimated Safety Spend | % of Total | Safety Researchers | Focus Areas |
|-----|------------------------|------------|--------------------|----|
| **Anthropic** | \$200-400M/year | 5-8% | 100-200+ | Constitutional AI, interpretability, evals |
...
| **Total Big Tech AI Capex (2025)** | \$320B+ | 1 year | \$320B+ | Millions | AI infrastructure |
...
The ratio of capabilities spending to safety spending is the single most important variable in this analysis. At current ratios (roughly 100:1 capabilities to safety), the industry is building increasingly powerful systems with a relatively thin safety margin.
...
3. **Safety is the variable**: The difference between 1% and 5% safety allocation on a \$200B budget is \$8 billion—enough to transform the entire safety research ecosystem. This is the highest-leverage target for external influence.

4. **The window is now**: Pre-TAI is the period when spending patterns are being established. Once infrastructure is built and organizational cultures are set, changing allocation becomes much harder.

5. **Other orgs must adapt**: The speed and scale of AI lab spending requires fundamentally different planning approaches from governments, philanthropies, academia, and civil society. Traditional timelines and budgets are inadequate.
