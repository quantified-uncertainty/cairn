...
importance: 82.5
llmSummary: Comprehensive quantitative analysis finding current 300-800 unfilled AI safety positions (30-50% gap) could worsen to 50-60% shortfall by 2027, with training pipelines producing only 220-450 researchers annually versus 500-1,500 needed. Identifies four critical bottlenecks and provides costed intervention analysis showing scaled MATS-style programs could add 200 researchers/year for $15-30M, with 2-4x ROI compared to opportunity costs.
