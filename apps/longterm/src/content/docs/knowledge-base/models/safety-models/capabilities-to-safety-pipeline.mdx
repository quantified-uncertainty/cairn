...
ratings:
  ...
  completeness: 7
importance: 78.5
llmSummary: This model quantifies the capabilities-to-safety researcher transition pipeline, finding severe bottlenecks with only 10-15% of aware ML researchers considering transitions and 60-75% blocked at the action stage. Training programs like MATS achieve 60-80% conversion at $20-40K per transition, while fellowships cost $50-100K, suggesting coordinated investment of $50M annually could plausibly double the 200-400 annual transition rate.
