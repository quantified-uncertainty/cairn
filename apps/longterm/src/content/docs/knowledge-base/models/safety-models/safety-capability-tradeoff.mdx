...
importance: 73.5
llmSummary: This model analyzes when AI safety measures conflict with or complement capabilities, finding most safety interventions impose 5-15% capability costs (OpenAI) to 15-30% (Anthropic), with techniques like RLHF actually improving useful capabilities by 10-30%. The framework identifies three relationship types (competitive, complementary, orthogonal) and shows racing dynamics systematically undermine safety investment absent coordination.
