...
importance: 72.5
llmSummary: "Analyzes when safety measures trade off against AI capabilities, finding most interventions impose 5-15% capability costs but RLHF shows +15-25% gains and Safe RLHF achieves 50x harm reduction while improving helpfulness. Under racing dynamics (60-75% probability), safety becomes competitively disadvantageous, creating systematic underinvestment absent coordination."
