...
ratings:
  ...
  completeness: 6.5
importance: 73.5
llmSummary: "This model identifies three equilibria for AI lab safety culture: racing-dominant (current state with 5-15% engineering capacity on safety), safety-competitive (requiring 20-40% safety investment), and regulation-imposed (15-25% uniform investment). Transition probabilities over 5 years: racing→regulation 40-60% (incident-driven), racing→safety-competitive 15-25% (coordination), with specific interventions like third-party audits estimated to shift reputation value parameter by +0.1-0.2."
