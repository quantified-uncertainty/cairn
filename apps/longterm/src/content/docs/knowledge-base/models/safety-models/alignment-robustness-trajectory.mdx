...
description: >-
  This model analyzes how alignment robustness changes with capability scaling.
  It estimates current techniques maintain 60-80% robustness at GPT-4 level but
  projects degradation to 30-50% at 100x capability, with critical thresholds
  around 10x-30x current capability.
sidebar:
  order: 38
quality: 68
...
importance: 80
llmSummary: >-
  Models how alignment robustness degrades as AI capabilities scale. Current
  RLHF/Constitutional AI techniques provide 60-80% robustness at GPT-4
  capability level. Projects degradation to 30-50% at 100x capability due to
  optimization pressure, distributional shift, and deception incentives.
  Identifies 10x-30x capability as critical threshold zone requiring new
  techniques.
