...
ratings:
  ...
  completeness: 7
importance: 78.5
llmSummary: Mathematical model shows AI capability diffusion compressed from 24-36 months (2020) to 12-18 months (2024), projecting 6-12 months by 2025-2026, with acceleration factor α≈0.15/year. Identifies compute governance (70-85% effective) and pre-deployment gates (60-80% effective) as high-leverage interventions before irreversible open-source proliferation, with expected 5,000 annual misuse events at full Tier 4-5 proliferation.
