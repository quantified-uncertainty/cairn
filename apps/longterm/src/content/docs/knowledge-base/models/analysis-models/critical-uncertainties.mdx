...
ratings:
  ...
  completeness: 6.5
importance: 78.5
llmSummary: "Synthesizes 35 empirically-grounded uncertainties across AI risk domains (compute, governance, capabilities) with quantitative estimates: scaling laws may break at 10^26-10^30 FLOP, 41-51% of experts assign >10% extinction probability, AGI median 2027-2031, safety funding at 1:33 ratio. Identifies $100-200M/year research budget could resolve key cruxes (scaling law breakdown, deception detection, alignment tax) that drive 60% of risk estimate variance."
