...
ratings:
  ...
  completeness: 7
importance: 82.5
llmSummary: Quantitative portfolio analysis framework estimating misalignment accounts for 40-70% of AI x-risk, misuse 15-35%, and structural risks 10-25%. Based on 2024 funding data ($110-130M external), recommends rebalancing toward governance (underfunded by ~$15-20M) and agent safety (~$7-12M gap), with specific allocation varying by timeline assumptions.
