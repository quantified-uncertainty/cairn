...
description: >-
  Mathematical framework showing how AI risks compound beyond additive effects
  through four mechanisms (multiplicative probability, severity multiplication,
  defense negation, nonlinear effects). Racing+deceptive alignment combinations
  show 3-8% catastrophic probability, with interaction coefficients of 2-10x
...
importance: 78.5
llmSummary: >-
  Mathematical framework demonstrates AI risks compound through four mechanisms
  (multiplicative probability, severity multiplication, defense negation,
  nonlinear effects), with racing+deceptive alignment showing 3-8% catastrophic
  probability versus 4.5% baseline additive. Provides quantitative interaction
  coefficients (α=2-10x) showing traditional models underestimate total risk by
  2-5x, enabling prioritization of compound pathway interventions.
...
When multiple AI risks occur simultaneously, their combined impact often dramatically exceeds simple addition. This mathematical framework analyzes how [racing dynamics](/knowledge-base/risks/structural/racing-dynamics/), [deceptive alignment](/knowledge-base/risks/accident/deceptive-alignment/), and [lock-in scenarios](/knowledge-base/risks/structural/irreversibility/) interact through four compounding mechanisms. The central insight: a world with three moderate risks isn't 3x as dangerous as one with a single risk—it can be 10-20x more dangerous due to multiplicative interactions.
...
| [Expertise Atrophy](/knowledge-base/risks/epistemic/expertise-atrophy/) + Corrigibility Failure | Defense negation | Variable | 3.3x | Medium-High |
...
**Mechanism**: [Racing dynamics](/knowledge-base/risks/structural/racing-dynamics/) compress safety timelines → inadequate testing → higher probability of [mesa-optimization](/knowledge-base/risks/accident/mesa-optimization/) → higher probability of [deceptive alignment](/knowledge-base/risks/accident/deceptive-alignment/).
...
| Moderate [expertise atrophy](/knowledge-base/risks/epistemic/expertise-atrophy/) | 35% | 30% | 19.5% (3.3x) |
...
| [Mesa-optimization](/knowledge-base/risks/accident/mesa-optimization/) + [Scheming](/knowledge-base/risks/accident/scheming/) | 3.0-6.0 | 2-6% | <R id="c4858d4ef280d8e6">Hubinger et al. (2019)</R> |
| Expertise Atrophy + Corrigibility Failure | 2.0-4.0 | 5-12% | <R id="eecd7c0e9ebb9cbe">RAND Corporation</R> |
| [Concentration](/knowledge-base/risks/structural/winner-take-all/) + [Authoritarian Tools](/knowledge-base/risks/misuse/authoritarian-tools/) | 3.0-5.0 | 5-12% | <R id="a306e0b63bdedbd5">Center for AI Safety</R> |
