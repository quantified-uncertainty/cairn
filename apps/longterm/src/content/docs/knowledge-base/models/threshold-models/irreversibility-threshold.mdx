...
ratings:
  ...
  completeness: 6
importance: 64.5
llmSummary: This model analyzes when AI decisions become locked-in through technical, economic, social, political, and existential dimensions, estimating 25% probability of crossing infeasible-reversal thresholds by 2035 with a 4-5 year expected intervention window. The framework provides cost curves showing exponential growth in reversal difficulty (2-5x per year), case studies across four domains, and scenario analysis showing 45% probability of competitive lock-in as the most likely trajectory.
