...
ratings:
  ...
  completeness: 6.5
importance: 76.5
llmSummary: This model analyzes five thresholds where AI speed exceeds human oversight capacity (200-500ms recognition, 1-2s intervention, comprehension, cascade, recursive). Financial markets have already crossed T1-T2 (operating at microsecond speeds vs human seconds), with 40% probability that 3+ domains exceed intervention threshold by 2030, requiring immediate speed limits and circuit breakers in critical infrastructure.
