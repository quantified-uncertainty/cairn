...
description: >-
  This model identifies thresholds where AI speed exceeds human oversight
  capacity. Current systems already operate 10-10,000x faster than humans in key
  domains, with oversight thresholds crossed in many areas.
sidebar:
  order: 22
quality: 78
...
importance: 77.5
llmSummary: >-
  Identifies five thresholds where AI speed exceeds human oversight capacity,
  with quantitative analysis showing financial markets already operate 10,000x
  faster than humans (T1-T2 crossed), content moderation at millions of
  decisions/day beyond review, and projections showing multiple domains
  approaching T4 (cascade criticality) by 2030. Provides mathematical criteria
  for each threshold and concrete speed ratios across domains.
