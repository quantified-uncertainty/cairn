...
importance: 64
llmSummary: Models epistemic collapse as threshold phenomenon with four capacities (verification, consensus, update, decision) crossing critical values around E=0.35. Estimates 35-45% probability of authentication-triggered collapse by 2027-2035, with intervention effectiveness declining sharply after 2027 prevention window closes.
