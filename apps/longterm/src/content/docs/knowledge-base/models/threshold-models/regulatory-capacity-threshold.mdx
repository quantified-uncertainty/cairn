...
ratings:
  ...
  completeness: 6
importance: 72
llmSummary: Models regulatory capacity using multiplicative decomposition (human capital × authority × scope) and finds current US/UK capacity at 0.15-0.25 versus 0.4-0.6 threshold needed, with capacity growing 15%/year while industry grows 100-200%/year. Projects 3-5 year window before gap becomes irreversible without crisis-level investment increasing capacity growth by 80-150%.
