...
description: >-
  This model estimates minimum regulatory capacity for credible AI oversight. It
  finds current US/UK capacity at 0.15-0.25 of the 0.4-0.6 threshold needed,
  with a 3-5 year window to build capacity before capability acceleration makes
  catch-up prohibitively difficult.
sidebar:
  order: 37
quality: 68
...
importance: 70
llmSummary: >-
  Models the ratio of regulatory capacity to industry capability needed for
  credible oversight. Current ratio is 0.15-0.25; threshold for effectiveness is
  0.4-0.6. Identifies hiring (technical staff), authority (legal powers), and
  coordination (international scope) as key bottlenecks. Projects 3-5 year
  window before capability growth makes capacity-building prohibitively
  difficult.
...
- [Institutional Adaptation Speed](/knowledge-base/models/institutional-adaptation-speed/) - How fast institutions can adapt
- [Racing Dynamics Impact](/knowledge-base/models/racing-dynamics-impact/) - Why capacity matters for racing
- [Parameter Interaction Network](/knowledge-base/models/parameter-interaction-network/) - How regulatory-capacity connects to other parameters
- [Safety Culture Equilibrium](/knowledge-base/models/safety-culture-equilibrium/) - Regulation-imposed equilibrium conditions
