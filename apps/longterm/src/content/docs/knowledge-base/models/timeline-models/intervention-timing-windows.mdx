...
ratings:
  ...
  completeness: 7.5
importance: 87.5
llmSummary: "Strategic timing model quantifying closure rates for four critical AI safety intervention windows (2024-2028): compute governance (70% closure by 2027, 24 months median remaining), international coordination (60% by 2028, 30 months), lab safety culture (80% by 2026, 12 months), and regulatory precedent (75% by 2027, 20 months). Recommends reallocating 20-30% of resources from stable-window work to closing-window interventions, with specific portfolio shifts from 15-20% to 40-45% on closing windows."
