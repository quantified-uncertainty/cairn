...
ratings:
  ...
  completeness: 6.8
importance: 72.5
llmSummary: "Quantitative timeline model projecting authentication system collapse across modalities: text detection already at random-chance (~50%), images declining 5-10%/year (threshold crossing 2026-2028), audio/video following similar trajectories. Projects 25-35% probability of rapid collapse by 2029-2030, with cumulative adaptation costs of $425B-1.7T globally, though notes market forces and institutional adaptation may substantially mitigate these outcomes."
...
metrics:
  ...
  tables: 38
  diagrams: 1
clusters: ["ai-safety", "cyber", "epistemics"]
---
