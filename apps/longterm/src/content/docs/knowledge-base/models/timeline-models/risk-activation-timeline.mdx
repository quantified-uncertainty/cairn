...
|------|--------|------------------|------------------|---------|
| **<EntityLink id="reward-hacking">Reward hacking</EntityLink>** | Active | Documented in all RLHF systems | Partial guardrails | No clear progress |
...
|-----------------|-----------|-----------|-----------------|
| **Disinformation proliferation** | <EntityLink id="epistemic-collapse">Epistemic collapse</EntityLink> | Trust erosion accelerates | -1 to -2 years |
...
- <EntityLink id="economic-disruption-impact" /> - Labor market transformation
