...
description: >-
  This model projects when AI achieves autonomous cyber attack capability across
  a 5-level spectrum. Current assessment shows ~50% progress toward full
  autonomy, with Level 3 attacks already documented and Level 4 projected by
  2029-2033 based on capability analysis of reconnaissance, exploitation, and
...
importance: 78.5
llmSummary: >-
  Models AI autonomous cyber attack capability progression across 5 levels,
  concluding current systems are ~50% toward full autonomy (Level 4) with
  September 2025 marking first Level 3 campaign. Projects Level 4 achievement by
  2029-2033 with $3-5T annual losses, based on quantified capability gaps across
  7 domains (reconnaissance 80%, exploitation 50%, persistence 30%).
...
**September 2025 marked a critical threshold**: <R id="0e46bc2e525e992b">Anthropic documented</R> the first large-scale AI-orchestrated cyberattack targeting ~30 organizations across tech, finance, and government sectors. This campaign achieved what researchers classify as Level 3 autonomy—AI-directed operations with minimal human intervention.
...
| **[Economic Disruption](/knowledge-base/risks/structural/economic-disruption/)** | 3-7 years | Medium-High | Medium | #3 near-term |
...
- [Multipolar Trap](/knowledge-base/risks/structural/multipolar-trap/) - International competition driving autonomous weapons development
- [Racing Dynamics](/knowledge-base/risks/structural/racing-dynamics/) - Competitive pressures accelerating capability development
