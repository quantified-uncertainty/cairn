...
ratings:
  ...
  completeness: 7
importance: 78.5
llmSummary: "This model estimates AI's marginal contribution to bioweapons risk through systematic uplift analysis across actor types and attack phases. Key finding: current knowledge uplift is modest (1.0-1.2x per RAND 2024) but evasion uplift is concerning (2-3x, potentially 7-10x by 2028), suggesting defensive investments should prioritize adaptive DNA screening over information restriction."
