...
ratings:
  ...
  actionability: 8
importance: 76.5
llmSummary: "Systematic model quantifying AI's marginal contribution to bioweapons risk, finding asymmetric uplift: evasion capabilities (2-3x current, potentially 7-10x by 2028) substantially exceed knowledge uplift (1.0-1.2x), with projected overall uplift increasing from 1.3-2.5x (2024) to 3-5x by 2030. Recommends prioritizing adaptive DNA synthesis screening ($200-400M/year) over information restrictions, as evasion uplift could undermine defenses before policy response."
...
metrics:
  ...
  tables: 37
  diagrams: 1
clusters: ["ai-safety", "biorisks", "governance"]
---
