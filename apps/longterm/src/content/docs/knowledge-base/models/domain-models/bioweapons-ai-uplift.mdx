...
description: >-
  This model estimates AI's marginal contribution to bioweapons risk over time.
  It projects uplift increasing from 1.3-2.5x (2024) to 3-5x by 2030, with
  biosecurity evasion capabilities posing the greatest concern as they could
...
importance: 85.5
llmSummary: >-
  Quantitative model estimating AI's marginal contribution to bioweapons risk
  across actor types and attack phases, finding modest current knowledge uplift
  (1.0-1.2x per RAND) but concerning evasion capabilities (2-3x, potentially
  7-10x by 2028). Analysis reveals critical asymmetry: AI helps attackers
  circumvent biosecurity defenses more than it aids synthesis, suggesting
  adaptive screening should be prioritized over information restriction.
...
Critically, the risk landscape is evolving rapidly. The [CSIS report](https://www.csis.org/analysis/opportunities-strengthen-us-biosecurity-ai-enabled-bioterrorism-what-policymakers-should) on AI-enabled bioterrorism (August 2025) notes that while OpenAI and Anthropic initially reported "little to no uplift" in 2024 assessments, both labs have since updated their evaluations to flag "substantial and immediate biorisks." OpenAI concluded in April 2025 that it expects its models to demonstrate "high risks" in the near future—meaning they could substantially increase the likelihood and frequency of bioterrorist attacks by providing meaningful assistance to novices. This rapid evolution underscores the importance of dynamic uplift assessment rather than static point-in-time evaluations.
...
- [Attack Chain Model](/knowledge-base/models/domain-models/bioweapons-attack-chain/) - Contextualizes how uplift fits into overall attack risk
- [Timeline Model](/knowledge-base/models/timeline-models/bioweapons-timeline/) - Projects when uplift becomes critically dangerous
