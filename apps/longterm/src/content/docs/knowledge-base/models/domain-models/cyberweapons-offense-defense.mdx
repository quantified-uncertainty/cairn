...
ratings:
  ...
  completeness: 7
importance: 78.5
llmSummary: "Quantitative model estimating AI shifts cyber offense-defense balance by 30-70% toward attackers (B_OD ratio 1.2-1.8), driven by 1.5-2.0× vulnerability discovery and 2.0-3.0× automation scaling advantages. Highest-priority interventions are government defensive AI R&D ($3-5B annually, -0.2 to -0.4 impact on balance), mandatory security standards, and threat intelligence sharing, with 35% probability offense advantage widens to 1.8-2.2 by 2027 absent intervention."
