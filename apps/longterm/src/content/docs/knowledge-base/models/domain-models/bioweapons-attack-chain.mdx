...
ratings:
  ...
  completeness: 7.5
importance: 84.5
llmSummary: Quantitative attack chain model decomposes AI-assisted bioweapons into seven sequential steps, finding overall catastrophic attack probability of 0.02-3.6% with state actors representing 80% of risk. DNA synthesis screening provides 5-15% risk reduction for $1-20M annually (most cost-effective), while metagenomic surveillance offers 15-25% reduction for $500M, validating defense-in-depth strategies.
