...
ratings:
  ...
  completeness: 7
importance: 82.5
llmSummary: "Quantitative model decomposing AI-assisted bioweapons attacks into 7 sequential steps finds overall attack probability of 0.02-3.6%, with state actors representing 80% of catastrophic risk. Defense-in-depth interventions like DNA synthesis screening ($100M annually, 5-15% risk reduction) and metagenomic surveillance ($500M annually, 15-25% reduction) offer high cost-effectiveness due to multiplicative probability structure."
