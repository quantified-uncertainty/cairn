...
- [Light Scaffolding](/knowledge-base/models/intelligence-paradigms/light-scaffolding) - Simpler tool use patterns
- [Dense Transformers](/knowledge-base/models/intelligence-paradigms/dense-transformers) - Underlying model architecture
- [AI Control Problem](/knowledge-base/risks/accident/loss-of-control/) - Broader control challenges
