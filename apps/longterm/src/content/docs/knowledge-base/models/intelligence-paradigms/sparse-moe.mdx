...
- [Dense Transformers](/knowledge-base/models/intelligence-paradigms/dense-transformers) - The simpler baseline
- [Heavy Scaffolding](/knowledge-base/models/intelligence-paradigms/heavy-scaffolding) - How MoE models are deployed
- [SSM/Mamba](/knowledge-base/models/intelligence-paradigms/ssm-mamba) - Alternative efficient architecture
