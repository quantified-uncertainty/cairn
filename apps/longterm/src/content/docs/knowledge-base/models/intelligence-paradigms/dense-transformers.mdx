...
| Llama 3 405B | 405B | 126 | 128K | ~$50M |
...
- [Sparse/MoE Transformers](/knowledge-base/models/intelligence-paradigms/sparse-moe) - Efficiency-focused variant
- [Heavy Scaffolding](/knowledge-base/models/intelligence-paradigms/heavy-scaffolding) - How transformers are deployed
- [Mechanistic Interpretability](/knowledge-base/responses/alignment/interpretability/) - Efforts to understand internals
