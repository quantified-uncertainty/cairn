...
- [Dense Transformers](/knowledge-base/models/intelligence-paradigms/dense-transformers) - The current dominant paradigm
- [SSM/Mamba](/knowledge-base/models/intelligence-paradigms/ssm-mamba) - A recent alternative architecture
- [Neuromorphic](/knowledge-base/models/intelligence-paradigms/neuromorphic) - Hardware-level novelty
- [Neuro-Symbolic](/knowledge-base/models/intelligence-paradigms/neuro-symbolic) - Combining known approaches
