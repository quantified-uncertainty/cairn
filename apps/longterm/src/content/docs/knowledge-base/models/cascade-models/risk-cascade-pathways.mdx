...
description: >-
  Analysis of how AI risks trigger each other in sequential chains, identifying
  5 critical pathways with cumulative probabilities of 1-45% for catastrophic
  outcomes. Racing dynamics leading to corner-cutting represents highest
  leverage intervention point with 80-90% trigger probability.
sidebar:
  order: 52
quality: 88
ratings:
...
importance: 84.5
llmSummary: >-
  Quantitative analysis of five AI risk cascade pathways using RAND methodology,
  finding 10-45% conditional probability for technical-structural fusion cascade
  and identifying corner-cutting from racing dynamics as highest-leverage
  intervention point with 80-90% trigger probability. Provides detection
  framework with early warning indicators and specific intervention windows (2-7
  years) for each cascade type.
...
This analysis identifies five primary cascade pathways with probabilities ranging from 1-45% for full cascade completion. The highest-leverage intervention opportunities occur at "chokepoint nodes" where multiple cascades can be blocked simultaneously. [Racing dynamics](/knowledge-base/risks/structural/racing-dynamics/) emerge as the most critical upstream initiator, triggering 80-90% of technical and power concentration cascades within 1-2 years.
...
The most direct path from [racing dynamics](/knowledge-base/risks/structural/racing-dynamics/) to catastrophic [corrigibility failure](/knowledge-base/risks/accident/corrigibility-failure/):
...
**Key Evidence**: During COVID-19, regions with higher automated medical screening showed 40% more diagnostic errors when systems failed, demonstrating [expertise atrophy](/knowledge-base/risks/epistemic/expertise-atrophy/) effects.
