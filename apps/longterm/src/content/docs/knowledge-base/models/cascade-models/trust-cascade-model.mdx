...
ratings:
  ...
  completeness: 6.5
importance: 67.5
llmSummary: Models institutional trust collapse as network contagion, finding critical thresholds at 30-40% trust below which institutions lose validation capacity and cascades become self-reinforcing. Estimates 45-60% probability of media-initiated cascade within 5 years, with AI multiplying attack effectiveness 60-5000x while degrading defenses 30-90%.
