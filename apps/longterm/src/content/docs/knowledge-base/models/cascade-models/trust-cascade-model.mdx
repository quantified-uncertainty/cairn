...
ratings:
  ...
  completeness: 7
importance: 72.5
llmSummary: "This model analyzes institutional trust collapse as network contagion, finding critical thresholds at 30-40% trust below which cascades become self-reinforcing. AI amplifies attacks 60-5000x while degrading defenses 60-90%, with current US institutions (media 32%, government 20%) already in cascade-vulnerable state, giving 2-5 year intervention window."
