...
ratings:
  ...
  completeness: 7.3
importance: 67.5
llmSummary: "This model analyzes how over-reliance on AI creates self-reinforcing cascades where trust exceeds actual reliability, projecting 10-25%/year skill atrophy rates and 50%+ loss of independent verification capability within 5 years in AI-dependent domains. It estimates 70-85% probability of major automation bias incidents by 2030, with healthcare showing 25-35% probability of 5K-50K deaths from diagnostic blind spots over 10 years."
