...
- <EntityLink id="lock-in-mechanisms" label="Lock-in Irreversibility Model" /> - Provides framework for understanding when automation dependence transitions from reversible efficiency choice to irreversible structural constraint
