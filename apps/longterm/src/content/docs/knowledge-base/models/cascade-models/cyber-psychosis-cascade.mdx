...
ratings:
  ...
  completeness: 5.5
importance: 44
llmSummary: "Models how AI-generated content triggers psychological harm cascades through three pathways (targeted campaigns, mass confusion, dependency), estimating 1-10% cascade probability by 2030 with expected harm of 4.73/10. Identifies 1-3% of population as highly vulnerable (5-10x risk multiplier) and projects 1.5-3% dependency rate by 2027, with defense currently 2-5 years behind offense capabilities."
