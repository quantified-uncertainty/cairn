...
ratings:
  ...
  completeness: 5.1
importance: 48.5
llmSummary: Model analyzes AI-generated content triggering psychological harm cascades, estimating 1-3% of population highly vulnerable with 5-10x risk multipliers, projecting 4.73/10 expected harm by 2030 across four scenarios (15% rapid cascade, 40% gradual accumulation). Identifies 5-10x funding gaps in detection/authentication infrastructure and mental health capacity, though estimates rely heavily on extrapolation from limited empirical data.
