...
importance: 72.5
llmSummary: Economic model analyzing AI safety research returns, estimating current $500-700M/year global spending is significantly below optimal with 2-5x marginal returns available. Recommends 3-10x funding increases across sectors ($1-2B philanthropic, $600M industry, $1B government) with priority shifts toward alignment theory (10%→20%) and governance research (10%→15%).
