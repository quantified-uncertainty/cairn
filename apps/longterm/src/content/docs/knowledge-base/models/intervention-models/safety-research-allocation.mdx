...
relatedRisks:
  ...
  - enfeeblement
importance: 82.5
llmSummary: "Quantifies AI safety research misallocation across sectors, finding industry controls 60-70% of ~$700M annual spending while critical areas like multi-agent dynamics (5% actual vs 15% optimal) and corrigibility (3% vs 10%) receive 3-5x less funding than warranted. Provides concrete intervention costs: $100M for 20 endowed academic chairs, $50M annually for compute infrastructure, with specific retention and capacity-building strategies."
