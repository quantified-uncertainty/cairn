...
ratings:
  ...
  completeness: 6
importance: 78.5
llmSummary: This framework systematically maps three belief dimensions (timelines, alignment difficulty, coordination feasibility) to four worldview clusters showing 2-10x differences in optimal intervention priorities, with specific portfolio recommendations for each. It identifies that 20-50% of field resources may be wasted through worldview-work misalignment and provides concrete decision procedures for individuals, organizations, and funders.
