...
|----------------------|----------|-------------|----------------------|
| Technical safety research | **Very High** | 8-12x via direct solutions | <EntityLink id="anthropic">Anthropic</EntityLink>, <EntityLink id="redwood">Redwood</EntityLink> |
...
| **<EntityLink id="redwood">Redwood Research</EntityLink>** | Technical optimist | Alignment research, interpretability |
