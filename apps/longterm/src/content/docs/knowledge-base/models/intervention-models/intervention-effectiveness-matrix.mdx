...
| **<EntityLink id="openai">OpenAI</EntityLink> Grants** | \$10M | Interpretability, scalable oversight | 8% |
...
| **Red-teaming & Evaluations** | \$13M | METR, UK AISI, <EntityLink id="apollo-research">Apollo Research</EntityLink> | Growing rapidly; regulatory drivers |
