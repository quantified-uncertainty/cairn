...
ratings:
  ...
  actionability: 9
importance: 92.5
llmSummary: "Systematically maps 15+ AI safety interventions to specific risks with quantitative effectiveness estimates (10-80% reduction ranges), revealing critical misallocation: 40% of 2024 funding ($400M+) flows to RLHF showing 10-20% effectiveness against deceptive alignment, while interpretability ($52M, 40-50% effectiveness) and AI Control (70-80% theoretical effectiveness) remain severely underfunded. Provides concrete reallocation recommendation: shift $100M+ annually from RLHF (reduce to 25%) toward interpretability (increase to 30%) and AI Control (20%)."
