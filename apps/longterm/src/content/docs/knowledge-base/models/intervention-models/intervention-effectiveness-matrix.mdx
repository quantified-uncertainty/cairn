...
ratings:
  ...
  completeness: 7.9
importance: 92.5
llmSummary: "Systematic quantitative mapping of 15+ AI safety interventions to risk categories reveals critical misallocation: 40% of 2024 funding ($400M+) targets RLHF methods showing only 10-20% effectiveness against deceptive alignment, while interpretability ($52M, 40-50% effective) and AI Control (theoretical 70% effectiveness, $10M) remain severely underfunded. Cost-effectiveness analysis shows interpretability delivers risk reduction at $1.7-3.5M per percentage point versus $13-40M for RLHF."
