...
- Pre-IPO tax planning for charitable transfers saves them real money—this is genuinely in their financial interest.
...
|-------------|----------------------|---------|
| DAF pre-commitment (tax planning) | **Yes** — saves real money on capital gains | Collaborative: "let us help you optimize" |
...
|---|-------------|------------|-----------|-------------|
| 1 | **DAF pre-commitment** | Help founders transfer equity to donor-advised funds before IPO, when capital gains tax savings are largest. Reframes giving as tax optimization, not sacrifice. Founders' own employees have done this through Anthropic's matching program—makes it natural for founders too. **Key limitation**: DAFs are restricted to 501(c)(3) grants only. No political donations, no lobbying, no 501(c)(4) policy organizations like <EntityLink id="americans-for-responsible-innovation">ARI</EntityLink>. This rules out a significant fraction of AI governance work. Also, DAFs allow grants to any 501(c)(3), which includes many low-impact charities—donors retain full advisory discretion over allocation. | \$300K-1M | \$50-250M |
...
### Why These Numbers Differ from Naive Estimates

An earlier version of this analysis showed CE ratios of 1,000:1 to 88,000:1. Here's what was wrong:

| Bias | How It Inflated Estimates | Correction |
|------|--------------------------|------------|
| **Understated costs** | Listed \$50-200K for DAF campaign; ignored years of senior staff time building relationships with billionaires | 3-10x cost increase when hidden costs included |
| **Selection bias** | Assumed engaged founders would otherwise not give; the 2 founders with strongest giving track records are most likely to engage AND give regardless | 30-70% counterfactual discount |
| **Inflated P(Engage)** | Listed 20-40% for DAF campaign; billionaire CEOs don't take cold meetings about personal giving from external advocates | 2-4x reduction |
| **Ignored backfire risk** | Treated all interventions as ≥0 impact; public pressure campaigns can alienate donors | Some interventions may have negative EV |
| **Conflated fulfillment with high-impact allocation** | "Pledge fulfilled" ≠ "money goes to high-impact causes"; a founder could donate 80% to their alma mater | Further discount for cause allocation |
| **Ignored opportunity cost** | Didn't account for what senior staff at these organizations could do instead | Hard to quantify but significant |
...
| <EntityLink id="givewell">GiveWell</EntityLink> | Advise on allocation | <EntityLink id="dario-amodei">Dario Amodei</EntityLink>'s early involvement; trusted brand | GiveWell focuses on global health, not meta-philanthropy |
...
**What**: Help founders transfer equity to donor-advised funds pre-IPO, emphasizing significant capital gains tax savings.
...
**Why it might work**: This is the one intervention with a genuine *financial* incentive for founders. Pre-IPO DAF transfers can save millions in capital gains taxes. It reframes the ask from "bind yourself morally" to "optimize your taxes while doing what you already said you'd do." Founders' existing financial advisors may already be recommending this, which means the effective giving community's marginal contribution might be providing the *philanthropic framework* (which causes to support, how to structure giving).

**Why it might not**: Founders' personal wealth managers and tax attorneys are already advising them. They don't need effective giving organizations to tell them about DAFs. The marginal value is in *cause allocation advice*, not the vehicle itself. And DAFs preserve full advisory discretion—money in a DAF can go to any 501(c)(3), regardless of impact.
...
**Backfire risk**: Low. Tax planning is non-threatening and financially beneficial.
