...
|---|-------------|------------|-----------|-------------|
| 1 | **DAF pre-commitment** | Help founders transfer equity to donor-advised funds before IPO, when the behavioral commitment cost is lowest — equity is illiquid paper wealth, not yet a spendable dollar amount. The matching program (3:1 historically) means employees have already done this, making it natural for founders too. Donating appreciated stock avoids ≈37% capital gains tax vs. selling first, but this benefit applies at any time, not just pre-IPO. The pre-IPO advantage is behavioral lock-in, not tax mechanics. See <EntityLink id="anthropic-pre-ipo-daf-transfers">pre-IPO DAF analysis</EntityLink> for details. **Key limitation**: DAFs are restricted to 501(c)(3) grants only — no political donations, no lobbying, no 501(c)(4) organizations like <EntityLink id="americans-for-responsible-innovation">ARI</EntityLink>. DAFs also allow grants to any 501(c)(3), so donors retain full advisory discretion over allocation. | \$300K-1M | \$50-250M |
