...
importance: 25
llmSummary: Whole Brain Emulation (uploading/simulating biological brains) requires 5-10nm scanning resolution and 10^18-10^25 FLOPS. Despite completing the fruit fly connectome (140K neurons) in 2024, scanning a human brain (86B neurons) would take ~100,000 years at current rates. Estimated <1% probability of arriving before AI-based transformative AI, making it largely irrelevant for near-term prioritization.
ratings:
  novelty: 3.5
  rigor: 6.5
  actionability: 2
