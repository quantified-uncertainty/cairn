...
importance: 72.5
llmSummary: Heavy scaffolding/agentic systems combine foundation models with orchestration code, tools, and memory to achieve 77.2% on SWE-bench Verified (5.5x improvement since 2023) but face 45-60% error propagation rates and humans outperform AI 2:1 on 32-hour tasks. The paradigm has 25-40% probability of dominance at transformative AI, with clear capability gains offset by reliability constraints that may limit autonomous operation to sub-8-hour horizons.
ratings:
  novelty: 4.5
  rigor: 6.5
  actionability: 5
...
metrics:
  ...
  diagrams: 2
---
import {Mermaid, EntityLink, DataExternalLinks, DataInfoBox} from '../../../../components/wiki';

<DataExternalLinks pageId="heavy-scaffolding" client:load />

<DataInfoBox entityId="heavy-scaffolding" />
