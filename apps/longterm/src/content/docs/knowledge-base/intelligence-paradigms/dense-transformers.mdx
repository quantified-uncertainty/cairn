...
- [Sparse/MoE Transformers](/knowledge-base/intelligence-paradigms/sparse-moe) - Efficiency-focused variant
- [Heavy Scaffolding](/knowledge-base/intelligence-paradigms/heavy-scaffolding) - How transformers are deployed
