...
|-------|------|-------------------|----------------|--------|
| **GPT-3** | 2020 | ~$4.6M | Compute-dominated | Industry estimates |
| **GPT-4** | 2023 | $100M-540M | Hardware: $40M amortized; staff: tens of millions | [Sam Altman public statements](https://fortune.com/2024/04/04/ai-training-costs-how-much-is-too-much-openai-gpt-anthropic-microsoft/) |
| **Llama 3.1 405B** | 2024 | ~$500M | 39.3M H100 GPU-hours at 700W TDP | [Meta Technical Report](https://ai.meta.com/blog/meta-llama-3-1/) |
| **2024 frontier models** | 2024 | greater than $1B | Research + inference: ~$7B total for OpenAI | [Epoch AI analysis](https://epoch.ai/data-insights/openai-compute-spend) |
| **2025-2027 projected** | 2025-27 | $5B-10B | Dario Amodei prediction | [Entrepreneur](https://www.entrepreneur.com/business-news/anthropic-ceo-ai-will-cost-10-billion-to-train-by-2025/476750) |
...
**Investment scale:** Microsoft has invested over $13B in OpenAI since 2019. Amazon and Google have invested $4B and $2B respectively in Anthropic. Microsoft reported plans to invest approximately $80B in FY2025 for AI-enabled data centers.
...
The transformer ecosystem represents approximately **$50B+ in specialized hardware** (H100s, TPUs optimized for attention), **8 years of tooling development** (PyTorch, JAX, CUDA kernels), and **thousands of trained researchers**. Microsoft alone plans to invest approximately $80B in FY2025 for AI-enabled data centers. Alternative architectures like Mamba face a massive disadvantage even if theoretically superior.

**Investment concentration:** OpenAI has received over $13B from Microsoft since 2019. Anthropic has received $4B from Amazon and $2B from Google. This capital is overwhelmingly directed at transformer-based development.
...
- Epoch AI (2024). ["Most of OpenAI's 2024 compute went to experiments"](https://epoch.ai/data-insights/openai-compute-spend). (~$5B R&D, ~$2B inference)
