...
importance: 5
quality: 24
llmSummary: "Auto-generated technical documentation listing 35 entity types (risks, capabilities, interventions, organizations) and 41 relationship types (causal, mitigation, structural) used in the wiki's data schema, with workflow diagrams showing YAML validation and build pipeline."
ratings:
  novelty: 0
  rigor: 4
  actionability: 2
