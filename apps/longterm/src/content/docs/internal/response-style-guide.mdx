...
| Level | Requirements |
|-------|--------------|
| 80-100 | Assessment table, diagram, 5+ citations, quantified effectiveness, **substantive prose paragraphs** (not just tables/outlines) |
| 60-79 | Assessment table, some citations, clear mechanism, explanatory prose between tables |
