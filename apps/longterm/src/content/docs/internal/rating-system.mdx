...
importance: 5
quality: 48
llmSummary: "This page documents LongtermWiki's content rating system, which combines LLM-graded subscores (novelty, rigor, actionability, completeness on 0-10 scales) with automated metrics (word count, citations) to derive quality scores (0-100) and importance ratings for prioritization decisions."
ratings:
  novelty: 2
  rigor: 6.5
  actionability: 7
