---
title: "Rating System"
description: "Reference documentation for CAIRN's content quality and importance rating system"
pageType: "documentation"
sidebar:
  order: 6
importance: 5
quality: 48
llmSummary: "This page documents CAIRN's content rating system, which combines LLM-graded subscores (novelty, rigor, actionability, completeness on 0-10 scales) with automated metrics (word count, citations) to derive quality scores (0-100) and importance ratings for prioritization decisions."
ratings:
  novelty: 2
  rigor: 6.5
  actionability: 7
...
CAIRN uses a multi-dimensional rating system combining LLM-graded subscores with automated metrics to produce a derived quality score (0-100).
...
npm run validate:templates    # Template structure
npm run validate:placeholders # Incomplete content
```
