...
| **"Crux" has traction in target audience** | Rationalist/EA community already uses "crux" terminology from CFAR | Strong candidate for naming |
...
This report surveys similar conceptual frameworks across multiple fields to identify appropriate terminology for CAIRN's factor visualization system. We examined:
...
IBIS's focus on structuring discourse around "wicked problems" resonates with CAIRN's goal. The emphasis on capturing positions and arguments for/against is similar to how we model different views on factors.
</Aside>
...
| Strength | Weakness |
|----------|----------|
| Directly relevant to CAIRN's mission | "Consideration" is abstract |
...
The crux concept directly aligns with CAIRN's goal of mapping key uncertainties that drive prioritization. "What would change your mind about this intervention?" is exactly what we're trying to capture.
</Aside>
...
| **Fit with CAIRN** | Excellent—aligns with Crux Graph component |

<Aside type="tip" title="Recommended">
"Crux Map" directly aligns with CAIRN's mission (mapping key uncertainties) and the target audience's vocabulary. The "crux" terminology is already established in the rationalist/EA community.
</Aside>
...
| **Fit with CAIRN** | Good—neutral, accessible |
...
| **Fit with CAIRN** | Good—clear meaning |
...
| **Fit with CAIRN** | Good—connects to "crucial considerations" |
...
| **Fit with CAIRN** | Moderate—less about uncertainty |
...
| **Fit with CAIRN** | Moderate—captures decision-relevance |
...
| **Fit with CAIRN** | Moderate—overemphasizes changeability |
...
**Rationale**:
1. Directly aligns with CAIRN's mission ("Crux Graph" is already a core component)
