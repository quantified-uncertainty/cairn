...
description: "Working document exploring failure modes, definitions of success, and strategic options for CAIRN"
sidebar:
  order: 2
---
...
Can we name 10 specific people who would use CAIRN weekly? If not, we need to do user research before building.
</Aside>
...
- [ ] Research what happened to similar past projects ✓ (see [Similar Projects Analysis](./similar-projects/))
