...
The impact estimates in Appendix B below are **naive estimates** that don't account for base rates. For rigorous Fermi estimation grounded in GiveWell, 80k Hours, and think tank data, see the [LongtermWiki Impact Model](/knowledge-base/models/impact-models/longtermwiki-impact).
