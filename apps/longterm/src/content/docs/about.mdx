...
importance: 22
quality: 43
llmSummary: "Meta-page providing transparency about wiki creation (AI-assisted via Claude), acknowledging systematic biases toward AI safety community perspective, and providing explicit guidance for evaluating claims. Includes quantitative wiki statistics and detailed limitations disclosure."
ratings:
  novelty: 4.5
  rigor: 6
  actionability: 3
...
- Shared funding sources (Coefficient Giving, EA funders)
