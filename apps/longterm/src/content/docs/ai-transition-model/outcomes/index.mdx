...
1. **Transition Turbulence is a pathway, not endpoint**: How rough the transition is affects *both* existential catastrophe and long-term trajectory. It belongs in <EntityLink id="__index__/ai-transition-model/factors/transition-turbulence">Root Factors</EntityLink>.
