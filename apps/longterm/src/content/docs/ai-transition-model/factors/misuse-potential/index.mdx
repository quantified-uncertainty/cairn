...
description: >-
  Root factor measuring the risk of AI being weaponized or exploited by
  malicious actors. Primary driver of Human-Caused Catastrophe scenarios.
sidebar:
  label: Overview
  order: 0
...
Misuse Potential and <EntityLink id="__index__/ai-transition-model/factors/misalignment-potential">Misalignment Potential</EntityLink> are complementary risk factors:
...
- <EntityLink id="__index__/ai-transition-model/factors/misalignment-potential">Misalignment Potential</EntityLink> — The complementary factor for AI-caused catastrophe
- <EntityLink id="__index__/ai-transition-model/factors/civilizational-competence">Civilizational Competence</EntityLink> — Governance can moderate misuse through regulation
