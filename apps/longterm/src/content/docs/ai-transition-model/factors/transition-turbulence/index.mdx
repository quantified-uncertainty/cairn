...
description: >-
  Root factor measuring disruption during the AI transition. High turbulence
  increases risk across all scenarios.
sidebar:
  label: Overview
  order: 0
...
Transition Turbulence measures how much disruption occurs as society navigates from current AI to whatever future emerges. Unlike <EntityLink id="__index__/ai-transition-model/scenarios">Ultimate Scenarios</EntityLink> (which describe *what* happens), Transition Turbulence describes *how rough the journey is*—and that roughness affects both whether we survive (<EntityLink id="existential-catastrophe">Existential Catastrophe</EntityLink>) and what world we end up in (<EntityLink id="long-term-trajectory">Long-term Trajectory</EntityLink>).
...
|---------------------|--------------|
| <EntityLink id="__index__/ai-transition-model/scenarios/ai-takeover">AI Takeover</EntityLink> | Turbulence increases risk of loss of control |
| <EntityLink id="__index__/ai-transition-model/scenarios/human-catastrophe">Human-Caused Catastrophe</EntityLink> | Turbulence can trigger state failures and desperate actions |
| <EntityLink id="__index__/ai-transition-model/scenarios/long-term-lockin">Long-term Lock-in</EntityLink> | Turbulent periods often lock in emergency measures |
...
### Ultimate Scenarios
- <EntityLink id="__index__/ai-transition-model/scenarios/long-term-lockin">Long-term Lock-in</EntityLink> — Crisis periods often lock in values/power structures
- <EntityLink id="__index__/ai-transition-model/scenarios/ai-takeover">AI Takeover</EntityLink> — Turbulence increases loss of control risk
