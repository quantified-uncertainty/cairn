...
Ultimate Scenarios are the intermediate pathways that connect <EntityLink id="__index__/ai-transition-model/factors">root factors</EntityLink> to <EntityLink id="__index__/ai-transition-model/outcomes">ultimate outcomes</EntityLink>. They describe *how* parameter changes lead to catastrophe (or success)—the specific mechanisms and pathways that determine what kind of future we get.

The <EntityLink id="__index__/ai-transition-model">AI Transition Model</EntityLink> uses **three main ultimate scenarios**:

1. **<EntityLink id="__index__/ai-transition-model/scenarios/ai-takeover">AI Takeover</EntityLink>** — AI gains decisive control
2. **<EntityLink id="__index__/ai-transition-model/scenarios/human-catastrophe">Human-Caused Catastrophe</EntityLink>** — Humans use AI for mass harm
3. **<EntityLink id="__index__/ai-transition-model/scenarios/long-term-lockin">Long-term Lock-in</EntityLink>** — Permanent entrenchment of values/power
...
- <EntityLink id="__index__/ai-transition-model/factors">Root Factors</EntityLink> — The parameter groupings that feed into ultimate scenarios
- <EntityLink id="__index__/ai-transition-model/outcomes">Ultimate Outcomes</EntityLink> — The high-level goals ultimate scenarios affect
