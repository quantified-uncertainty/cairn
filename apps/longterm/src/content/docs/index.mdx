...
1. [AI Transition Model](/ai-transition-model/) - Framework for understanding AI outcomes
2. [Explore All Content](/explore/) - Browse the complete database
...
<CardGrid>
  ...
  <Card title="Start Learning" icon="open-book">
    [Explore the AI Transition Model →](/ai-transition-model/)
  </Card>
</CardGrid>
