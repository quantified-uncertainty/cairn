...
<Aside type="tip" title="Why This Matters for CAIRN">
CAIRN aims to be more than a wiki. The Critical Insight framework helps distinguish between content that merely documents existing knowledge versus content that genuinely moves the needle on how people reason about AI safety priorities.
</Aside>
...
## Application to CAIRN

CAIRN content can be evaluated against the Critical Insight framework:
