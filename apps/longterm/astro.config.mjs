          ...
          sidebar: [
              ...
              },
              {
                  ...
                  items: [
                      ...
                      { label: 'Venture Capital', collapsed: true, autogenerate: { directory: 'knowledge-base/organizations/venture-capital' } },
                      { label: 'AI Finance', collapsed: true, autogenerate: { directory: 'knowledge-base/organizations/finance' } },
