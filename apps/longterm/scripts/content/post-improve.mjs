 ...
 *
 * Usage:
 *   node scripts/content/post-improve.mjs              # Run all fixes
 *   node scripts/content/post-improve.mjs --fix-only   # Only fix, don't re-grade
 *   node scripts/content/post-improve.mjs --grade-only # Only re-grade
 */
...
async function runGrading(limit) {
  ...
  return new Promise((resolve) => {
    const proc = spawn('node', [
      'scripts/content/grade-content.mjs',
