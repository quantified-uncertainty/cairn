 ...
 *
 * Usage:
 *   node scripts/grade-by-template.mjs                    # Grade all pages
 *   node scripts/grade-by-template.mjs --template knowledge-base-risk  # Specific template
 *   node scripts/grade-by-template.mjs --page bioweapons  # Specific page
 *   node scripts/grade-by-template.mjs --json             # Output as JSON
 *   node scripts/grade-by-template.mjs --csv              # Output as CSV
 *   node scripts/grade-by-template.mjs --failing          # Only show failing pages
 *   node scripts/grade-by-template.mjs --top 20           # Show top 20 lowest scores
 */
