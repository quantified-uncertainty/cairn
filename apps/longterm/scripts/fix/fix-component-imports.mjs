 ...
 *
 * Usage:
 *   npm run crux -- fix imports              # Preview changes (dry run)
 *   npm run crux -- fix imports --apply      # Apply changes
 *   npm run crux -- fix imports --verbose    # Show detailed info
 *   npm run crux -- fix imports --file path  # Fix single file
 */
