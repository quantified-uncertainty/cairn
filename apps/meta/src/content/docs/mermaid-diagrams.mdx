...
importance: 0
quality: 45
llmSummary: "Internal style guide for creating Mermaid diagrams in the wiki, providing layout rules, color palettes, and best practices to ensure diagrams render well in narrow content areas. Recommends vertical layouts over horizontal, tables for taxonomies, and includes anti-patterns to avoid."
---
