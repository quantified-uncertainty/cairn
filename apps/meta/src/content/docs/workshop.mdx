...
|---------|-------------|-------|
| [LongTermWiki](https://longtermwiki.com/) | Comprehensive AI safety knowledge navigator — risks, interventions, organizations, key uncertainties | ~500 pages, YAML data layer, custom components |
...
The source for both is at [github.com/quantified-uncertainty/cairn](https://github.com/quantified-uncertainty/cairn). LongTermWiki took months of iterative work, but the basic structure was scaffolded in a single session.
...
For [LongTermWiki](https://longtermwiki.com/) (~500 pages), we eventually added:
...
| **LongTermWiki source** | [github.com/quantified-uncertainty/cairn](https://github.com/quantified-uncertainty/cairn) |
