...
2. **Scaffold the project** (ideally done before arriving — see [pre-workshop setup](#before-the-workshop--do-this-now))
...
- **Deploy it** — Having a live URL motivates you to keep improving. Takes 5 minutes with Netlify or Vercel (see [deployment options](#deployment-options) below).
- **Run `/init`** to create a `CLAUDE.md` if you haven't — makes every future session more productive (see [CLAUDE.md reference](#claudemd-teaching-claude-about-your-project) below)
