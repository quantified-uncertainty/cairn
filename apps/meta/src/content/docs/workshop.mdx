...
<Aside type="tip" title="Use Any LLM as Your Guide">
As you work through this workshop, keep an LLM chat open — [Claude.ai](https://claude.ai), ChatGPT, Gemini, or whichever you prefer. You can ask it questions at any step: "What does this terminal error mean?", "Help me pick a good topic structure", "Explain what `npm run dev` does", etc. Think of it as a knowledgeable assistant sitting next to you. This is separate from Claude Code (which edits your files directly) — any LLM chat works for getting unstuck and asking questions along the way.
</Aside>
...
**Slides:** [Google Slides](https://docs.google.com/presentation/d/1JAm0jZ-3Hu2rgYug6sy-5l5vjhYYPovy/edit)
...
| Resource | URL |
|----------|-----|
| **Workshop slides** | [Google Slides](https://docs.google.com/presentation/d/1JAm0jZ-3Hu2rgYug6sy-5l5vjhYYPovy/edit) |
