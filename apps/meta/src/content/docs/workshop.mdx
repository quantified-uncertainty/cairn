...
2. **Go to [claude.ai/code](https://claude.ai/code)** — this gives you a full development environment in your browser (terminal, file editor, web preview — everything you need)
...
<Tabs>
  <TabItem label="Web App (easiest)">
    ...
    4. You get a built-in terminal, file editor, and web preview — all in one browser tab

    The web app handles Node.js, npm, dev servers, and file editing for you. You can scaffold your project, run Claude Code, and preview your site without installing anything locally.
...
<Tabs>
  <TabItem label="Web App">
    The web app at [claude.ai/code](https://claude.ai/code) handles this for you — Claude Code, the terminal, file editor, and web preview are all in one interface. You can:

    - **Chat with Claude** in the main panel
    - **See file changes** as Claude makes them
    - **Preview your site** in the built-in browser pane
    - **Use the terminal** for git commands or manual operations

    No split-pane setup needed — just start building.
  </TabItem>
...
2. **Scaffold the project**
   ...
   <Tabs>
     <TabItem label="Web App">
       ...
       Claude will run the commands, install dependencies, and start the dev server. You'll see the site appear in the preview pane.
     </TabItem>
...
3. **Start the dev server and Claude Code**
   ...
   <Tabs>
     <TabItem label="Web App">
       If you asked Claude to run `npm run dev` in the previous step, it's already running. You should see your site in the preview pane. If you used the QURI starter, you'll see "My Research Wiki" — if vanilla Starlight, "Welcome to Starlight."

       You're already chatting with Claude — skip to step 5.
     </TabItem>
     <TabItem label="Local CLI">
