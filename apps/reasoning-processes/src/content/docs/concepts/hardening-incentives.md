...
*Family 5 of the [Hardening overview](/concepts/hardening-techniques/). Where the producer is a strategic agent, the move is mechanism design: arrange payoffs so truth-telling is the equilibrium. The lever, its limit, the constructions, and a worked bound.*
...
|---|---|---|---|---|
| Escrow-and-clawback credit | persuasion surplus $\le$ unvalidated weight (below) **[exact]** | paying out on belief-movement before resolution | prototyped | — |
