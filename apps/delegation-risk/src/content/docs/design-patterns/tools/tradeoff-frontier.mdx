...
| More autonomy | Higher delegation risk |
...
- [Delegation Risk Calculator](/design-patterns/tools/delegation-risk-calculator/) — Quantify your risk exposure
- [Risk Inheritance](/design-patterns/tools/trust-propagation/) — Model trust through delegation chains
- [Decision Guide](/design-patterns/tools/decision-guide/) — Choose implementation approach
