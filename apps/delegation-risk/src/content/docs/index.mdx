...
hero:
  ...
  actions:
    - text: Get Started
      ...
      icon: right-arrow
    - text: Download PDF
      link: https://github.com/quantified-uncertainty/delegation-risk-framework/releases/download/v1.0.0/delegation-risk-framework-book.pdf
      icon: document
      variant: secondary
    - text: GitHub
...
**Navigation Guides**: [Reading Order](/getting-started/reading-order/) · [Site Map](/reference/site-map/)
